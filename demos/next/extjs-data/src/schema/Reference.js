 ...
 *
 * + {@link Field#reference reference config}
 *
 ...
 * value for such a field matches the value of the {@link Model#idProperty id}
 ...
 *      });
 *
 * If the name of the generated {@link Association association} or other aspects
...
/**
 * @cfg {Boolean} [unique] `true` True for this reference to create a `OneToOne`
 * relationship. If not specified, the default is `ManyToOne`.
 */
