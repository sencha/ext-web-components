...
export default class Mz_pivot_Grid extends Ext_grid_Panel {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Mz_pivot_Grid.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Mz_pivot_Grid.PROPERTIES()),
            events.concat(Mz_pivot_Grid.EVENTS())
        )
    }
