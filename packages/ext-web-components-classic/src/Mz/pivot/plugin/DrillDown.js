...
export default class Mz_pivot_plugin_DrillDown extends Ext_plugin_Abstract {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Mz_pivot_plugin_DrillDown.PROPERTIES()),
      events.concat(Mz_pivot_plugin_DrillDown.EVENTS())
    )
  }
