...
export default class Mz_pivot_Table extends Ext_grid_Panel {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Mz_pivot_Table.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Mz_pivot_Table.PROPERTIES()),
            events.concat(Mz_pivot_Table.EVENTS())
        )
    }
