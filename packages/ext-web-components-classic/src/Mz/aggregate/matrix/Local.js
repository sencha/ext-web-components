...
export default class Mz_aggregate_matrix_Local extends Ext_pivot_matrix_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Mz_aggregate_matrix_Local.PROPERTIES()),
      events.concat(Mz_aggregate_matrix_Local.EVENTS())
    )
  }
