...
export default class Ext_exporter_file_ooxml_excel_Font extends Ext_exporter_file_ooxml_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_exporter_file_ooxml_excel_Font.PROPERTIES()),
      events.concat(Ext_exporter_file_ooxml_excel_Font.EVENTS())
    )
  }
