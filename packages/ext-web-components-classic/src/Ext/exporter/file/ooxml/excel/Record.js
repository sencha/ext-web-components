...
export default class Ext_exporter_file_ooxml_excel_Record extends Ext_exporter_file_ooxml_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_exporter_file_ooxml_excel_Record.PROPERTIES()),
      events.concat(Ext_exporter_file_ooxml_excel_Record.EVENTS())
    )
  }
