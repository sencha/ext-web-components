...
export default class Ext_exporter_file_ooxml_excel_Fill extends Ext_exporter_file_ooxml_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_exporter_file_ooxml_excel_Fill.PROPERTIES()),
      events.concat(Ext_exporter_file_ooxml_excel_Fill.EVENTS())
    )
  }
