...
export default class Ext_exporter_file_ooxml_excel_Stylesheet extends Ext_exporter_file_ooxml_Xml {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_exporter_file_ooxml_excel_Stylesheet.PROPERTIES()),
      events.concat(Ext_exporter_file_ooxml_excel_Stylesheet.EVENTS())
    )
  }
