...
export default class Ext_exporter_file_ooxml_Relationship extends Ext_exporter_file_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_exporter_file_ooxml_Relationship.PROPERTIES()),
      events.concat(Ext_exporter_file_ooxml_Relationship.EVENTS())
    )
  }
