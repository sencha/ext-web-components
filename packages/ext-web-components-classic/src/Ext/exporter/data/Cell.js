...
export default class Ext_exporter_data_Cell extends Ext_exporter_data_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_exporter_data_Cell.PROPERTIES()),
      events.concat(Ext_exporter_data_Cell.EVENTS())
    )
  }
