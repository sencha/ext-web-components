...
export default class Ext_exporter_excel_Xlsx extends Ext_exporter_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_exporter_excel_Xlsx.PROPERTIES()),
      events.concat(Ext_exporter_excel_Xlsx.EVENTS())
    )
  }
