...
export default class Ext_ColorPalette extends Ext_Component {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_ColorPalette.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_ColorPalette.PROPERTIES()),
            events.concat(Ext_ColorPalette.EVENTS())
        )
    }
