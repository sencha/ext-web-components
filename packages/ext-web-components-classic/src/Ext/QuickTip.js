...
export default class Ext_QuickTip extends Ext_tip_ToolTip {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_QuickTip.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_QuickTip.PROPERTIES()),
            events.concat(Ext_QuickTip.EVENTS())
        )
    }
