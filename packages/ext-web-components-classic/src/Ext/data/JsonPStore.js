...
export default class Ext_data_JsonPStore extends Ext_data_Store {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_data_JsonPStore.PROPERTIES()),
      events.concat(Ext_data_JsonPStore.EVENTS())
    )
  }
