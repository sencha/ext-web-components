...
export default class Ext_data_query_Compiler extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_data_query_Compiler.PROPERTIES()),
      events.concat(Ext_data_query_Compiler.EVENTS())
    )
  }
