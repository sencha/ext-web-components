...
export default class Ext_data_summary_Base extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_data_summary_Base.PROPERTIES()),
      events.concat(Ext_data_summary_Base.EVENTS())
    )
  }
