...
export default class Ext_data_schema_Schema extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_data_schema_Schema.PROPERTIES()),
      events.concat(Ext_data_schema_Schema.EVENTS())
    )
  }
