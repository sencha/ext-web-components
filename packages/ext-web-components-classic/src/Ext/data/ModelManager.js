...
export default class Ext_data_ModelManager extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_data_ModelManager.PROPERTIES()),
      events.concat(Ext_data_ModelManager.EVENTS())
    )
  }
