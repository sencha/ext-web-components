...
export default class Ext_data_SimpleStore extends Ext_data_Store {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_data_SimpleStore.PROPERTIES()),
      events.concat(Ext_data_SimpleStore.EVENTS())
    )
  }
