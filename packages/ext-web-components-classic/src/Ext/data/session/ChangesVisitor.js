...
export default class Ext_data_session_ChangesVisitor extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_data_session_ChangesVisitor.PROPERTIES()),
      events.concat(Ext_data_session_ChangesVisitor.EVENTS())
    )
  }
