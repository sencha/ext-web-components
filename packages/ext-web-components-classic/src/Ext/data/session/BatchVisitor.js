...
export default class Ext_data_session_BatchVisitor extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_data_session_BatchVisitor.PROPERTIES()),
      events.concat(Ext_data_session_BatchVisitor.EVENTS())
    )
  }
