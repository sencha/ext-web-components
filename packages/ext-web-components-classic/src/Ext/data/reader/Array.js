...
export default class Ext_data_reader_Array extends Ext_data_reader_Json {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_data_reader_Array.PROPERTIES()),
      events.concat(Ext_data_reader_Array.EVENTS())
    )
  }
