...
export default class Ext_data_reader_Reader extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_data_reader_Reader.PROPERTIES()),
      events.concat(Ext_data_reader_Reader.EVENTS())
    )
  }
