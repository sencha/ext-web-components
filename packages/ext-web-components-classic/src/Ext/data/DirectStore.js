...
export default class Ext_data_DirectStore extends Ext_data_Store {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_data_DirectStore.PROPERTIES()),
      events.concat(Ext_data_DirectStore.EVENTS())
    )
  }
