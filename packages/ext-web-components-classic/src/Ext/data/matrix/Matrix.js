...
export default class Ext_data_matrix_Matrix extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_data_matrix_Matrix.PROPERTIES()),
      events.concat(Ext_data_matrix_Matrix.EVENTS())
    )
  }
