...
export default class Ext_data_validator_Number extends Ext_data_validator_Validator {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_data_validator_Number.PROPERTIES()),
      events.concat(Ext_data_validator_Number.EVENTS())
    )
  }
