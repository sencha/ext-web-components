...
export default class Ext_data_validator_Email extends Ext_data_validator_Format {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_data_validator_Email.PROPERTIES()),
      events.concat(Ext_data_validator_Email.EVENTS())
    )
  }
