...
export default class Ext_data_validator_Url extends Ext_data_validator_Format {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_data_validator_Url.PROPERTIES()),
      events.concat(Ext_data_validator_Url.EVENTS())
    )
  }
