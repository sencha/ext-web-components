...
export default class Ext_data_validator_IPAddress extends Ext_data_validator_Format {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_data_validator_IPAddress.PROPERTIES()),
      events.concat(Ext_data_validator_IPAddress.EVENTS())
    )
  }
