...
export default class Ext_data_virtual_Group extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_data_virtual_Group.PROPERTIES()),
      events.concat(Ext_data_virtual_Group.EVENTS())
    )
  }
