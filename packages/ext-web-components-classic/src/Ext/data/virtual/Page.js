...
export default class Ext_data_virtual_Page extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_data_virtual_Page.PROPERTIES()),
      events.concat(Ext_data_virtual_Page.EVENTS())
    )
  }
