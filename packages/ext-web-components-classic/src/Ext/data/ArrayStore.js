...
export default class Ext_data_ArrayStore extends Ext_data_Store {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_data_ArrayStore.PROPERTIES()),
      events.concat(Ext_data_ArrayStore.EVENTS())
    )
  }
