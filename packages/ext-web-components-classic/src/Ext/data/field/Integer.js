...
export default class Ext_data_field_Integer extends Ext_data_field_Field {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_data_field_Integer.PROPERTIES()),
      events.concat(Ext_data_field_Integer.EVENTS())
    )
  }
