...
export default class Ext_data_field_Boolean extends Ext_data_field_Field {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_data_field_Boolean.PROPERTIES()),
      events.concat(Ext_data_field_Boolean.EVENTS())
    )
  }
