...
export default class Ext_pivot_result_Base extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_pivot_result_Base.PROPERTIES()),
      events.concat(Ext_pivot_result_Base.EVENTS())
    )
  }
