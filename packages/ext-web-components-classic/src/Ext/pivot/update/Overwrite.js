...
export default class Ext_pivot_update_Overwrite extends Ext_pivot_update_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_pivot_update_Overwrite.PROPERTIES()),
      events.concat(Ext_pivot_update_Overwrite.EVENTS())
    )
  }
