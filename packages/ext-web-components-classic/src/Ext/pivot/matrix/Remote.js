...
export default class Ext_pivot_matrix_Remote extends Ext_pivot_matrix_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_pivot_matrix_Remote.PROPERTIES()),
      events.concat(Ext_pivot_matrix_Remote.EVENTS())
    )
  }
