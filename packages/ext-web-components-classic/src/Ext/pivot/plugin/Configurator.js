...
export default class Ext_pivot_plugin_Configurator extends Ext_plugin_Abstract {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_pivot_plugin_Configurator.PROPERTIES()),
      events.concat(Ext_pivot_plugin_Configurator.EVENTS())
    )
  }
