...
export default class Ext_util_XTemplateParser extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_util_XTemplateParser.PROPERTIES()),
      events.concat(Ext_util_XTemplateParser.EVENTS())
    )
  }
