...
export default class Ext_util_AbstractMixedCollection extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_util_AbstractMixedCollection.PROPERTIES()),
      events.concat(Ext_util_AbstractMixedCollection.EVENTS())
    )
  }
