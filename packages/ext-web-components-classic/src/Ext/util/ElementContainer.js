...
export default class Ext_util_ElementContainer extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_util_ElementContainer.PROPERTIES()),
      events.concat(Ext_util_ElementContainer.EVENTS())
    )
  }
