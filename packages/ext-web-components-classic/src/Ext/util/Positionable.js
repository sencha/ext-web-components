...
export default class Ext_util_Positionable extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_util_Positionable.PROPERTIES()),
      events.concat(Ext_util_Positionable.EVENTS())
    )
  }
