...
export default class Ext_util_SorterCollection extends Ext_util_Collection {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_util_SorterCollection.PROPERTIES()),
      events.concat(Ext_util_SorterCollection.EVENTS())
    )
  }
