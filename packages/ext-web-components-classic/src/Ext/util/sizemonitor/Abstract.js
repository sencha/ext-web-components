...
export default class Ext_util_sizemonitor_Abstract extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_util_sizemonitor_Abstract.PROPERTIES()),
      events.concat(Ext_util_sizemonitor_Abstract.EVENTS())
    )
  }
