...
export default class Ext_util_CollectionKey extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_util_CollectionKey.PROPERTIES()),
      events.concat(Ext_util_CollectionKey.EVENTS())
    )
  }
