...
export default class Ext_util_GroupCollection extends Ext_util_Collection {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_util_GroupCollection.PROPERTIES()),
      events.concat(Ext_util_GroupCollection.EVENTS())
    )
  }
