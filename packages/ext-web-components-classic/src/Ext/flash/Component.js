...
export default class Ext_flash_Component extends Ext_Component {
    ...
    {name:'failure', parameters:'sender'},
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_flash_Component.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_flash_Component.PROPERTIES()),
            events.concat(Ext_flash_Component.EVENTS())
        )
    }
