...
export default class Ext_list_ListView extends Ext_panel_Table {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_list_ListView.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_list_ListView.PROPERTIES()),
            events.concat(Ext_list_ListView.EVENTS())
        )
    }
