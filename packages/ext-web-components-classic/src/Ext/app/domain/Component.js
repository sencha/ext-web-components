...
export default class Ext_app_domain_Component extends Ext_app_EventDomain {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_app_domain_Component.PROPERTIES()),
      events.concat(Ext_app_domain_Component.EVENTS())
    )
  }
