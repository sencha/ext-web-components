...
export default class Ext_container_Monitor extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_container_Monitor.PROPERTIES()),
      events.concat(Ext_container_Monitor.EVENTS())
    )
  }
