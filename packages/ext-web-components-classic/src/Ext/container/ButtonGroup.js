...
export default class Ext_container_ButtonGroup extends Ext_panel_Panel {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_container_ButtonGroup.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_container_ButtonGroup.PROPERTIES()),
            events.concat(Ext_container_ButtonGroup.EVENTS())
        )
    }
