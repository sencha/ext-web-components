...
export default class Ext_layout_HBoxLayout extends Ext_layout_container_Box {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_layout_HBoxLayout.PROPERTIES()),
      events.concat(Ext_layout_HBoxLayout.EVENTS())
    )
  }
