...
export default class Ext_layout_boxOverflow_None extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_layout_boxOverflow_None.PROPERTIES()),
      events.concat(Ext_layout_boxOverflow_None.EVENTS())
    )
  }
