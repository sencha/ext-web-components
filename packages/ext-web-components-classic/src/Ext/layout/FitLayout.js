...
export default class Ext_layout_FitLayout extends Ext_layout_container_Container {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_layout_FitLayout.PROPERTIES()),
      events.concat(Ext_layout_FitLayout.EVENTS())
    )
  }
