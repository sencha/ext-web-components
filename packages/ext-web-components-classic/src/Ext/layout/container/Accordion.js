...
export default class Ext_layout_container_Accordion extends Ext_layout_container_VBox {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_layout_container_Accordion.PROPERTIES()),
      events.concat(Ext_layout_container_Accordion.EVENTS())
    )
  }
