...
export default class Ext_layout_container_boxOverflow_Menu extends Ext_layout_container_boxOverflow_None {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_layout_container_boxOverflow_Menu.PROPERTIES()),
      events.concat(Ext_layout_container_boxOverflow_Menu.EVENTS())
    )
  }
