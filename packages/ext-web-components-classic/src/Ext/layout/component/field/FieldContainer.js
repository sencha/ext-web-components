...
export default class Ext_layout_component_field_FieldContainer extends Ext_layout_component_Auto {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_layout_component_field_FieldContainer.PROPERTIES()),
      events.concat(Ext_layout_component_field_FieldContainer.EVENTS())
    )
  }
