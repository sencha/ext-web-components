...
export default class Ext_dd_DragDropManager extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_dd_DragDropManager.PROPERTIES()),
      events.concat(Ext_dd_DragDropManager.EVENTS())
    )
  }
