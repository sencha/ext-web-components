...
export default class Ext_event_publisher_Focus extends Ext_event_publisher_Dom {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_event_publisher_Focus.PROPERTIES()),
      events.concat(Ext_event_publisher_Focus.EVENTS())
    )
  }
