...
export default class Ext_ItemCollection extends Ext_util_MixedCollection {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_ItemCollection.PROPERTIES()),
      events.concat(Ext_ItemCollection.EVENTS())
    )
  }
