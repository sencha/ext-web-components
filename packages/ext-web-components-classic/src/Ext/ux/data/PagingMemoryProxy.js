...
export default class Ext_ux_data_PagingMemoryProxy extends Ext_data_proxy_Memory {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_ux_data_PagingMemoryProxy.PROPERTIES()),
      events.concat(Ext_ux_data_PagingMemoryProxy.EVENTS())
    )
  }
