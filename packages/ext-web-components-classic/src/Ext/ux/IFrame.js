...
export default class Ext_ux_IFrame extends Ext_Component {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_ux_IFrame.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_ux_IFrame.PROPERTIES()),
            events.concat(Ext_ux_IFrame.EVENTS())
        )
    }
