...
export default class Ext_ux_statusbar_StatusBar extends Ext_toolbar_Toolbar {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_ux_statusbar_StatusBar.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_ux_statusbar_StatusBar.PROPERTIES()),
            events.concat(Ext_ux_statusbar_StatusBar.EVENTS())
        )
    }
