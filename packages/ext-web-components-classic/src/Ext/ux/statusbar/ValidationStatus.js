...
export default class Ext_ux_statusbar_ValidationStatus extends Ext_Component {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_ux_statusbar_ValidationStatus.PROPERTIES()),
      events.concat(Ext_ux_statusbar_ValidationStatus.EVENTS())
    )
  }
