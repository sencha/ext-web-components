...
export default class Ext_ux_FieldReplicator extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_ux_FieldReplicator.PROPERTIES()),
      events.concat(Ext_ux_FieldReplicator.EVENTS())
    )
  }
