...
export default class Ext_ux_colorpick_SliderAlpha extends Ext_ux_colorpick_Slider {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_ux_colorpick_SliderAlpha.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_ux_colorpick_SliderAlpha.PROPERTIES()),
            events.concat(Ext_ux_colorpick_SliderAlpha.EVENTS())
        )
    }
