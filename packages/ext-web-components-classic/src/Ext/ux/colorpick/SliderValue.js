...
export default class Ext_ux_colorpick_SliderValue extends Ext_ux_colorpick_Slider {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_ux_colorpick_SliderValue.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_ux_colorpick_SliderValue.PROPERTIES()),
            events.concat(Ext_ux_colorpick_SliderValue.EVENTS())
        )
    }
