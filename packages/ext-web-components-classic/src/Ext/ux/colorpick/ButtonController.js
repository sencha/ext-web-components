...
export default class Ext_ux_colorpick_ButtonController extends Ext_app_ViewController {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_ux_colorpick_ButtonController.PROPERTIES()),
      events.concat(Ext_ux_colorpick_ButtonController.EVENTS())
    )
  }
