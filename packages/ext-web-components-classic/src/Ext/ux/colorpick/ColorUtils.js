...
export default class Ext_ux_colorpick_ColorUtils extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_ux_colorpick_ColorUtils.PROPERTIES()),
      events.concat(Ext_ux_colorpick_ColorUtils.EVENTS())
    )
  }
