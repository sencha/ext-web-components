...
export default class Ext_ux_colorpick_SliderHue extends Ext_ux_colorpick_Slider {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_ux_colorpick_SliderHue.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_ux_colorpick_SliderHue.PROPERTIES()),
            events.concat(Ext_ux_colorpick_SliderHue.EVENTS())
        )
    }
