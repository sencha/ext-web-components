...
export default class Ext_ux_colorpick_Slider extends Ext_container_Container {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_ux_colorpick_Slider.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_ux_colorpick_Slider.PROPERTIES()),
            events.concat(Ext_ux_colorpick_Slider.EVENTS())
        )
    }
