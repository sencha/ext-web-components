...
export default class Ext_ux_GMapPanel extends Ext_panel_Panel {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_ux_GMapPanel.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_ux_GMapPanel.PROPERTIES()),
            events.concat(Ext_ux_GMapPanel.EVENTS())
        )
    }
