...
export default class Ext_ux_grid_SubTable extends Ext_grid_plugin_RowExpander {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_ux_grid_SubTable.PROPERTIES()),
      events.concat(Ext_ux_grid_SubTable.EVENTS())
    )
  }
