...
export default class Ext_ux_grid_TransformGrid extends Ext_grid_Panel {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_ux_grid_TransformGrid.PROPERTIES()),
      events.concat(Ext_ux_grid_TransformGrid.EVENTS())
    )
  }
