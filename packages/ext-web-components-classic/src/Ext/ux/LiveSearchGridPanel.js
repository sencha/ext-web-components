...
export default class Ext_ux_LiveSearchGridPanel extends Ext_grid_Panel {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_ux_LiveSearchGridPanel.PROPERTIES()),
      events.concat(Ext_ux_LiveSearchGridPanel.EVENTS())
    )
  }
