...
export default class Ext_ux_DataView_Animated extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_ux_DataView_Animated.PROPERTIES()),
      events.concat(Ext_ux_DataView_Animated.EVENTS())
    )
  }
