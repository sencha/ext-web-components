...
export default class Ext_ux_DataView_DragSelector extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_ux_DataView_DragSelector.PROPERTIES()),
      events.concat(Ext_ux_DataView_DragSelector.EVENTS())
    )
  }
