...
export default class Ext_ux_desktop_StartMenu extends Ext_menu_Menu {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_ux_desktop_StartMenu.PROPERTIES()),
      events.concat(Ext_ux_desktop_StartMenu.EVENTS())
    )
  }
