...
export default class Ext_ux_desktop_Wallpaper extends Ext_Component {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_ux_desktop_Wallpaper.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_ux_desktop_Wallpaper.PROPERTIES()),
            events.concat(Ext_ux_desktop_Wallpaper.EVENTS())
        )
    }
