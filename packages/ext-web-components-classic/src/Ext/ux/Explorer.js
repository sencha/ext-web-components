...
export default class Ext_ux_Explorer extends Ext_panel_Panel {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_ux_Explorer.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_ux_Explorer.PROPERTIES()),
            events.concat(Ext_ux_Explorer.EVENTS())
        )
    }
