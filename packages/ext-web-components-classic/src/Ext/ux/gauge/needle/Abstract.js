...
export default class Ext_ux_gauge_needle_Abstract extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_ux_gauge_needle_Abstract.PROPERTIES()),
      events.concat(Ext_ux_gauge_needle_Abstract.EVENTS())
    )
  }
