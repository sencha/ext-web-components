...
export default class Ext_ListView extends Ext_panel_Table {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_ListView.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_ListView.PROPERTIES()),
            events.concat(Ext_ListView.EVENTS())
        )
    }
