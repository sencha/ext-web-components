...
export default class Ext_Slider extends Ext_slider_Multi {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_Slider.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_Slider.PROPERTIES()),
            events.concat(Ext_Slider.EVENTS())
        )
    }
