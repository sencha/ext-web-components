...
export default class Ext_direct_RemotingMethod extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_direct_RemotingMethod.PROPERTIES()),
      events.concat(Ext_direct_RemotingMethod.EVENTS())
    )
  }
