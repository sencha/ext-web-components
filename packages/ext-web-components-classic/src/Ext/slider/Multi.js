...
export default class Ext_slider_Multi extends Ext_form_field_Base {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_slider_Multi.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_slider_Multi.PROPERTIES()),
            events.concat(Ext_slider_Multi.EVENTS())
        )
    }
