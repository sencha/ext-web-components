...
export default class Ext_slider_SingleSlider extends Ext_slider_Multi {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_slider_SingleSlider.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_slider_SingleSlider.PROPERTIES()),
            events.concat(Ext_slider_SingleSlider.EVENTS())
        )
    }
