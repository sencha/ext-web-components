...
export default class Ext_resizer_SplitterTracker extends Ext_dd_DragTracker {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_resizer_SplitterTracker.PROPERTIES()),
      events.concat(Ext_resizer_SplitterTracker.EVENTS())
    )
  }
