...
export default class Ext_resizer_Splitter extends Ext_Component {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_resizer_Splitter.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_resizer_Splitter.PROPERTIES()),
            events.concat(Ext_resizer_Splitter.EVENTS())
        )
    }
