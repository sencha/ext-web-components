...
export default class Ext_draw_TimingFunctions extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_draw_TimingFunctions.PROPERTIES()),
      events.concat(Ext_draw_TimingFunctions.EVENTS())
    )
  }
