...
export default class Ext_draw_sprite_AttributeDefinition extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_draw_sprite_AttributeDefinition.PROPERTIES()),
      events.concat(Ext_draw_sprite_AttributeDefinition.EVENTS())
    )
  }
