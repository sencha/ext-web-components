...
export default class Ext_draw_sprite_Sector extends Ext_draw_sprite_Path {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_draw_sprite_Sector.PROPERTIES()),
      events.concat(Ext_draw_sprite_Sector.EVENTS())
    )
  }
