...
export default class Ext_draw_sprite_AnimationParser extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_draw_sprite_AnimationParser.PROPERTIES()),
      events.concat(Ext_draw_sprite_AnimationParser.EVENTS())
    )
  }
