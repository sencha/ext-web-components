...
export default class Ext_draw_sprite_Sprite extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_draw_sprite_Sprite.PROPERTIES()),
      events.concat(Ext_draw_sprite_Sprite.EVENTS())
    )
  }
