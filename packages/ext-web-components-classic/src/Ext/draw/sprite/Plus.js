...
export default class Ext_draw_sprite_Plus extends Ext_draw_sprite_Path {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_draw_sprite_Plus.PROPERTIES()),
      events.concat(Ext_draw_sprite_Plus.EVENTS())
    )
  }
