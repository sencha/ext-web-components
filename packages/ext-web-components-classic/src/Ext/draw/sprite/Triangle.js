...
export default class Ext_draw_sprite_Triangle extends Ext_draw_sprite_Path {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_draw_sprite_Triangle.PROPERTIES()),
      events.concat(Ext_draw_sprite_Triangle.EVENTS())
    )
  }
