...
export default class Ext_draw_sprite_Cross extends Ext_draw_sprite_Path {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_draw_sprite_Cross.PROPERTIES()),
      events.concat(Ext_draw_sprite_Cross.EVENTS())
    )
  }
