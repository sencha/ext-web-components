...
export default class Ext_draw_sprite_AttributeParser extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_draw_sprite_AttributeParser.PROPERTIES()),
      events.concat(Ext_draw_sprite_AttributeParser.EVENTS())
    )
  }
