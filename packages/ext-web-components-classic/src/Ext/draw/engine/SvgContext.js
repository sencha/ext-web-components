...
export default class Ext_draw_engine_SvgContext extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_draw_engine_SvgContext.PROPERTIES()),
      events.concat(Ext_draw_engine_SvgContext.EVENTS())
    )
  }
