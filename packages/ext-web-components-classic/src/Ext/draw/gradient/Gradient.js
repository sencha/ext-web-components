...
export default class Ext_draw_gradient_Gradient extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_draw_gradient_Gradient.PROPERTIES()),
      events.concat(Ext_draw_gradient_Gradient.EVENTS())
    )
  }
