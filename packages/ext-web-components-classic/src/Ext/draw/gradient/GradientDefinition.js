...
export default class Ext_draw_gradient_GradientDefinition extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_draw_gradient_GradientDefinition.PROPERTIES()),
      events.concat(Ext_draw_gradient_GradientDefinition.EVENTS())
    )
  }
