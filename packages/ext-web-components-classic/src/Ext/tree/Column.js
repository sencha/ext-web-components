...
export default class Ext_tree_Column extends Ext_grid_column_Column {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_tree_Column.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_tree_Column.PROPERTIES()),
            events.concat(Ext_tree_Column.EVENTS())
        )
    }
