...
export default class Ext_Tip extends Ext_panel_Panel {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_Tip.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_Tip.PROPERTIES()),
            events.concat(Ext_Tip.EVENTS())
        )
    }
