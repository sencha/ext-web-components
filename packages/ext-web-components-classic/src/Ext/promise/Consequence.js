...
export default class Ext_promise_Consequence extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_promise_Consequence.PROPERTIES()),
      events.concat(Ext_promise_Consequence.EVENTS())
    )
  }
