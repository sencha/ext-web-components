...
export default class Ext_StoreManager extends Ext_util_MixedCollection {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_StoreManager.PROPERTIES()),
      events.concat(Ext_StoreManager.EVENTS())
    )
  }
