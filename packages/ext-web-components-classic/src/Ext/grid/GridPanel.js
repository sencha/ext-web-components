...
export default class Ext_grid_GridPanel extends Ext_panel_Table {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_grid_GridPanel.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_grid_GridPanel.PROPERTIES()),
            events.concat(Ext_grid_GridPanel.EVENTS())
        )
    }
