...
export default class Ext_grid_locking_HeaderContainer extends Ext_grid_header_Container {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_grid_locking_HeaderContainer.PROPERTIES()),
      events.concat(Ext_grid_locking_HeaderContainer.EVENTS())
    )
  }
