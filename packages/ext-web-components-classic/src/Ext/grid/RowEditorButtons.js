...
export default class Ext_grid_RowEditorButtons extends Ext_container_Container {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_grid_RowEditorButtons.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_grid_RowEditorButtons.PROPERTIES()),
            events.concat(Ext_grid_RowEditorButtons.EVENTS())
        )
    }
