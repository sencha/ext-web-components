...
export default class Ext_grid_property_Store extends Ext_data_Store {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_grid_property_Store.PROPERTIES()),
      events.concat(Ext_grid_property_Store.EVENTS())
    )
  }
