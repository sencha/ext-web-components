...
export default class Ext_grid_PropertyColumnModel extends Ext_grid_header_Container {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_grid_PropertyColumnModel.PROPERTIES()),
      events.concat(Ext_grid_PropertyColumnModel.EVENTS())
    )
  }
