...
export default class Ext_grid_Panel extends Ext_panel_Table {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_grid_Panel.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_grid_Panel.PROPERTIES()),
            events.concat(Ext_grid_Panel.EVENTS())
        )
    }
