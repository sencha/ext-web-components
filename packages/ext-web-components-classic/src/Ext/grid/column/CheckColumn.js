...
export default class Ext_grid_column_CheckColumn extends Ext_grid_column_Column {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_grid_column_CheckColumn.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_grid_column_CheckColumn.PROPERTIES()),
            events.concat(Ext_grid_column_CheckColumn.EVENTS())
        )
    }
