...
export default class Ext_grid_header_DragZone extends Ext_dd_DragZone {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_grid_header_DragZone.PROPERTIES()),
      events.concat(Ext_grid_header_DragZone.EVENTS())
    )
  }
