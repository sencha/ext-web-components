...
export default class Ext_grid_filters_filter_Base extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_grid_filters_filter_Base.PROPERTIES()),
      events.concat(Ext_grid_filters_filter_Base.EVENTS())
    )
  }
