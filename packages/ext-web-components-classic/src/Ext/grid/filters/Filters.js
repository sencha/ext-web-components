...
export default class Ext_grid_filters_Filters extends Ext_plugin_Abstract {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_grid_filters_Filters.PROPERTIES()),
      events.concat(Ext_grid_filters_Filters.EVENTS())
    )
  }
