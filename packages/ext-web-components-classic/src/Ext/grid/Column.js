...
export default class Ext_grid_Column extends Ext_grid_header_Container {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_grid_Column.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_grid_Column.PROPERTIES()),
            events.concat(Ext_grid_Column.EVENTS())
        )
    }
