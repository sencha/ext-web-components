...
export default class Ext_FormPanel extends Ext_panel_Panel {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_FormPanel.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_FormPanel.PROPERTIES()),
            events.concat(Ext_FormPanel.EVENTS())
        )
    }
