...
export default class Ext_dashboard_Column extends Ext_container_Container {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_dashboard_Column.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_dashboard_Column.PROPERTIES()),
            events.concat(Ext_dashboard_Column.EVENTS())
        )
    }
