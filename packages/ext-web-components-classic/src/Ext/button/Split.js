...
export default class Ext_button_Split extends Ext_button_Button {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_button_Split.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_button_Split.PROPERTIES()),
            events.concat(Ext_button_Split.EVENTS())
        )
    }
