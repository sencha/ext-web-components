...
export default class Ext_button_Button extends Ext_Component {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_button_Button.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_button_Button.PROPERTIES()),
            events.concat(Ext_button_Button.EVENTS())
        )
    }
