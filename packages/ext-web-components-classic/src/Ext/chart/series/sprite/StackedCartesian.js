...
export default class Ext_chart_series_sprite_StackedCartesian extends Ext_chart_series_sprite_Cartesian {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_chart_series_sprite_StackedCartesian.PROPERTIES()),
      events.concat(Ext_chart_series_sprite_StackedCartesian.EVENTS())
    )
  }
