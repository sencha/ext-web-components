...
export default class Ext_chart_series_Pie3D extends Ext_chart_series_Polar {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_chart_series_Pie3D.PROPERTIES()),
      events.concat(Ext_chart_series_Pie3D.EVENTS())
    )
  }
