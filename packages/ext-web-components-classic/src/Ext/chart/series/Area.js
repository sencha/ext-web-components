...
export default class Ext_chart_series_Area extends Ext_chart_series_StackedCartesian {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_chart_series_Area.PROPERTIES()),
      events.concat(Ext_chart_series_Area.EVENTS())
    )
  }
