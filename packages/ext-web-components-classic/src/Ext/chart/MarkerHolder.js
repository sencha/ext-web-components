...
export default class Ext_chart_MarkerHolder extends Ext_Mixin {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_chart_MarkerHolder.PROPERTIES()),
      events.concat(Ext_chart_MarkerHolder.EVENTS())
    )
  }
