...
export default class Ext_chart_theme_series_BoxPlot extends Ext_chart_theme_series_Series {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_chart_theme_series_BoxPlot.PROPERTIES()),
      events.concat(Ext_chart_theme_series_BoxPlot.EVENTS())
    )
  }
