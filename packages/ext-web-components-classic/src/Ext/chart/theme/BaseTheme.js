...
export default class Ext_chart_theme_BaseTheme extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_chart_theme_BaseTheme.PROPERTIES()),
      events.concat(Ext_chart_theme_BaseTheme.EVENTS())
    )
  }
