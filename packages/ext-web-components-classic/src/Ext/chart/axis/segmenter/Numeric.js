...
export default class Ext_chart_axis_segmenter_Numeric extends Ext_chart_axis_segmenter_Segmenter {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_chart_axis_segmenter_Numeric.PROPERTIES()),
      events.concat(Ext_chart_axis_segmenter_Numeric.EVENTS())
    )
  }
