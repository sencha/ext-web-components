...
export default class Ext_chart_axis_layout_Layout extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_chart_axis_layout_Layout.PROPERTIES()),
      events.concat(Ext_chart_axis_layout_Layout.EVENTS())
    )
  }
