...
export default class Ext_chart_legend_store_Store extends Ext_data_Store {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_chart_legend_store_Store.PROPERTIES()),
      events.concat(Ext_chart_legend_store_Store.EVENTS())
    )
  }
