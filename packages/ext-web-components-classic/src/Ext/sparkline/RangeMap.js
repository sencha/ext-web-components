...
export default class Ext_sparkline_RangeMap extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_sparkline_RangeMap.PROPERTIES()),
      events.concat(Ext_sparkline_RangeMap.EVENTS())
    )
  }
