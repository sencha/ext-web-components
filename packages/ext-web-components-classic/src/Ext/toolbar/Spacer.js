...
export default class Ext_toolbar_Spacer extends Ext_Component {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_toolbar_Spacer.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_toolbar_Spacer.PROPERTIES()),
            events.concat(Ext_toolbar_Spacer.EVENTS())
        )
    }
