...
export default class Ext_toolbar_Fill extends Ext_Component {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_toolbar_Fill.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_toolbar_Fill.PROPERTIES()),
            events.concat(Ext_toolbar_Fill.EVENTS())
        )
    }
