...
export default class Ext_toolbar_Item extends Ext_Component {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_toolbar_Item.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_toolbar_Item.PROPERTIES()),
            events.concat(Ext_toolbar_Item.EVENTS())
        )
    }
