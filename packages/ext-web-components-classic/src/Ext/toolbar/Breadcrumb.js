...
export default class Ext_toolbar_Breadcrumb extends Ext_container_Container {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_toolbar_Breadcrumb.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_toolbar_Breadcrumb.PROPERTIES()),
            events.concat(Ext_toolbar_Breadcrumb.EVENTS())
        )
    }
