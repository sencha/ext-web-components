...
export default class Ext_toolbar_Toolbar extends Ext_container_Container {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_toolbar_Toolbar.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_toolbar_Toolbar.PROPERTIES()),
            events.concat(Ext_toolbar_Toolbar.EVENTS())
        )
    }
