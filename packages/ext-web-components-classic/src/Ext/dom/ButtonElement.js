...
export default class Ext_dom_ButtonElement extends Ext_dom_Element {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_dom_ButtonElement.PROPERTIES()),
      events.concat(Ext_dom_ButtonElement.EVENTS())
    )
  }
