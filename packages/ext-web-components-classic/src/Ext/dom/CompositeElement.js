...
export default class Ext_dom_CompositeElement extends Ext_dom_CompositeElementLite {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_dom_CompositeElement.PROPERTIES()),
      events.concat(Ext_dom_CompositeElement.EVENTS())
    )
  }
