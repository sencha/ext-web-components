...
export default class Ext_dom_CompositeElementLite extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_dom_CompositeElementLite.PROPERTIES()),
      events.concat(Ext_dom_CompositeElementLite.EVENTS())
    )
  }
