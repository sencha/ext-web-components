...
export default class Ext_fx_animation_Slide extends Ext_fx_animation_Abstract {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_fx_animation_Slide.PROPERTIES()),
      events.concat(Ext_fx_animation_Slide.EVENTS())
    )
  }
