...
export default class Ext_fx_animation_Fade extends Ext_fx_animation_Abstract {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_fx_animation_Fade.PROPERTIES()),
      events.concat(Ext_fx_animation_Fade.EVENTS())
    )
  }
