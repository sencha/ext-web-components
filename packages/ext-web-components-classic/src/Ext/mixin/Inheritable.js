...
export default class Ext_mixin_Inheritable extends Ext_Mixin {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_mixin_Inheritable.PROPERTIES()),
      events.concat(Ext_mixin_Inheritable.EVENTS())
    )
  }
