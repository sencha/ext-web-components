...
export default class Ext_mixin_Templatable extends Ext_Mixin {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_mixin_Templatable.PROPERTIES()),
      events.concat(Ext_mixin_Templatable.EVENTS())
    )
  }
