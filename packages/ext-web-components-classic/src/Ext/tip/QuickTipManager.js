...
export default class Ext_tip_QuickTipManager extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_tip_QuickTipManager.PROPERTIES()),
      events.concat(Ext_tip_QuickTipManager.EVENTS())
    )
  }
