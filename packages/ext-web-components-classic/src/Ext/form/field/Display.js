...
export default class Ext_form_field_Display extends Ext_form_field_Base {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_form_field_Display.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_form_field_Display.PROPERTIES()),
            events.concat(Ext_form_field_Display.EVENTS())
        )
    }
