...
export default class Ext_form_field_Spinner extends Ext_form_field_Text {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_form_field_Spinner.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_form_field_Spinner.PROPERTIES()),
            events.concat(Ext_form_field_Spinner.EVENTS())
        )
    }
