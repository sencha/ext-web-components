...
export default class Ext_form_field_FileButton extends Ext_button_Button {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_form_field_FileButton.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_form_field_FileButton.PROPERTIES()),
            events.concat(Ext_form_field_FileButton.EVENTS())
        )
    }
