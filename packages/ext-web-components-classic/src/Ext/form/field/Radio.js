...
export default class Ext_form_field_Radio extends Ext_form_field_Checkbox {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_form_field_Radio.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_form_field_Radio.PROPERTIES()),
            events.concat(Ext_form_field_Radio.EVENTS())
        )
    }
