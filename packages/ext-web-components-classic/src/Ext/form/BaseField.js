...
export default class Ext_form_BaseField extends Ext_Component {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_form_BaseField.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_form_BaseField.PROPERTIES()),
            events.concat(Ext_form_BaseField.EVENTS())
        )
    }
