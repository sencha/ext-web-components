...
export default class Ext_form_FieldContainer extends Ext_container_Container {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_form_FieldContainer.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_form_FieldContainer.PROPERTIES()),
            events.concat(Ext_form_FieldContainer.EVENTS())
        )
    }
