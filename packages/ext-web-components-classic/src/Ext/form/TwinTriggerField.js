...
export default class Ext_form_TwinTriggerField extends Ext_form_field_Text {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_form_TwinTriggerField.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_form_TwinTriggerField.PROPERTIES()),
            events.concat(Ext_form_TwinTriggerField.EVENTS())
        )
    }
