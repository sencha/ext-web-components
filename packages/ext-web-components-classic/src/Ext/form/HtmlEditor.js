...
export default class Ext_form_HtmlEditor extends Ext_form_FieldContainer {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_form_HtmlEditor.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_form_HtmlEditor.PROPERTIES()),
            events.concat(Ext_form_HtmlEditor.EVENTS())
        )
    }
