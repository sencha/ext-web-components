...
export default class Ext_form_TriggerField extends Ext_form_field_Text {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_form_TriggerField.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_form_TriggerField.PROPERTIES()),
            events.concat(Ext_form_TriggerField.EVENTS())
        )
    }
