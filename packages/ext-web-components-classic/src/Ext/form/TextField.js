...
export default class Ext_form_TextField extends Ext_form_field_Base {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_form_TextField.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_form_TextField.PROPERTIES()),
            events.concat(Ext_form_TextField.EVENTS())
        )
    }
