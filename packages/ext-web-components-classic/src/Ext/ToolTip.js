...
export default class Ext_ToolTip extends Ext_tip_Tip {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_ToolTip.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_ToolTip.PROPERTIES()),
            events.concat(Ext_ToolTip.EVENTS())
        )
    }
