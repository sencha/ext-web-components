...
export default class Ext_panel_Bar extends Ext_container_Container {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_panel_Bar.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_panel_Bar.PROPERTIES()),
            events.concat(Ext_panel_Bar.EVENTS())
        )
    }
