...
export default class Ext_panel_Table extends Ext_panel_Panel {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_panel_Table.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_panel_Table.PROPERTIES()),
            events.concat(Ext_panel_Table.EVENTS())
        )
    }
