...
export default class Ext_parse_symbol_Paren extends Ext_parse_Symbol {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_parse_symbol_Paren.PROPERTIES()),
      events.concat(Ext_parse_symbol_Paren.EVENTS())
    )
  }
