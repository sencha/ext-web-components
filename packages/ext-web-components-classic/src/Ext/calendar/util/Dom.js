...
export default class Ext_calendar_util_Dom extends Ext_Base {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_calendar_util_Dom.PROPERTIES()),
      events.concat(Ext_calendar_util_Dom.EVENTS())
    )
  }
