...
export default class Ext_calendar_store_EventSource extends Ext_data_Store {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_calendar_store_EventSource.PROPERTIES()),
      events.concat(Ext_calendar_store_EventSource.EVENTS())
    )
  }
