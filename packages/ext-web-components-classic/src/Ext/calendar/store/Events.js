...
export default class Ext_calendar_store_Events extends Ext_data_Store {
  ...
  constructor(properties, events) {
    super (
      properties.concat(Ext_calendar_store_Events.PROPERTIES()),
      events.concat(Ext_calendar_store_Events.EVENTS())
    )
  }
