...
export default class Ext_picker_Month extends Ext_Component {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_picker_Month.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_picker_Month.PROPERTIES()),
            events.concat(Ext_picker_Month.EVENTS())
        )
    }
