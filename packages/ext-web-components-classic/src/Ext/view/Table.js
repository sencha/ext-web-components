...
export default class Ext_view_Table extends Ext_view_View {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_view_Table.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_view_Table.PROPERTIES()),
            events.concat(Ext_view_Table.EVENTS())
        )
    }
