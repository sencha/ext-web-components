...
export default class Ext_view_BoundList extends Ext_view_View {
...
//]}
    ...
    static get observedAttributes() {
        ...
        //for (var property in Ext_view_BoundList.PROPERTIESOBJECT()) {
        //    attrs.push(property)
        //}
    ...
    constructor(properties, events) {
        super (
            properties.concat(Ext_view_BoundList.PROPERTIES()),
            events.concat(Ext_view_BoundList.EVENTS())
        )
    }
