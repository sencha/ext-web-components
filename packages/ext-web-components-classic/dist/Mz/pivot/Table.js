...
var Mz_pivot_Table = /*#__PURE__*/function (_Ext_grid_Panel) {
  _inheritsLoose(Mz_pivot_Table, _Ext_grid_Panel);

  var _super = _createSuper(Mz_pivot_Table);

  Mz_pivot_Table.PROPERTIES = function PROPERTIES() {
  ...
  Mz_pivot_Table.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Mz_pivot_Table.getProperties = function getProperties(properties) {
    properties = properties.concat(Mz_pivot_Table.PROPERTIES());
  ...
  _createClass(Mz_pivot_Table, null, [{
    ...
    get: function get() {
      ...
      Mz_pivot_Table.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Mz_pivot_Table(properties, events) {
    return _Ext_grid_Panel.call(this, properties.concat(Mz_pivot_Table.PROPERTIES()), events.concat(Mz_pivot_Table.EVENTS())) || this;
  }

  var _proto = Mz_pivot_Table.prototype;
  ...
  return Mz_pivot_Table;
}(Ext_grid_Panel);

export { Mz_pivot_Table as default };