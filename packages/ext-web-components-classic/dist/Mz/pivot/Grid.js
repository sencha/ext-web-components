...
function (_Ext_grid_Panel) {
  ...
  Mz_pivot_Grid.getProperties = function getProperties(properties) {
    properties = properties.concat(Mz_pivot_Grid.PROPERTIES());
    return Ext_grid_Panel.getProperties(properties);
  };

  Mz_pivot_Grid.getEvents = function getEvents(events) {
    events = events.concat(Mz_pivot_Grid.EVENTS());
  ...
  _createClass(Mz_pivot_Grid, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_grid_Panel.observedAttributes; //for (var property in Mz_pivot_Grid.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Mz_pivot_Grid.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Mz_pivot_Grid.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Mz_pivot_Grid(properties, events) {
    return _Ext_grid_Panel.call(this, properties.concat(Mz_pivot_Grid.PROPERTIES()), events.concat(Mz_pivot_Grid.EVENTS())) || this;
  }

  var _proto = Mz_pivot_Grid.prototype;
  ...
  return Mz_pivot_Grid;
}(Ext_grid_Panel);

export { Mz_pivot_Grid as default };