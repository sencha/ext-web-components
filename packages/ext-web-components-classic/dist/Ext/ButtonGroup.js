...
function (_Ext_panel_Panel) {
  _inheritsLoose(Ext_ButtonGroup, _Ext_panel_Panel);

  Ext_ButtonGroup.PROPERTIES = function PROPERTIES() {
  ...
  Ext_ButtonGroup.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_ButtonGroup.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_ButtonGroup.PROPERTIES());
    return Ext_panel_Panel.getProperties(properties);
  };

  Ext_ButtonGroup.getEvents = function getEvents(events) {
    events = events.concat(Ext_ButtonGroup.EVENTS());
  ...
  _createClass(Ext_ButtonGroup, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_panel_Panel.observedAttributes; //for (var property in Ext_ButtonGroup.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_ButtonGroup.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_ButtonGroup.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_ButtonGroup(properties, events) {
    return _Ext_panel_Panel.call(this, properties.concat(Ext_ButtonGroup.PROPERTIES()), events.concat(Ext_ButtonGroup.EVENTS())) || this;
  }

  var _proto = Ext_ButtonGroup.prototype;
  ...
  return Ext_ButtonGroup;
}(Ext_panel_Panel);

export { Ext_ButtonGroup as default };