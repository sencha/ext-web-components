...
var Ext_picker_Month =
/*#__PURE__*/
function (_Ext_Component) {
  _inheritsLoose(Ext_picker_Month, _Ext_Component);

  Ext_picker_Month.PROPERTIES = function PROPERTIES() {
  ...
  Ext_picker_Month.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_picker_Month.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_picker_Month.PROPERTIES());
    return Ext_Component.getProperties(properties);
  };

  Ext_picker_Month.getEvents = function getEvents(events) {
    events = events.concat(Ext_picker_Month.EVENTS());
  ...
  _createClass(Ext_picker_Month, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_picker_Month.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_picker_Month.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_picker_Month.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_picker_Month(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_picker_Month.PROPERTIES()), events.concat(Ext_picker_Month.EVENTS())) || this;
  }

  var _proto = Ext_picker_Month.prototype;
  ...
  return Ext_picker_Month;
}(Ext_Component);

export { Ext_picker_Month as default };