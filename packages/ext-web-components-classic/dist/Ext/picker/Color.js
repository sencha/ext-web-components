...
var Ext_picker_Color =
/*#__PURE__*/
function (_Ext_Component) {
  _inheritsLoose(Ext_picker_Color, _Ext_Component);

  Ext_picker_Color.PROPERTIES = function PROPERTIES() {
  ...
  Ext_picker_Color.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_picker_Color.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_picker_Color.PROPERTIES());
    return Ext_Component.getProperties(properties);
  };

  Ext_picker_Color.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_picker_Color, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_picker_Color.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_picker_Color(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_picker_Color.PROPERTIES()), events.concat(Ext_picker_Color.EVENTS())) || this;
  }

  var _proto = Ext_picker_Color.prototype;
  ...
  return Ext_picker_Color;
}(Ext_Component);

export { Ext_picker_Color as default };