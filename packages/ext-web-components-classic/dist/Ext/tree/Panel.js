...
function (_Ext_panel_Table) {
  ...
  Ext_tree_Panel.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_tree_Panel.PROPERTIES());
    return Ext_panel_Table.getProperties(properties);
  };

  Ext_tree_Panel.getEvents = function getEvents(events) {
    events = events.concat(Ext_tree_Panel.EVENTS());
  ...
  _createClass(Ext_tree_Panel, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_panel_Table.observedAttributes; //for (var property in Ext_tree_Panel.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_tree_Panel.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_tree_Panel.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_tree_Panel(properties, events) {
    return _Ext_panel_Table.call(this, properties.concat(Ext_tree_Panel.PROPERTIES()), events.concat(Ext_tree_Panel.EVENTS())) || this;
  }

  var _proto = Ext_tree_Panel.prototype;
  ...
  return Ext_tree_Panel;
}(Ext_panel_Table);

export { Ext_tree_Panel as default };