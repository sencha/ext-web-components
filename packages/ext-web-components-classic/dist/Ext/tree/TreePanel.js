...
var Ext_tree_TreePanel = /*#__PURE__*/function (_Ext_panel_Table) {
  ...
  var _super = _createSuper(Ext_tree_TreePanel);
  ...
  Ext_tree_TreePanel.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_tree_TreePanel.getProperties = function getProperties(properties) {
  ...
  function Ext_tree_TreePanel(properties, events) {
    return _Ext_panel_Table.call(this, properties.concat(Ext_tree_TreePanel.PROPERTIES()), events.concat(Ext_tree_TreePanel.EVENTS())) || this;
  }

  var _proto = Ext_tree_TreePanel.prototype;
  ...
  return Ext_tree_TreePanel;
}(Ext_panel_Table);

export { Ext_tree_TreePanel as default };