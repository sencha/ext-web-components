...
var Ext_tree_View = /*#__PURE__*/function (_Ext_view_Table) {
  ...
  Ext_tree_View.EVENTS = function EVENTS() {
    return [{
      ...
      name: 'nodedragover',
      parameters: 'targetNode,position,dragData,e'
    }, {
      name: 'refresh',
      parameters: 'sender'
    }, {
  ...
  Ext_tree_View.getProperties = function getProperties(properties) {
  ...
  function Ext_tree_View(properties, events) {
    return _Ext_view_Table.call(this, properties.concat(Ext_tree_View.PROPERTIES()), events.concat(Ext_tree_View.EVENTS())) || this;
  }

  var _proto = Ext_tree_View.prototype;

  _proto.connectedCallback = function connectedCallback() {
    _Ext_view_Table.prototype.connectedCallback.call(this);
  };

  _proto.attributeChangedCallback = function attributeChangedCallback(attrName, oldVal, newVal) {
    _Ext_view_Table.prototype.attributeChangedCallback.call(this, attrName, oldVal, newVal);
  };

  return Ext_tree_View;
}(Ext_view_Table);

export { Ext_tree_View as default };