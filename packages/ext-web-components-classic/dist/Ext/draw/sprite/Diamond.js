...
var Ext_draw_sprite_Diamond = /*#__PURE__*/function (_Ext_draw_sprite_Path) {
  _inheritsLoose(Ext_draw_sprite_Diamond, _Ext_draw_sprite_Path);

  var _super = _createSuper(Ext_draw_sprite_Diamond);

  Ext_draw_sprite_Diamond.PROPERTIES = function PROPERTIES() {
  ...
  Ext_draw_sprite_Diamond.EVENTS = function EVENTS() {
    return [{
      name: 'ready',
  ...
  function Ext_draw_sprite_Diamond(properties, events) {
    return _Ext_draw_sprite_Path.call(this, properties.concat(Ext_draw_sprite_Diamond.PROPERTIES()), events.concat(Ext_draw_sprite_Diamond.EVENTS())) || this;
  }

  var _proto = Ext_draw_sprite_Diamond.prototype;
  ...
  return Ext_draw_sprite_Diamond;
}(Ext_draw_sprite_Path);

export { Ext_draw_sprite_Diamond as default };