...
var Ext_list_ListView =
/*#__PURE__*/
function (_Ext_panel_Table) {
  _inheritsLoose(Ext_list_ListView, _Ext_panel_Table);

  Ext_list_ListView.PROPERTIES = function PROPERTIES() {
  ...
  Ext_list_ListView.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_list_ListView.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_list_ListView.PROPERTIES());
    return Ext_panel_Table.getProperties(properties);
  };

  Ext_list_ListView.getEvents = function getEvents(events) {
    events = events.concat(Ext_list_ListView.EVENTS());
  ...
  _createClass(Ext_list_ListView, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_panel_Table.observedAttributes; //for (var property in Ext_list_ListView.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_list_ListView.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_list_ListView.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_list_ListView(properties, events) {
    return _Ext_panel_Table.call(this, properties.concat(Ext_list_ListView.PROPERTIES()), events.concat(Ext_list_ListView.EVENTS())) || this;
  }

  var _proto = Ext_list_ListView.prototype;
  ...
  return Ext_list_ListView;
}(Ext_panel_Table);

export { Ext_list_ListView as default };