...
var Ext_AbstractContainer =
/*#__PURE__*/
function (_Ext_Component) {
  _inheritsLoose(Ext_AbstractContainer, _Ext_Component);

  Ext_AbstractContainer.PROPERTIES = function PROPERTIES() {
  ...
  Ext_AbstractContainer.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_AbstractContainer.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_AbstractContainer.PROPERTIES());
    return Ext_Component.getProperties(properties);
  };

  Ext_AbstractContainer.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_AbstractContainer, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_AbstractContainer.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_AbstractContainer(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_AbstractContainer.PROPERTIES()), events.concat(Ext_AbstractContainer.EVENTS())) || this;
  }

  var _proto = Ext_AbstractContainer.prototype;
  ...
  return Ext_AbstractContainer;
}(Ext_Component);

export { Ext_AbstractContainer as default };