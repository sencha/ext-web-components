...
function (_Ext_panel_Table) {
  _inheritsLoose(Ext_TreePanel, _Ext_panel_Table);

  Ext_TreePanel.PROPERTIES = function PROPERTIES() {
  ...
  Ext_TreePanel.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_TreePanel.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_TreePanel.PROPERTIES());
    return Ext_panel_Table.getProperties(properties);
  };

  Ext_TreePanel.getEvents = function getEvents(events) {
    events = events.concat(Ext_TreePanel.EVENTS());
  ...
  _createClass(Ext_TreePanel, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_panel_Table.observedAttributes; //for (var property in Ext_TreePanel.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_TreePanel.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_TreePanel.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_TreePanel(properties, events) {
    return _Ext_panel_Table.call(this, properties.concat(Ext_TreePanel.PROPERTIES()), events.concat(Ext_TreePanel.EVENTS())) || this;
  }

  var _proto = Ext_TreePanel.prototype;
  ...
  return Ext_TreePanel;
}(Ext_panel_Table);

export { Ext_TreePanel as default };