...
var Ext_FormPanel = /*#__PURE__*/function (_Ext_panel_Panel) {
  ...
  Ext_FormPanel.getProperties = function getProperties(properties) {
  ...
  _createClass(Ext_FormPanel, null, [{
    ...
    get: function get() {
      ...
      Ext_FormPanel.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_FormPanel(properties, events) {
    return _Ext_panel_Panel.call(this, properties.concat(Ext_FormPanel.PROPERTIES()), events.concat(Ext_FormPanel.EVENTS())) || this;
  }

  var _proto = Ext_FormPanel.prototype;
  ...
  return Ext_FormPanel;
}(Ext_panel_Panel);

export { Ext_FormPanel as default };