...
var Ext_dashboard_Panel =
/*#__PURE__*/
function (_Ext_panel_Panel) {
  _inheritsLoose(Ext_dashboard_Panel, _Ext_panel_Panel);

  Ext_dashboard_Panel.PROPERTIES = function PROPERTIES() {
  ...
  Ext_dashboard_Panel.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_dashboard_Panel.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_dashboard_Panel.PROPERTIES());
    return Ext_panel_Panel.getProperties(properties);
  };

  Ext_dashboard_Panel.getEvents = function getEvents(events) {
    events = events.concat(Ext_dashboard_Panel.EVENTS());
  ...
  _createClass(Ext_dashboard_Panel, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_panel_Panel.observedAttributes; //for (var property in Ext_dashboard_Panel.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_dashboard_Panel.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_dashboard_Panel.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_dashboard_Panel(properties, events) {
    return _Ext_panel_Panel.call(this, properties.concat(Ext_dashboard_Panel.PROPERTIES()), events.concat(Ext_dashboard_Panel.EVENTS())) || this;
  }

  var _proto = Ext_dashboard_Panel.prototype;
  ...
  return Ext_dashboard_Panel;
}(Ext_panel_Panel);

export { Ext_dashboard_Panel as default };