...
function (_Ext_panel_Panel) {
  ...
  Ext_dashboard_Dashboard.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_dashboard_Dashboard.PROPERTIES());
    return Ext_panel_Panel.getProperties(properties);
  };

  Ext_dashboard_Dashboard.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_dashboard_Dashboard, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_panel_Panel.observedAttributes; //for (var property in Ext_dashboard_Dashboard.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_dashboard_Dashboard(properties, events) {
    return _Ext_panel_Panel.call(this, properties.concat(Ext_dashboard_Dashboard.PROPERTIES()), events.concat(Ext_dashboard_Dashboard.EVENTS())) || this;
  }

  var _proto = Ext_dashboard_Dashboard.prototype;
  ...
  return Ext_dashboard_Dashboard;
}(Ext_panel_Panel);

export { Ext_dashboard_Dashboard as default };