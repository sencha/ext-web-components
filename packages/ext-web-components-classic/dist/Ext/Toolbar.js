...
function (_Ext_container_Contai) {
  _inheritsLoose(Ext_Toolbar, _Ext_container_Contai);
  ...
  _createClass(Ext_Toolbar, null, [{
    ...
    get: function get() {
      var attrs = _Ext_container_Contai.observedAttributes; //for (var property in Ext_Toolbar.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_Toolbar(properties, events) {
    return _Ext_container_Contai.call(this, properties.concat(Ext_Toolbar.PROPERTIES()), events.concat(Ext_Toolbar.EVENTS())) || this;
  }
