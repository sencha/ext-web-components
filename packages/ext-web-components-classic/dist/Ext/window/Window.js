...
function (_Ext_panel_Panel) {
  _inheritsLoose(Ext_window_Window, _Ext_panel_Panel);
  ...
  _createClass(Ext_window_Window, null, [{
    ...
    get: function get() {
      var attrs = _Ext_panel_Panel.observedAttributes; //for (var property in Ext_window_Window.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_window_Window(properties, events) {
    return _Ext_panel_Panel.call(this, properties.concat(Ext_window_Window.PROPERTIES()), events.concat(Ext_window_Window.EVENTS())) || this;
  }
