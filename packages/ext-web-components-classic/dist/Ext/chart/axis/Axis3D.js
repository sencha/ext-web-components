...
var Ext_chart_axis_Axis3D = /*#__PURE__*/function (_Ext_chart_axis_Axis) {
  _inheritsLoose(Ext_chart_axis_Axis3D, _Ext_chart_axis_Axis);

  var _super = _createSuper(Ext_chart_axis_Axis3D);

  Ext_chart_axis_Axis3D.PROPERTIES = function PROPERTIES() {
  ...
  Ext_chart_axis_Axis3D.EVENTS = function EVENTS() {
    return [{
      name: 'rangechange',
  ...
  Ext_chart_axis_Axis3D.getProperties = function getProperties(properties) {
  ...
  function Ext_chart_axis_Axis3D(properties, events) {
    return _Ext_chart_axis_Axis.call(this, properties.concat(Ext_chart_axis_Axis3D.PROPERTIES()), events.concat(Ext_chart_axis_Axis3D.EVENTS())) || this;
  }

  var _proto = Ext_chart_axis_Axis3D.prototype;
  ...
  return Ext_chart_axis_Axis3D;
}(Ext_chart_axis_Axis);

export { Ext_chart_axis_Axis3D as default };