...
var Ext_chart_series_Scatter = /*#__PURE__*/function (_Ext_chart_series_Car) {
  _inheritsLoose(Ext_chart_series_Scatter, _Ext_chart_series_Car);

  var _super = _createSuper(Ext_chart_series_Scatter);

  Ext_chart_series_Scatter.PROPERTIES = function PROPERTIES() {
  ...
  Ext_chart_series_Scatter.EVENTS = function EVENTS() {
    return [{
      name: 'chartattached',
  ...
  Ext_chart_series_Scatter.getProperties = function getProperties(properties) {
  ...
  Ext_chart_series_Scatter.getEvents = function getEvents(events) {
    events = events.concat(Ext_chart_series_Scatter.EVENTS());
    return Ext_chart_series_Cartesian.getEvents(events);
  };

  _createClass(Ext_chart_series_Scatter, null, [{
  ...
  function Ext_chart_series_Scatter(properties, events) {
    return _Ext_chart_series_Car.call(this, properties.concat(Ext_chart_series_Scatter.PROPERTIES()), events.concat(Ext_chart_series_Scatter.EVENTS())) || this;
  }

  var _proto = Ext_chart_series_Scatter.prototype;
  ...
  return Ext_chart_series_Scatter;
}(Ext_chart_series_Cartesian);

export { Ext_chart_series_Scatter as default };