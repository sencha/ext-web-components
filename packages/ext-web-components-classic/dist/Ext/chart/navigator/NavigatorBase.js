...
var Ext_chart_navigator_NavigatorBase = /*#__PURE__*/function (_Ext_chart_CartesianC) {
  ...
  Ext_chart_navigator_NavigatorBase.getProperties = function getProperties(properties) {
  ...
  Ext_chart_navigator_NavigatorBase.getEvents = function getEvents(events) {
    events = events.concat(Ext_chart_navigator_NavigatorBase.EVENTS());
    return Ext_chart_CartesianChart.getEvents(events);
  };

  _createClass(Ext_chart_navigator_NavigatorBase, null, [{
  ...
  function Ext_chart_navigator_NavigatorBase(properties, events) {
    return _Ext_chart_CartesianC.call(this, properties.concat(Ext_chart_navigator_NavigatorBase.PROPERTIES()), events.concat(Ext_chart_navigator_NavigatorBase.EVENTS())) || this;
  }

  var _proto = Ext_chart_navigator_NavigatorBase.prototype;
  ...
  return Ext_chart_navigator_NavigatorBase;
}(Ext_chart_CartesianChart);

export { Ext_chart_navigator_NavigatorBase as default };