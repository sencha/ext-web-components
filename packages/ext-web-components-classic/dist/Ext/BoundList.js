...
function (_Ext_view_View) {
  _inheritsLoose(Ext_BoundList, _Ext_view_View);

  Ext_BoundList.PROPERTIES = function PROPERTIES() {
  ...
  Ext_BoundList.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_BoundList.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_BoundList.PROPERTIES());
    return Ext_view_View.getProperties(properties);
  };

  Ext_BoundList.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_BoundList, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_view_View.observedAttributes; //for (var property in Ext_BoundList.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_BoundList(properties, events) {
    return _Ext_view_View.call(this, properties.concat(Ext_BoundList.PROPERTIES()), events.concat(Ext_BoundList.EVENTS())) || this;
  }

  var _proto = Ext_BoundList.prototype;
  ...
  return Ext_BoundList;
}(Ext_view_View);

export { Ext_BoundList as default };