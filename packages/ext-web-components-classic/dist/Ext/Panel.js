...
function (_Ext_container_Contai) {
  _inheritsLoose(Ext_Panel, _Ext_container_Contai);
  ...
  _createClass(Ext_Panel, null, [{
    ...
    get: function get() {
      var attrs = _Ext_container_Contai.observedAttributes; //for (var property in Ext_Panel.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_Panel(properties, events) {
    return _Ext_container_Contai.call(this, properties.concat(Ext_Panel.PROPERTIES()), events.concat(Ext_Panel.EVENTS())) || this;
  }
