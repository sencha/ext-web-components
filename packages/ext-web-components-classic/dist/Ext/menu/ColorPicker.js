...
var Ext_menu_ColorPicker = /*#__PURE__*/function (_Ext_menu_Menu) {
  ...
  Ext_menu_ColorPicker.getProperties = function getProperties(properties) {
  ...
  function Ext_menu_ColorPicker(properties, events) {
    return _Ext_menu_Menu.call(this, properties.concat(Ext_menu_ColorPicker.PROPERTIES()), events.concat(Ext_menu_ColorPicker.EVENTS())) || this;
  }

  var _proto = Ext_menu_ColorPicker.prototype;
  ...
  return Ext_menu_ColorPicker;
}(Ext_menu_Menu);

export { Ext_menu_ColorPicker as default };