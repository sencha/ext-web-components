...
function (_Ext_menu_Menu) {
  ...
  Ext_menu_DatePicker.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_menu_DatePicker.PROPERTIES());
    return Ext_menu_Menu.getProperties(properties);
  };

  Ext_menu_DatePicker.getEvents = function getEvents(events) {
    events = events.concat(Ext_menu_DatePicker.EVENTS());
  ...
  _createClass(Ext_menu_DatePicker, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_menu_Menu.observedAttributes; //for (var property in Ext_menu_DatePicker.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_menu_DatePicker.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_menu_DatePicker.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_menu_DatePicker(properties, events) {
    return _Ext_menu_Menu.call(this, properties.concat(Ext_menu_DatePicker.PROPERTIES()), events.concat(Ext_menu_DatePicker.EVENTS())) || this;
  }

  var _proto = Ext_menu_DatePicker.prototype;
  ...
  return Ext_menu_DatePicker;
}(Ext_menu_Menu);

export { Ext_menu_DatePicker as default };