...
var Ext_slider_Multi =
/*#__PURE__*/
function (_Ext_form_field_Base) {
  _inheritsLoose(Ext_slider_Multi, _Ext_form_field_Base);

  Ext_slider_Multi.PROPERTIES = function PROPERTIES() {
  ...
  Ext_slider_Multi.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_slider_Multi.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_slider_Multi.PROPERTIES());
    return Ext_form_field_Base.getProperties(properties);
  };

  Ext_slider_Multi.getEvents = function getEvents(events) {
    events = events.concat(Ext_slider_Multi.EVENTS());
  ...
  _createClass(Ext_slider_Multi, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_form_field_Base.observedAttributes; //for (var property in Ext_slider_Multi.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_slider_Multi.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_slider_Multi.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_slider_Multi(properties, events) {
    return _Ext_form_field_Base.call(this, properties.concat(Ext_slider_Multi.PROPERTIES()), events.concat(Ext_slider_Multi.EVENTS())) || this;
  }

  var _proto = Ext_slider_Multi.prototype;
  ...
  return Ext_slider_Multi;
}(Ext_form_field_Base);

export { Ext_slider_Multi as default };