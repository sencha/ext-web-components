...
var Ext_slider_Single =
/*#__PURE__*/
function (_Ext_slider_Multi) {
  _inheritsLoose(Ext_slider_Single, _Ext_slider_Multi);

  Ext_slider_Single.PROPERTIES = function PROPERTIES() {
  ...
  Ext_slider_Single.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_slider_Single.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_slider_Single.PROPERTIES());
    return Ext_slider_Multi.getProperties(properties);
  };

  Ext_slider_Single.getEvents = function getEvents(events) {
    events = events.concat(Ext_slider_Single.EVENTS());
  ...
  _createClass(Ext_slider_Single, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_slider_Multi.observedAttributes; //for (var property in Ext_slider_Single.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_slider_Single.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_slider_Single.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_slider_Single(properties, events) {
    return _Ext_slider_Multi.call(this, properties.concat(Ext_slider_Single.PROPERTIES()), events.concat(Ext_slider_Single.EVENTS())) || this;
  }

  var _proto = Ext_slider_Single.prototype;
  ...
  return Ext_slider_Single;
}(Ext_slider_Multi);

export { Ext_slider_Single as default };