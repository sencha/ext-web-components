...
var Ext_slider_SingleSlider = /*#__PURE__*/function (_Ext_slider_Multi) {
  _inheritsLoose(Ext_slider_SingleSlider, _Ext_slider_Multi);

  var _super = _createSuper(Ext_slider_SingleSlider);

  Ext_slider_SingleSlider.PROPERTIES = function PROPERTIES() {
  ...
  Ext_slider_SingleSlider.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_slider_SingleSlider.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_slider_SingleSlider.PROPERTIES());
  ...
  _createClass(Ext_slider_SingleSlider, null, [{
    ...
    get: function get() {
      ...
      Ext_slider_SingleSlider.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_slider_SingleSlider(properties, events) {
    return _Ext_slider_Multi.call(this, properties.concat(Ext_slider_SingleSlider.PROPERTIES()), events.concat(Ext_slider_SingleSlider.EVENTS())) || this;
  }

  var _proto = Ext_slider_SingleSlider.prototype;
  ...
  return Ext_slider_SingleSlider;
}(Ext_slider_Multi);

export { Ext_slider_SingleSlider as default };