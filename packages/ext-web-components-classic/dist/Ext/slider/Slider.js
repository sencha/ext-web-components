...
function (_Ext_slider_Multi) {
  ...
  _createClass(Ext_slider_Slider, null, [{
    ...
    get: function get() {
      var attrs = _Ext_slider_Multi.observedAttributes; //for (var property in Ext_slider_Slider.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_slider_Slider(properties, events) {
    return _Ext_slider_Multi.call(this, properties.concat(Ext_slider_Slider.PROPERTIES()), events.concat(Ext_slider_Slider.EVENTS())) || this;
  }
