...
function (_Ext_tip_Tip) {
  ...
  Ext_slider_Tip.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_slider_Tip.PROPERTIES());
    return Ext_tip_Tip.getProperties(properties);
  };

  Ext_slider_Tip.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_slider_Tip, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_tip_Tip.observedAttributes; //for (var property in Ext_slider_Tip.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_slider_Tip(properties, events) {
    return _Ext_tip_Tip.call(this, properties.concat(Ext_slider_Tip.PROPERTIES()), events.concat(Ext_slider_Tip.EVENTS())) || this;
  }

  var _proto = Ext_slider_Tip.prototype;
  ...
  return Ext_slider_Tip;
}(Ext_tip_Tip);

export { Ext_slider_Tip as default };