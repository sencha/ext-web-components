...
function (_Ext_slider_Multi) {
  _inheritsLoose(Ext_Slider, _Ext_slider_Multi);

  Ext_Slider.PROPERTIES = function PROPERTIES() {
  ...
  Ext_Slider.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_Slider.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_Slider.PROPERTIES());
    return Ext_slider_Multi.getProperties(properties);
  };

  Ext_Slider.getEvents = function getEvents(events) {
    events = events.concat(Ext_Slider.EVENTS());
  ...
  _createClass(Ext_Slider, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_slider_Multi.observedAttributes; //for (var property in Ext_Slider.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_Slider.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_Slider.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_Slider(properties, events) {
    return _Ext_slider_Multi.call(this, properties.concat(Ext_Slider.PROPERTIES()), events.concat(Ext_Slider.EVENTS())) || this;
  }

  var _proto = Ext_Slider.prototype;
