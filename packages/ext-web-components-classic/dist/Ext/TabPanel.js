...
function (_Ext_panel_Panel) {
  _inheritsLoose(Ext_TabPanel, _Ext_panel_Panel);
  ...
  _createClass(Ext_TabPanel, null, [{
    ...
    get: function get() {
      var attrs = _Ext_panel_Panel.observedAttributes; //for (var property in Ext_TabPanel.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_TabPanel(properties, events) {
    return _Ext_panel_Panel.call(this, properties.concat(Ext_TabPanel.PROPERTIES()), events.concat(Ext_TabPanel.EVENTS())) || this;
  }
