...
/*#__PURE__*/
function (_Ext_Base) {
  _inheritsLoose(Ext_Component, _Ext_Base);
  ...
  _createClass(Ext_Component, null, [{
    ...
    get: function get() {
      var attrs = _Ext_Base.observedAttributes; //for (var property in Ext_Component.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_Component(properties, events) {
    return _Ext_Base.call(this, properties.concat(Ext_Component.PROPERTIES()), events.concat(Ext_Component.EVENTS())) || this;
  }
