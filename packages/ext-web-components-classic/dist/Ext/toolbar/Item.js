...
var Ext_toolbar_Item =
/*#__PURE__*/
function (_Ext_Component) {
  _inheritsLoose(Ext_toolbar_Item, _Ext_Component);

  Ext_toolbar_Item.PROPERTIES = function PROPERTIES() {
  ...
  Ext_toolbar_Item.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_toolbar_Item.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_toolbar_Item.PROPERTIES());
    return Ext_Component.getProperties(properties);
  };

  Ext_toolbar_Item.getEvents = function getEvents(events) {
    events = events.concat(Ext_toolbar_Item.EVENTS());
  ...
  _createClass(Ext_toolbar_Item, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_toolbar_Item.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_toolbar_Item.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_toolbar_Item.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_toolbar_Item(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_toolbar_Item.PROPERTIES()), events.concat(Ext_toolbar_Item.EVENTS())) || this;
  }

  var _proto = Ext_toolbar_Item.prototype;
  ...
  return Ext_toolbar_Item;
}(Ext_Component);

export { Ext_toolbar_Item as default };