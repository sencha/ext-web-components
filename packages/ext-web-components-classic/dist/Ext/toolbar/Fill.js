...
var Ext_toolbar_Fill =
/*#__PURE__*/
function (_Ext_Component) {
  _inheritsLoose(Ext_toolbar_Fill, _Ext_Component);

  Ext_toolbar_Fill.PROPERTIES = function PROPERTIES() {
  ...
  Ext_toolbar_Fill.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_toolbar_Fill.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_toolbar_Fill.PROPERTIES());
    return Ext_Component.getProperties(properties);
  };

  Ext_toolbar_Fill.getEvents = function getEvents(events) {
    events = events.concat(Ext_toolbar_Fill.EVENTS());
  ...
  _createClass(Ext_toolbar_Fill, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_toolbar_Fill.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_toolbar_Fill.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_toolbar_Fill.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_toolbar_Fill(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_toolbar_Fill.PROPERTIES()), events.concat(Ext_toolbar_Fill.EVENTS())) || this;
  }

  var _proto = Ext_toolbar_Fill.prototype;
  ...
  return Ext_toolbar_Fill;
}(Ext_Component);

export { Ext_toolbar_Fill as default };