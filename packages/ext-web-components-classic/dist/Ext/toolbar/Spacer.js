...
var Ext_toolbar_Spacer =
/*#__PURE__*/
function (_Ext_Component) {
  _inheritsLoose(Ext_toolbar_Spacer, _Ext_Component);

  Ext_toolbar_Spacer.PROPERTIES = function PROPERTIES() {
  ...
  Ext_toolbar_Spacer.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_toolbar_Spacer.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_toolbar_Spacer.PROPERTIES());
    return Ext_Component.getProperties(properties);
  };

  Ext_toolbar_Spacer.getEvents = function getEvents(events) {
    events = events.concat(Ext_toolbar_Spacer.EVENTS());
  ...
  _createClass(Ext_toolbar_Spacer, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_toolbar_Spacer.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_toolbar_Spacer.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_toolbar_Spacer.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_toolbar_Spacer(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_toolbar_Spacer.PROPERTIES()), events.concat(Ext_toolbar_Spacer.EVENTS())) || this;
  }

  var _proto = Ext_toolbar_Spacer.prototype;
  ...
  return Ext_toolbar_Spacer;
}(Ext_Component);

export { Ext_toolbar_Spacer as default };