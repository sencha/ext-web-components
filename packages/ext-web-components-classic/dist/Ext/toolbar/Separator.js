...
var Ext_toolbar_Separator = /*#__PURE__*/function (_Ext_toolbar_Item) {
  ...
  var _super = _createSuper(Ext_toolbar_Separator);
  ...
  Ext_toolbar_Separator.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_toolbar_Separator.getProperties = function getProperties(properties) {
  ...
  function Ext_toolbar_Separator(properties, events) {
    return _Ext_toolbar_Item.call(this, properties.concat(Ext_toolbar_Separator.PROPERTIES()), events.concat(Ext_toolbar_Separator.EVENTS())) || this;
  }

  var _proto = Ext_toolbar_Separator.prototype;
  ...
  return Ext_toolbar_Separator;
}(Ext_toolbar_Item);

export { Ext_toolbar_Separator as default };