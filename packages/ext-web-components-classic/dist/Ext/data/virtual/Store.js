...
var Ext_data_virtual_Store = /*#__PURE__*/function (_Ext_data_ProxyStore) {
  ...
  var _super = _createSuper(Ext_data_virtual_Store);

  Ext_data_virtual_Store.PROPERTIES = function PROPERTIES() {
    return ['asynchronousLoad', 'autoDestroy', 'autoLoad', 'autoSort', 'autoSync', 'batchUpdateMode', 'fields', 'filters', 'groupDir', 'grouper', 'groupField', 'leadingBufferZone', 'listeners', 'model', 'pageSize', 'proxy', 'reloadOnClearSorters', 'remoteFilter', 'remoteSort', 'sorters', 'sortOnLoad', 'statefulFilters', 'storeId', 'trackRemoved', 'trailingBufferZone'];
  };
