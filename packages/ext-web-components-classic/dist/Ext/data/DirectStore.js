...
var Ext_data_DirectStore = /*#__PURE__*/function (_Ext_data_Store) {
  _inheritsLoose(Ext_data_DirectStore, _Ext_data_Store);

  var _super = _createSuper(Ext_data_DirectStore);

  Ext_data_DirectStore.PROPERTIES = function PROPERTIES() {
  ...
  Ext_data_DirectStore.EVENTS = function EVENTS() {
    return [{
      name: 'add',
  ...
  Ext_data_DirectStore.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_data_DirectStore.PROPERTIES());
    return Ext_data_Store.getProperties(properties);
  };

  Ext_data_DirectStore.getEvents = function getEvents(events) {
    events = events.concat(Ext_data_DirectStore.EVENTS());
    return Ext_data_Store.getEvents(events);
  };

  _createClass(Ext_data_DirectStore, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_data_Store.observedAttributes;
      Ext_data_DirectStore.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_data_DirectStore.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_data_DirectStore(properties, events) {
    return _Ext_data_Store.call(this, properties.concat(Ext_data_DirectStore.PROPERTIES()), events.concat(Ext_data_DirectStore.EVENTS())) || this;
  }

  var _proto = Ext_data_DirectStore.prototype;
  ...
  return Ext_data_DirectStore;
}(Ext_data_Store);

export { Ext_data_DirectStore as default };