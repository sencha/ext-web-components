...
var Ext_data_Store = /*#__PURE__*/function (_Ext_data_ProxyStore) {
  _inheritsLoose(Ext_data_Store, _Ext_data_ProxyStore);

  var _super = _createSuper(Ext_data_Store);

  Ext_data_Store.PROPERTIES = function PROPERTIES() {
  ...
  Ext_data_Store.EVENTS = function EVENTS() {
    return [{
      name: 'add',
  ...
  function Ext_data_Store(properties, events) {
    return _Ext_data_ProxyStore.call(this, properties.concat(Ext_data_Store.PROPERTIES()), events.concat(Ext_data_Store.EVENTS())) || this;
  }

  var _proto = Ext_data_Store.prototype;
  ...
  return Ext_data_Store;
}(Ext_data_ProxyStore);

export { Ext_data_Store as default };