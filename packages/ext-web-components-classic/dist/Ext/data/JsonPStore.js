...
var Ext_data_JsonPStore = /*#__PURE__*/function (_Ext_data_Store) {
  _inheritsLoose(Ext_data_JsonPStore, _Ext_data_Store);

  var _super = _createSuper(Ext_data_JsonPStore);

  Ext_data_JsonPStore.PROPERTIES = function PROPERTIES() {
  ...
  Ext_data_JsonPStore.EVENTS = function EVENTS() {
    return [{
      name: 'add',
  ...
  Ext_data_JsonPStore.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_data_JsonPStore.PROPERTIES());
    return Ext_data_Store.getProperties(properties);
  };

  Ext_data_JsonPStore.getEvents = function getEvents(events) {
    events = events.concat(Ext_data_JsonPStore.EVENTS());
    return Ext_data_Store.getEvents(events);
  };

  _createClass(Ext_data_JsonPStore, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_data_Store.observedAttributes;
      Ext_data_JsonPStore.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_data_JsonPStore.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_data_JsonPStore(properties, events) {
    return _Ext_data_Store.call(this, properties.concat(Ext_data_JsonPStore.PROPERTIES()), events.concat(Ext_data_JsonPStore.EVENTS())) || this;
  }

  var _proto = Ext_data_JsonPStore.prototype;
  ...
  return Ext_data_JsonPStore;
}(Ext_data_Store);

export { Ext_data_JsonPStore as default };