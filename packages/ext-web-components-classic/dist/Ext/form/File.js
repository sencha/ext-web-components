...
function (_Ext_form_field_Text) {
  _inheritsLoose(Ext_form_File, _Ext_form_field_Text);

  Ext_form_File.PROPERTIES = function PROPERTIES() {
  ...
  Ext_form_File.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_form_File.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_form_File.PROPERTIES());
    return Ext_form_field_Text.getProperties(properties);
  };

  Ext_form_File.getEvents = function getEvents(events) {
    events = events.concat(Ext_form_File.EVENTS());
  ...
  _createClass(Ext_form_File, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_form_field_Text.observedAttributes; //for (var property in Ext_form_File.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_form_File.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_form_File.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_form_File(properties, events) {
    return _Ext_form_field_Text.call(this, properties.concat(Ext_form_File.PROPERTIES()), events.concat(Ext_form_File.EVENTS())) || this;
  }

  var _proto = Ext_form_File.prototype;
  ...
  return Ext_form_File;
}(Ext_form_field_Text);

export { Ext_form_File as default };