...
function (_Ext_panel_Panel) {
  _inheritsLoose(Ext_form_FormPanel, _Ext_panel_Panel);
  ...
  _createClass(Ext_form_FormPanel, null, [{
    ...
    get: function get() {
      var attrs = _Ext_panel_Panel.observedAttributes; //for (var property in Ext_form_FormPanel.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_form_FormPanel(properties, events) {
    return _Ext_panel_Panel.call(this, properties.concat(Ext_form_FormPanel.PROPERTIES()), events.concat(Ext_form_FormPanel.EVENTS())) || this;
  }
