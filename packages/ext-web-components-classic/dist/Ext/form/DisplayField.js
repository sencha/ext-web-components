...
var Ext_form_DisplayField =
/*#__PURE__*/
function (_Ext_form_field_Base) {
  _inheritsLoose(Ext_form_DisplayField, _Ext_form_field_Base);

  Ext_form_DisplayField.PROPERTIES = function PROPERTIES() {
  ...
  Ext_form_DisplayField.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_form_DisplayField.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_form_DisplayField.PROPERTIES());
    return Ext_form_field_Base.getProperties(properties);
  };

  Ext_form_DisplayField.getEvents = function getEvents(events) {
    events = events.concat(Ext_form_DisplayField.EVENTS());
  ...
  _createClass(Ext_form_DisplayField, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_form_field_Base.observedAttributes; //for (var property in Ext_form_DisplayField.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_form_DisplayField.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_form_DisplayField.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_form_DisplayField(properties, events) {
    return _Ext_form_field_Base.call(this, properties.concat(Ext_form_DisplayField.PROPERTIES()), events.concat(Ext_form_DisplayField.EVENTS())) || this;
  }

  var _proto = Ext_form_DisplayField.prototype;
  ...
  return Ext_form_DisplayField;
}(Ext_form_field_Base);

export { Ext_form_DisplayField as default };