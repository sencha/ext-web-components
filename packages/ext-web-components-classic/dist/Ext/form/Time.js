...
function (_Ext_form_field_Combo) {
  _inheritsLoose(Ext_form_Time, _Ext_form_field_Combo);

  Ext_form_Time.PROPERTIES = function PROPERTIES() {
  ...
  Ext_form_Time.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_form_Time.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_form_Time.PROPERTIES());
    return Ext_form_field_ComboBox.getProperties(properties);
  };

  Ext_form_Time.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_form_Time, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_form_field_Combo.observedAttributes; //for (var property in Ext_form_Time.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_form_Time(properties, events) {
    return _Ext_form_field_Combo.call(this, properties.concat(Ext_form_Time.PROPERTIES()), events.concat(Ext_form_Time.EVENTS())) || this;
  }

  var _proto = Ext_form_Time.prototype;
  ...
  return Ext_form_Time;
}(Ext_form_field_ComboBox);

export { Ext_form_Time as default };