...
function (_Ext_form_field_Base) {
  _inheritsLoose(Ext_form_Hidden, _Ext_form_field_Base);
  ...
  _createClass(Ext_form_Hidden, null, [{
    ...
    get: function get() {
      var attrs = _Ext_form_field_Base.observedAttributes; //for (var property in Ext_form_Hidden.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_form_Hidden(properties, events) {
    return _Ext_form_field_Base.call(this, properties.concat(Ext_form_Hidden.PROPERTIES()), events.concat(Ext_form_Hidden.EVENTS())) || this;
  }
