...
var Ext_form_TimeField =
/*#__PURE__*/
function (_Ext_form_field_Combo) {
  _inheritsLoose(Ext_form_TimeField, _Ext_form_field_Combo);

  Ext_form_TimeField.PROPERTIES = function PROPERTIES() {
  ...
  Ext_form_TimeField.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_form_TimeField.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_form_TimeField.PROPERTIES());
    return Ext_form_field_ComboBox.getProperties(properties);
  };

  Ext_form_TimeField.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_form_TimeField, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_form_field_Combo.observedAttributes; //for (var property in Ext_form_TimeField.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_form_TimeField(properties, events) {
    return _Ext_form_field_Combo.call(this, properties.concat(Ext_form_TimeField.PROPERTIES()), events.concat(Ext_form_TimeField.EVENTS())) || this;
  }

  var _proto = Ext_form_TimeField.prototype;
  ...
  return Ext_form_TimeField;
}(Ext_form_field_ComboBox);

export { Ext_form_TimeField as default };