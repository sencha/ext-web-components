...
function (_Ext_form_field_Picke) {
  _inheritsLoose(Ext_form_Date, _Ext_form_field_Picke);

  Ext_form_Date.PROPERTIES = function PROPERTIES() {
  ...
  Ext_form_Date.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_form_Date.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_form_Date.PROPERTIES());
    return Ext_form_field_Picker.getProperties(properties);
  };

  Ext_form_Date.getEvents = function getEvents(events) {
    events = events.concat(Ext_form_Date.EVENTS());
  ...
  _createClass(Ext_form_Date, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_form_field_Picke.observedAttributes; //for (var property in Ext_form_Date.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_form_Date.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_form_Date.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_form_Date(properties, events) {
    return _Ext_form_field_Picke.call(this, properties.concat(Ext_form_Date.PROPERTIES()), events.concat(Ext_form_Date.EVENTS())) || this;
  }

  var _proto = Ext_form_Date.prototype;
  ...
  return Ext_form_Date;
}(Ext_form_field_Picker);

export { Ext_form_Date as default };