...
var Ext_form_TriggerField =
/*#__PURE__*/
function (_Ext_form_field_Text) {
  _inheritsLoose(Ext_form_TriggerField, _Ext_form_field_Text);

  Ext_form_TriggerField.PROPERTIES = function PROPERTIES() {
  ...
  Ext_form_TriggerField.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_form_TriggerField.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_form_TriggerField.PROPERTIES());
    return Ext_form_field_Text.getProperties(properties);
  };

  Ext_form_TriggerField.getEvents = function getEvents(events) {
    events = events.concat(Ext_form_TriggerField.EVENTS());
  ...
  _createClass(Ext_form_TriggerField, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_form_field_Text.observedAttributes; //for (var property in Ext_form_TriggerField.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_form_TriggerField.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_form_TriggerField.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_form_TriggerField(properties, events) {
    return _Ext_form_field_Text.call(this, properties.concat(Ext_form_TriggerField.PROPERTIES()), events.concat(Ext_form_TriggerField.EVENTS())) || this;
  }

  var _proto = Ext_form_TriggerField.prototype;
  ...
  return Ext_form_TriggerField;
}(Ext_form_field_Text);

export { Ext_form_TriggerField as default };