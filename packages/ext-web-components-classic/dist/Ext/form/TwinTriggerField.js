...
var Ext_form_TwinTriggerField =
/*#__PURE__*/
function (_Ext_form_field_Text) {
  _inheritsLoose(Ext_form_TwinTriggerField, _Ext_form_field_Text);

  Ext_form_TwinTriggerField.PROPERTIES = function PROPERTIES() {
  ...
  Ext_form_TwinTriggerField.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_form_TwinTriggerField.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_form_TwinTriggerField.PROPERTIES());
    return Ext_form_field_Text.getProperties(properties);
  };

  Ext_form_TwinTriggerField.getEvents = function getEvents(events) {
    events = events.concat(Ext_form_TwinTriggerField.EVENTS());
  ...
  _createClass(Ext_form_TwinTriggerField, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_form_field_Text.observedAttributes; //for (var property in Ext_form_TwinTriggerField.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_form_TwinTriggerField.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_form_TwinTriggerField.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_form_TwinTriggerField(properties, events) {
    return _Ext_form_field_Text.call(this, properties.concat(Ext_form_TwinTriggerField.PROPERTIES()), events.concat(Ext_form_TwinTriggerField.EVENTS())) || this;
  }

  var _proto = Ext_form_TwinTriggerField.prototype;
  ...
  return Ext_form_TwinTriggerField;
}(Ext_form_field_Text);

export { Ext_form_TwinTriggerField as default };