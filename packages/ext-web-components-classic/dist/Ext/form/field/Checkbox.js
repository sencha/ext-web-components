...
var Ext_form_field_Checkbox =
/*#__PURE__*/
function (_Ext_form_field_Base) {
  _inheritsLoose(Ext_form_field_Checkbox, _Ext_form_field_Base);

  Ext_form_field_Checkbox.PROPERTIES = function PROPERTIES() {
  ...
  Ext_form_field_Checkbox.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_form_field_Checkbox.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_form_field_Checkbox.PROPERTIES());
    return Ext_form_field_Base.getProperties(properties);
  };

  Ext_form_field_Checkbox.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_form_field_Checkbox, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_form_field_Base.observedAttributes; //for (var property in Ext_form_field_Checkbox.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_form_field_Checkbox(properties, events) {
    return _Ext_form_field_Base.call(this, properties.concat(Ext_form_field_Checkbox.PROPERTIES()), events.concat(Ext_form_field_Checkbox.EVENTS())) || this;
  }

  var _proto = Ext_form_field_Checkbox.prototype;
  ...
  return Ext_form_field_Checkbox;
}(Ext_form_field_Base);

export { Ext_form_field_Checkbox as default };