...
var Ext_form_field_Spinner = /*#__PURE__*/function (_Ext_form_field_Text) {
  ...
  Ext_form_field_Spinner.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_form_field_Spinner.PROPERTIES());
  ...
  _createClass(Ext_form_field_Spinner, null, [{
    ...
    get: function get() {
      ...
      Ext_form_field_Spinner.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_form_field_Spinner(properties, events) {
    return _Ext_form_field_Text.call(this, properties.concat(Ext_form_field_Spinner.PROPERTIES()), events.concat(Ext_form_field_Spinner.EVENTS())) || this;
  }

  var _proto = Ext_form_field_Spinner.prototype;
  ...
  return Ext_form_field_Spinner;
}(Ext_form_field_Text);

export { Ext_form_field_Spinner as default };