...
var Ext_form_field_Trigger =
/*#__PURE__*/
function (_Ext_form_field_Text) {
  _inheritsLoose(Ext_form_field_Trigger, _Ext_form_field_Text);

  Ext_form_field_Trigger.PROPERTIES = function PROPERTIES() {
  ...
  Ext_form_field_Trigger.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_form_field_Trigger.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_form_field_Trigger.PROPERTIES());
    return Ext_form_field_Text.getProperties(properties);
  };

  Ext_form_field_Trigger.getEvents = function getEvents(events) {
    events = events.concat(Ext_form_field_Trigger.EVENTS());
  ...
  _createClass(Ext_form_field_Trigger, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_form_field_Text.observedAttributes; //for (var property in Ext_form_field_Trigger.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_form_field_Trigger.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_form_field_Trigger.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_form_field_Trigger(properties, events) {
    return _Ext_form_field_Text.call(this, properties.concat(Ext_form_field_Trigger.PROPERTIES()), events.concat(Ext_form_field_Trigger.EVENTS())) || this;
  }

  var _proto = Ext_form_field_Trigger.prototype;
  ...
  return Ext_form_field_Trigger;
}(Ext_form_field_Text);

export { Ext_form_field_Trigger as default };