...
var Ext_form_field_Display =
/*#__PURE__*/
function (_Ext_form_field_Base) {
  _inheritsLoose(Ext_form_field_Display, _Ext_form_field_Base);

  Ext_form_field_Display.PROPERTIES = function PROPERTIES() {
  ...
  Ext_form_field_Display.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_form_field_Display.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_form_field_Display.PROPERTIES());
    return Ext_form_field_Base.getProperties(properties);
  };

  Ext_form_field_Display.getEvents = function getEvents(events) {
    events = events.concat(Ext_form_field_Display.EVENTS());
  ...
  _createClass(Ext_form_field_Display, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_form_field_Base.observedAttributes; //for (var property in Ext_form_field_Display.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_form_field_Display.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_form_field_Display.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_form_field_Display(properties, events) {
    return _Ext_form_field_Base.call(this, properties.concat(Ext_form_field_Display.PROPERTIES()), events.concat(Ext_form_field_Display.EVENTS())) || this;
  }

  var _proto = Ext_form_field_Display.prototype;
  ...
  return Ext_form_field_Display;
}(Ext_form_field_Base);

export { Ext_form_field_Display as default };