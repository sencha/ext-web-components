...
function (_Ext_form_field_Text) {
  ...
  Ext_form_field_TextArea.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_form_field_TextArea.PROPERTIES());
    return Ext_form_field_Text.getProperties(properties);
  };

  Ext_form_field_TextArea.getEvents = function getEvents(events) {
    events = events.concat(Ext_form_field_TextArea.EVENTS());
  ...
  _createClass(Ext_form_field_TextArea, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_form_field_Text.observedAttributes; //for (var property in Ext_form_field_TextArea.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_form_field_TextArea.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_form_field_TextArea.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_form_field_TextArea(properties, events) {
    return _Ext_form_field_Text.call(this, properties.concat(Ext_form_field_TextArea.PROPERTIES()), events.concat(Ext_form_field_TextArea.EVENTS())) || this;
  }

  var _proto = Ext_form_field_TextArea.prototype;
  ...
  return Ext_form_field_TextArea;
}(Ext_form_field_Text);

export { Ext_form_field_TextArea as default };