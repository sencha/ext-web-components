...
var Ext_form_field_Text =
/*#__PURE__*/
function (_Ext_form_field_Base) {
  _inheritsLoose(Ext_form_field_Text, _Ext_form_field_Base);

  Ext_form_field_Text.PROPERTIES = function PROPERTIES() {
  ...
  Ext_form_field_Text.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_form_field_Text.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_form_field_Text.PROPERTIES());
    return Ext_form_field_Base.getProperties(properties);
  };

  Ext_form_field_Text.getEvents = function getEvents(events) {
    events = events.concat(Ext_form_field_Text.EVENTS());
  ...
  _createClass(Ext_form_field_Text, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_form_field_Base.observedAttributes; //for (var property in Ext_form_field_Text.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_form_field_Text.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_form_field_Text.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_form_field_Text(properties, events) {
    return _Ext_form_field_Base.call(this, properties.concat(Ext_form_field_Text.PROPERTIES()), events.concat(Ext_form_field_Text.EVENTS())) || this;
  }

  var _proto = Ext_form_field_Text.prototype;
  ...
  return Ext_form_field_Text;
}(Ext_form_field_Base);

export { Ext_form_field_Text as default };