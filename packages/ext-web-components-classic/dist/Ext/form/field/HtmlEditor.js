...
var Ext_form_field_HtmlEditor =
/*#__PURE__*/
function (_Ext_form_FieldContai) {
  _inheritsLoose(Ext_form_field_HtmlEditor, _Ext_form_FieldContai);

  Ext_form_field_HtmlEditor.PROPERTIES = function PROPERTIES() {
  ...
  Ext_form_field_HtmlEditor.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_form_field_HtmlEditor.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_form_field_HtmlEditor.PROPERTIES());
    return Ext_form_FieldContainer.getProperties(properties);
  };

  Ext_form_field_HtmlEditor.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_form_field_HtmlEditor, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_form_FieldContai.observedAttributes; //for (var property in Ext_form_field_HtmlEditor.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_form_field_HtmlEditor(properties, events) {
    return _Ext_form_FieldContai.call(this, properties.concat(Ext_form_field_HtmlEditor.PROPERTIES()), events.concat(Ext_form_field_HtmlEditor.EVENTS())) || this;
  }

  var _proto = Ext_form_field_HtmlEditor.prototype;
  ...
  return Ext_form_field_HtmlEditor;
}(Ext_form_FieldContainer);

export { Ext_form_field_HtmlEditor as default };