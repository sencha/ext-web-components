...
var Ext_form_field_Hidden =
/*#__PURE__*/
function (_Ext_form_field_Base) {
  _inheritsLoose(Ext_form_field_Hidden, _Ext_form_field_Base);

  Ext_form_field_Hidden.PROPERTIES = function PROPERTIES() {
  ...
  Ext_form_field_Hidden.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_form_field_Hidden.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_form_field_Hidden.PROPERTIES());
    return Ext_form_field_Base.getProperties(properties);
  };

  Ext_form_field_Hidden.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_form_field_Hidden, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_form_field_Base.observedAttributes; //for (var property in Ext_form_field_Hidden.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_form_field_Hidden(properties, events) {
    return _Ext_form_field_Base.call(this, properties.concat(Ext_form_field_Hidden.PROPERTIES()), events.concat(Ext_form_field_Hidden.EVENTS())) || this;
  }

  var _proto = Ext_form_field_Hidden.prototype;
  ...
  return Ext_form_field_Hidden;
}(Ext_form_field_Base);

export { Ext_form_field_Hidden as default };