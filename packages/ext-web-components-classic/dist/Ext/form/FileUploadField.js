...
var Ext_form_FileUploadField =
/*#__PURE__*/
function (_Ext_form_field_Text) {
  _inheritsLoose(Ext_form_FileUploadField, _Ext_form_field_Text);

  Ext_form_FileUploadField.PROPERTIES = function PROPERTIES() {
  ...
  Ext_form_FileUploadField.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_form_FileUploadField.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_form_FileUploadField.PROPERTIES());
    return Ext_form_field_Text.getProperties(properties);
  };

  Ext_form_FileUploadField.getEvents = function getEvents(events) {
    events = events.concat(Ext_form_FileUploadField.EVENTS());
  ...
  _createClass(Ext_form_FileUploadField, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_form_field_Text.observedAttributes; //for (var property in Ext_form_FileUploadField.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_form_FileUploadField.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_form_FileUploadField.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_form_FileUploadField(properties, events) {
    return _Ext_form_field_Text.call(this, properties.concat(Ext_form_FileUploadField.PROPERTIES()), events.concat(Ext_form_FileUploadField.EVENTS())) || this;
  }

  var _proto = Ext_form_FileUploadField.prototype;
  ...
  return Ext_form_FileUploadField;
}(Ext_form_field_Text);

export { Ext_form_FileUploadField as default };