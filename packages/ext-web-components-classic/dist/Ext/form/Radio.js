...
var Ext_form_Radio =
/*#__PURE__*/
function (_Ext_form_field_Check) {
  _inheritsLoose(Ext_form_Radio, _Ext_form_field_Check);
  ...
  _createClass(Ext_form_Radio, null, [{
    ...
    get: function get() {
      var attrs = _Ext_form_field_Check.observedAttributes; //for (var property in Ext_form_Radio.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_form_Radio(properties, events) {
    return _Ext_form_field_Check.call(this, properties.concat(Ext_form_Radio.PROPERTIES()), events.concat(Ext_form_Radio.EVENTS())) || this;
  }
