...
var Ext_form_DateField =
/*#__PURE__*/
function (_Ext_form_field_Picke) {
  _inheritsLoose(Ext_form_DateField, _Ext_form_field_Picke);

  Ext_form_DateField.PROPERTIES = function PROPERTIES() {
  ...
  Ext_form_DateField.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_form_DateField.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_form_DateField.PROPERTIES());
    return Ext_form_field_Picker.getProperties(properties);
  };

  Ext_form_DateField.getEvents = function getEvents(events) {
    events = events.concat(Ext_form_DateField.EVENTS());
  ...
  _createClass(Ext_form_DateField, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_form_field_Picke.observedAttributes; //for (var property in Ext_form_DateField.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_form_DateField.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_form_DateField.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_form_DateField(properties, events) {
    return _Ext_form_field_Picke.call(this, properties.concat(Ext_form_DateField.PROPERTIES()), events.concat(Ext_form_DateField.EVENTS())) || this;
  }

  var _proto = Ext_form_DateField.prototype;
  ...
  return Ext_form_DateField;
}(Ext_form_field_Picker);

export { Ext_form_DateField as default };