...
function (_Ext_form_field_Spinn) {
  _inheritsLoose(Ext_form_Number, _Ext_form_field_Spinn);
  ...
  _createClass(Ext_form_Number, null, [{
    ...
    get: function get() {
      var attrs = _Ext_form_field_Spinn.observedAttributes; //for (var property in Ext_form_Number.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_form_Number(properties, events) {
    return _Ext_form_field_Spinn.call(this, properties.concat(Ext_form_Number.PROPERTIES()), events.concat(Ext_form_Number.EVENTS())) || this;
  }
