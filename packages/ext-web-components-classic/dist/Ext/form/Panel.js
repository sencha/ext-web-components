...
function (_Ext_panel_Panel) {
  _inheritsLoose(Ext_form_Panel, _Ext_panel_Panel);
  ...
  _createClass(Ext_form_Panel, null, [{
    ...
    get: function get() {
      var attrs = _Ext_panel_Panel.observedAttributes; //for (var property in Ext_form_Panel.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_form_Panel(properties, events) {
    return _Ext_panel_Panel.call(this, properties.concat(Ext_form_Panel.PROPERTIES()), events.concat(Ext_form_Panel.EVENTS())) || this;
  }
