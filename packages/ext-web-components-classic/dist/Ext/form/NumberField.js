...
var Ext_form_NumberField = /*#__PURE__*/function (_Ext_form_field_Spinn) {
  ...
  var _super = _createSuper(Ext_form_NumberField);
  ...
  Ext_form_NumberField.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_form_NumberField.getProperties = function getProperties(properties) {
  ...
  function Ext_form_NumberField(properties, events) {
    return _Ext_form_field_Spinn.call(this, properties.concat(Ext_form_NumberField.PROPERTIES()), events.concat(Ext_form_NumberField.EVENTS())) || this;
  }

  var _proto = Ext_form_NumberField.prototype;
  ...
  return Ext_form_NumberField;
}(Ext_form_field_Spinner);

export { Ext_form_NumberField as default };