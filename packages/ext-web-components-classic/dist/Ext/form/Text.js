...
function (_Ext_form_field_Base) {
  _inheritsLoose(Ext_form_Text, _Ext_form_field_Base);
  ...
  _createClass(Ext_form_Text, null, [{
    ...
    get: function get() {
      var attrs = _Ext_form_field_Base.observedAttributes; //for (var property in Ext_form_Text.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_form_Text(properties, events) {
    return _Ext_form_field_Base.call(this, properties.concat(Ext_form_Text.PROPERTIES()), events.concat(Ext_form_Text.EVENTS())) || this;
  }
