...
function (_Ext_form_field_Text) {
  _inheritsLoose(Ext_form_Picker, _Ext_form_field_Text);

  Ext_form_Picker.PROPERTIES = function PROPERTIES() {
  ...
  Ext_form_Picker.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_form_Picker.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_form_Picker.PROPERTIES());
    return Ext_form_field_Text.getProperties(properties);
  };

  Ext_form_Picker.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_form_Picker, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_form_field_Text.observedAttributes; //for (var property in Ext_form_Picker.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_form_Picker(properties, events) {
    return _Ext_form_field_Text.call(this, properties.concat(Ext_form_Picker.PROPERTIES()), events.concat(Ext_form_Picker.EVENTS())) || this;
  }

  var _proto = Ext_form_Picker.prototype;
  ...
  return Ext_form_Picker;
}(Ext_form_field_Text);

export { Ext_form_Picker as default };