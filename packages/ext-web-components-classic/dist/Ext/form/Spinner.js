...
function (_Ext_form_field_Text) {
  _inheritsLoose(Ext_form_Spinner, _Ext_form_field_Text);
  ...
  _createClass(Ext_form_Spinner, null, [{
    ...
    get: function get() {
      var attrs = _Ext_form_field_Text.observedAttributes; //for (var property in Ext_form_Spinner.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_form_Spinner(properties, events) {
    return _Ext_form_field_Text.call(this, properties.concat(Ext_form_Spinner.PROPERTIES()), events.concat(Ext_form_Spinner.EVENTS())) || this;
  }
