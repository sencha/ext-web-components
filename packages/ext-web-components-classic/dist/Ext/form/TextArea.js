...
function (_Ext_form_field_Text) {
  _inheritsLoose(Ext_form_TextArea, _Ext_form_field_Text);
  ...
  _createClass(Ext_form_TextArea, null, [{
    ...
    get: function get() {
      var attrs = _Ext_form_field_Text.observedAttributes; //for (var property in Ext_form_TextArea.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_form_TextArea(properties, events) {
    return _Ext_form_field_Text.call(this, properties.concat(Ext_form_TextArea.PROPERTIES()), events.concat(Ext_form_TextArea.EVENTS())) || this;
  }
