...
var Ext_dom_Element_Fly = /*#__PURE__*/function (_Ext_dom_Element) {
  _inheritsLoose(Ext_dom_Element_Fly, _Ext_dom_Element);

  var _super = _createSuper(Ext_dom_Element_Fly);

  Ext_dom_Element_Fly.PROPERTIES = function PROPERTIES() {
    return ['listeners'];
  };

  Ext_dom_Element_Fly.EVENTS = function EVENTS() {
    return [{
      name: 'abort',
      parameters: 'e,t'
    }, {
  ...
  function Ext_dom_Element_Fly(properties, events) {
    return _Ext_dom_Element.call(this, properties.concat(Ext_dom_Element_Fly.PROPERTIES()), events.concat(Ext_dom_Element_Fly.EVENTS())) || this;
  }

  var _proto = Ext_dom_Element_Fly.prototype;
  ...
  return Ext_dom_Element_Fly;
}(Ext_dom_Element);

export { Ext_dom_Element_Fly as default };