...
var Ext_dom_CompositeElement = /*#__PURE__*/function (_Ext_dom_CompositeEle) {
  ...
  var _super = _createSuper(Ext_dom_CompositeElement);

  Ext_dom_CompositeElement.PROPERTIES = function PROPERTIES() {
    return ['bubbleEvents', 'listeners'];
  };

  Ext_dom_CompositeElement.EVENTS = function EVENTS() {
    return [{
      name: 'abort',
      parameters: 'e,t'
    }, {
  ...
  Ext_dom_CompositeElement.getProperties = function getProperties(properties) {
  ...
  Ext_dom_CompositeElement.getEvents = function getEvents(events) {
    events = events.concat(Ext_dom_CompositeElement.EVENTS());
    return Ext_dom_CompositeElementLite.getEvents(events);
  };

  _createClass(Ext_dom_CompositeElement, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_dom_CompositeEle.observedAttributes;
      Ext_dom_CompositeElement.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_dom_CompositeElement.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_dom_CompositeElement(properties, events) {
    return _Ext_dom_CompositeEle.call(this, properties.concat(Ext_dom_CompositeElement.PROPERTIES()), events.concat(Ext_dom_CompositeElement.EVENTS())) || this;
  }

  var _proto = Ext_dom_CompositeElement.prototype;
  ...
  return Ext_dom_CompositeElement;
}(Ext_dom_CompositeElementLite);

export { Ext_dom_CompositeElement as default };