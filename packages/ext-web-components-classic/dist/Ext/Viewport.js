...
function (_Ext_container_Contai) {
  _inheritsLoose(Ext_Viewport, _Ext_container_Contai);
  ...
  _createClass(Ext_Viewport, null, [{
    ...
    get: function get() {
      var attrs = _Ext_container_Contai.observedAttributes; //for (var property in Ext_Viewport.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_Viewport(properties, events) {
    return _Ext_container_Contai.call(this, properties.concat(Ext_Viewport.PROPERTIES()), events.concat(Ext_Viewport.EVENTS())) || this;
  }
