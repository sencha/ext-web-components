...
var Ext_QuickTip = /*#__PURE__*/function (_Ext_tip_ToolTip) {
  _inheritsLoose(Ext_QuickTip, _Ext_tip_ToolTip);

  var _super = _createSuper(Ext_QuickTip);

  Ext_QuickTip.PROPERTIES = function PROPERTIES() {
  ...
  Ext_QuickTip.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_QuickTip.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_QuickTip.PROPERTIES());
  ...
  _createClass(Ext_QuickTip, null, [{
    ...
    get: function get() {
      ...
      Ext_QuickTip.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_QuickTip(properties, events) {
    return _Ext_tip_ToolTip.call(this, properties.concat(Ext_QuickTip.PROPERTIES()), events.concat(Ext_QuickTip.EVENTS())) || this;
  }

  var _proto = Ext_QuickTip.prototype;
...
export { Ext_QuickTip as default };