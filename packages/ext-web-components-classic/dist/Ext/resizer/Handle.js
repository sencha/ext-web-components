...
var Ext_resizer_Handle = /*#__PURE__*/function (_Ext_Component) {
  _inheritsLoose(Ext_resizer_Handle, _Ext_Component);

  var _super = _createSuper(Ext_resizer_Handle);

  Ext_resizer_Handle.PROPERTIES = function PROPERTIES() {
  ...
  Ext_resizer_Handle.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_resizer_Handle.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_resizer_Handle.PROPERTIES());
    return Ext_Component.getProperties(properties);
  };

  Ext_resizer_Handle.getEvents = function getEvents(events) {
    events = events.concat(Ext_resizer_Handle.EVENTS());
    return Ext_Component.getEvents(events);
  };

  _createClass(Ext_resizer_Handle, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Component.observedAttributes;
      Ext_resizer_Handle.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_resizer_Handle.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_resizer_Handle(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_resizer_Handle.PROPERTIES()), events.concat(Ext_resizer_Handle.EVENTS())) || this;
  }

  var _proto = Ext_resizer_Handle.prototype;
  ...
  return Ext_resizer_Handle;
}(Ext_Component);

export { Ext_resizer_Handle as default };