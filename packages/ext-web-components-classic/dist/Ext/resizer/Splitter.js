...
var Ext_resizer_Splitter =
/*#__PURE__*/
function (_Ext_Component) {
  _inheritsLoose(Ext_resizer_Splitter, _Ext_Component);

  Ext_resizer_Splitter.PROPERTIES = function PROPERTIES() {
  ...
  Ext_resizer_Splitter.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_resizer_Splitter.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_resizer_Splitter.PROPERTIES());
    return Ext_Component.getProperties(properties);
  };

  Ext_resizer_Splitter.getEvents = function getEvents(events) {
    events = events.concat(Ext_resizer_Splitter.EVENTS());
  ...
  _createClass(Ext_resizer_Splitter, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_resizer_Splitter.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_resizer_Splitter.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_resizer_Splitter.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_resizer_Splitter(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_resizer_Splitter.PROPERTIES()), events.concat(Ext_resizer_Splitter.EVENTS())) || this;
  }

  var _proto = Ext_resizer_Splitter.prototype;
  ...
  return Ext_resizer_Splitter;
}(Ext_Component);

export { Ext_resizer_Splitter as default };