...
var Ext_resizer_BorderSplitter = /*#__PURE__*/function (_Ext_resizer_Splitter) {
  ...
  var _super = _createSuper(Ext_resizer_BorderSplitter);
  ...
  Ext_resizer_BorderSplitter.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_resizer_BorderSplitter.getProperties = function getProperties(properties) {
  ...
  function Ext_resizer_BorderSplitter(properties, events) {
    return _Ext_resizer_Splitter.call(this, properties.concat(Ext_resizer_BorderSplitter.PROPERTIES()), events.concat(Ext_resizer_BorderSplitter.EVENTS())) || this;
  }

  var _proto = Ext_resizer_BorderSplitter.prototype;
  ...
  return Ext_resizer_BorderSplitter;
}(Ext_resizer_Splitter);

export { Ext_resizer_BorderSplitter as default };