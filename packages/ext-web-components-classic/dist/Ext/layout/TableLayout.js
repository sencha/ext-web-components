...
var Ext_layout_TableLayout = /*#__PURE__*/function (_Ext_layout_container) {
  _inheritsLoose(Ext_layout_TableLayout, _Ext_layout_container);

  var _super = _createSuper(Ext_layout_TableLayout);

  Ext_layout_TableLayout.PROPERTIES = function PROPERTIES() {
    return ['animatePolicy', 'childEls', 'columns', 'itemCls', 'tableAttrs', 'tdAttrs', 'trAttrs'];
  };

  Ext_layout_TableLayout.EVENTS = function EVENTS() {
    return [{
      name: 'ready',
  ...
  Ext_layout_TableLayout.getProperties = function getProperties(properties) {
  ...
  function Ext_layout_TableLayout(properties, events) {
    return _Ext_layout_container.call(this, properties.concat(Ext_layout_TableLayout.PROPERTIES()), events.concat(Ext_layout_TableLayout.EVENTS())) || this;
  }

  var _proto = Ext_layout_TableLayout.prototype;
  ...
  return Ext_layout_TableLayout;
}(Ext_layout_container_Container);

export { Ext_layout_TableLayout as default };