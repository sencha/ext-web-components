...
import Ext_view_AbstractView from '../../Ext/view/AbstractView.js';

var Ext_view_View =
/*#__PURE__*/
function (_Ext_view_AbstractVie) {
  _inheritsLoose(Ext_view_View, _Ext_view_AbstractVie);

  Ext_view_View.PROPERTIES = function PROPERTIES() {
  ...
  Ext_view_View.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_view_View.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_view_View.PROPERTIES());
    return Ext_view_AbstractView.getProperties(properties);
  };

  Ext_view_View.getEvents = function getEvents(events) {
    events = events.concat(Ext_view_View.EVENTS());
  ...
  _createClass(Ext_view_View, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_view_AbstractVie.observedAttributes; //for (var property in Ext_view_View.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_view_View.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_view_View.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_view_View(properties, events) {
    return _Ext_view_AbstractVie.call(this, properties.concat(Ext_view_View.PROPERTIES()), events.concat(Ext_view_View.EVENTS())) || this;
  }

  var _proto = Ext_view_View.prototype;

  _proto.connectedCallback = function connectedCallback() {
    _Ext_view_AbstractVie.prototype.connectedCallback.call(this);
  };

  _proto.attributeChangedCallback = function attributeChangedCallback(attrName, oldVal, newVal) {
    _Ext_view_AbstractVie.prototype.attributeChangedCallback.call(this, attrName, oldVal, newVal);
  };

  return Ext_view_View;
}(Ext_view_AbstractView);

export { Ext_view_View as default };