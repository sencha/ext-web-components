...
function (_Ext_grid_Panel) {
  ...
  Ext_view_MultiSelector.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_view_MultiSelector.PROPERTIES());
    return Ext_grid_Panel.getProperties(properties);
  };

  Ext_view_MultiSelector.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_view_MultiSelector, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_grid_Panel.observedAttributes; //for (var property in Ext_view_MultiSelector.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_view_MultiSelector(properties, events) {
    return _Ext_grid_Panel.call(this, properties.concat(Ext_view_MultiSelector.PROPERTIES()), events.concat(Ext_view_MultiSelector.EVENTS())) || this;
  }

  var _proto = Ext_view_MultiSelector.prototype;
  ...
  return Ext_view_MultiSelector;
}(Ext_grid_Panel);

export { Ext_view_MultiSelector as default };