...
var Ext_view_BoundList =
/*#__PURE__*/
function (_Ext_view_View) {
  _inheritsLoose(Ext_view_BoundList, _Ext_view_View);

  Ext_view_BoundList.PROPERTIES = function PROPERTIES() {
  ...
  Ext_view_BoundList.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_view_BoundList.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_view_BoundList.PROPERTIES());
    return Ext_view_View.getProperties(properties);
  };

  Ext_view_BoundList.getEvents = function getEvents(events) {
    events = events.concat(Ext_view_BoundList.EVENTS());
  ...
  _createClass(Ext_view_BoundList, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_view_View.observedAttributes; //for (var property in Ext_view_BoundList.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_view_BoundList.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_view_BoundList.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_view_BoundList(properties, events) {
    return _Ext_view_View.call(this, properties.concat(Ext_view_BoundList.PROPERTIES()), events.concat(Ext_view_BoundList.EVENTS())) || this;
  }

  var _proto = Ext_view_BoundList.prototype;
  ...
  return Ext_view_BoundList;
}(Ext_view_View);

export { Ext_view_BoundList as default };