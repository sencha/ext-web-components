...
function (_Ext_panel_Panel) {
  _inheritsLoose(Ext_Tip, _Ext_panel_Panel);

  Ext_Tip.PROPERTIES = function PROPERTIES() {
  ...
  Ext_Tip.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_Tip.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_Tip.PROPERTIES());
    return Ext_panel_Panel.getProperties(properties);
  };

  Ext_Tip.getEvents = function getEvents(events) {
    events = events.concat(Ext_Tip.EVENTS());
  ...
  _createClass(Ext_Tip, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_panel_Panel.observedAttributes; //for (var property in Ext_Tip.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_Tip.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_Tip.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_Tip(properties, events) {
    return _Ext_panel_Panel.call(this, properties.concat(Ext_Tip.PROPERTIES()), events.concat(Ext_Tip.EVENTS())) || this;
  }

  var _proto = Ext_Tip.prototype;
