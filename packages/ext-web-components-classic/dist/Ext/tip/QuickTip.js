...
var Ext_tip_QuickTip =
/*#__PURE__*/
function (_Ext_tip_ToolTip) {
  _inheritsLoose(Ext_tip_QuickTip, _Ext_tip_ToolTip);

  Ext_tip_QuickTip.PROPERTIES = function PROPERTIES() {
  ...
  Ext_tip_QuickTip.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_tip_QuickTip.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_tip_QuickTip.PROPERTIES());
    return Ext_tip_ToolTip.getProperties(properties);
  };

  Ext_tip_QuickTip.getEvents = function getEvents(events) {
    events = events.concat(Ext_tip_QuickTip.EVENTS());
    return Ext_tip_ToolTip.getEvents(events);
  } //events
  ////configs
  //
  //static XTYPE() {return 'quicktip'}
  ...
  _createClass(Ext_tip_QuickTip, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_tip_ToolTip.observedAttributes; //for (var property in Ext_tip_QuickTip.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_tip_QuickTip.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_tip_QuickTip.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_tip_QuickTip(properties, events) {
    return _Ext_tip_ToolTip.call(this, properties.concat(Ext_tip_QuickTip.PROPERTIES()), events.concat(Ext_tip_QuickTip.EVENTS())) || this;
  }

  var _proto = Ext_tip_QuickTip.prototype;
  ...
  return Ext_tip_QuickTip;
}(Ext_tip_ToolTip);

export { Ext_tip_QuickTip as default };