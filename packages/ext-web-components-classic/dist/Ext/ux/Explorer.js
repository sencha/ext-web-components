...
function (_Ext_panel_Panel) {
  ...
  Ext_ux_Explorer.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_ux_Explorer.PROPERTIES());
    return Ext_panel_Panel.getProperties(properties);
  };

  Ext_ux_Explorer.getEvents = function getEvents(events) {
    events = events.concat(Ext_ux_Explorer.EVENTS());
  ...
  _createClass(Ext_ux_Explorer, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_panel_Panel.observedAttributes; //for (var property in Ext_ux_Explorer.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_ux_Explorer.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_ux_Explorer.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_ux_Explorer(properties, events) {
    return _Ext_panel_Panel.call(this, properties.concat(Ext_ux_Explorer.PROPERTIES()), events.concat(Ext_ux_Explorer.EVENTS())) || this;
  }

  var _proto = Ext_ux_Explorer.prototype;
  ...
  return Ext_ux_Explorer;
}(Ext_panel_Panel);

export { Ext_ux_Explorer as default };