...
function (_Ext_Component) {
  _inheritsLoose(Ext_ux_IFrame, _Ext_Component);

  Ext_ux_IFrame.PROPERTIES = function PROPERTIES() {
  ...
  Ext_ux_IFrame.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_ux_IFrame.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_ux_IFrame.PROPERTIES());
    return Ext_Component.getProperties(properties);
  };

  Ext_ux_IFrame.getEvents = function getEvents(events) {
    events = events.concat(Ext_ux_IFrame.EVENTS());
  ...
  _createClass(Ext_ux_IFrame, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_ux_IFrame.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_ux_IFrame.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_ux_IFrame.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_ux_IFrame(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_ux_IFrame.PROPERTIES()), events.concat(Ext_ux_IFrame.EVENTS())) || this;
  }

  var _proto = Ext_ux_IFrame.prototype;
  ...
  return Ext_ux_IFrame;
}(Ext_Component);

export { Ext_ux_IFrame as default };