...
var Ext_ux_event_RecorderManager =
/*#__PURE__*/
function (_Ext_panel_Panel) {
  _inheritsLoose(Ext_ux_event_RecorderManager, _Ext_panel_Panel);

  Ext_ux_event_RecorderManager.PROPERTIES = function PROPERTIES() {
  ...
  Ext_ux_event_RecorderManager.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_ux_event_RecorderManager.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_ux_event_RecorderManager.PROPERTIES());
    return Ext_panel_Panel.getProperties(properties);
  };

  Ext_ux_event_RecorderManager.getEvents = function getEvents(events) {
    events = events.concat(Ext_ux_event_RecorderManager.EVENTS());
    return Ext_panel_Panel.getEvents(events);
  } //events
  ////configs
  //
  //static XTYPE() {return 'eventrecordermanager'}
  ...
  _createClass(Ext_ux_event_RecorderManager, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_panel_Panel.observedAttributes; //for (var property in Ext_ux_event_RecorderManager.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_ux_event_RecorderManager.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_ux_event_RecorderManager.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_ux_event_RecorderManager(properties, events) {
    return _Ext_panel_Panel.call(this, properties.concat(Ext_ux_event_RecorderManager.PROPERTIES()), events.concat(Ext_ux_event_RecorderManager.EVENTS())) || this;
  }

  var _proto = Ext_ux_event_RecorderManager.prototype;
  ...
  return Ext_ux_event_RecorderManager;
}(Ext_panel_Panel);

export { Ext_ux_event_RecorderManager as default };