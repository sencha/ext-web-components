...
var Ext_ux_colorpick_Slider =
/*#__PURE__*/
function (_Ext_container_Contai) {
  _inheritsLoose(Ext_ux_colorpick_Slider, _Ext_container_Contai);

  Ext_ux_colorpick_Slider.PROPERTIES = function PROPERTIES() {
  ...
  Ext_ux_colorpick_Slider.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_ux_colorpick_Slider.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_ux_colorpick_Slider.PROPERTIES());
    return Ext_container_Container.getProperties(properties);
  };

  Ext_ux_colorpick_Slider.getEvents = function getEvents(events) {
    events = events.concat(Ext_ux_colorpick_Slider.EVENTS());
    return Ext_container_Container.getEvents(events);
  } //events
  ////configs
  //
  //static XTYPE() {return 'colorpickerslider'}
  ...
  _createClass(Ext_ux_colorpick_Slider, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_container_Contai.observedAttributes; //for (var property in Ext_ux_colorpick_Slider.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_ux_colorpick_Slider.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_ux_colorpick_Slider.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_ux_colorpick_Slider(properties, events) {
    return _Ext_container_Contai.call(this, properties.concat(Ext_ux_colorpick_Slider.PROPERTIES()), events.concat(Ext_ux_colorpick_Slider.EVENTS())) || this;
  }

  var _proto = Ext_ux_colorpick_Slider.prototype;
  ...
  return Ext_ux_colorpick_Slider;
}(Ext_container_Container);

export { Ext_ux_colorpick_Slider as default };