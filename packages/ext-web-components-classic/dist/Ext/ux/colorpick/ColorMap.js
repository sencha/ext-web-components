...
var Ext_ux_colorpick_ColorMap =
/*#__PURE__*/
function (_Ext_container_Contai) {
  _inheritsLoose(Ext_ux_colorpick_ColorMap, _Ext_container_Contai);

  Ext_ux_colorpick_ColorMap.PROPERTIES = function PROPERTIES() {
  ...
  Ext_ux_colorpick_ColorMap.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  _createClass(Ext_ux_colorpick_ColorMap, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_container_Contai.observedAttributes; //for (var property in Ext_ux_colorpick_ColorMap.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_ux_colorpick_ColorMap(properties, events) {
    return _Ext_container_Contai.call(this, properties.concat(Ext_ux_colorpick_ColorMap.PROPERTIES()), events.concat(Ext_ux_colorpick_ColorMap.EVENTS())) || this;
  }

  var _proto = Ext_ux_colorpick_ColorMap.prototype;
  ...
  return Ext_ux_colorpick_ColorMap;
}(Ext_container_Container);

export { Ext_ux_colorpick_ColorMap as default };