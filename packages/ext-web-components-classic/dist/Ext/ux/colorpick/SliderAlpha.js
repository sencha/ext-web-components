...
var Ext_ux_colorpick_SliderAlpha =
/*#__PURE__*/
function (_Ext_ux_colorpick_Sli) {
  _inheritsLoose(Ext_ux_colorpick_SliderAlpha, _Ext_ux_colorpick_Sli);

  Ext_ux_colorpick_SliderAlpha.PROPERTIES = function PROPERTIES() {
  ...
  Ext_ux_colorpick_SliderAlpha.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_ux_colorpick_SliderAlpha.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_ux_colorpick_SliderAlpha.PROPERTIES());
    return Ext_ux_colorpick_Slider.getProperties(properties);
  };

  Ext_ux_colorpick_SliderAlpha.getEvents = function getEvents(events) {
    events = events.concat(Ext_ux_colorpick_SliderAlpha.EVENTS());
  ...
  _createClass(Ext_ux_colorpick_SliderAlpha, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_ux_colorpick_Sli.observedAttributes; //for (var property in Ext_ux_colorpick_SliderAlpha.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_ux_colorpick_SliderAlpha.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_ux_colorpick_SliderAlpha.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_ux_colorpick_SliderAlpha(properties, events) {
    return _Ext_ux_colorpick_Sli.call(this, properties.concat(Ext_ux_colorpick_SliderAlpha.PROPERTIES()), events.concat(Ext_ux_colorpick_SliderAlpha.EVENTS())) || this;
  }

  var _proto = Ext_ux_colorpick_SliderAlpha.prototype;
  ...
  return Ext_ux_colorpick_SliderAlpha;
}(Ext_ux_colorpick_Slider);

export { Ext_ux_colorpick_SliderAlpha as default };