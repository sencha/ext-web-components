...
var Ext_ux_colorpick_SliderValue = /*#__PURE__*/function (_Ext_ux_colorpick_Sli) {
  _inheritsLoose(Ext_ux_colorpick_SliderValue, _Ext_ux_colorpick_Sli);

  var _super = _createSuper(Ext_ux_colorpick_SliderValue);

  Ext_ux_colorpick_SliderValue.PROPERTIES = function PROPERTIES() {
  ...
  Ext_ux_colorpick_SliderValue.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_ux_colorpick_SliderValue.getProperties = function getProperties(properties) {
  ...
  _createClass(Ext_ux_colorpick_SliderValue, null, [{
    ...
    get: function get() {
      ...
      Ext_ux_colorpick_SliderValue.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_ux_colorpick_SliderValue(properties, events) {
    return _Ext_ux_colorpick_Sli.call(this, properties.concat(Ext_ux_colorpick_SliderValue.PROPERTIES()), events.concat(Ext_ux_colorpick_SliderValue.EVENTS())) || this;
  }

  var _proto = Ext_ux_colorpick_SliderValue.prototype;
  ...
  return Ext_ux_colorpick_SliderValue;
}(Ext_ux_colorpick_Slider);

export { Ext_ux_colorpick_SliderValue as default };