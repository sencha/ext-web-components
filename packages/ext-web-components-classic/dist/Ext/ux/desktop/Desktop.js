...
var Ext_ux_desktop_Desktop =
/*#__PURE__*/
function (_Ext_panel_Panel) {
  _inheritsLoose(Ext_ux_desktop_Desktop, _Ext_panel_Panel);

  Ext_ux_desktop_Desktop.PROPERTIES = function PROPERTIES() {
  ...
  Ext_ux_desktop_Desktop.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_ux_desktop_Desktop.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_ux_desktop_Desktop.PROPERTIES());
    return Ext_panel_Panel.getProperties(properties);
  };

  Ext_ux_desktop_Desktop.getEvents = function getEvents(events) {
    events = events.concat(Ext_ux_desktop_Desktop.EVENTS());
    return Ext_panel_Panel.getEvents(events);
  } //events
  ////configs
  //
  //static XTYPE() {return 'desktop'}
  ...
  _createClass(Ext_ux_desktop_Desktop, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_panel_Panel.observedAttributes; //for (var property in Ext_ux_desktop_Desktop.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_ux_desktop_Desktop.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_ux_desktop_Desktop.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_ux_desktop_Desktop(properties, events) {
    return _Ext_panel_Panel.call(this, properties.concat(Ext_ux_desktop_Desktop.PROPERTIES()), events.concat(Ext_ux_desktop_Desktop.EVENTS())) || this;
  }

  var _proto = Ext_ux_desktop_Desktop.prototype;
  ...
  return Ext_ux_desktop_Desktop;
}(Ext_panel_Panel);

export { Ext_ux_desktop_Desktop as default };