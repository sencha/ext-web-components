...
var Ext_ux_desktop_Video =
/*#__PURE__*/
function (_Ext_panel_Panel) {
  _inheritsLoose(Ext_ux_desktop_Video, _Ext_panel_Panel);

  Ext_ux_desktop_Video.PROPERTIES = function PROPERTIES() {
  ...
  Ext_ux_desktop_Video.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_ux_desktop_Video.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_ux_desktop_Video.PROPERTIES());
    return Ext_panel_Panel.getProperties(properties);
  };

  Ext_ux_desktop_Video.getEvents = function getEvents(events) {
    events = events.concat(Ext_ux_desktop_Video.EVENTS());
  ...
  _createClass(Ext_ux_desktop_Video, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_panel_Panel.observedAttributes; //for (var property in Ext_ux_desktop_Video.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_ux_desktop_Video.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_ux_desktop_Video.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_ux_desktop_Video(properties, events) {
    return _Ext_panel_Panel.call(this, properties.concat(Ext_ux_desktop_Video.PROPERTIES()), events.concat(Ext_ux_desktop_Video.EVENTS())) || this;
  }

  var _proto = Ext_ux_desktop_Video.prototype;
  ...
  return Ext_ux_desktop_Video;
}(Ext_panel_Panel);

export { Ext_ux_desktop_Video as default };