...
var Ext_ux_desktop_Wallpaper =
/*#__PURE__*/
function (_Ext_Component) {
  _inheritsLoose(Ext_ux_desktop_Wallpaper, _Ext_Component);

  Ext_ux_desktop_Wallpaper.PROPERTIES = function PROPERTIES() {
  ...
  Ext_ux_desktop_Wallpaper.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_ux_desktop_Wallpaper.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_ux_desktop_Wallpaper.PROPERTIES());
    return Ext_Component.getProperties(properties);
  };

  Ext_ux_desktop_Wallpaper.getEvents = function getEvents(events) {
    events = events.concat(Ext_ux_desktop_Wallpaper.EVENTS());
  ...
  _createClass(Ext_ux_desktop_Wallpaper, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_Component.observedAttributes; //for (var property in Ext_ux_desktop_Wallpaper.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_ux_desktop_Wallpaper.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_ux_desktop_Wallpaper.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_ux_desktop_Wallpaper(properties, events) {
    return _Ext_Component.call(this, properties.concat(Ext_ux_desktop_Wallpaper.PROPERTIES()), events.concat(Ext_ux_desktop_Wallpaper.EVENTS())) || this;
  }

  var _proto = Ext_ux_desktop_Wallpaper.prototype;
  ...
  return Ext_ux_desktop_Wallpaper;
}(Ext_Component);

export { Ext_ux_desktop_Wallpaper as default };