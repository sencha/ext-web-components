...
function (_Ext_form_FieldContai) {
  ...
  Ext_ux_Multiselect.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_ux_Multiselect.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_ux_Multiselect.PROPERTIES());
    return Ext_form_FieldContainer.getProperties(properties);
  };

  Ext_ux_Multiselect.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_ux_Multiselect, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_form_FieldContai.observedAttributes; //for (var property in Ext_ux_Multiselect.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_ux_Multiselect(properties, events) {
    return _Ext_form_FieldContai.call(this, properties.concat(Ext_ux_Multiselect.PROPERTIES()), events.concat(Ext_ux_Multiselect.EVENTS())) || this;
  }

  var _proto = Ext_ux_Multiselect.prototype;
  ...
  return Ext_ux_Multiselect;
}(Ext_form_FieldContainer);

export { Ext_ux_Multiselect as default };