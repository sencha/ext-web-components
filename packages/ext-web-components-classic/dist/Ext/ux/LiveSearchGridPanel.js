...
var Ext_ux_LiveSearchGridPanel = /*#__PURE__*/function (_Ext_grid_Panel) {
  ...
  Ext_ux_LiveSearchGridPanel.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_ux_LiveSearchGridPanel.PROPERTIES());
    return Ext_grid_Panel.getProperties(properties);
  };

  Ext_ux_LiveSearchGridPanel.getEvents = function getEvents(events) {
    events = events.concat(Ext_ux_LiveSearchGridPanel.EVENTS());
    return Ext_grid_Panel.getEvents(events);
  };

  _createClass(Ext_ux_LiveSearchGridPanel, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_grid_Panel.observedAttributes;
      Ext_ux_LiveSearchGridPanel.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_ux_LiveSearchGridPanel.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_ux_LiveSearchGridPanel(properties, events) {
    return _Ext_grid_Panel.call(this, properties.concat(Ext_ux_LiveSearchGridPanel.PROPERTIES()), events.concat(Ext_ux_LiveSearchGridPanel.EVENTS())) || this;
  }

  var _proto = Ext_ux_LiveSearchGridPanel.prototype;
  ...
  return Ext_ux_LiveSearchGridPanel;
}(Ext_grid_Panel);

export { Ext_ux_LiveSearchGridPanel as default };