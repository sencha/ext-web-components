...
var Ext_ux_form_SearchField =
/*#__PURE__*/
function (_Ext_form_field_Text) {
  _inheritsLoose(Ext_ux_form_SearchField, _Ext_form_field_Text);

  Ext_ux_form_SearchField.PROPERTIES = function PROPERTIES() {
  ...
  Ext_ux_form_SearchField.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_ux_form_SearchField.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_ux_form_SearchField.PROPERTIES());
    return Ext_form_field_Text.getProperties(properties);
  };

  Ext_ux_form_SearchField.getEvents = function getEvents(events) {
    events = events.concat(Ext_ux_form_SearchField.EVENTS());
  ...
  _createClass(Ext_ux_form_SearchField, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_form_field_Text.observedAttributes; //for (var property in Ext_ux_form_SearchField.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_ux_form_SearchField.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_ux_form_SearchField.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_ux_form_SearchField(properties, events) {
    return _Ext_form_field_Text.call(this, properties.concat(Ext_ux_form_SearchField.PROPERTIES()), events.concat(Ext_ux_form_SearchField.EVENTS())) || this;
  }

  var _proto = Ext_ux_form_SearchField.prototype;
  ...
  return Ext_ux_form_SearchField;
}(Ext_form_field_Text);

export { Ext_ux_form_SearchField as default };