...
function (_Ext_form_field_Text) {
  ...
  Ext_ux_form_FileUploadField.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_ux_form_FileUploadField.PROPERTIES());
    return Ext_form_field_Text.getProperties(properties);
  };

  Ext_ux_form_FileUploadField.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_ux_form_FileUploadField, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_form_field_Text.observedAttributes; //for (var property in Ext_ux_form_FileUploadField.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_ux_form_FileUploadField(properties, events) {
    return _Ext_form_field_Text.call(this, properties.concat(Ext_ux_form_FileUploadField.PROPERTIES()), events.concat(Ext_ux_form_FileUploadField.EVENTS())) || this;
  }

  var _proto = Ext_ux_form_FileUploadField.prototype;
  ...
  return Ext_ux_form_FileUploadField;
}(Ext_form_field_Text);

export { Ext_ux_form_FileUploadField as default };