...
var Ext_ux_form_ItemSelector = /*#__PURE__*/function (_Ext_ux_form_MultiSel) {
  _inheritsLoose(Ext_ux_form_ItemSelector, _Ext_ux_form_MultiSel);

  var _super = _createSuper(Ext_ux_form_ItemSelector);

  Ext_ux_form_ItemSelector.PROPERTIES = function PROPERTIES() {
  ...
  Ext_ux_form_ItemSelector.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_ux_form_ItemSelector.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_ux_form_ItemSelector.PROPERTIES());
  ...
  _createClass(Ext_ux_form_ItemSelector, null, [{
    ...
    get: function get() {
      ...
      Ext_ux_form_ItemSelector.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_ux_form_ItemSelector(properties, events) {
    return _Ext_ux_form_MultiSel.call(this, properties.concat(Ext_ux_form_ItemSelector.PROPERTIES()), events.concat(Ext_ux_form_ItemSelector.EVENTS())) || this;
  }

  var _proto = Ext_ux_form_ItemSelector.prototype;
  ...
  return Ext_ux_form_ItemSelector;
}(Ext_ux_form_MultiSelect);

export { Ext_ux_form_ItemSelector as default };