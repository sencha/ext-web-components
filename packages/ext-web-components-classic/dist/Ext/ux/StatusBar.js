...
var Ext_ux_StatusBar =
/*#__PURE__*/
function (_Ext_toolbar_Toolbar) {
  _inheritsLoose(Ext_ux_StatusBar, _Ext_toolbar_Toolbar);

  Ext_ux_StatusBar.PROPERTIES = function PROPERTIES() {
  ...
  Ext_ux_StatusBar.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_ux_StatusBar.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_ux_StatusBar.PROPERTIES());
    return Ext_toolbar_Toolbar.getProperties(properties);
  };

  Ext_ux_StatusBar.getEvents = function getEvents(events) {
    events = events.concat(Ext_ux_StatusBar.EVENTS());
  ...
  _createClass(Ext_ux_StatusBar, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_toolbar_Toolbar.observedAttributes; //for (var property in Ext_ux_StatusBar.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_ux_StatusBar.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_ux_StatusBar.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_ux_StatusBar(properties, events) {
    return _Ext_toolbar_Toolbar.call(this, properties.concat(Ext_ux_StatusBar.PROPERTIES()), events.concat(Ext_ux_StatusBar.EVENTS())) || this;
  }

  var _proto = Ext_ux_StatusBar.prototype;
  ...
  return Ext_ux_StatusBar;
}(Ext_toolbar_Toolbar);

export { Ext_ux_StatusBar as default };