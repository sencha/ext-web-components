...
var Ext_ux_grid_TransformGrid = /*#__PURE__*/function (_Ext_grid_Panel) {
  ...
  var _super = _createSuper(Ext_ux_grid_TransformGrid);
  ...
  Ext_ux_grid_TransformGrid.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_ux_grid_TransformGrid.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_ux_grid_TransformGrid.PROPERTIES());
    return Ext_grid_Panel.getProperties(properties);
  };

  Ext_ux_grid_TransformGrid.getEvents = function getEvents(events) {
    events = events.concat(Ext_ux_grid_TransformGrid.EVENTS());
    return Ext_grid_Panel.getEvents(events);
  };

  _createClass(Ext_ux_grid_TransformGrid, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_grid_Panel.observedAttributes;
      Ext_ux_grid_TransformGrid.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_ux_grid_TransformGrid.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_ux_grid_TransformGrid(properties, events) {
    return _Ext_grid_Panel.call(this, properties.concat(Ext_ux_grid_TransformGrid.PROPERTIES()), events.concat(Ext_ux_grid_TransformGrid.EVENTS())) || this;
  }

  var _proto = Ext_ux_grid_TransformGrid.prototype;
  ...
  return Ext_ux_grid_TransformGrid;
}(Ext_grid_Panel);

export { Ext_ux_grid_TransformGrid as default };