...
var Ext_ux_DataTip = /*#__PURE__*/function (_Ext_tip_ToolTip) {
  ...
  var _super = _createSuper(Ext_ux_DataTip);
  ...
  Ext_ux_DataTip.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_ux_DataTip.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_ux_DataTip.PROPERTIES());
    return Ext_tip_ToolTip.getProperties(properties);
  };

  Ext_ux_DataTip.getEvents = function getEvents(events) {
    events = events.concat(Ext_ux_DataTip.EVENTS());
    return Ext_tip_ToolTip.getEvents(events);
  };

  _createClass(Ext_ux_DataTip, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_tip_ToolTip.observedAttributes;
      Ext_ux_DataTip.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_ux_DataTip.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_ux_DataTip(properties, events) {
    return _Ext_tip_ToolTip.call(this, properties.concat(Ext_ux_DataTip.PROPERTIES()), events.concat(Ext_ux_DataTip.EVENTS())) || this;
  }

  var _proto = Ext_ux_DataTip.prototype;
  ...
  return Ext_ux_DataTip;
}(Ext_tip_ToolTip);

export { Ext_ux_DataTip as default };