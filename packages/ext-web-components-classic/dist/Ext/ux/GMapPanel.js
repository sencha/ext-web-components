...
var Ext_ux_GMapPanel =
/*#__PURE__*/
function (_Ext_panel_Panel) {
  _inheritsLoose(Ext_ux_GMapPanel, _Ext_panel_Panel);

  Ext_ux_GMapPanel.PROPERTIES = function PROPERTIES() {
  ...
  Ext_ux_GMapPanel.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_ux_GMapPanel.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_ux_GMapPanel.PROPERTIES());
    return Ext_panel_Panel.getProperties(properties);
  };

  Ext_ux_GMapPanel.getEvents = function getEvents(events) {
    events = events.concat(Ext_ux_GMapPanel.EVENTS());
    return Ext_panel_Panel.getEvents(events);
  } //events
  ////configs
  //
  //static XTYPE() {return 'gmappanel'}
  ...
  _createClass(Ext_ux_GMapPanel, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_panel_Panel.observedAttributes; //for (var property in Ext_ux_GMapPanel.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_ux_GMapPanel.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_ux_GMapPanel.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_ux_GMapPanel(properties, events) {
    return _Ext_panel_Panel.call(this, properties.concat(Ext_ux_GMapPanel.PROPERTIES()), events.concat(Ext_ux_GMapPanel.EVENTS())) || this;
  }

  var _proto = Ext_ux_GMapPanel.prototype;
  ...
  return Ext_ux_GMapPanel;
}(Ext_panel_Panel);

export { Ext_ux_GMapPanel as default };