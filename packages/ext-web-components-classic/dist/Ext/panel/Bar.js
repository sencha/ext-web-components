...
function (_Ext_container_Contai) {
  _inheritsLoose(Ext_panel_Bar, _Ext_container_Contai);

  Ext_panel_Bar.PROPERTIES = function PROPERTIES() {
  ...
  Ext_panel_Bar.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_panel_Bar.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_panel_Bar.PROPERTIES());
    return Ext_container_Container.getProperties(properties);
  };

  Ext_panel_Bar.getEvents = function getEvents(events) {
    events = events.concat(Ext_panel_Bar.EVENTS());
  ...
  _createClass(Ext_panel_Bar, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_container_Contai.observedAttributes; //for (var property in Ext_panel_Bar.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_panel_Bar.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_panel_Bar.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_panel_Bar(properties, events) {
    return _Ext_container_Contai.call(this, properties.concat(Ext_panel_Bar.PROPERTIES()), events.concat(Ext_panel_Bar.EVENTS())) || this;
  }

  var _proto = Ext_panel_Bar.prototype;
  ...
  return Ext_panel_Bar;
}(Ext_container_Container);

export { Ext_panel_Bar as default };