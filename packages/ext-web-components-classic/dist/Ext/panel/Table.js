...
var Ext_panel_Table = /*#__PURE__*/function (_Ext_panel_Panel) {
  _inheritsLoose(Ext_panel_Table, _Ext_panel_Panel);

  var _super = _createSuper(Ext_panel_Table);

  Ext_panel_Table.PROPERTIES = function PROPERTIES() {
  ...
  Ext_panel_Table.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_panel_Table.getProperties = function getProperties(properties) {
  ...
  _createClass(Ext_panel_Table, null, [{
    ...
    get: function get() {
      ...
      Ext_panel_Table.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_panel_Table(properties, events) {
    return _Ext_panel_Panel.call(this, properties.concat(Ext_panel_Table.PROPERTIES()), events.concat(Ext_panel_Table.EVENTS())) || this;
  }

  var _proto = Ext_panel_Table.prototype;
  ...
  return Ext_panel_Table;
}(Ext_panel_Panel);

export { Ext_panel_Table as default };