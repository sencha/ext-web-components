...
var Ext_ToolTip = /*#__PURE__*/function (_Ext_tip_Tip) {
  _inheritsLoose(Ext_ToolTip, _Ext_tip_Tip);

  var _super = _createSuper(Ext_ToolTip);

  Ext_ToolTip.PROPERTIES = function PROPERTIES() {
  ...
  Ext_ToolTip.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_ToolTip.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_ToolTip.PROPERTIES());
  ...
  _createClass(Ext_ToolTip, null, [{
    ...
    get: function get() {
      ...
      Ext_ToolTip.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_ToolTip(properties, events) {
    return _Ext_tip_Tip.call(this, properties.concat(Ext_ToolTip.PROPERTIES()), events.concat(Ext_ToolTip.EVENTS())) || this;
  }

  var _proto = Ext_ToolTip.prototype;
