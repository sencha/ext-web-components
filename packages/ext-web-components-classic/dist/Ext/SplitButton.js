...
function (_Ext_button_Button) {
  _inheritsLoose(Ext_SplitButton, _Ext_button_Button);
  ...
  _createClass(Ext_SplitButton, null, [{
    ...
    get: function get() {
      var attrs = _Ext_button_Button.observedAttributes; //for (var property in Ext_SplitButton.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_SplitButton(properties, events) {
    return _Ext_button_Button.call(this, properties.concat(Ext_SplitButton.PROPERTIES()), events.concat(Ext_SplitButton.EVENTS())) || this;
  }
