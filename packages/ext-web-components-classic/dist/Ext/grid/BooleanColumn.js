...
function (_Ext_grid_column_Colu) {
  ...
  Ext_grid_BooleanColumn.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_grid_BooleanColumn.PROPERTIES());
    return Ext_grid_column_Column.getProperties(properties);
  };

  Ext_grid_BooleanColumn.getEvents = function getEvents(events) {
    events = events.concat(Ext_grid_BooleanColumn.EVENTS());
  ...
  _createClass(Ext_grid_BooleanColumn, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_grid_column_Colu.observedAttributes; //for (var property in Ext_grid_BooleanColumn.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_grid_BooleanColumn.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_grid_BooleanColumn.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_grid_BooleanColumn(properties, events) {
    return _Ext_grid_column_Colu.call(this, properties.concat(Ext_grid_BooleanColumn.PROPERTIES()), events.concat(Ext_grid_BooleanColumn.EVENTS())) || this;
  }

  var _proto = Ext_grid_BooleanColumn.prototype;
  ...
  return Ext_grid_BooleanColumn;
}(Ext_grid_column_Column);

export { Ext_grid_BooleanColumn as default };