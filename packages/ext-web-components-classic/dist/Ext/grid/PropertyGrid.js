...
var Ext_grid_PropertyGrid =
/*#__PURE__*/
function (_Ext_grid_Panel) {
  _inheritsLoose(Ext_grid_PropertyGrid, _Ext_grid_Panel);

  Ext_grid_PropertyGrid.PROPERTIES = function PROPERTIES() {
  ...
  Ext_grid_PropertyGrid.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_grid_PropertyGrid.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_grid_PropertyGrid.PROPERTIES());
    return Ext_grid_Panel.getProperties(properties);
  };

  Ext_grid_PropertyGrid.getEvents = function getEvents(events) {
    events = events.concat(Ext_grid_PropertyGrid.EVENTS());
  ...
  _createClass(Ext_grid_PropertyGrid, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_grid_Panel.observedAttributes; //for (var property in Ext_grid_PropertyGrid.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_grid_PropertyGrid.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_grid_PropertyGrid.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_grid_PropertyGrid(properties, events) {
    return _Ext_grid_Panel.call(this, properties.concat(Ext_grid_PropertyGrid.PROPERTIES()), events.concat(Ext_grid_PropertyGrid.EVENTS())) || this;
  }

  var _proto = Ext_grid_PropertyGrid.prototype;
  ...
  return Ext_grid_PropertyGrid;
}(Ext_grid_Panel);

export { Ext_grid_PropertyGrid as default };