...
var Ext_grid_TemplateColumn =
/*#__PURE__*/
function (_Ext_grid_column_Colu) {
  _inheritsLoose(Ext_grid_TemplateColumn, _Ext_grid_column_Colu);

  Ext_grid_TemplateColumn.PROPERTIES = function PROPERTIES() {
  ...
  Ext_grid_TemplateColumn.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_grid_TemplateColumn.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_grid_TemplateColumn.PROPERTIES());
    return Ext_grid_column_Column.getProperties(properties);
  };

  Ext_grid_TemplateColumn.getEvents = function getEvents(events) {
    events = events.concat(Ext_grid_TemplateColumn.EVENTS());
  ...
  _createClass(Ext_grid_TemplateColumn, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_grid_column_Colu.observedAttributes; //for (var property in Ext_grid_TemplateColumn.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_grid_TemplateColumn.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_grid_TemplateColumn.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_grid_TemplateColumn(properties, events) {
    return _Ext_grid_column_Colu.call(this, properties.concat(Ext_grid_TemplateColumn.PROPERTIES()), events.concat(Ext_grid_TemplateColumn.EVENTS())) || this;
  }

  var _proto = Ext_grid_TemplateColumn.prototype;
  ...
  return Ext_grid_TemplateColumn;
}(Ext_grid_column_Column);

export { Ext_grid_TemplateColumn as default };