...
function (_Ext_grid_Panel) {
  ...
  Ext_grid_property_Grid.EVENTS = function EVENTS() {
    return [{
      ...
      parameters: 'source,recordId,value,oldValue'
    }, {
  ...
  Ext_grid_property_Grid.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_grid_property_Grid.PROPERTIES());
    return Ext_grid_Panel.getProperties(properties);
  };

  Ext_grid_property_Grid.getEvents = function getEvents(events) {
    events = events.concat(Ext_grid_property_Grid.EVENTS());
  ...
  _createClass(Ext_grid_property_Grid, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_grid_Panel.observedAttributes; //for (var property in Ext_grid_property_Grid.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_grid_property_Grid.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_grid_property_Grid.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_grid_property_Grid(properties, events) {
    return _Ext_grid_Panel.call(this, properties.concat(Ext_grid_property_Grid.PROPERTIES()), events.concat(Ext_grid_property_Grid.EVENTS())) || this;
  }

  var _proto = Ext_grid_property_Grid.prototype;

  _proto.connectedCallback = function connectedCallback() {
    _Ext_grid_Panel.prototype.connectedCallback.call(this);
  };

  _proto.attributeChangedCallback = function attributeChangedCallback(attrName, oldVal, newVal) {
    _Ext_grid_Panel.prototype.attributeChangedCallback.call(this, attrName, oldVal, newVal);
  };

  return Ext_grid_property_Grid;
}(Ext_grid_Panel);

export { Ext_grid_property_Grid as default };