...
var Ext_grid_property_HeaderContainer = /*#__PURE__*/function (_Ext_grid_header_Cont) {
  _inheritsLoose(Ext_grid_property_HeaderContainer, _Ext_grid_header_Cont);

  var _super = _createSuper(Ext_grid_property_HeaderContainer);

  Ext_grid_property_HeaderContainer.PROPERTIES = function PROPERTIES() {
  ...
  Ext_grid_property_HeaderContainer.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_grid_property_HeaderContainer.getProperties = function getProperties(properties) {
  ...
  Ext_grid_property_HeaderContainer.getEvents = function getEvents(events) {
    events = events.concat(Ext_grid_property_HeaderContainer.EVENTS());
    return Ext_grid_header_Container.getEvents(events);
  };

  _createClass(Ext_grid_property_HeaderContainer, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_grid_header_Cont.observedAttributes;
      Ext_grid_property_HeaderContainer.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_grid_property_HeaderContainer.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_grid_property_HeaderContainer(properties, events) {
    return _Ext_grid_header_Cont.call(this, properties.concat(Ext_grid_property_HeaderContainer.PROPERTIES()), events.concat(Ext_grid_property_HeaderContainer.EVENTS())) || this;
  }

  var _proto = Ext_grid_property_HeaderContainer.prototype;
  ...
  return Ext_grid_property_HeaderContainer;
}(Ext_grid_header_Container);

export { Ext_grid_property_HeaderContainer as default };