...
var Ext_grid_RowNumberer =
/*#__PURE__*/
function (_Ext_grid_column_Colu) {
  _inheritsLoose(Ext_grid_RowNumberer, _Ext_grid_column_Colu);

  Ext_grid_RowNumberer.PROPERTIES = function PROPERTIES() {
  ...
  Ext_grid_RowNumberer.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_grid_RowNumberer.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_grid_RowNumberer.PROPERTIES());
    return Ext_grid_column_Column.getProperties(properties);
  };

  Ext_grid_RowNumberer.getEvents = function getEvents(events) {
    events = events.concat(Ext_grid_RowNumberer.EVENTS());
  ...
  _createClass(Ext_grid_RowNumberer, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_grid_column_Colu.observedAttributes; //for (var property in Ext_grid_RowNumberer.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_grid_RowNumberer.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_grid_RowNumberer.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_grid_RowNumberer(properties, events) {
    return _Ext_grid_column_Colu.call(this, properties.concat(Ext_grid_RowNumberer.PROPERTIES()), events.concat(Ext_grid_RowNumberer.EVENTS())) || this;
  }

  var _proto = Ext_grid_RowNumberer.prototype;
  ...
  return Ext_grid_RowNumberer;
}(Ext_grid_column_Column);

export { Ext_grid_RowNumberer as default };