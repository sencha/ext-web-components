...
var Ext_grid_NumberColumn =
/*#__PURE__*/
function (_Ext_grid_column_Colu) {
  _inheritsLoose(Ext_grid_NumberColumn, _Ext_grid_column_Colu);

  Ext_grid_NumberColumn.PROPERTIES = function PROPERTIES() {
  ...
  Ext_grid_NumberColumn.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_grid_NumberColumn.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_grid_NumberColumn.PROPERTIES());
    return Ext_grid_column_Column.getProperties(properties);
  };

  Ext_grid_NumberColumn.getEvents = function getEvents(events) {
    events = events.concat(Ext_grid_NumberColumn.EVENTS());
  ...
  _createClass(Ext_grid_NumberColumn, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_grid_column_Colu.observedAttributes; //for (var property in Ext_grid_NumberColumn.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_grid_NumberColumn.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_grid_NumberColumn.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_grid_NumberColumn(properties, events) {
    return _Ext_grid_column_Colu.call(this, properties.concat(Ext_grid_NumberColumn.PROPERTIES()), events.concat(Ext_grid_NumberColumn.EVENTS())) || this;
  }

  var _proto = Ext_grid_NumberColumn.prototype;
  ...
  return Ext_grid_NumberColumn;
}(Ext_grid_column_Column);

export { Ext_grid_NumberColumn as default };