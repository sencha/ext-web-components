...
var Ext_grid_DateColumn =
/*#__PURE__*/
function (_Ext_grid_column_Colu) {
  _inheritsLoose(Ext_grid_DateColumn, _Ext_grid_column_Colu);

  Ext_grid_DateColumn.PROPERTIES = function PROPERTIES() {
  ...
  Ext_grid_DateColumn.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_grid_DateColumn.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_grid_DateColumn.PROPERTIES());
    return Ext_grid_column_Column.getProperties(properties);
  };

  Ext_grid_DateColumn.getEvents = function getEvents(events) {
    events = events.concat(Ext_grid_DateColumn.EVENTS());
  ...
  _createClass(Ext_grid_DateColumn, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_grid_column_Colu.observedAttributes; //for (var property in Ext_grid_DateColumn.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_grid_DateColumn.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_grid_DateColumn.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_grid_DateColumn(properties, events) {
    return _Ext_grid_column_Colu.call(this, properties.concat(Ext_grid_DateColumn.PROPERTIES()), events.concat(Ext_grid_DateColumn.EVENTS())) || this;
  }

  var _proto = Ext_grid_DateColumn.prototype;
  ...
  return Ext_grid_DateColumn;
}(Ext_grid_column_Column);

export { Ext_grid_DateColumn as default };