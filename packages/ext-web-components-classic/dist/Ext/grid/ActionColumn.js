...
var Ext_grid_ActionColumn =
/*#__PURE__*/
function (_Ext_grid_column_Colu) {
  _inheritsLoose(Ext_grid_ActionColumn, _Ext_grid_column_Colu);

  Ext_grid_ActionColumn.PROPERTIES = function PROPERTIES() {
  ...
  Ext_grid_ActionColumn.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_grid_ActionColumn.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_grid_ActionColumn.PROPERTIES());
    return Ext_grid_column_Column.getProperties(properties);
  };

  Ext_grid_ActionColumn.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_grid_ActionColumn, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_grid_column_Colu.observedAttributes; //for (var property in Ext_grid_ActionColumn.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_grid_ActionColumn(properties, events) {
    return _Ext_grid_column_Colu.call(this, properties.concat(Ext_grid_ActionColumn.PROPERTIES()), events.concat(Ext_grid_ActionColumn.EVENTS())) || this;
  }

  var _proto = Ext_grid_ActionColumn.prototype;
  ...
  return Ext_grid_ActionColumn;
}(Ext_grid_column_Column);

export { Ext_grid_ActionColumn as default };