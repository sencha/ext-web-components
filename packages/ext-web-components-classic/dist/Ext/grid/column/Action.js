...
function (_Ext_grid_column_Colu) {
  ...
  Ext_grid_column_Action.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_grid_column_Action.PROPERTIES());
    return Ext_grid_column_Column.getProperties(properties);
  };

  Ext_grid_column_Action.getEvents = function getEvents(events) {
    events = events.concat(Ext_grid_column_Action.EVENTS());
    return Ext_grid_column_Column.getEvents(events);
  } //events
  ////configs
  //
  //static XTYPE() {return 'actioncolumn'}
  ...
  _createClass(Ext_grid_column_Action, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_grid_column_Colu.observedAttributes; //for (var property in Ext_grid_column_Action.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_grid_column_Action.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_grid_column_Action.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_grid_column_Action(properties, events) {
    return _Ext_grid_column_Colu.call(this, properties.concat(Ext_grid_column_Action.PROPERTIES()), events.concat(Ext_grid_column_Action.EVENTS())) || this;
  }

  var _proto = Ext_grid_column_Action.prototype;
  ...
  return Ext_grid_column_Action;
}(Ext_grid_column_Column);

export { Ext_grid_column_Action as default };