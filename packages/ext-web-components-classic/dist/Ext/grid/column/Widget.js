...
function (_Ext_grid_column_Colu) {
  ...
  Ext_grid_column_Widget.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_grid_column_Widget.PROPERTIES());
    return Ext_grid_column_Column.getProperties(properties);
  };

  Ext_grid_column_Widget.getEvents = function getEvents(events) {
    events = events.concat(Ext_grid_column_Widget.EVENTS());
  ...
  _createClass(Ext_grid_column_Widget, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_grid_column_Colu.observedAttributes; //for (var property in Ext_grid_column_Widget.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_grid_column_Widget.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_grid_column_Widget.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_grid_column_Widget(properties, events) {
    return _Ext_grid_column_Colu.call(this, properties.concat(Ext_grid_column_Widget.PROPERTIES()), events.concat(Ext_grid_column_Widget.EVENTS())) || this;
  }

  var _proto = Ext_grid_column_Widget.prototype;
  ...
  return Ext_grid_column_Widget;
}(Ext_grid_column_Column);

export { Ext_grid_column_Widget as default };