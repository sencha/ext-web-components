...
var Ext_grid_column_CheckColumn =
/*#__PURE__*/
function (_Ext_grid_column_Colu) {
  _inheritsLoose(Ext_grid_column_CheckColumn, _Ext_grid_column_Colu);

  Ext_grid_column_CheckColumn.PROPERTIES = function PROPERTIES() {
  ...
  Ext_grid_column_CheckColumn.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_grid_column_CheckColumn.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_grid_column_CheckColumn.PROPERTIES());
    return Ext_grid_column_Column.getProperties(properties);
  };

  Ext_grid_column_CheckColumn.getEvents = function getEvents(events) {
    events = events.concat(Ext_grid_column_CheckColumn.EVENTS());
  ...
  _createClass(Ext_grid_column_CheckColumn, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_grid_column_Colu.observedAttributes; //for (var property in Ext_grid_column_CheckColumn.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_grid_column_CheckColumn.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_grid_column_CheckColumn.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_grid_column_CheckColumn(properties, events) {
    return _Ext_grid_column_Colu.call(this, properties.concat(Ext_grid_column_CheckColumn.PROPERTIES()), events.concat(Ext_grid_column_CheckColumn.EVENTS())) || this;
  }

  var _proto = Ext_grid_column_CheckColumn.prototype;
  ...
  return Ext_grid_column_CheckColumn;
}(Ext_grid_column_Column);

export { Ext_grid_column_CheckColumn as default };