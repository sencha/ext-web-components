...
function (_Ext_view_View) {
  _inheritsLoose(Ext_grid_View, _Ext_view_View);

  Ext_grid_View.PROPERTIES = function PROPERTIES() {
  ...
  Ext_grid_View.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_grid_View.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_grid_View.PROPERTIES());
    return Ext_view_View.getProperties(properties);
  };

  Ext_grid_View.getEvents = function getEvents(events) {
    events = events.concat(Ext_grid_View.EVENTS());
  ...
  _createClass(Ext_grid_View, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_view_View.observedAttributes; //for (var property in Ext_grid_View.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_grid_View.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_grid_View.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_grid_View(properties, events) {
    return _Ext_view_View.call(this, properties.concat(Ext_grid_View.PROPERTIES()), events.concat(Ext_grid_View.EVENTS())) || this;
  }

  var _proto = Ext_grid_View.prototype;
  ...
  return Ext_grid_View;
}(Ext_view_View);

export { Ext_grid_View as default };