...
function (_Ext_grid_header_Cont) {
  _inheritsLoose(Ext_grid_Column, _Ext_grid_header_Cont);

  Ext_grid_Column.PROPERTIES = function PROPERTIES() {
  ...
  Ext_grid_Column.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_grid_Column.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_grid_Column.PROPERTIES());
    return Ext_grid_header_Container.getProperties(properties);
  };

  Ext_grid_Column.getEvents = function getEvents(events) {
    events = events.concat(Ext_grid_Column.EVENTS());
  ...
  _createClass(Ext_grid_Column, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_grid_header_Cont.observedAttributes; //for (var property in Ext_grid_Column.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}

      Ext_grid_Column.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_grid_Column.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_grid_Column(properties, events) {
    return _Ext_grid_header_Cont.call(this, properties.concat(Ext_grid_Column.PROPERTIES()), events.concat(Ext_grid_Column.EVENTS())) || this;
  }

  var _proto = Ext_grid_Column.prototype;
...
export { Ext_grid_Column as default };