...
var Ext_grid_GridPanel = /*#__PURE__*/function (_Ext_panel_Table) {
  _inheritsLoose(Ext_grid_GridPanel, _Ext_panel_Table);

  var _super = _createSuper(Ext_grid_GridPanel);

  Ext_grid_GridPanel.PROPERTIES = function PROPERTIES() {
  ...
  Ext_grid_GridPanel.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_grid_GridPanel.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_grid_GridPanel.PROPERTIES());
  ...
  _createClass(Ext_grid_GridPanel, null, [{
    ...
    get: function get() {
      ...
      Ext_grid_GridPanel.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_grid_GridPanel(properties, events) {
    return _Ext_panel_Table.call(this, properties.concat(Ext_grid_GridPanel.PROPERTIES()), events.concat(Ext_grid_GridPanel.EVENTS())) || this;
  }

  var _proto = Ext_grid_GridPanel.prototype;
  ...
  return Ext_grid_GridPanel;
}(Ext_panel_Table);

export { Ext_grid_GridPanel as default };