...
var Ext_CycleButton = /*#__PURE__*/function (_Ext_button_Split) {
  _inheritsLoose(Ext_CycleButton, _Ext_button_Split);

  var _super = _createSuper(Ext_CycleButton);

  Ext_CycleButton.PROPERTIES = function PROPERTIES() {
  ...
  Ext_CycleButton.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_CycleButton.getProperties = function getProperties(properties) {
  ...
  function Ext_CycleButton(properties, events) {
    return _Ext_button_Split.call(this, properties.concat(Ext_CycleButton.PROPERTIES()), events.concat(Ext_CycleButton.EVENTS())) || this;
  }

  var _proto = Ext_CycleButton.prototype;
  ...
  return Ext_CycleButton;
}(Ext_button_Split);

export { Ext_CycleButton as default };