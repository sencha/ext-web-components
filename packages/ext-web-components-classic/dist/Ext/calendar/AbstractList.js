...
function (_Ext_view_View) {
  _inheritsLoose(Ext_calendar_AbstractList, _Ext_view_View);
  ...
  _createClass(Ext_calendar_AbstractList, null, [{
    ...
    get: function get() {
      var attrs = _Ext_view_View.observedAttributes; //for (var property in Ext_calendar_AbstractList.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_calendar_AbstractList(properties, events) {
    return _Ext_view_View.call(this, properties.concat(Ext_calendar_AbstractList.PROPERTIES()), events.concat(Ext_calendar_AbstractList.EVENTS())) || this;
  }
