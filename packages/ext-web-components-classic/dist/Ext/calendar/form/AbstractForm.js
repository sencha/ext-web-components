...
function (_Ext_window_Window) {
  ...
  _createClass(Ext_calendar_form_AbstractForm, null, [{
    ...
    get: function get() {
      var attrs = _Ext_window_Window.observedAttributes; //for (var property in Ext_calendar_form_AbstractForm.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_calendar_form_AbstractForm(properties, events) {
    return _Ext_window_Window.call(this, properties.concat(Ext_calendar_form_AbstractForm.PROPERTIES()), events.concat(Ext_calendar_form_AbstractForm.EVENTS())) || this;
  }
