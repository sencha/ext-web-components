...
var Ext_pivot_plugin_configurator_window_FieldSettings = /*#__PURE__*/function (_Ext_pivot_plugin_con) {
  _inheritsLoose(Ext_pivot_plugin_configurator_window_FieldSettings, _Ext_pivot_plugin_con);

  var _super = _createSuper(Ext_pivot_plugin_configurator_window_FieldSettings);

  Ext_pivot_plugin_configurator_window_FieldSettings.PROPERTIES = function PROPERTIES() {
  ...
  Ext_pivot_plugin_configurator_window_FieldSettings.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_pivot_plugin_configurator_window_FieldSettings.getProperties = function getProperties(properties) {
  ...
  Ext_pivot_plugin_configurator_window_FieldSettings.getEvents = function getEvents(events) {
  ...
  _createClass(Ext_pivot_plugin_configurator_window_FieldSettings, null, [{
  ...
  function Ext_pivot_plugin_configurator_window_FieldSettings(properties, events) {
    return _Ext_pivot_plugin_con.call(this, properties.concat(Ext_pivot_plugin_configurator_window_FieldSettings.PROPERTIES()), events.concat(Ext_pivot_plugin_configurator_window_FieldSettings.EVENTS())) || this;
  }

  var _proto = Ext_pivot_plugin_configurator_window_FieldSettings.prototype;
  ...
  return Ext_pivot_plugin_configurator_window_FieldSettings;
}(Ext_pivot_plugin_configurator_window_Window);

export { Ext_pivot_plugin_configurator_window_FieldSettings as default };