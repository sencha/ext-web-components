...
import Ext_pivot_plugin_configurator_window_FilterLabel from '../../../../../Ext/pivot/plugin/configurator/window/FilterLabel.js';

var Ext_pivot_plugin_configurator_window_FilterValue = /*#__PURE__*/function (_Ext_pivot_plugin_con) {
  _inheritsLoose(Ext_pivot_plugin_configurator_window_FilterValue, _Ext_pivot_plugin_con);

  var _super = _createSuper(Ext_pivot_plugin_configurator_window_FilterValue);

  Ext_pivot_plugin_configurator_window_FilterValue.PROPERTIES = function PROPERTIES() {
  ...
  Ext_pivot_plugin_configurator_window_FilterValue.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_pivot_plugin_configurator_window_FilterValue.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_pivot_plugin_configurator_window_FilterValue.PROPERTIES());
    return Ext_pivot_plugin_configurator_window_FilterLabel.getProperties(properties);
  };

  Ext_pivot_plugin_configurator_window_FilterValue.getEvents = function getEvents(events) {
    events = events.concat(Ext_pivot_plugin_configurator_window_FilterValue.EVENTS());
    return Ext_pivot_plugin_configurator_window_FilterLabel.getEvents(events);
  };

  _createClass(Ext_pivot_plugin_configurator_window_FilterValue, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_pivot_plugin_con.observedAttributes;
      Ext_pivot_plugin_configurator_window_FilterValue.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_pivot_plugin_configurator_window_FilterValue.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_pivot_plugin_configurator_window_FilterValue(properties, events) {
    return _Ext_pivot_plugin_con.call(this, properties.concat(Ext_pivot_plugin_configurator_window_FilterValue.PROPERTIES()), events.concat(Ext_pivot_plugin_configurator_window_FilterValue.EVENTS())) || this;
  }

  var _proto = Ext_pivot_plugin_configurator_window_FilterValue.prototype;

  _proto.connectedCallback = function connectedCallback() {
    _Ext_pivot_plugin_con.prototype.connectedCallback.call(this);
  };

  _proto.attributeChangedCallback = function attributeChangedCallback(attrName, oldVal, newVal) {
    _Ext_pivot_plugin_con.prototype.attributeChangedCallback.call(this, attrName, oldVal, newVal);
  };

  return Ext_pivot_plugin_configurator_window_FilterValue;
}(Ext_pivot_plugin_configurator_window_FilterLabel);

export { Ext_pivot_plugin_configurator_window_FilterValue as default };