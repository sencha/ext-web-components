...
var Ext_pivot_plugin_configurator_window_Settings = /*#__PURE__*/function (_Ext_pivot_plugin_con) {
  _inheritsLoose(Ext_pivot_plugin_configurator_window_Settings, _Ext_pivot_plugin_con);

  var _super = _createSuper(Ext_pivot_plugin_configurator_window_Settings);

  Ext_pivot_plugin_configurator_window_Settings.PROPERTIES = function PROPERTIES() {
  ...
  Ext_pivot_plugin_configurator_window_Settings.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_pivot_plugin_configurator_window_Settings.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_pivot_plugin_configurator_window_Settings.PROPERTIES());
    return Ext_pivot_plugin_configurator_window_Window.getProperties(properties);
  };

  Ext_pivot_plugin_configurator_window_Settings.getEvents = function getEvents(events) {
    events = events.concat(Ext_pivot_plugin_configurator_window_Settings.EVENTS());
    return Ext_pivot_plugin_configurator_window_Window.getEvents(events);
  };

  _createClass(Ext_pivot_plugin_configurator_window_Settings, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_pivot_plugin_con.observedAttributes;
      Ext_pivot_plugin_configurator_window_Settings.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_pivot_plugin_configurator_window_Settings.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_pivot_plugin_configurator_window_Settings(properties, events) {
    return _Ext_pivot_plugin_con.call(this, properties.concat(Ext_pivot_plugin_configurator_window_Settings.PROPERTIES()), events.concat(Ext_pivot_plugin_configurator_window_Settings.EVENTS())) || this;
  }

  var _proto = Ext_pivot_plugin_configurator_window_Settings.prototype;
  ...
  return Ext_pivot_plugin_configurator_window_Settings;
}(Ext_pivot_plugin_configurator_window_Window);

export { Ext_pivot_plugin_configurator_window_Settings as default };