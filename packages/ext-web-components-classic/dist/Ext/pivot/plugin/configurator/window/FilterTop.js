...
var Ext_pivot_plugin_configurator_window_FilterTop = /*#__PURE__*/function (_Ext_pivot_plugin_con) {
  ...
  var _super = _createSuper(Ext_pivot_plugin_configurator_window_FilterTop);
  ...
  Ext_pivot_plugin_configurator_window_FilterTop.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'sender'
    }, {
  ...
  Ext_pivot_plugin_configurator_window_FilterTop.getProperties = function getProperties(properties) {
    properties = properties.concat(Ext_pivot_plugin_configurator_window_FilterTop.PROPERTIES());
    return Ext_pivot_plugin_configurator_window_Window.getProperties(properties);
  };

  Ext_pivot_plugin_configurator_window_FilterTop.getEvents = function getEvents(events) {
    events = events.concat(Ext_pivot_plugin_configurator_window_FilterTop.EVENTS());
    return Ext_pivot_plugin_configurator_window_Window.getEvents(events);
  };

  _createClass(Ext_pivot_plugin_configurator_window_FilterTop, null, [{
    key: "observedAttributes",
    get: function get() {
      var attrs = _Ext_pivot_plugin_con.observedAttributes;
      Ext_pivot_plugin_configurator_window_FilterTop.PROPERTIES().forEach(function (property, index, array) {
        attrs.push(property);
      });
      Ext_pivot_plugin_configurator_window_FilterTop.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_pivot_plugin_configurator_window_FilterTop(properties, events) {
    return _Ext_pivot_plugin_con.call(this, properties.concat(Ext_pivot_plugin_configurator_window_FilterTop.PROPERTIES()), events.concat(Ext_pivot_plugin_configurator_window_FilterTop.EVENTS())) || this;
  }

  var _proto = Ext_pivot_plugin_configurator_window_FilterTop.prototype;
  ...
  return Ext_pivot_plugin_configurator_window_FilterTop;
}(Ext_pivot_plugin_configurator_window_Window);

export { Ext_pivot_plugin_configurator_window_FilterTop as default };