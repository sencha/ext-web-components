...
function (_Ext_panel_Panel) {
  ...
  _createClass(Ext_pivot_plugin_configurator_Panel, null, [{
    ...
    get: function get() {
      var attrs = _Ext_panel_Panel.observedAttributes; //for (var property in Ext_pivot_plugin_configurator_Panel.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_pivot_plugin_configurator_Panel(properties, events) {
    return _Ext_panel_Panel.call(this, properties.concat(Ext_pivot_plugin_configurator_Panel.PROPERTIES()), events.concat(Ext_pivot_plugin_configurator_Panel.EVENTS())) || this;
  }
