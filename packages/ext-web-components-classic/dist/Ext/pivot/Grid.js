...
function (_Ext_grid_Panel) {
  _inheritsLoose(Ext_pivot_Grid, _Ext_grid_Panel);
  ...
  _createClass(Ext_pivot_Grid, null, [{
    ...
    get: function get() {
      var attrs = _Ext_grid_Panel.observedAttributes; //for (var property in Ext_pivot_Grid.PROPERTIESOBJECT()) {
      //    attrs.push(property)
      //}
  ...
  function Ext_pivot_Grid(properties, events) {
    return _Ext_grid_Panel.call(this, properties.concat(Ext_pivot_Grid.PROPERTIES()), events.concat(Ext_pivot_Grid.EVENTS())) || this;
  }
