...
follow the [Getting Started guide](https://github.com/sencha/ext-web-components/blob/ext-web-components-7.2.0/packages/ext-web-components-classic/GETTING_STARTED.md).
