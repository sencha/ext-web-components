...
class ExtBase extends HTMLElement {
  ...
  static get observedAttributes() {
    ...
    this.EVENTS().forEach(function (eventparameter, index, array) {
      var eventName = 'on' + eventparameter.name
      //attrs.push('on'+eventparameter.name)
      if(eventName == 'onready' || eventName == 'onselectionchange') {
  ...
  attributeChangedCallback(attr, oldVal, newVal) {
    console.log('attr-before: ' + attr)

    var first = attr.substring(0, 2);
    //console.log(first)
    ...
    //if (/^ext/.test(attr)) {
      if (newVal) {
        ...
        //o[attr] = newVal;
        console.dir(o)
        //console.log(this['extselectionchange'])
        // if (attr.slice(2) == 'selectionchange') {
        //   //this.addEventListener('selectionchange', function() {console.log('here2...')});
        //   this.addEventListener('selectionchange', function() {eval('main.selectionchange(event)')});

        // }


        //this.addEventListener(attr.slice(2), function() {eval('main.selectionchange(event)')});
...
//         console.log('in setEvent')
//         console.log(event)
//         console.dir(me)
// //        me.addEventListener('selectionchange', function() {console.log('here...')});
//       }
...
//        console.log(eventparameter)
  ...
  addTheChild(parentCmp, childCmp) {
    ...
    if (parentxtype === 'panel' && childxtype === 'treelist') {
      console.log('$$$$$$$')
