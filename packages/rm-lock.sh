...
rm ext-web-components-boilerplate-svelte/package-lock.json
rm ext-web-components-boilerplate-vue-cli/package-lock.json
rm ext-web-components-classic/package-lock.json
...
rm ext-web-components-modern/package-lock.json
