...
rm ext-web-components-boilerplate-angular/package-lock.json
rm ext-web-components-boilerplate-react/package-lock.json
rm ext-web-components-boilerplate-vue/package-lock.json
