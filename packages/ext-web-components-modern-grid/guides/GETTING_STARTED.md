## Getting started for @sencha/ext-web-components-modern-grid
...
- Create a folder named ext-web-components-modern-grid-demo

mac
```sh
mkdir ext-web-components-modern-grid-demo
cd ext-web-components-modern-grid-demo
```

windows
```sh
md ext-web-components-modern-grid-demo
cd ext-web-components-modern-grid-demo
```

- In the ext-web-components-modern-grid-demo folder, create a package.json file with the following:

```sh
{
  "name": "ext-web-components-modern-grid-demo",
  "version": "7.2.1",
  "description": "ext-web-components-modern-grid-demo",
  "scripts": {
    "start": "npx servor . index.html 8080 --reload --browse"
  },
  "devDependencies": {
    "@sencha/ext-web-components-modern-grid": "~7.2.1",
...
- In the ext-web-components-modern-grid-demo folder, create an index.html file with the following:
...
- Run the following in the ext-web-components-modern-grid-demo folder
