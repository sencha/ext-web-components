...
var Ext_grid_filters_menu_Base = /*#__PURE__*/function (_Ext_menu_CheckItem) {
  _inheritsLoose(Ext_grid_filters_menu_Base, _Ext_menu_CheckItem);

  Ext_grid_filters_menu_Base.PROPERTIES = function PROPERTIES() {
  ...
  Ext_grid_filters_menu_Base.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  function Ext_grid_filters_menu_Base(properties, events) {
    return _Ext_menu_CheckItem.call(this, properties.concat(Ext_grid_filters_menu_Base.PROPERTIES()), events.concat(Ext_grid_filters_menu_Base.EVENTS())) || this;
  }

  var _proto = Ext_grid_filters_menu_Base.prototype;
  ...
  return Ext_grid_filters_menu_Base;
}(Ext_menu_CheckItem);

export { Ext_grid_filters_menu_Base as default };