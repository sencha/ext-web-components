...
var Ext_Msg = /*#__PURE__*/function (_Ext_MessageBox) {
  _inheritsLoose(Ext_Msg, _Ext_MessageBox);

  var _super = _createSuper(Ext_Msg);
  ...
  _createClass(Ext_Msg, null, [{
    ...
    get: function get() {
      var attrs = _Ext_MessageBox.observedAttributes;
  ...
  function Ext_Msg(properties, events) {
    return _Ext_MessageBox.call(this, properties.concat(Ext_Msg.PROPERTIES()), events.concat(Ext_Msg.EVENTS())) || this;
  }

  var _proto = Ext_Msg.prototype;

  _proto.connectedCallback = function connectedCallback() {
    _Ext_MessageBox.prototype.connectedCallback.call(this);
  };

  _proto.attributeChangedCallback = function attributeChangedCallback(attrName, oldVal, newVal) {
    _Ext_MessageBox.prototype.attributeChangedCallback.call(this, attrName, oldVal, newVal);
  };
