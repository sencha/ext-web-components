...
var Ext_viewport_WindowsPhone = /*#__PURE__*/function (_Ext_viewport_Default) {
  _inheritsLoose(Ext_viewport_WindowsPhone, _Ext_viewport_Default);

  var _super = _createSuper(Ext_viewport_WindowsPhone);

  Ext_viewport_WindowsPhone.PROPERTIES = function PROPERTIES() {
  ...
  Ext_viewport_WindowsPhone.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  function Ext_viewport_WindowsPhone(properties, events) {
    return _Ext_viewport_Default.call(this, properties.concat(Ext_viewport_WindowsPhone.PROPERTIES()), events.concat(Ext_viewport_WindowsPhone.EVENTS())) || this;
  }

  var _proto = Ext_viewport_WindowsPhone.prototype;
  ...
  return Ext_viewport_WindowsPhone;
}(Ext_viewport_Default);

export { Ext_viewport_WindowsPhone as default };