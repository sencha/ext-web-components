...
var Ext_viewport_Android = /*#__PURE__*/function (_Ext_viewport_Default) {
  _inheritsLoose(Ext_viewport_Android, _Ext_viewport_Default);

  var _super = _createSuper(Ext_viewport_Android);

  Ext_viewport_Android.PROPERTIES = function PROPERTIES() {
  ...
  Ext_viewport_Android.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  function Ext_viewport_Android(properties, events) {
    return _Ext_viewport_Default.call(this, properties.concat(Ext_viewport_Android.PROPERTIES()), events.concat(Ext_viewport_Android.EVENTS())) || this;
  }

  var _proto = Ext_viewport_Android.prototype;
  ...
  return Ext_viewport_Android;
}(Ext_viewport_Default);

export { Ext_viewport_Android as default };