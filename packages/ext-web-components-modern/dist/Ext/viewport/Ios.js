...
var Ext_viewport_Ios = /*#__PURE__*/function (_Ext_viewport_Default) {
  _inheritsLoose(Ext_viewport_Ios, _Ext_viewport_Default);

  var _super = _createSuper(Ext_viewport_Ios);

  Ext_viewport_Ios.PROPERTIES = function PROPERTIES() {
  ...
  Ext_viewport_Ios.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  function Ext_viewport_Ios(properties, events) {
    return _Ext_viewport_Default.call(this, properties.concat(Ext_viewport_Ios.PROPERTIES()), events.concat(Ext_viewport_Ios.EVENTS())) || this;
  }

  var _proto = Ext_viewport_Ios.prototype;
  ...
  return Ext_viewport_Ios;
}(Ext_viewport_Default);

export { Ext_viewport_Ios as default };