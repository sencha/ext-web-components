...
var Ext_viewport_WP = /*#__PURE__*/function (_Ext_viewport_Default) {
  _inheritsLoose(Ext_viewport_WP, _Ext_viewport_Default);

  var _super = _createSuper(Ext_viewport_WP);

  Ext_viewport_WP.PROPERTIES = function PROPERTIES() {
  ...
  Ext_viewport_WP.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  function Ext_viewport_WP(properties, events) {
    return _Ext_viewport_Default.call(this, properties.concat(Ext_viewport_WP.PROPERTIES()), events.concat(Ext_viewport_WP.EVENTS())) || this;
  }

  var _proto = Ext_viewport_WP.prototype;
  ...
  return Ext_viewport_WP;
}(Ext_viewport_Default);

export { Ext_viewport_WP as default };