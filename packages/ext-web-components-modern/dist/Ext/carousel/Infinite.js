...
var Ext_carousel_Infinite = /*#__PURE__*/function (_Ext_carousel_Carouse) {
  _inheritsLoose(Ext_carousel_Infinite, _Ext_carousel_Carouse);

  var _super = _createSuper(Ext_carousel_Infinite);

  Ext_carousel_Infinite.PROPERTIES = function PROPERTIES() {
  ...
  Ext_carousel_Infinite.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  function Ext_carousel_Infinite(properties, events) {
    return _Ext_carousel_Carouse.call(this, properties.concat(Ext_carousel_Infinite.PROPERTIES()), events.concat(Ext_carousel_Infinite.EVENTS())) || this;
  }

  var _proto = Ext_carousel_Infinite.prototype;
  ...
  return Ext_carousel_Infinite;
}(Ext_carousel_Carousel);

export { Ext_carousel_Infinite as default };