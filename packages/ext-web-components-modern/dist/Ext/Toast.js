...
var Ext_Toast = /*#__PURE__*/function (_Ext_Sheet) {
  _inheritsLoose(Ext_Toast, _Ext_Sheet);

  var _super = _createSuper(Ext_Toast);

  Ext_Toast.PROPERTIES = function PROPERTIES() {
  ...
  Ext_Toast.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  function Ext_Toast(properties, events) {
    return _Ext_Sheet.call(this, properties.concat(Ext_Toast.PROPERTIES()), events.concat(Ext_Toast.EVENTS())) || this;
  }

  var _proto = Ext_Toast.prototype;
