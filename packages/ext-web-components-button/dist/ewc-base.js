...
//Wed Oct 16 2019 10:15:00 GMT-0400 (Eastern Daylight Time)
...
function (_HTMLElement) {
  ...
  function EwcBaseComponent(properties, events) {
    ...
    _this = _HTMLElement.call(this) || this; // console.log(window.Ext)
    ...
    //     tag.async = false;
    //     tag.src = "./ext/ext.all.js";
    //     tag.onload = function() {
    //         console.log('load is done')
    //     }
    //     //document.body.appendChild(tag);
    //     document.getElementsByTagName('head')[0].appendChild(tag);
    //     //tag.src = "./ext/css.all.js";
    //     //document.head.appendChild(tag);
    // }
    // var tag = document.createElement("script");
    // tag.type = "text/javascript";
    // tag.src = "../ext/ext.button.js";
    // document.getElementsByTagName('head')[0].appendChild(tag);
    // var tag = document.createElement("script");
    // tag.type = "text/javascript";
    // tag.src = "../ext/css.button.js";
    // document.getElementsByTagName('head')[0].appendChild(tag);
  ...
  _proto.createExtComponent = function createExtComponent() {
    ...
    if (methis.base.DIRECTION == 'BottomToTop') {
      ...
      if (A.props['viewport'] == true) {
        ...
        this.doExtCreate(meA, methis, false); // Ext.onReady(function () {
      ...
      if (A.props['viewport'] == true) {
        ...
        //     methis.currentEl.A.ext = Ext.create(meA.props);
        //     console.log(methis.currentEl.A.ext)
        //     methis.assessChildren(methis.base, methis.xtype);
        // });
      }
    }
  ...
  _proto.doExtCreate = function doExtCreate(meA, methis, isApplication) {
    if (window.Ext == undefined) {
      ...
      csstag.onload = function () {
        console.log('csstag load is done');
      };
      ...
      exttag.onload = function () {
        console.log('exttagload is done');
        console.log(methis.parentType + ' - Ext.create: ' + methis.currentElName + ' HTML parent: ' + methis.currentElName);
        methis.currentEl.A.ext = Ext.create(meA.props);
        console.log(meA.props);
        console.log(methis.currentEl.A.ext);
