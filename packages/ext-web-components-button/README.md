## @sencha/ext-web-components-button

last run: Wed Oct 16 2019 10:15:00 GMT-0400 (Eastern Daylight Time)
...
```sh
ng new ng-ewc-button --minimal=true --interactive=false -g=true --skipInstall=true
```
...
```sh
"@sencha/ext-web-components-button": "~7.1.0",
...
```sh
declare var Ext: any
import '@sencha/ext-web-components-button/ext-web-components-button.module'
...
##### @sencha/ext-web-components-button/ext-web-components-button.module
