...
class Ext_grid_column_Column_Component extends Ext_grid_HeaderContainer_Component {
//events
//configs
...
constructor() {
    super (
        Ext_grid_column_Column_Component.METHODS(),
        Ext_grid_column_Column_Component.XTYPE(),
        Ext_grid_column_Column_Component.PROPERTIESOBJECT(),
        Ext_grid_column_Column_Component.EVENTS()
    )
...
(function () {
  Ext.onReady(function() {
    window.customElements.define('ext-gridcolumn', Ext_grid_column_Column_Component);
  });
})();
