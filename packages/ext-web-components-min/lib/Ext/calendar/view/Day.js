...
constructor() {
    super (
        Ext_calendar_view_Day_Component.METHODS(),
        Ext_calendar_view_Day_Component.XTYPE(),
        Ext_calendar_view_Day_Component.PROPERTIESOBJECT(),
        Ext_calendar_view_Day_Component.EVENTS()
    )
...
(function () {
  Ext.onReady(function() {
    window.customElements.define('ext-calendar-dayview', Ext_calendar_view_Day_Component);
  });
})();
