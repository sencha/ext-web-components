...
class Ext_dataview_Component_Component extends Ext_dataview_Abstract_Component {
//events
...
(function () {
  Ext.onReady(function() {
    window.customElements.define('ext-componentdataview', Ext_dataview_Component_Component);
  });
})();
