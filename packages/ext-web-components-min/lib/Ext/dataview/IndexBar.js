...
constructor() {
    super (
        Ext_dataview_IndexBar_Component.METHODS(),
        Ext_dataview_IndexBar_Component.XTYPE(),
        Ext_dataview_IndexBar_Component.PROPERTIESOBJECT(),
        Ext_dataview_IndexBar_Component.EVENTS()
    )
...
(function () {
  Ext.onReady(function() {
    window.customElements.define('ext-indexbar', Ext_dataview_IndexBar_Component);
  });
})();
