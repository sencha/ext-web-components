...
constructor() {
    super (
        Ext_field_ComboBox_Component.METHODS(),
        Ext_field_ComboBox_Component.XTYPE(),
        Ext_field_ComboBox_Component.PROPERTIESOBJECT(),
        Ext_field_ComboBox_Component.EVENTS()
    )
...
(function () {
  Ext.onReady(function() {
    window.customElements.define('ext-combobox', Ext_field_ComboBox_Component);
  });
})();
