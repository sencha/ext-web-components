...
constructor() {
    super (
        Ext_field_Field_Component.METHODS(),
        Ext_field_Field_Component.XTYPE(),
        Ext_field_Field_Component.PROPERTIESOBJECT(),
        Ext_field_Field_Component.EVENTS()
    )
...
(function () {
  Ext.onReady(function() {
    window.customElements.define('ext-field', Ext_field_Field_Component);
  });
})();
