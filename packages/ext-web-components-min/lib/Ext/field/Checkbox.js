...
constructor() {
    super (
        Ext_field_Checkbox_Component.METHODS(),
        Ext_field_Checkbox_Component.XTYPE(),
        Ext_field_Checkbox_Component.PROPERTIESOBJECT(),
        Ext_field_Checkbox_Component.EVENTS()
    )
...
(function () {
  Ext.onReady(function() {
    window.customElements.define('ext-checkbox', Ext_field_Checkbox_Component);
  });
})();
