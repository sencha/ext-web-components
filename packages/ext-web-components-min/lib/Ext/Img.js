...
constructor() {
    super (
        Ext_Img_Component.METHODS(),
        Ext_Img_Component.XTYPE(),
        Ext_Img_Component.PROPERTIESOBJECT(),
        Ext_Img_Component.EVENTS()
    )
...
(function () {
  Ext.onReady(function() {
    window.customElements.define('ext-image', Ext_Img_Component);
  });
})();
