...
class Ext_Widget_Component extends Ext_Evented_Component {
//events
...
constructor() {
    super (
        Ext_Widget_Component.METHODS(),
        Ext_Widget_Component.XTYPE(),
        Ext_Widget_Component.PROPERTIESOBJECT(),
        Ext_Widget_Component.EVENTS()
    )
...
(function () {
  Ext.onReady(function() {
    window.customElements.define('ext-widget', Ext_Widget_Component);
  });
})();
