...
constructor() {
    super (
        Ext_form_Panel_Component.METHODS(),
        Ext_form_Panel_Component.XTYPE(),
        Ext_form_Panel_Component.PROPERTIESOBJECT(),
        Ext_form_Panel_Component.EVENTS()
    )
...
(function () {
  Ext.onReady(function() {
    window.customElements.define('ext-formpanel', Ext_form_Panel_Component);
  });
})();
