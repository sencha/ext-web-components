...
constructor() {
    super (
        Ext_SegmentedButton_Component.METHODS(),
        Ext_SegmentedButton_Component.XTYPE(),
        Ext_SegmentedButton_Component.PROPERTIESOBJECT(),
        Ext_SegmentedButton_Component.EVENTS()
    )
...
(function () {
  Ext.onReady(function() {
    window.customElements.define('ext-segmentedbutton', Ext_SegmentedButton_Component);
  });
})();
