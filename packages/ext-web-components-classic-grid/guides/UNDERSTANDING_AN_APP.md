## Understanding an app for @sencha/ext-web-components-classic-grid
...
follow the [Getting Started guide](https://github.com/sencha/ext-web-components/blob/ext-web-components-7.1.1/packages/ext-web-components-classic-grid/GETTING_STARTED.md).
