...
static METHODS() { return [
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_sparkline_BarBase_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_sparkline_BarBase_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_sparkline_BarBase_Component.METHODS()),
            events.concat(Ext_sparkline_BarBase_Component.EVENTS())



            //events.concat(Ext_sparkline_BarBase_Component.EVENTS()),
            //propertiesobject.concat(Ext_sparkline_BarBase_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_sparkline_BarBase_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_sparkline_BarBase_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_sparkline_BarBase_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_sparkline_BarBase_Component.METHODS())
        )
