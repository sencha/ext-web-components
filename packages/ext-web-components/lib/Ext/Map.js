...
export default class Ext_Map_Component extends Ext_Container_Component {
//events
...
{ name:'setMapCenter',function: function(coordinates) { return this.ext.setMapCenter(coordinates) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_Map_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_Map_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_Map_Component.METHODS()),
            events.concat(Ext_Map_Component.EVENTS())



            //events.concat(Ext_Map_Component.EVENTS()),
            //propertiesobject.concat(Ext_Map_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_Map_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_Map_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_Map_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_Map_Component.METHODS())
        )
        //this.XTYPE = Ext_Map_Component.XTYPE()
