...
{ name:'updateValue',function: function() { return this.ext.updateValue() } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_slider_Slider_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_slider_Slider_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_slider_Slider_Component.METHODS()),
            events.concat(Ext_slider_Slider_Component.EVENTS())



            //events.concat(Ext_slider_Slider_Component.EVENTS()),
            //propertiesobject.concat(Ext_slider_Slider_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_slider_Slider_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_slider_Slider_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_slider_Slider_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_slider_Slider_Component.METHODS())
        )
