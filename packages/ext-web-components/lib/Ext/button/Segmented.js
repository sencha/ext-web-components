...
{ name:'updateFirstAndLastCls',function: function(items) { return this.ext.updateFirstAndLastCls(items) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_button_Segmented_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_button_Segmented_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_button_Segmented_Component.METHODS()),
            events.concat(Ext_button_Segmented_Component.EVENTS())



            //events.concat(Ext_button_Segmented_Component.EVENTS()),
            //propertiesobject.concat(Ext_button_Segmented_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_button_Segmented_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_button_Segmented_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_button_Segmented_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_button_Segmented_Component.METHODS())
        )
