...
{ name:'shouldAutoHide',function: function(trigger) { return this.ext.shouldAutoHide(trigger) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_IndexBar_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_IndexBar_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_IndexBar_Component.METHODS()),
            events.concat(Ext_IndexBar_Component.EVENTS())



            //events.concat(Ext_IndexBar_Component.EVENTS()),
            //propertiesobject.concat(Ext_IndexBar_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_IndexBar_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_IndexBar_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_IndexBar_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_IndexBar_Component.METHODS())
        )
