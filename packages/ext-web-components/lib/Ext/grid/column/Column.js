...
export default class Ext_grid_column_Column_Component extends Ext_grid_HeaderContainer_Component {
//events
//configs
...
{ name:'toggleSortState',function: function() { return this.ext.toggleSortState() } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_grid_column_Column_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_grid_column_Column_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_grid_column_Column_Component.METHODS()),
            events.concat(Ext_grid_column_Column_Component.EVENTS())



            //events.concat(Ext_grid_column_Column_Component.EVENTS()),
            //propertiesobject.concat(Ext_grid_column_Column_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_grid_column_Column_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_grid_column_Column_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_grid_column_Column_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_grid_column_Column_Component.METHODS())
        )
        //this.XTYPE = Ext_grid_column_Column_Component.XTYPE()
