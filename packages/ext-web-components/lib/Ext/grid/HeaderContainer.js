...
{ name:'updateMenuDisabledState',function: function() { return this.ext.updateMenuDisabledState() } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_grid_HeaderContainer_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_grid_HeaderContainer_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_grid_HeaderContainer_Component.METHODS()),
            events.concat(Ext_grid_HeaderContainer_Component.EVENTS())



            //events.concat(Ext_grid_HeaderContainer_Component.EVENTS()),
            //propertiesobject.concat(Ext_grid_HeaderContainer_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_grid_HeaderContainer_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_grid_HeaderContainer_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_grid_HeaderContainer_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_grid_HeaderContainer_Component.METHODS())
        )
