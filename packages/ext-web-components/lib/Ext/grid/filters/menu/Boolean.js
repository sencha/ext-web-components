...
static METHODS() { return [
    ...
    constructor() {
        super (
            Ext_grid_filters_menu_Boolean_Component.METHODS(),
            Ext_grid_filters_menu_Boolean_Component.XTYPE(),
            Ext_grid_filters_menu_Boolean_Component.PROPERTIESOBJECT(),
            Ext_grid_filters_menu_Boolean_Component.EVENTS()
        )
