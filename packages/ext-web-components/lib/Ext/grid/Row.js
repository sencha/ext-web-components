...
{ name:'getCells',function: function(selector) { return this.ext.getCells(selector) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_grid_Row_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_grid_Row_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_grid_Row_Component.METHODS()),
            events.concat(Ext_grid_Row_Component.EVENTS())



            //events.concat(Ext_grid_Row_Component.EVENTS()),
            //propertiesobject.concat(Ext_grid_Row_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_grid_Row_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_grid_Row_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_grid_Row_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_grid_Row_Component.METHODS())
        )
