...
{ name:'toggle',function: function() { return this.ext.toggle() } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_grid_cell_Tree_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_grid_cell_Tree_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_grid_cell_Tree_Component.METHODS()),
            events.concat(Ext_grid_cell_Tree_Component.EVENTS())



            //events.concat(Ext_grid_cell_Tree_Component.EVENTS()),
            //propertiesobject.concat(Ext_grid_cell_Tree_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_grid_cell_Tree_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_grid_cell_Tree_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_grid_cell_Tree_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_grid_cell_Tree_Component.METHODS())
        )
