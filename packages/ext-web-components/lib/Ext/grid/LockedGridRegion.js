...
static METHODS() { return [
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_grid_LockedGridRegion_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_grid_LockedGridRegion_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_grid_LockedGridRegion_Component.METHODS()),
            events.concat(Ext_grid_LockedGridRegion_Component.EVENTS())



            //events.concat(Ext_grid_LockedGridRegion_Component.EVENTS()),
            //propertiesobject.concat(Ext_grid_LockedGridRegion_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_grid_LockedGridRegion_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_grid_LockedGridRegion_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_grid_LockedGridRegion_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_grid_LockedGridRegion_Component.METHODS())
        )
