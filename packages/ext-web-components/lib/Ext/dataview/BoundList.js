...
{ name:'beforeSelectionRefresh',function: function(toDeselect,toReselect) { return this.ext.beforeSelectionRefresh(toDeselect,toReselect) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_dataview_BoundList_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_dataview_BoundList_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_dataview_BoundList_Component.METHODS()),
            events.concat(Ext_dataview_BoundList_Component.EVENTS())



            //events.concat(Ext_dataview_BoundList_Component.EVENTS()),
            //propertiesobject.concat(Ext_dataview_BoundList_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_dataview_BoundList_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_dataview_BoundList_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_dataview_BoundList_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_dataview_BoundList_Component.METHODS())
        )
