...
{ name:'changeItem',function: function(itemIndex,recordIndex) { return this.ext.changeItem(itemIndex,recordIndex) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_dataview_Component_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_dataview_Component_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_dataview_Component_Component.METHODS()),
            events.concat(Ext_dataview_Component_Component.EVENTS())



            //events.concat(Ext_dataview_Component_Component.EVENTS()),
            //propertiesobject.concat(Ext_dataview_Component_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_dataview_Component_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_dataview_Component_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_dataview_Component_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_dataview_Component_Component.METHODS())
        )
