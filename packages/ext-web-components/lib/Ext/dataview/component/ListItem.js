...
static METHODS() { return [
    ...
    constructor() {
        super (
            Ext_dataview_component_ListItem_Component.METHODS(),
            Ext_dataview_component_ListItem_Component.XTYPE(),
            Ext_dataview_component_ListItem_Component.PROPERTIESOBJECT(),
            Ext_dataview_component_ListItem_Component.EVENTS()
        )
