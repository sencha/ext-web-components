...
{ name:'updateRecord',function: function(record) { return this.ext.updateRecord(record) } },
    ...
    constructor() {
        super (
            Ext_dataview_component_DataItem_Component.METHODS(),
            Ext_dataview_component_DataItem_Component.XTYPE(),
            Ext_dataview_component_DataItem_Component.PROPERTIESOBJECT(),
            Ext_dataview_component_DataItem_Component.EVENTS()
        )
