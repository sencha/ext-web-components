...
static METHODS() { return [
    ...
    constructor() {
        super (
            Ext_dataview_component_SimpleListItem_Component.METHODS(),
            Ext_dataview_component_SimpleListItem_Component.XTYPE(),
            Ext_dataview_component_SimpleListItem_Component.PROPERTIESOBJECT(),
            Ext_dataview_component_SimpleListItem_Component.EVENTS()
        )
