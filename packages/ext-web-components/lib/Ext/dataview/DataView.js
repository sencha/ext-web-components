...
{ name:'getItemClass',function: function(data) { return this.ext.getItemClass(data) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_dataview_DataView_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_dataview_DataView_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_dataview_DataView_Component.METHODS()),
            events.concat(Ext_dataview_DataView_Component.EVENTS())



            //events.concat(Ext_dataview_DataView_Component.EVENTS()),
            //propertiesobject.concat(Ext_dataview_DataView_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_dataview_DataView_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_dataview_DataView_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_dataview_DataView_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_dataview_DataView_Component.METHODS())
        )
