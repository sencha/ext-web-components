...
export default class Ext_dataview_List_Component extends Ext_dataview_Component_Component {
//events
...
{ name:'scrollToRecord',function: function(record,animation) { return this.ext.scrollToRecord(record,animation) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_dataview_List_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_dataview_List_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_dataview_List_Component.METHODS()),
            events.concat(Ext_dataview_List_Component.EVENTS())



            //events.concat(Ext_dataview_List_Component.EVENTS()),
            //propertiesobject.concat(Ext_dataview_List_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_dataview_List_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_dataview_List_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_dataview_List_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_dataview_List_Component.METHODS())
        )
        //this.XTYPE = Ext_dataview_List_Component.XTYPE()
