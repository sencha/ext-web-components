...
{ name:'updateRecord',function: function(record) { return this.ext.updateRecord(record) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_dataview_DataItem_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_dataview_DataItem_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_dataview_DataItem_Component.METHODS()),
            events.concat(Ext_dataview_DataItem_Component.EVENTS())



            //events.concat(Ext_dataview_DataItem_Component.EVENTS()),
            //propertiesobject.concat(Ext_dataview_DataItem_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_dataview_DataItem_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_dataview_DataItem_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_dataview_DataItem_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_dataview_DataItem_Component.METHODS())
        )
