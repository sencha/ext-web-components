...
static METHODS() { return [
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_dataview_listswiper_Item_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_dataview_listswiper_Item_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_dataview_listswiper_Item_Component.METHODS()),
            events.concat(Ext_dataview_listswiper_Item_Component.EVENTS())



            //events.concat(Ext_dataview_listswiper_Item_Component.EVENTS()),
            //propertiesobject.concat(Ext_dataview_listswiper_Item_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_dataview_listswiper_Item_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_dataview_listswiper_Item_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_dataview_listswiper_Item_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_dataview_listswiper_Item_Component.METHODS())
        )
