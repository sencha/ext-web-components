...
{ name:'updateMessageCls',function: function(newMessageCls,oldMessageCls) { return this.ext.updateMessageCls(newMessageCls,oldMessageCls) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_LoadMask_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_LoadMask_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_LoadMask_Component.METHODS()),
            events.concat(Ext_LoadMask_Component.EVENTS())



            //events.concat(Ext_LoadMask_Component.EVENTS()),
            //propertiesobject.concat(Ext_LoadMask_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_LoadMask_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_LoadMask_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_LoadMask_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_LoadMask_Component.METHODS())
        )
