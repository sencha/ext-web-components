...
export default class Ext_container_Container_Component extends Ext_Component_Component {
//events
...
{ name:'unmask',function: function() { return this.ext.unmask() } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_container_Container_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_container_Container_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_container_Container_Component.METHODS()),
            events.concat(Ext_container_Container_Component.EVENTS())



            //events.concat(Ext_container_Container_Component.EVENTS()),
            //propertiesobject.concat(Ext_container_Container_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_container_Container_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_container_Container_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_container_Container_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_container_Container_Component.METHODS())
        )
        //this.XTYPE = Ext_container_Container_Component.XTYPE()
