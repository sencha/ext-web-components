...
{ name:'unmask',function: function() { return this.ext.unmask() } },
    ...
    constructor() {
        super (
            Ext_container_Container_Component.METHODS(),
            Ext_container_Container_Component.XTYPE(),
            Ext_container_Container_Component.PROPERTIESOBJECT(),
            Ext_container_Container_Component.EVENTS()
        )
