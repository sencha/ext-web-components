...
export default class Ext_NestedList_Component extends Ext_Container_Component {
//events
...
{ name:'syncToolbar',function: function(forceDetail) { return this.ext.syncToolbar(forceDetail) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_NestedList_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_NestedList_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_NestedList_Component.METHODS()),
            events.concat(Ext_NestedList_Component.EVENTS())



            //events.concat(Ext_NestedList_Component.EVENTS()),
            //propertiesobject.concat(Ext_NestedList_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_NestedList_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_NestedList_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_NestedList_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_NestedList_Component.METHODS())
        )
        //this.XTYPE = Ext_NestedList_Component.XTYPE()
