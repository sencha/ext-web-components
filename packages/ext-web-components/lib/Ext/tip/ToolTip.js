...
{ name:'realignToTarget',function: function() { return this.ext.realignToTarget() } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_tip_ToolTip_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_tip_ToolTip_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_tip_ToolTip_Component.METHODS()),
            events.concat(Ext_tip_ToolTip_Component.EVENTS())



            //events.concat(Ext_tip_ToolTip_Component.EVENTS()),
            //propertiesobject.concat(Ext_tip_ToolTip_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_tip_ToolTip_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_tip_ToolTip_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_tip_ToolTip_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_tip_ToolTip_Component.METHODS())
        )
