...
{ name:'setGroupValue',function: function(value) { return this.ext.setGroupValue(value) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_field_Radio_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_field_Radio_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_field_Radio_Component.METHODS()),
            events.concat(Ext_field_Radio_Component.EVENTS())



            //events.concat(Ext_field_Radio_Component.EVENTS()),
            //propertiesobject.concat(Ext_field_Radio_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_field_Radio_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_field_Radio_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_field_Radio_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_field_Radio_Component.METHODS())
        )
