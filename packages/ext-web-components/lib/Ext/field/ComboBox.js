...
export default class Ext_field_ComboBox_Component extends Ext_field_Select_Component {
//events
...
{ name:'serializePrimaryFilter',function: function(filter) { return this.ext.serializePrimaryFilter(filter) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_field_ComboBox_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_field_ComboBox_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_field_ComboBox_Component.METHODS()),
            events.concat(Ext_field_ComboBox_Component.EVENTS())



            //events.concat(Ext_field_ComboBox_Component.EVENTS()),
            //propertiesobject.concat(Ext_field_ComboBox_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_field_ComboBox_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_field_ComboBox_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_field_ComboBox_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_field_ComboBox_Component.METHODS())
        )
        //this.XTYPE = Ext_field_ComboBox_Component.XTYPE()
        //this.PROPERTIESOBJECT = this.extendObject(this.PROPERTIESOBJECT, Ext_field_ComboBox_Component.PROPERTIESOBJECT());
        //this.methods = this.extendArray(this.methods, Ext_field_ComboBox_Component.METHODS());
        //this.events = this.extendArray(this.events, Ext_field_ComboBox_Component.EVENTS());
