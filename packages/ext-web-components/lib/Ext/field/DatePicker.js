...
{ name:'updateDateFormat',function: function() { return this.ext.updateDateFormat() } },
    ...
    constructor() {
        super (
            Ext_field_DatePicker_Component.METHODS(),
            Ext_field_DatePicker_Component.XTYPE(),
            Ext_field_DatePicker_Component.PROPERTIESOBJECT(),
            Ext_field_DatePicker_Component.EVENTS()
        )
