...
export default class Ext_field_DatePicker_Component extends Ext_field_Picker_Component {
//events
...
{ name:'updateDateFormat',function: function() { return this.ext.updateDateFormat() } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_field_DatePicker_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_field_DatePicker_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_field_DatePicker_Component.METHODS()),
            events.concat(Ext_field_DatePicker_Component.EVENTS())



            //events.concat(Ext_field_DatePicker_Component.EVENTS()),
            //propertiesobject.concat(Ext_field_DatePicker_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_field_DatePicker_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_field_DatePicker_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_field_DatePicker_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_field_DatePicker_Component.METHODS())
        )
        //this.XTYPE = Ext_field_DatePicker_Component.XTYPE()
