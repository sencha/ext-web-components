...
export default class Ext_field_Field_Component extends Ext_Component_Component {
//events
...
{ name:'validate',function: function(skipLazy) { return this.ext.validate(skipLazy) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_field_Field_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_field_Field_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_field_Field_Component.METHODS()),
            events.concat(Ext_field_Field_Component.EVENTS())



            //events.concat(Ext_field_Field_Component.EVENTS()),
            //propertiesobject.concat(Ext_field_Field_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_field_Field_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_field_Field_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_field_Field_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_field_Field_Component.METHODS())
        )
        //this.XTYPE = Ext_field_Field_Component.XTYPE()
        //this.PROPERTIESOBJECT = this.extendObject(this.PROPERTIESOBJECT, Ext_field_Field_Component.PROPERTIESOBJECT());
        //this.methods = this.extendArray(this.methods, Ext_field_Field_Component.METHODS());
        //this.events = this.extendArray(this.events, Ext_field_Field_Component.EVENTS());
