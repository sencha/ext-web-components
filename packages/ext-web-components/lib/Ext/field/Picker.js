...
{ name:'setPickerLocation',function: function(fromKeyboard) { return this.ext.setPickerLocation(fromKeyboard) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_field_Picker_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_field_Picker_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_field_Picker_Component.METHODS()),
            events.concat(Ext_field_Picker_Component.EVENTS())



            //events.concat(Ext_field_Picker_Component.EVENTS()),
            //propertiesobject.concat(Ext_field_Picker_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_field_Picker_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_field_Picker_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_field_Picker_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_field_Picker_Component.METHODS())
        )
