...
{ name:'load',function: function(options) { return this.ext.load(options) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_field_Panel_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_field_Panel_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_field_Panel_Component.METHODS()),
            events.concat(Ext_field_Panel_Component.EVENTS())



            //events.concat(Ext_field_Panel_Component.EVENTS()),
            //propertiesobject.concat(Ext_field_Panel_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_field_Panel_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_field_Panel_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_field_Panel_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_field_Panel_Component.METHODS())
        )
