...
{ name:'updateInactiveLabel',function: function(newInactiveLabel,oldInactiveLabel) { return this.ext.updateInactiveLabel(newInactiveLabel,oldInactiveLabel) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_field_Toggle_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_field_Toggle_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_field_Toggle_Component.METHODS()),
            events.concat(Ext_field_Toggle_Component.EVENTS())



            //events.concat(Ext_field_Toggle_Component.EVENTS()),
            //propertiesobject.concat(Ext_field_Toggle_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_field_Toggle_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_field_Toggle_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_field_Toggle_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_field_Toggle_Component.METHODS())
        )
