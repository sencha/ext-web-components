...
static METHODS() { return [
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_field_trigger_SpinUp_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_field_trigger_SpinUp_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_field_trigger_SpinUp_Component.METHODS()),
            events.concat(Ext_field_trigger_SpinUp_Component.EVENTS())



            //events.concat(Ext_field_trigger_SpinUp_Component.EVENTS()),
            //propertiesobject.concat(Ext_field_trigger_SpinUp_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_field_trigger_SpinUp_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_field_trigger_SpinUp_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_field_trigger_SpinUp_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_field_trigger_SpinUp_Component.METHODS())
        )
