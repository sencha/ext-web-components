...
export default class Ext_field_Checkbox_Component extends Ext_field_Input_Component {
//events
...
{ name:'uncheck',function: function() { return this.ext.uncheck() } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_field_Checkbox_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_field_Checkbox_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_field_Checkbox_Component.METHODS()),
            events.concat(Ext_field_Checkbox_Component.EVENTS())



            //events.concat(Ext_field_Checkbox_Component.EVENTS()),
            //propertiesobject.concat(Ext_field_Checkbox_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_field_Checkbox_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_field_Checkbox_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_field_Checkbox_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_field_Checkbox_Component.METHODS())
        )
        //this.XTYPE = Ext_field_Checkbox_Component.XTYPE()
