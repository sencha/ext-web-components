...
{ name:'updateUseTitleForBackButtonText',function: function(useTitleForBackButtonText) { return this.ext.updateUseTitleForBackButtonText(useTitleForBackButtonText) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_navigation_View_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_navigation_View_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_navigation_View_Component.METHODS()),
            events.concat(Ext_navigation_View_Component.EVENTS())



            //events.concat(Ext_navigation_View_Component.EVENTS()),
            //propertiesobject.concat(Ext_navigation_View_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_navigation_View_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_navigation_View_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_navigation_View_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_navigation_View_Component.METHODS())
        )
