...
{ name:'updateView',function: function(newView) { return this.ext.updateView(newView) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_navigation_Bar_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_navigation_Bar_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_navigation_Bar_Component.METHODS()),
            events.concat(Ext_navigation_Bar_Component.EVENTS())



            //events.concat(Ext_navigation_Bar_Component.EVENTS()),
            //propertiesobject.concat(Ext_navigation_Bar_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_navigation_Bar_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_navigation_Bar_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_navigation_Bar_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_navigation_Bar_Component.METHODS())
        )
