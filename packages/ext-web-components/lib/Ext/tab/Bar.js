...
{ name:'updateTabRotation',function: function(rotation) { return this.ext.updateTabRotation(rotation) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_tab_Bar_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_tab_Bar_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_tab_Bar_Component.METHODS()),
            events.concat(Ext_tab_Bar_Component.EVENTS())



            //events.concat(Ext_tab_Bar_Component.EVENTS()),
            //propertiesobject.concat(Ext_tab_Bar_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_tab_Bar_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_tab_Bar_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_tab_Bar_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_tab_Bar_Component.METHODS())
        )
