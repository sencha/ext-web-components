...
{ name:'updateButtonOnDataChange',function: function() { return this.ext.updateButtonOnDataChange() } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_BreadcrumbBar_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_BreadcrumbBar_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_BreadcrumbBar_Component.METHODS()),
            events.concat(Ext_BreadcrumbBar_Component.EVENTS())



            //events.concat(Ext_BreadcrumbBar_Component.EVENTS()),
            //propertiesobject.concat(Ext_BreadcrumbBar_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_BreadcrumbBar_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_BreadcrumbBar_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_BreadcrumbBar_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_BreadcrumbBar_Component.METHODS())
        )
