...
static METHODS() { return [
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_picker_SelectPicker_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_picker_SelectPicker_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_picker_SelectPicker_Component.METHODS()),
            events.concat(Ext_picker_SelectPicker_Component.EVENTS())



            //events.concat(Ext_picker_SelectPicker_Component.EVENTS()),
            //propertiesobject.concat(Ext_picker_SelectPicker_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_picker_SelectPicker_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_picker_SelectPicker_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_picker_SelectPicker_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_picker_SelectPicker_Component.METHODS())
        )
