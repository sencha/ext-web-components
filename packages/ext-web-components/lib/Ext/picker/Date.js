...
{ name:'updateYearTo',function: function() { return this.ext.updateYearTo() } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_picker_Date_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_picker_Date_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_picker_Date_Component.METHODS()),
            events.concat(Ext_picker_Date_Component.EVENTS())



            //events.concat(Ext_picker_Date_Component.EVENTS()),
            //propertiesobject.concat(Ext_picker_Date_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_picker_Date_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_picker_Date_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_picker_Date_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_picker_Date_Component.METHODS())
        )
