...
export default class Ext_picker_Picker_Component extends Ext_Sheet_Component {
//events
...
{ name:'updateUseTitles',function: function(useTitles) { return this.ext.updateUseTitles(useTitles) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_picker_Picker_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_picker_Picker_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_picker_Picker_Component.METHODS()),
            events.concat(Ext_picker_Picker_Component.EVENTS())



            //events.concat(Ext_picker_Picker_Component.EVENTS()),
            //propertiesobject.concat(Ext_picker_Picker_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_picker_Picker_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_picker_Picker_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_picker_Picker_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_picker_Picker_Component.METHODS())
        )
        //this.XTYPE = Ext_picker_Picker_Component.XTYPE()
