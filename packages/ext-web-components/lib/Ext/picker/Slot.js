...
{ name:'updateAlign',function: function(newAlign,oldAlign) { return this.ext.updateAlign(newAlign,oldAlign) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_picker_Slot_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_picker_Slot_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_picker_Slot_Component.METHODS()),
            events.concat(Ext_picker_Slot_Component.EVENTS())



            //events.concat(Ext_picker_Slot_Component.EVENTS()),
            //propertiesobject.concat(Ext_picker_Slot_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_picker_Slot_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_picker_Slot_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_picker_Slot_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_picker_Slot_Component.METHODS())
        )
