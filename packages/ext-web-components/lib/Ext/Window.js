...
export default class Ext_Window_Component extends Ext_Panel_Component {
//events
...
{ name:'restore',function: function(animation) { return this.ext.restore(animation) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_Window_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_Window_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_Window_Component.METHODS()),
            events.concat(Ext_Window_Component.EVENTS())



            //events.concat(Ext_Window_Component.EVENTS()),
            //propertiesobject.concat(Ext_Window_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_Window_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_Window_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_Window_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_Window_Component.METHODS())
        )
        //this.XTYPE = Ext_Window_Component.XTYPE()
