...
{ name:'toggle',function: function() { return this.ext.toggle() } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_Button_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_Button_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_Button_Component.METHODS()),
            events.concat(Ext_Button_Component.EVENTS())



            //events.concat(Ext_Button_Component.EVENTS()),
            //propertiesobject.concat(Ext_Button_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_Button_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_Button_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_Button_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_Button_Component.METHODS())
        )
