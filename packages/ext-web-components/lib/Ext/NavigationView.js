...
{ name:'updateUseTitleForBackButtonText',function: function(useTitleForBackButtonText) { return this.ext.updateUseTitleForBackButtonText(useTitleForBackButtonText) } },
    ...
    constructor() {
        super (
            Ext_NavigationView_Component.METHODS(),
            Ext_NavigationView_Component.XTYPE(),
            Ext_NavigationView_Component.PROPERTIESOBJECT(),
            Ext_NavigationView_Component.EVENTS()
        )
