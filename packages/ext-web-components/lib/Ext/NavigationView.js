...
export default class Ext_NavigationView_Component extends Ext_Container_Component {
//events
...
{ name:'updateUseTitleForBackButtonText',function: function(useTitleForBackButtonText) { return this.ext.updateUseTitleForBackButtonText(useTitleForBackButtonText) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_NavigationView_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_NavigationView_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_NavigationView_Component.METHODS()),
            events.concat(Ext_NavigationView_Component.EVENTS())



            //events.concat(Ext_NavigationView_Component.EVENTS()),
            //propertiesobject.concat(Ext_NavigationView_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_NavigationView_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_NavigationView_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_NavigationView_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_NavigationView_Component.METHODS())
        )
        //this.XTYPE = Ext_NavigationView_Component.XTYPE()
