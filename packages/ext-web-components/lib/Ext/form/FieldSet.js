...
{ name:'updateTitle',function: function(newTitle,oldTitle) { return this.ext.updateTitle(newTitle,oldTitle) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_form_FieldSet_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_form_FieldSet_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_form_FieldSet_Component.METHODS()),
            events.concat(Ext_form_FieldSet_Component.EVENTS())



            //events.concat(Ext_form_FieldSet_Component.EVENTS()),
            //propertiesobject.concat(Ext_form_FieldSet_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_form_FieldSet_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_form_FieldSet_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_form_FieldSet_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_form_FieldSet_Component.METHODS())
        )
