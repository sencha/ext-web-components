...
{ name:'validate',function: function(skipLazy) { return this.ext.validate(skipLazy) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_form_Field_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_form_Field_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_form_Field_Component.METHODS()),
            events.concat(Ext_form_Field_Component.EVENTS())



            //events.concat(Ext_form_Field_Component.EVENTS()),
            //propertiesobject.concat(Ext_form_Field_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_form_Field_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_form_Field_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_form_Field_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_form_Field_Component.METHODS())
        )
