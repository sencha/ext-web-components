...
{ name:'setGroupValue',function: function(value) { return this.ext.setGroupValue(value) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_form_Radio_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_form_Radio_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_form_Radio_Component.METHODS()),
            events.concat(Ext_form_Radio_Component.EVENTS())



            //events.concat(Ext_form_Radio_Component.EVENTS()),
            //propertiesobject.concat(Ext_form_Radio_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_form_Radio_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_form_Radio_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_form_Radio_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_form_Radio_Component.METHODS())
        )
