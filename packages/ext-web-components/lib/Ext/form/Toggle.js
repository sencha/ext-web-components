...
export default class Ext_form_Toggle_Component extends Ext_field_SingleSlider_Component {
//events
...
{ name:'updateInactiveLabel',function: function(newInactiveLabel,oldInactiveLabel) { return this.ext.updateInactiveLabel(newInactiveLabel,oldInactiveLabel) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_form_Toggle_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_form_Toggle_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_form_Toggle_Component.METHODS()),
            events.concat(Ext_form_Toggle_Component.EVENTS())



            //events.concat(Ext_form_Toggle_Component.EVENTS()),
            //propertiesobject.concat(Ext_form_Toggle_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_form_Toggle_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_form_Toggle_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_form_Toggle_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_form_Toggle_Component.METHODS())
        )
        //this.XTYPE = Ext_form_Toggle_Component.XTYPE()
