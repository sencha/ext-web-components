...
{ name:'submit',function: function(options,e) { return this.ext.submit(options,e) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_form_FormPanel_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_form_FormPanel_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_form_FormPanel_Component.METHODS()),
            events.concat(Ext_form_FormPanel_Component.EVENTS())



            //events.concat(Ext_form_FormPanel_Component.EVENTS()),
            //propertiesobject.concat(Ext_form_FormPanel_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_form_FormPanel_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_form_FormPanel_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_form_FormPanel_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_form_FormPanel_Component.METHODS())
        )
