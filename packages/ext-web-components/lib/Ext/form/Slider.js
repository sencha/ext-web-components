...
export default class Ext_form_Slider_Component extends Ext_field_Field_Component {
//events
...
{ name:'setValues',function: function(value) { return this.ext.setValues(value) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_form_Slider_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_form_Slider_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_form_Slider_Component.METHODS()),
            events.concat(Ext_form_Slider_Component.EVENTS())



            //events.concat(Ext_form_Slider_Component.EVENTS()),
            //propertiesobject.concat(Ext_form_Slider_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_form_Slider_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_form_Slider_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_form_Slider_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_form_Slider_Component.METHODS())
        )
        //this.XTYPE = Ext_form_Slider_Component.XTYPE()
        //this.PROPERTIESOBJECT = this.extendObject(this.PROPERTIESOBJECT, Ext_form_Slider_Component.PROPERTIESOBJECT());
        //this.methods = this.extendArray(this.methods, Ext_form_Slider_Component.METHODS());
        //this.events = this.extendArray(this.events, Ext_form_Slider_Component.EVENTS());
