...
export default class Ext_form_Text_Component extends Ext_field_Input_Component {
//events
...
{ name:'syncTriggers',function: function() { return this.ext.syncTriggers() } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_form_Text_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_form_Text_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_form_Text_Component.METHODS()),
            events.concat(Ext_form_Text_Component.EVENTS())



            //events.concat(Ext_form_Text_Component.EVENTS()),
            //propertiesobject.concat(Ext_form_Text_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_form_Text_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_form_Text_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_form_Text_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_form_Text_Component.METHODS())
        )
        //this.XTYPE = Ext_form_Text_Component.XTYPE()
