...
{ name:'serializePrimaryFilter',function: function(filter) { return this.ext.serializePrimaryFilter(filter) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_form_field_ComboBox_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_form_field_ComboBox_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_form_field_ComboBox_Component.METHODS()),
            events.concat(Ext_form_field_ComboBox_Component.EVENTS())



            //events.concat(Ext_form_field_ComboBox_Component.EVENTS()),
            //propertiesobject.concat(Ext_form_field_ComboBox_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_form_field_ComboBox_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_form_field_ComboBox_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_form_field_ComboBox_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_form_field_ComboBox_Component.METHODS())
        )
