...
export default class Ext_form_Select_Component extends Ext_field_Picker_Component {
//events
...
{ name:'updateSelection',function: function(selection,oldSelection) { return this.ext.updateSelection(selection,oldSelection) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_form_Select_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_form_Select_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_form_Select_Component.METHODS()),
            events.concat(Ext_form_Select_Component.EVENTS())



            //events.concat(Ext_form_Select_Component.EVENTS()),
            //propertiesobject.concat(Ext_form_Select_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_form_Select_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_form_Select_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_form_Select_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_form_Select_Component.METHODS())
        )
        //this.XTYPE = Ext_form_Select_Component.XTYPE()
