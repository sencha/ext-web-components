...
export default class Ext_form_Spinner_Component extends Ext_field_Number_Component {
//events
...
{ name:'spin',function: function(down) { return this.ext.spin(down) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_form_Spinner_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_form_Spinner_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_form_Spinner_Component.METHODS()),
            events.concat(Ext_form_Spinner_Component.EVENTS())



            //events.concat(Ext_form_Spinner_Component.EVENTS()),
            //propertiesobject.concat(Ext_form_Spinner_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_form_Spinner_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_form_Spinner_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_form_Spinner_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_form_Spinner_Component.METHODS())
        )
        //this.XTYPE = Ext_form_Spinner_Component.XTYPE()
