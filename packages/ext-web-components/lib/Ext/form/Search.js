...
static METHODS() { return [
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_form_Search_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_form_Search_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_form_Search_Component.METHODS()),
            events.concat(Ext_form_Search_Component.EVENTS())



            //events.concat(Ext_form_Search_Component.EVENTS()),
            //propertiesobject.concat(Ext_form_Search_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_form_Search_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_form_Search_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_form_Search_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_form_Search_Component.METHODS())
        )
