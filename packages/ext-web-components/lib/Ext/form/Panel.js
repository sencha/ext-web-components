...
export default class Ext_form_Panel_Component extends Ext_field_Panel_Component {
//events
...
{ name:'submit',function: function(options,e) { return this.ext.submit(options,e) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_form_Panel_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_form_Panel_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_form_Panel_Component.METHODS()),
            events.concat(Ext_form_Panel_Component.EVENTS())



            //events.concat(Ext_form_Panel_Component.EVENTS()),
            //propertiesobject.concat(Ext_form_Panel_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_form_Panel_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_form_Panel_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_form_Panel_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_form_Panel_Component.METHODS())
        )
        //this.XTYPE = Ext_form_Panel_Component.XTYPE()
