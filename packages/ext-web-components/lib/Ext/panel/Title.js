...
static METHODS() { return [
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_panel_Title_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_panel_Title_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_panel_Title_Component.METHODS()),
            events.concat(Ext_panel_Title_Component.EVENTS())



            //events.concat(Ext_panel_Title_Component.EVENTS()),
            //propertiesobject.concat(Ext_panel_Title_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_panel_Title_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_panel_Title_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_panel_Title_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_panel_Title_Component.METHODS())
        )
