...
export default class Ext_panel_Panel_Component extends Ext_Container_Component {
//events
...
{ name:'toggleCollapsed',function: function(collapsed,animation) { return this.ext.toggleCollapsed(collapsed,animation) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_panel_Panel_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_panel_Panel_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_panel_Panel_Component.METHODS()),
            events.concat(Ext_panel_Panel_Component.EVENTS())



            //events.concat(Ext_panel_Panel_Component.EVENTS()),
            //propertiesobject.concat(Ext_panel_Panel_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_panel_Panel_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_panel_Panel_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_panel_Panel_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_panel_Panel_Component.METHODS())
        )
        //this.XTYPE = Ext_panel_Panel_Component.XTYPE()
