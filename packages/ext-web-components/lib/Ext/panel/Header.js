...
static METHODS() { return [
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_panel_Header_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_panel_Header_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_panel_Header_Component.METHODS()),
            events.concat(Ext_panel_Header_Component.EVENTS())



            //events.concat(Ext_panel_Header_Component.EVENTS()),
            //propertiesobject.concat(Ext_panel_Header_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_panel_Header_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_panel_Header_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_panel_Header_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_panel_Header_Component.METHODS())
        )
