...
{ name:'unmask',function: function() { return this.ext.unmask() } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_Container_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_Container_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_Container_Component.METHODS()),
            events.concat(Ext_Container_Component.EVENTS())



            //events.concat(Ext_Container_Component.EVENTS()),
            //propertiesobject.concat(Ext_Container_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_Container_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_Container_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_Container_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_Container_Component.METHODS())
        )
