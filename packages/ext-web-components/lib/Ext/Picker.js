...
{ name:'updateUseTitles',function: function(useTitles) { return this.ext.updateUseTitles(useTitles) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_Picker_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_Picker_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_Picker_Component.METHODS()),
            events.concat(Ext_Picker_Component.EVENTS())



            //events.concat(Ext_Picker_Component.EVENTS()),
            //propertiesobject.concat(Ext_Picker_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_Picker_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_Picker_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_Picker_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_Picker_Component.METHODS())
        )
