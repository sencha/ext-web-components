...
{ name:'updateTabRotation',function: function(rotation) { return this.ext.updateTabRotation(rotation) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_TabBar_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_TabBar_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_TabBar_Component.METHODS()),
            events.concat(Ext_TabBar_Component.EVENTS())



            //events.concat(Ext_TabBar_Component.EVENTS()),
            //propertiesobject.concat(Ext_TabBar_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_TabBar_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_TabBar_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_TabBar_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_TabBar_Component.METHODS())
        )
