...
static METHODS() { return [
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_pivot_cell_Group_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_pivot_cell_Group_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_pivot_cell_Group_Component.METHODS()),
            events.concat(Ext_pivot_cell_Group_Component.EVENTS())



            //events.concat(Ext_pivot_cell_Group_Component.EVENTS()),
            //propertiesobject.concat(Ext_pivot_cell_Group_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_pivot_cell_Group_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_pivot_cell_Group_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_pivot_cell_Group_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_pivot_cell_Group_Component.METHODS())
        )
