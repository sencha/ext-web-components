...
{ name:'updatePosterUrl',function: function(newUrl) { return this.ext.updatePosterUrl(newUrl) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_Video_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_Video_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_Video_Component.METHODS()),
            events.concat(Ext_Video_Component.EVENTS())



            //events.concat(Ext_Video_Component.EVENTS()),
            //propertiesobject.concat(Ext_Video_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_Video_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_Video_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_Video_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_Video_Component.METHODS())
        )
