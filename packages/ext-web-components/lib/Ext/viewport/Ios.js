...
static METHODS() { return [
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_viewport_Ios_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_viewport_Ios_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_viewport_Ios_Component.METHODS()),
            events.concat(Ext_viewport_Ios_Component.EVENTS())



            //events.concat(Ext_viewport_Ios_Component.EVENTS()),
            //propertiesobject.concat(Ext_viewport_Ios_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_viewport_Ios_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_viewport_Ios_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_viewport_Ios_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_viewport_Ios_Component.METHODS())
        )
