...
{ name:'toggleMenu',function: function(side) { return this.ext.toggleMenu(side) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_viewport_Default_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_viewport_Default_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_viewport_Default_Component.METHODS()),
            events.concat(Ext_viewport_Default_Component.EVENTS())



            //events.concat(Ext_viewport_Default_Component.EVENTS()),
            //propertiesobject.concat(Ext_viewport_Default_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_viewport_Default_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_viewport_Default_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_viewport_Default_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_viewport_Default_Component.METHODS())
        )
