...
static METHODS() { return [
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_viewport_WindowsPhone_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_viewport_WindowsPhone_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_viewport_WindowsPhone_Component.METHODS()),
            events.concat(Ext_viewport_WindowsPhone_Component.EVENTS())



            //events.concat(Ext_viewport_WindowsPhone_Component.EVENTS()),
            //propertiesobject.concat(Ext_viewport_WindowsPhone_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_viewport_WindowsPhone_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_viewport_WindowsPhone_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_viewport_WindowsPhone_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_viewport_WindowsPhone_Component.METHODS())
        )
