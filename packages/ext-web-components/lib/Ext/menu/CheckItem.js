...
{ name:'setChecked',function: function(checked,suppressEvents) { return this.ext.setChecked(checked,suppressEvents) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_menu_CheckItem_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_menu_CheckItem_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_menu_CheckItem_Component.METHODS()),
            events.concat(Ext_menu_CheckItem_Component.EVENTS())



            //events.concat(Ext_menu_CheckItem_Component.EVENTS()),
            //propertiesobject.concat(Ext_menu_CheckItem_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_menu_CheckItem_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_menu_CheckItem_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_menu_CheckItem_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_menu_CheckItem_Component.METHODS())
        )
