...
{ name:'hideParentMenus',function: function() { return this.ext.hideParentMenus() } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_menu_Item_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_menu_Item_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_menu_Item_Component.METHODS()),
            events.concat(Ext_menu_Item_Component.EVENTS())



            //events.concat(Ext_menu_Item_Component.EVENTS()),
            //propertiesobject.concat(Ext_menu_Item_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_menu_Item_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_menu_Item_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_menu_Item_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_menu_Item_Component.METHODS())
        )
