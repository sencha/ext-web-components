...
{ name:'waitFor',function: function(surface) { return this.ext.waitFor(surface) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_draw_Surface_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_draw_Surface_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_draw_Surface_Component.METHODS()),
            events.concat(Ext_draw_Surface_Component.EVENTS())



            //events.concat(Ext_draw_Surface_Component.EVENTS()),
            //propertiesobject.concat(Ext_draw_Surface_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_draw_Surface_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_draw_Surface_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_draw_Surface_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_draw_Surface_Component.METHODS())
        )
