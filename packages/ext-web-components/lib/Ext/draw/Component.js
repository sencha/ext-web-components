...
export default class Ext_draw_Component_Component extends Ext_draw_ContainerBase_Component {
//events
...
{ name:'stopResizeTimer',function: function() { return this.ext.stopResizeTimer() } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_draw_Component_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_draw_Component_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_draw_Component_Component.METHODS()),
            events.concat(Ext_draw_Component_Component.EVENTS())



            //events.concat(Ext_draw_Component_Component.EVENTS()),
            //propertiesobject.concat(Ext_draw_Component_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_draw_Component_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_draw_Component_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_draw_Component_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_draw_Component_Component.METHODS())
        )
        //this.XTYPE = Ext_draw_Component_Component.XTYPE()
