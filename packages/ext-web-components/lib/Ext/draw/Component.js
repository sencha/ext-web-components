...
{ name:'stopResizeTimer',function: function() { return this.ext.stopResizeTimer() } },
    ...
    constructor() {
        super (
            Ext_draw_Component_Component.METHODS(),
            Ext_draw_Component_Component.XTYPE(),
            Ext_draw_Component_Component.PROPERTIESOBJECT(),
            Ext_draw_Component_Component.EVENTS()
        )
