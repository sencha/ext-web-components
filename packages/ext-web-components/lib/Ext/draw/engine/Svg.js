...
{ name:'toSVG',function: function(size,surfaces) { return this.ext.toSVG(size,surfaces) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_draw_engine_Svg_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_draw_engine_Svg_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_draw_engine_Svg_Component.METHODS()),
            events.concat(Ext_draw_engine_Svg_Component.EVENTS())



            //events.concat(Ext_draw_engine_Svg_Component.EVENTS()),
            //propertiesobject.concat(Ext_draw_engine_Svg_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_draw_engine_Svg_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_draw_engine_Svg_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_draw_engine_Svg_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_draw_engine_Svg_Component.METHODS())
        )
