...
{ name:'updateRect',function: function(rect) { return this.ext.updateRect(rect) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_draw_engine_Canvas_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_draw_engine_Canvas_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_draw_engine_Canvas_Component.METHODS()),
            events.concat(Ext_draw_engine_Canvas_Component.EVENTS())



            //events.concat(Ext_draw_engine_Canvas_Component.EVENTS()),
            //propertiesobject.concat(Ext_draw_engine_Canvas_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_draw_engine_Canvas_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_draw_engine_Canvas_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_draw_engine_Canvas_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_draw_engine_Canvas_Component.METHODS())
        )
