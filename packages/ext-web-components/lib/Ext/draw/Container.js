...
{ name:'stopResizeTimer',function: function() { return this.ext.stopResizeTimer() } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_draw_Container_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_draw_Container_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_draw_Container_Component.METHODS()),
            events.concat(Ext_draw_Container_Component.EVENTS())



            //events.concat(Ext_draw_Container_Component.EVENTS()),
            //propertiesobject.concat(Ext_draw_Container_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_draw_Container_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_draw_Container_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_draw_Container_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_draw_Container_Component.METHODS())
        )
