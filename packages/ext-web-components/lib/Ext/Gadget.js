...
{ name:'updateWidth',function: function(width) { return this.ext.updateWidth(width) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_Gadget_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_Gadget_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_Gadget_Component.METHODS()),
            events.concat(Ext_Gadget_Component.EVENTS())



            //events.concat(Ext_Gadget_Component.EVENTS()),
            //propertiesobject.concat(Ext_Gadget_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_Gadget_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_Gadget_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_Gadget_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_Gadget_Component.METHODS())
        )
