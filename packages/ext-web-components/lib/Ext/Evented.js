...
static METHODS() { return [
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_Evented_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_Evented_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_Evented_Component.METHODS()),
            events.concat(Ext_Evented_Component.EVENTS())



            //events.concat(Ext_Evented_Component.EVENTS()),
            //propertiesobject.concat(Ext_Evented_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_Evented_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_Evented_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_Evented_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_Evented_Component.METHODS())
        )
