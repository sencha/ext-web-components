...
{ name:'updateTitle',function: function(newTitle) { return this.ext.updateTitle(newTitle) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_MessageBox_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_MessageBox_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_MessageBox_Component.METHODS()),
            events.concat(Ext_MessageBox_Component.EVENTS())



            //events.concat(Ext_MessageBox_Component.EVENTS()),
            //propertiesobject.concat(Ext_MessageBox_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_MessageBox_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_MessageBox_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_MessageBox_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_MessageBox_Component.METHODS())
        )
