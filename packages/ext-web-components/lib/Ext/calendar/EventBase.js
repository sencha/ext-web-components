...
{ name:'cloneForProxy',function: function() { return this.ext.cloneForProxy() } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_calendar_EventBase_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_calendar_EventBase_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_calendar_EventBase_Component.METHODS()),
            events.concat(Ext_calendar_EventBase_Component.EVENTS())



            //events.concat(Ext_calendar_EventBase_Component.EVENTS()),
            //propertiesobject.concat(Ext_calendar_EventBase_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_calendar_EventBase_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_calendar_EventBase_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_calendar_EventBase_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_calendar_EventBase_Component.METHODS())
        )
