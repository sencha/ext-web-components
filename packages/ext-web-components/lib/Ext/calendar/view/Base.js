...
{ name:'utcToLocal',function: function(d) { return this.ext.utcToLocal(d) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_calendar_view_Base_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_calendar_view_Base_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_calendar_view_Base_Component.METHODS()),
            events.concat(Ext_calendar_view_Base_Component.EVENTS())



            //events.concat(Ext_calendar_view_Base_Component.EVENTS()),
            //propertiesobject.concat(Ext_calendar_view_Base_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_calendar_view_Base_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_calendar_view_Base_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_calendar_view_Base_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_calendar_view_Base_Component.METHODS())
        )
