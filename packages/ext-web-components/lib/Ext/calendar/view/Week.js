...
{ name:'getMoveInterval',function: function() { return this.ext.getMoveInterval() } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_calendar_view_Week_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_calendar_view_Week_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_calendar_view_Week_Component.METHODS()),
            events.concat(Ext_calendar_view_Week_Component.EVENTS())



            //events.concat(Ext_calendar_view_Week_Component.EVENTS()),
            //propertiesobject.concat(Ext_calendar_view_Week_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_calendar_view_Week_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_calendar_view_Week_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_calendar_view_Week_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_calendar_view_Week_Component.METHODS())
        )
