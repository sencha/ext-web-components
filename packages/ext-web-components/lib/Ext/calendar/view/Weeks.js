...
{ name:'selectRange',function: function(from,to) { return this.ext.selectRange(from,to) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_calendar_view_Weeks_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_calendar_view_Weeks_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_calendar_view_Weeks_Component.METHODS()),
            events.concat(Ext_calendar_view_Weeks_Component.EVENTS())



            //events.concat(Ext_calendar_view_Weeks_Component.EVENTS()),
            //propertiesobject.concat(Ext_calendar_view_Weeks_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_calendar_view_Weeks_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_calendar_view_Weeks_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_calendar_view_Weeks_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_calendar_view_Weeks_Component.METHODS())
        )
