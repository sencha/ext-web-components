...
{ name:'previousYear',function: function(years) { return this.ext.previousYear(years) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_calendar_view_Month_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_calendar_view_Month_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_calendar_view_Month_Component.METHODS()),
            events.concat(Ext_calendar_view_Month_Component.EVENTS())



            //events.concat(Ext_calendar_view_Month_Component.EVENTS()),
            //propertiesobject.concat(Ext_calendar_view_Month_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_calendar_view_Month_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_calendar_view_Month_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_calendar_view_Month_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_calendar_view_Month_Component.METHODS())
        )
