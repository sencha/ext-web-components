...
static METHODS() { return [
    ...
    constructor() {
        super (
            Ext_calendar_panel_AbstractBase_Component.METHODS(),
            Ext_calendar_panel_AbstractBase_Component.XTYPE(),
            Ext_calendar_panel_AbstractBase_Component.PROPERTIESOBJECT(),
            Ext_calendar_panel_AbstractBase_Component.EVENTS()
        )
