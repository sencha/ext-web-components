...
static METHODS() { return [
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_calendar_panel_Day_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_calendar_panel_Day_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_calendar_panel_Day_Component.METHODS()),
            events.concat(Ext_calendar_panel_Day_Component.EVENTS())



            //events.concat(Ext_calendar_panel_Day_Component.EVENTS()),
            //propertiesobject.concat(Ext_calendar_panel_Day_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_calendar_panel_Day_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_calendar_panel_Day_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_calendar_panel_Day_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_calendar_panel_Day_Component.METHODS())
        )
