...
{ name:'setViews',function: function() { return this.ext.setViews() } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_calendar_panel_Panel_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_calendar_panel_Panel_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_calendar_panel_Panel_Component.METHODS()),
            events.concat(Ext_calendar_panel_Panel_Component.EVENTS())



            //events.concat(Ext_calendar_panel_Panel_Component.EVENTS()),
            //propertiesobject.concat(Ext_calendar_panel_Panel_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_calendar_panel_Panel_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_calendar_panel_Panel_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_calendar_panel_Panel_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_calendar_panel_Panel_Component.METHODS())
        )
