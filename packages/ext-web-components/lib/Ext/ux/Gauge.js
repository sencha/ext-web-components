...
export default class Ext_ux_Gauge_Component extends Ext_Gadget_Component {
//events
//configs
...
{ name:'stopAnimation',function: function() { return this.ext.stopAnimation() } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_ux_Gauge_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_ux_Gauge_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_ux_Gauge_Component.METHODS()),
            events.concat(Ext_ux_Gauge_Component.EVENTS())



            //events.concat(Ext_ux_Gauge_Component.EVENTS()),
            //propertiesobject.concat(Ext_ux_Gauge_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_ux_Gauge_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_ux_Gauge_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_ux_Gauge_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_ux_Gauge_Component.METHODS())
        )
        //this.XTYPE = Ext_ux_Gauge_Component.XTYPE()
        //this.PROPERTIESOBJECT = this.extendObject(this.PROPERTIESOBJECT, Ext_ux_Gauge_Component.PROPERTIESOBJECT());
        //this.methods = this.extendArray(this.methods, Ext_ux_Gauge_Component.METHODS());
        //this.events = this.extendArray(this.events, Ext_ux_Gauge_Component.EVENTS());
