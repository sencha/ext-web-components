...
{ name:'updateVolume',function: function(volume) { return this.ext.updateVolume(volume) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_Media_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_Media_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_Media_Component.METHODS()),
            events.concat(Ext_Media_Component.EVENTS())



            //events.concat(Ext_Media_Component.EVENTS()),
            //propertiesobject.concat(Ext_Media_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_Media_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_Media_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_Media_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_Media_Component.METHODS())
        )
