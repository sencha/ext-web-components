...
{ name:'restore',function: function(animation) { return this.ext.restore(animation) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_Dialog_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_Dialog_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_Dialog_Component.METHODS()),
            events.concat(Ext_Dialog_Component.EVENTS())



            //events.concat(Ext_Dialog_Component.EVENTS()),
            //propertiesobject.concat(Ext_Dialog_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_Dialog_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_Dialog_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_Dialog_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_Dialog_Component.METHODS())
        )
