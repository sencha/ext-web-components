...
{ name:'resizeHandler',function: function(size) { return this.ext.resizeHandler(size) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_d3_canvas_Canvas_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_d3_canvas_Canvas_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_d3_canvas_Canvas_Component.METHODS()),
            events.concat(Ext_d3_canvas_Canvas_Component.EVENTS())



            //events.concat(Ext_d3_canvas_Canvas_Component.EVENTS()),
            //propertiesobject.concat(Ext_d3_canvas_Canvas_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_d3_canvas_Canvas_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_d3_canvas_Canvas_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_d3_canvas_Canvas_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_d3_canvas_Canvas_Component.METHODS())
        )
