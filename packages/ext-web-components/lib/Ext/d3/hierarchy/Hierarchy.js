...
{ name:'updateEventName',function: function(name,oldName,handler) { return this.ext.updateEventName(name,oldName,handler) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_d3_hierarchy_Hierarchy_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_d3_hierarchy_Hierarchy_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_d3_hierarchy_Hierarchy_Component.METHODS()),
            events.concat(Ext_d3_hierarchy_Hierarchy_Component.EVENTS())



            //events.concat(Ext_d3_hierarchy_Hierarchy_Component.EVENTS()),
            //propertiesobject.concat(Ext_d3_hierarchy_Hierarchy_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_d3_hierarchy_Hierarchy_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_d3_hierarchy_Hierarchy_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_d3_hierarchy_Hierarchy_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_d3_hierarchy_Hierarchy_Component.METHODS())
        )
