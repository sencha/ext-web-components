...
{ name:'textVisibilityFn',function: function(selection) { return this.ext.textVisibilityFn(selection) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_d3_hierarchy_TreeMap_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_d3_hierarchy_TreeMap_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_d3_hierarchy_TreeMap_Component.METHODS()),
            events.concat(Ext_d3_hierarchy_TreeMap_Component.EVENTS())



            //events.concat(Ext_d3_hierarchy_TreeMap_Component.EVENTS()),
            //propertiesobject.concat(Ext_d3_hierarchy_TreeMap_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_d3_hierarchy_TreeMap_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_d3_hierarchy_TreeMap_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_d3_hierarchy_TreeMap_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_d3_hierarchy_TreeMap_Component.METHODS())
        )
