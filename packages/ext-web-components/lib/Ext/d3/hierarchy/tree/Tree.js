...
static METHODS() { return [
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_d3_hierarchy_tree_Tree_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_d3_hierarchy_tree_Tree_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_d3_hierarchy_tree_Tree_Component.METHODS()),
            events.concat(Ext_d3_hierarchy_tree_Tree_Component.EVENTS())



            //events.concat(Ext_d3_hierarchy_tree_Tree_Component.EVENTS()),
            //propertiesobject.concat(Ext_d3_hierarchy_tree_Tree_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_d3_hierarchy_tree_Tree_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_d3_hierarchy_tree_Tree_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_d3_hierarchy_tree_Tree_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_d3_hierarchy_tree_Tree_Component.METHODS())
        )
