...
export default class Ext_Component_Component extends Ext_Widget_Component {
//events
...
{ name:'whenVisible',function: function(fn,args) { return this.ext.whenVisible(fn,args) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_Component_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_Component_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_Component_Component.METHODS()),
            events.concat(Ext_Component_Component.EVENTS())



            //events.concat(Ext_Component_Component.EVENTS()),
            //propertiesobject.concat(Ext_Component_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_Component_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_Component_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_Component_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_Component_Component.METHODS())
        )
        //this.XTYPE = Ext_Component_Component.XTYPE()
