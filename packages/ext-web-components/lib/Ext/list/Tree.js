...
{ name:'removeItem',function: function(node) { return this.ext.removeItem(node) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_list_Tree_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_list_Tree_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_list_Tree_Component.METHODS()),
            events.concat(Ext_list_Tree_Component.EVENTS())



            //events.concat(Ext_list_Tree_Component.EVENTS()),
            //propertiesobject.concat(Ext_list_Tree_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_list_Tree_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_list_Tree_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_list_Tree_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_list_Tree_Component.METHODS())
        )
