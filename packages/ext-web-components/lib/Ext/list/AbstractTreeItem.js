...
{ name:'updateOwner',function: function(owner) { return this.ext.updateOwner(owner) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_list_AbstractTreeItem_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_list_AbstractTreeItem_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_list_AbstractTreeItem_Component.METHODS()),
            events.concat(Ext_list_AbstractTreeItem_Component.EVENTS())



            //events.concat(Ext_list_AbstractTreeItem_Component.EVENTS()),
            //propertiesobject.concat(Ext_list_AbstractTreeItem_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_list_AbstractTreeItem_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_list_AbstractTreeItem_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_list_AbstractTreeItem_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_list_AbstractTreeItem_Component.METHODS())
        )
