...
export default class Ext_Widget_Component extends Ext_Evented_Component {
//events
...
{ name:'updateWidth',function: function(width) { return this.ext.updateWidth(width) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_Widget_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_Widget_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_Widget_Component.METHODS()),
            events.concat(Ext_Widget_Component.EVENTS())



            //events.concat(Ext_Widget_Component.EVENTS()),
            //propertiesobject.concat(Ext_Widget_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_Widget_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_Widget_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_Widget_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_Widget_Component.METHODS())
        )
        //this.XTYPE = Ext_Widget_Component.XTYPE()
