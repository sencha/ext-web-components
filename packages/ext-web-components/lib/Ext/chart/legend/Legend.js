...
static METHODS() { return [
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_chart_legend_Legend_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_chart_legend_Legend_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_chart_legend_Legend_Component.METHODS()),
            events.concat(Ext_chart_legend_Legend_Component.EVENTS())



            //events.concat(Ext_chart_legend_Legend_Component.EVENTS()),
            //propertiesobject.concat(Ext_chart_legend_Legend_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_chart_legend_Legend_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_chart_legend_Legend_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_chart_legend_Legend_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_chart_legend_Legend_Component.METHODS())
        )
