...
export default class Ext_SegmentedButton_Component extends Ext_Container_Component {
//events
...
{ name:'updateFirstAndLastCls',function: function(items) { return this.ext.updateFirstAndLastCls(items) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_SegmentedButton_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_SegmentedButton_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_SegmentedButton_Component.METHODS()),
            events.concat(Ext_SegmentedButton_Component.EVENTS())



            //events.concat(Ext_SegmentedButton_Component.EVENTS()),
            //propertiesobject.concat(Ext_SegmentedButton_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_SegmentedButton_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_SegmentedButton_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_SegmentedButton_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_SegmentedButton_Component.METHODS())
        )
        //this.XTYPE = Ext_SegmentedButton_Component.XTYPE()
        //this.PROPERTIESOBJECT = this.extendObject(this.PROPERTIESOBJECT, Ext_SegmentedButton_Component.PROPERTIESOBJECT());
        //this.methods = this.extendArray(this.methods, Ext_SegmentedButton_Component.METHODS());
        //this.events = this.extendArray(this.events, Ext_SegmentedButton_Component.EVENTS());
