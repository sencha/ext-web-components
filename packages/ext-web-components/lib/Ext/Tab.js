...
static METHODS() { return [
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_Tab_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_Tab_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_Tab_Component.METHODS()),
            events.concat(Ext_Tab_Component.EVENTS())



            //events.concat(Ext_Tab_Component.EVENTS()),
            //propertiesobject.concat(Ext_Tab_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_Tab_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_Tab_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_Tab_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_Tab_Component.METHODS())
        )
