...
{ name:'updateSrc',function: function(newSrc) { return this.ext.updateSrc(newSrc) } },
    ...
    constructor(propertiesobject, methods, events) {
        super (
            Object.assign(propertiesobject, Ext_Image_Component.PROPERTIESOBJECT()),
            //{propertiesobject, Ext_Image_Component.PROPERTIESOBJECT()},
            methods.concat(Ext_Image_Component.METHODS()),
            events.concat(Ext_Image_Component.EVENTS())



            //events.concat(Ext_Image_Component.EVENTS()),
            //propertiesobject.concat(Ext_Image_Component.PROPERTIESOBJECT()),
            //methods.concat(Ext_Image_Component.METHODS())

            //EwcBaseComponent.extendArray(events, Ext_Image_Component.EVENTS()),
            //EwcBaseComponent.extendArray(propertiesobject, Ext_Image_Component.PROPERTIESOBJECT()),
            //EwcBaseComponent.extendArray(methods, Ext_Image_Component.METHODS())
        )
