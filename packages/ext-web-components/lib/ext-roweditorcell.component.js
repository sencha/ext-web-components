...
export class ExtRoweditorcellComponent extends ExtBase {
...
{ name:'whenVisible',function: function(fn,args) { return this.ext.whenVisible(fn,args) } },
  ...
  constructor() {
    super()
    this.METHODS = ExtRoweditorcellComponent.METHODS()
    this.XTYPE = ExtRoweditorcellComponent.XTYPE()
    //this.PROPERTIES = ExtRoweditorcellComponent.PROPERTIES()
    this.PROPERTIESOBJECT = ExtRoweditorcellComponent.PROPERTIESOBJECT()
    this.EVENTS = ExtRoweditorcellComponent.EVENTS()
  }
