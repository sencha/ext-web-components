...
export class ExtRoweditorbarComponent extends ExtBase {
...
{ name:'whenVisible',function: function(fn,args) { return this.ext.whenVisible(fn,args) } },
  ...
  constructor() {
    super()
    this.METHODS = ExtRoweditorbarComponent.METHODS()
    this.XTYPE = ExtRoweditorbarComponent.XTYPE()
    //this.PROPERTIES = ExtRoweditorbarComponent.PROPERTIES()
    this.PROPERTIESOBJECT = ExtRoweditorbarComponent.PROPERTIESOBJECT()
    this.EVENTS = ExtRoweditorbarComponent.EVENTS()
  }
