...
export class ExtGroupcontainerComponent extends ExtBase {
...
{ name:'whenVisible',function: function(fn,args) { return this.ext.whenVisible(fn,args) } },
  ...
  constructor() {
    super()
    this.METHODS = ExtGroupcontainerComponent.METHODS()
    this.XTYPE = ExtGroupcontainerComponent.XTYPE()
    //this.PROPERTIES = ExtGroupcontainerComponent.PROPERTIES()
    this.PROPERTIESOBJECT = ExtGroupcontainerComponent.PROPERTIESOBJECT()
    this.EVENTS = ExtGroupcontainerComponent.EVENTS()
  }
