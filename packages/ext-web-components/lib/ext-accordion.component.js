...
export class ExtAccordionComponent extends ExtBase {
...
get defaultPanelUI(){return this.getAttribute('defaultPanelUI')};set defaultPanelUI(defaultPanelUI){this.setAttribute('defaultPanelUI',defaultPanelUI)}
...
get expandedFirst(){return this.getAttribute('expandedFirst')};set expandedFirst(expandedFirst){this.setAttribute('expandedFirst',expandedFirst)}
...
get openable(){return this.getAttribute('openable')};set openable(openable){this.setAttribute('openable',openable)}
...
{ name:'whenVisible',function: function(fn,args) { return this.ext.whenVisible(fn,args) } },
  ...
  constructor() {
    super()
    this.METHODS = ExtAccordionComponent.METHODS()
    this.XTYPE = ExtAccordionComponent.XTYPE()
    //this.PROPERTIES = ExtAccordionComponent.PROPERTIES()
    this.PROPERTIESOBJECT = ExtAccordionComponent.PROPERTIESOBJECT()
    this.EVENTS = ExtAccordionComponent.EVENTS()
  }
