...
export class ExtRoweditorComponent extends ExtBase {
...
get ownerListeners(){return this.getAttribute('ownerListeners')};set ownerListeners(ownerListeners){this.setAttribute('ownerListeners',ownerListeners)}
...
get sourceListeners(){return this.getAttribute('sourceListeners')};set sourceListeners(sourceListeners){this.setAttribute('sourceListeners',sourceListeners)}
...
get storeListeners(){return this.getAttribute('storeListeners')};set storeListeners(storeListeners){this.setAttribute('storeListeners',storeListeners)}
...
{ name:'whenVisible',function: function(fn,args) { return this.ext.whenVisible(fn,args) } },
  ...
  constructor() {
    super()
    this.METHODS = ExtRoweditorComponent.METHODS()
    this.XTYPE = ExtRoweditorComponent.XTYPE()
    //this.PROPERTIES = ExtRoweditorComponent.PROPERTIES()
    this.PROPERTIESOBJECT = ExtRoweditorComponent.PROPERTIESOBJECT()
    this.EVENTS = ExtRoweditorComponent.EVENTS()
  }
