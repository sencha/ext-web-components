...
export class ExtListitemplaceholderComponent extends ExtBase {
...
{ name:'whenVisible',function: function(fn,args) { return this.ext.whenVisible(fn,args) } },
  ...
  constructor() {
    super()
    this.METHODS = ExtListitemplaceholderComponent.METHODS()
    this.XTYPE = ExtListitemplaceholderComponent.XTYPE()
    //this.PROPERTIES = ExtListitemplaceholderComponent.PROPERTIES()
    this.PROPERTIESOBJECT = ExtListitemplaceholderComponent.PROPERTIESOBJECT()
    this.EVENTS = ExtListitemplaceholderComponent.EVENTS()
  }
