...
export class ExtFroalaeditorfieldComponent extends ExtBase {
get activationKey(){return this.getAttribute('activationKey')};set activationKey(activationKey){this.setAttribute('activationKey',activationKey)}
get alignSelf(){return this.getAttribute('alignSelf')};set alignSelf(alignSelf){this.setAttribute('alignSelf',alignSelf)}
...
get bubbleDirty(){return this.getAttribute('bubbleDirty')};set bubbleDirty(bubbleDirty){this.setAttribute('bubbleDirty',bubbleDirty)}
...
get fieldDefaults(){return this.getAttribute('fieldDefaults')};set fieldDefaults(fieldDefaults){this.setAttribute('fieldDefaults',fieldDefaults)}
...
get ondirtychange(){return this.getAttribute('ondirtychange')};set ondirtychange(ondirtychange){this.setAttribute('ondirtychange',ondirtychange)}
...
{ name:'adjustChildDirtyCount',function: function(dirty) { return this.ext.adjustChildDirtyCount(dirty) } },
...
{ name:'beginSyncChildDirty',function: function() { return this.ext.beginSyncChildDirty() } },
...
{ name:'finishSyncChildDirty',function: function() { return this.ext.finishSyncChildDirty() } },
...
{ name:'fireDirtyChange',function: function() { return this.ext.fireDirtyChange() } },
...
{ name:'fixDirtyState',function: function() { return this.ext.fixDirtyState() } },
...
{ name:'isFroalaEvent',function: function(event) { return this.ext.isFroalaEvent(event) } },
...
{ name:'monitorConfiguredListeners',function: function(froalaEditor) { return this.ext.monitorConfiguredListeners(froalaEditor) } },
...
{ name:'whenVisible',function: function(fn,args) { return this.ext.whenVisible(fn,args) } },
  ...
  constructor() {
    super()
    this.METHODS = ExtFroalaeditorfieldComponent.METHODS()
    this.XTYPE = ExtFroalaeditorfieldComponent.XTYPE()
    //this.PROPERTIES = ExtFroalaeditorfieldComponent.PROPERTIES()
    this.PROPERTIESOBJECT = ExtFroalaeditorfieldComponent.PROPERTIESOBJECT()
    this.EVENTS = ExtFroalaeditorfieldComponent.EVENTS()
  }
