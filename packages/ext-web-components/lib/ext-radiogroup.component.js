...
export class ExtRadiogroupComponent extends ExtBase {
...
get fieldsName(){return this.getAttribute('fieldsName')};set fieldsName(fieldsName){this.setAttribute('fieldsName',fieldsName)}
...
get simpleValue(){return this.getAttribute('simpleValue')};set simpleValue(simpleValue){this.setAttribute('simpleValue',simpleValue)}
...
{ name:'whenVisible',function: function(fn,args) { return this.ext.whenVisible(fn,args) } },
  ...
  constructor() {
    super()
    this.METHODS = ExtRadiogroupComponent.METHODS()
    this.XTYPE = ExtRadiogroupComponent.XTYPE()
    //this.PROPERTIES = ExtRadiogroupComponent.PROPERTIES()
    this.PROPERTIESOBJECT = ExtRadiogroupComponent.PROPERTIESOBJECT()
    this.EVENTS = ExtRadiogroupComponent.EVENTS()
  }
