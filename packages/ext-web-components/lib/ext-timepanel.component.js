...
get alignPMInside(){return this.getAttribute('alignPMInside')};set alignPMInside(alignPMInside){this.setAttribute('alignPMInside',alignPMInside)}
...
get hourDisplayFormat(){return this.getAttribute('hourDisplayFormat')};set hourDisplayFormat(hourDisplayFormat){this.setAttribute('hourDisplayFormat',hourDisplayFormat)}
...
get meridiem(){return this.getAttribute('meridiem')};set meridiem(meridiem){this.setAttribute('meridiem',meridiem)}
