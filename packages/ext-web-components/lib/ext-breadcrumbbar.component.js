...
export class ExtBreadcrumbbarComponent extends ExtBase {
...
get btnCls(){return this.getAttribute('btnCls')};set btnCls(btnCls){this.setAttribute('btnCls',btnCls)}
get buttonConfig(){return this.getAttribute('buttonConfig')};set buttonConfig(buttonConfig){this.setAttribute('buttonConfig',buttonConfig)}
get buttonUI(){return this.getAttribute('buttonUI')};set buttonUI(buttonUI){this.setAttribute('buttonUI',buttonUI)}
...
get showIcons(){return this.getAttribute('showIcons')};set showIcons(showIcons){this.setAttribute('showIcons',showIcons)}
get showMenuIcons(){return this.getAttribute('showMenuIcons')};set showMenuIcons(showMenuIcons){this.setAttribute('showMenuIcons',showMenuIcons)}
...
get useSplitButtons(){return this.getAttribute('useSplitButtons')};set useSplitButtons(useSplitButtons){this.setAttribute('useSplitButtons',useSplitButtons)}
...
{ name:'whenVisible',function: function(fn,args) { return this.ext.whenVisible(fn,args) } },
  ...
  constructor() {
    super()
    this.METHODS = ExtBreadcrumbbarComponent.METHODS()
    this.XTYPE = ExtBreadcrumbbarComponent.XTYPE()
    //this.PROPERTIES = ExtBreadcrumbbarComponent.PROPERTIES()
    this.PROPERTIESOBJECT = ExtBreadcrumbbarComponent.PROPERTIESOBJECT()
    this.EVENTS = ExtBreadcrumbbarComponent.EVENTS()
  }
