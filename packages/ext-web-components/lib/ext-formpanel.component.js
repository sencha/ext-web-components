...
get jsonSubmit(){return this.getAttribute('jsonSubmit')};set jsonSubmit(jsonSubmit){this.setAttribute('jsonSubmit',jsonSubmit)}
...
get titleCollapse(){return this.getAttribute('titleCollapse')};set titleCollapse(titleCollapse){this.setAttribute('titleCollapse',titleCollapse)}
