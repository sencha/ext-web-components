...
export class ExtDragcolumnComponent extends ExtBase {
...
get editorDefaults(){return this.getAttribute('editorDefaults')};set editorDefaults(editorDefaults){this.setAttribute('editorDefaults',editorDefaults)}
...
{ name:'whenVisible',function: function(fn,args) { return this.ext.whenVisible(fn,args) } },
  ...
  constructor() {
    super()
    this.METHODS = ExtDragcolumnComponent.METHODS()
    this.XTYPE = ExtDragcolumnComponent.XTYPE()
    //this.PROPERTIES = ExtDragcolumnComponent.PROPERTIES()
    this.PROPERTIESOBJECT = ExtDragcolumnComponent.PROPERTIESOBJECT()
    this.EVENTS = ExtDragcolumnComponent.EVENTS()
  }
