...
export class ExtRoweditorgapComponent extends ExtBase {
...
{ name:'whenVisible',function: function(fn,args) { return this.ext.whenVisible(fn,args) } },
  ...
  constructor() {
    super()
    this.METHODS = ExtRoweditorgapComponent.METHODS()
    this.XTYPE = ExtRoweditorgapComponent.XTYPE()
    //this.PROPERTIES = ExtRoweditorgapComponent.PROPERTIES()
    this.PROPERTIESOBJECT = ExtRoweditorgapComponent.PROPERTIESOBJECT()
    this.EVENTS = ExtRoweditorgapComponent.EVENTS()
  }
