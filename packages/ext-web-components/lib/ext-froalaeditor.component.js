...
export class ExtFroalaeditorComponent extends ExtBase {
...
{ name:'whenVisible',function: function(fn,args) { return this.ext.whenVisible(fn,args) } },
  ...
  constructor() {
    super()
    this.METHODS = ExtFroalaeditorComponent.METHODS()
    this.XTYPE = ExtFroalaeditorComponent.XTYPE()
    //this.PROPERTIES = ExtFroalaeditorComponent.PROPERTIES()
    this.PROPERTIESOBJECT = ExtFroalaeditorComponent.PROPERTIESOBJECT()
    this.EVENTS = ExtFroalaeditorComponent.EVENTS()
  }
