...
export class ExtCheckboxgroupComponent extends ExtBase {
...
{ name:'whenVisible',function: function(fn,args) { return this.ext.whenVisible(fn,args) } },
  ...
  constructor() {
    super()
    this.METHODS = ExtCheckboxgroupComponent.METHODS()
    this.XTYPE = ExtCheckboxgroupComponent.XTYPE()
    //this.PROPERTIES = ExtCheckboxgroupComponent.PROPERTIES()
    this.PROPERTIESOBJECT = ExtCheckboxgroupComponent.PROPERTIESOBJECT()
    this.EVENTS = ExtCheckboxgroupComponent.EVENTS()
  }
