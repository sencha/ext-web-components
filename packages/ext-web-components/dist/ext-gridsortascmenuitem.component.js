...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtGridsortascmenuitemComponent, _ExtBase);

  ExtGridsortascmenuitemComponent.XTYPE = function XTYPE() {
    return 'gridsortascmenuitem';
  };

  ExtGridsortascmenuitemComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtGridsortascmenuitemComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
      ...
      parameters: 'gridsortascmenuitem,checked'
    }, {
      ...
      name: 'beforetofront',
      parameters: 'gridsortascmenuitem'
    }, {
      ...
      name: 'blur',
      parameters: 'gridsortascmenuitem,event'
    }, {
      name: 'bottomchange',
  ...
  ExtGridsortascmenuitemComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtGridsortascmenuitemComponent, [{
    key: "allowUncheck",
    get: function get() {
  ...
  function ExtGridsortascmenuitemComponent() {
    ...
    _this.METHODS = ExtGridsortascmenuitemComponent.METHODS();
    _this.XTYPE = ExtGridsortascmenuitemComponent.XTYPE(); //this.PROPERTIES = ExtGridsortascmenuitemComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtGridsortascmenuitemComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtGridsortascmenuitemComponent.EVENTS();
    return _this;
  }

  var _proto = ExtGridsortascmenuitemComponent.prototype;
