...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtHeadercontainerComponent, _ExtBase);

  ExtHeadercontainerComponent.XTYPE = function XTYPE() {
    return 'headercontainer';
  };

  ExtHeadercontainerComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtHeadercontainerComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'newActiveItem,headercontainer,oldActiveItem'
    }, {
      name: 'activeItemchange',
      parameters: 'sender,value,oldValue'
    }, {
      name: 'add',
      parameters: 'headercontainer,item,index'
    }, {
      name: 'added',
      ...
      name: 'blur',
      parameters: 'headercontainer,event'
    }, {
      name: 'bottomchange',
      parameters: 'sender,value,oldValue'
    }, {
      ...
      name: 'deactivate',
      parameters: 'oldActiveItem,headercontainer,newActiveItem'
    }, {
      name: 'destroy',
      parameters: ''
    }, {
      ...
      name: 'move',
      parameters: 'headercontainer,item,toIndex,fromIndex'
    }, {
      name: 'moved',
      ...
      name: 'renderedchange',
      parameters: 'headercontainer,item,rendered'
    }, {
      name: 'resize',
  ...
  ExtHeadercontainerComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtHeadercontainerComponent, [{
  ...
  function ExtHeadercontainerComponent() {
    ...
    _this.METHODS = ExtHeadercontainerComponent.METHODS();
    _this.XTYPE = ExtHeadercontainerComponent.XTYPE(); //this.PROPERTIES = ExtHeadercontainerComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtHeadercontainerComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtHeadercontainerComponent.EVENTS();
    return _this;
  }

  var _proto = ExtHeadercontainerComponent.prototype;
