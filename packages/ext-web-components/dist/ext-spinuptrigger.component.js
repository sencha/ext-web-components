...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtSpinuptriggerComponent, _ExtBase);

  ExtSpinuptriggerComponent.XTYPE = function XTYPE() {
    return 'spinuptrigger';
  };

  ExtSpinuptriggerComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtSpinuptriggerComponent.EVENTS = function EVENTS() {
    return [{
      ...
      name: 'beforetofront',
      parameters: 'spinuptrigger'
    }, {
      name: 'beforewidthchange',
      parameters: 'sender,value,oldValue,undefined'
    }, {
      name: 'blur',
      parameters: 'spinuptrigger,event'
    }, {
      name: 'disabledchange',
  ...
  ExtSpinuptriggerComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtSpinuptriggerComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtSpinuptriggerComponent() {
    ...
    _this.METHODS = ExtSpinuptriggerComponent.METHODS();
    _this.XTYPE = ExtSpinuptriggerComponent.XTYPE(); //this.PROPERTIES = ExtSpinuptriggerComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtSpinuptriggerComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtSpinuptriggerComponent.EVENTS();
    return _this;
  }

  var _proto = ExtSpinuptriggerComponent.prototype;
