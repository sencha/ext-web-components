...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtTemplatecolumnComponent, _ExtBase);

  ExtTemplatecolumnComponent.XTYPE = function XTYPE() {
    return 'templatecolumn';
  };

  ExtTemplatecolumnComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    var _ref;
  ...
  ExtTemplatecolumnComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtTemplatecolumnComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtTemplatecolumnComponent, [{
  ...
  function ExtTemplatecolumnComponent() {
    ...
    _this.METHODS = ExtTemplatecolumnComponent.METHODS();
    _this.XTYPE = ExtTemplatecolumnComponent.XTYPE(); //this.PROPERTIES = ExtTemplatecolumnComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtTemplatecolumnComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtTemplatecolumnComponent.EVENTS();
    return _this;
  }

  var _proto = ExtTemplatecolumnComponent.prototype;
