...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtDataitemComponent, _ExtBase);

  ExtDataitemComponent.XTYPE = function XTYPE() {
    return 'dataitem';
  };

  ExtDataitemComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtDataitemComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'newActiveItem,dataitem,oldActiveItem'
    }, {
      name: 'activeItemchange',
      parameters: 'sender,value,oldValue'
    }, {
      name: 'add',
      parameters: 'dataitem,item,index'
    }, {
      name: 'added',
      ...
      name: 'deactivate',
      parameters: 'oldActiveItem,dataitem,newActiveItem'
    }, {
      name: 'destroy',
      parameters: ''
    }, {
      ...
      name: 'move',
      parameters: 'dataitem,item,toIndex,fromIndex'
    }, {
      name: 'moved',
      ...
      name: 'renderedchange',
      parameters: 'dataitem,item,rendered'
    }, {
      name: 'resize',
  ...
  ExtDataitemComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtDataitemComponent, [{
  ...
  function ExtDataitemComponent() {
    ...
    _this.METHODS = ExtDataitemComponent.METHODS();
    _this.XTYPE = ExtDataitemComponent.XTYPE(); //this.PROPERTIES = ExtDataitemComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtDataitemComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtDataitemComponent.EVENTS();
    return _this;
  }

  var _proto = ExtDataitemComponent.prototype;
