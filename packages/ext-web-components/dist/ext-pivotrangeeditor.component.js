...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtPivotrangeeditorComponent, _ExtBase);

  ExtPivotrangeeditorComponent.XTYPE = function XTYPE() {
    return 'pivotrangeeditor';
  };

  ExtPivotrangeeditorComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtPivotrangeeditorComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtPivotrangeeditorComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtPivotrangeeditorComponent, [{
  ...
  function ExtPivotrangeeditorComponent() {
    ...
    _this.METHODS = ExtPivotrangeeditorComponent.METHODS();
    _this.XTYPE = ExtPivotrangeeditorComponent.XTYPE(); //this.PROPERTIES = ExtPivotrangeeditorComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtPivotrangeeditorComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtPivotrangeeditorComponent.EVENTS();
    return _this;
  }

  var _proto = ExtPivotrangeeditorComponent.prototype;
