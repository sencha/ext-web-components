...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtTabpanelComponent, _ExtBase);

  ExtTabpanelComponent.XTYPE = function XTYPE() {
    return 'tabpanel';
  };

  ExtTabpanelComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtTabpanelComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'newActiveItem,tabpanel,oldActiveItem'
    }, {
      name: 'activeItemchange',
      parameters: 'sender,value,oldValue'
    }, {
      name: 'add',
      parameters: 'tabpanel,item,index'
    }, {
      name: 'added',
      ...
      name: 'deactivate',
      parameters: 'oldActiveItem,tabpanel,newActiveItem'
    }, {
      name: 'destroy',
      parameters: ''
    }, {
      ...
      name: 'move',
      parameters: 'tabpanel,item,toIndex,fromIndex'
    }, {
      name: 'moved',
      ...
      name: 'renderedchange',
      parameters: 'tabpanel,item,rendered'
    }, {
      name: 'resize',
  ...
  ExtTabpanelComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtTabpanelComponent, [{
    ...
    key: "autoOrientAnimation",
    get: function get() {
      return this.getAttribute('autoOrientAnimation');
    },
    set: function set(autoOrientAnimation) {
      this.setAttribute('autoOrientAnimation', autoOrientAnimation);
    }
  }, {
    key: "autoSize",
    get: function get() {
    ...
    key: "tabBar",
    get: function get() {
      return this.getAttribute('tabBar');
    },
    set: function set(tabBar) {
      this.setAttribute('tabBar', tabBar);
    }
  }, {
    key: "tabBarPosition",
    get: function get() {
      return this.getAttribute('tabBarPosition');
    },
    set: function set(tabBarPosition) {
      this.setAttribute('tabBarPosition', tabBarPosition);
    }
  }, {
    key: "tabIndex",
    get: function get() {
    ...
    key: "tabRotation",
    get: function get() {
      return this.getAttribute('tabRotation');
    },
    set: function set(tabRotation) {
      this.setAttribute('tabRotation', tabRotation);
    }
  }, {
    key: "toFrontOnShow",
    get: function get() {
  ...
  function ExtTabpanelComponent() {
    ...
    _this.METHODS = ExtTabpanelComponent.METHODS();
    _this.XTYPE = ExtTabpanelComponent.XTYPE(); //this.PROPERTIES = ExtTabpanelComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtTabpanelComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtTabpanelComponent.EVENTS();
    return _this;
  }

  var _proto = ExtTabpanelComponent.prototype;
