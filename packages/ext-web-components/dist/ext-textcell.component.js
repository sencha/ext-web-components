...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtTextcellComponent, _ExtBase);

  ExtTextcellComponent.XTYPE = function XTYPE() {
    return 'textcell';
  };

  ExtTextcellComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    var _ref;
  ...
  ExtTextcellComponent.EVENTS = function EVENTS() {
    return [{
  ...
  ExtTextcellComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtTextcellComponent, [{
    key: "align",
    get: function get() {
  ...
  function ExtTextcellComponent() {
    ...
    _this.METHODS = ExtTextcellComponent.METHODS();
    _this.XTYPE = ExtTextcellComponent.XTYPE(); //this.PROPERTIES = ExtTextcellComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtTextcellComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtTextcellComponent.EVENTS();
    return _this;
  }

  var _proto = ExtTextcellComponent.prototype;
