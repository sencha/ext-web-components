...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtListswiperitemComponent, _ExtBase);

  ExtListswiperitemComponent.XTYPE = function XTYPE() {
    return 'listswiperitem';
  };

  ExtListswiperitemComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "action": ["any"],
  ...
  ExtListswiperitemComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'newActiveItem,listswiperitem,oldActiveItem'
    }, {
      name: 'activeItemchange',
      parameters: 'sender,value,oldValue'
    }, {
      name: 'add',
      parameters: 'listswiperitem,item,index'
    }, {
      name: 'added',
      ...
      name: 'blur',
      parameters: 'listswiperitem,event'
    }, {
      name: 'bottomchange',
      parameters: 'sender,value,oldValue'
    }, {
      ...
      name: 'deactivate',
      parameters: 'oldActiveItem,listswiperitem,newActiveItem'
    }, {
      name: 'destroy',
      parameters: ''
    }, {
      ...
      name: 'move',
      parameters: 'listswiperitem,item,toIndex,fromIndex'
    }, {
      name: 'moved',
      ...
      name: 'renderedchange',
      parameters: 'listswiperitem,item,rendered'
    }, {
      name: 'resize',
  ...
  ExtListswiperitemComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtListswiperitemComponent, [{
    key: "action",
    get: function get() {
    ...
    get: function get() {
      return this.getAttribute('translationTarget');
    },
    set: function set(translationTarget) {
      this.setAttribute('translationTarget', translationTarget);
    }
  }, {
    key: "twoWayBindable",
    get: function get() {
    ...
    key: "undo",
    get: function get() {
      return this.getAttribute('undo');
    },
    set: function set(undo) {
      this.setAttribute('undo', undo);
    }
  }, {
    key: "userCls",
    get: function get() {
  ...
  function ExtListswiperitemComponent() {
    ...
    _this.METHODS = ExtListswiperitemComponent.METHODS();
    _this.XTYPE = ExtListswiperitemComponent.XTYPE(); //this.PROPERTIES = ExtListswiperitemComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtListswiperitemComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtListswiperitemComponent.EVENTS();
    return _this;
  }

  var _proto = ExtListswiperitemComponent.prototype;
