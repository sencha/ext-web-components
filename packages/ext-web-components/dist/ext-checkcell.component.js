...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtCheckcellComponent, _ExtBase);

  ExtCheckcellComponent.XTYPE = function XTYPE() {
    return 'checkcell';
  };

  ExtCheckcellComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    var _ref;
  ...
  ExtCheckcellComponent.EVENTS = function EVENTS() {
    return [{
      ...
      name: 'beforetofront',
      parameters: 'checkcell'
    }, {
      name: 'beforewidthchange',
      parameters: 'sender,value,oldValue,undefined'
    }, {
      name: 'blur',
      parameters: 'checkcell,event'
    }, {
      name: 'disabledchange',
  ...
  ExtCheckcellComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtCheckcellComponent, [{
    key: "align",
    get: function get() {
  ...
  function ExtCheckcellComponent() {
    ...
    _this.METHODS = ExtCheckcellComponent.METHODS();
    _this.XTYPE = ExtCheckcellComponent.XTYPE(); //this.PROPERTIES = ExtCheckcellComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtCheckcellComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtCheckcellComponent.EVENTS();
    return _this;
  }

  var _proto = ExtCheckcellComponent.prototype;
