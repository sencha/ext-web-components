...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtSpindowntriggerComponent, _ExtBase);

  ExtSpindowntriggerComponent.XTYPE = function XTYPE() {
    return 'spindowntrigger';
  };

  ExtSpindowntriggerComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtSpindowntriggerComponent.EVENTS = function EVENTS() {
    return [{
      ...
      name: 'beforetofront',
      parameters: 'spindowntrigger'
    }, {
      name: 'beforewidthchange',
      parameters: 'sender,value,oldValue,undefined'
    }, {
      name: 'blur',
      parameters: 'spindowntrigger,event'
    }, {
      name: 'disabledchange',
  ...
  ExtSpindowntriggerComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtSpindowntriggerComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtSpindowntriggerComponent() {
    ...
    _this.METHODS = ExtSpindowntriggerComponent.METHODS();
    _this.XTYPE = ExtSpindowntriggerComponent.XTYPE(); //this.PROPERTIES = ExtSpindowntriggerComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtSpindowntriggerComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtSpindowntriggerComponent.EVENTS();
    return _this;
  }

  var _proto = ExtSpindowntriggerComponent.prototype;
