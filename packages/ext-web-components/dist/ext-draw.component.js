...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtDrawComponent, _ExtBase);

  ExtDrawComponent.XTYPE = function XTYPE() {
    return 'draw';
  };

  ExtDrawComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtDrawComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtDrawComponent.METHODS = function METHODS() {
    return [{
  ...
  function ExtDrawComponent() {
    ...
    _this.METHODS = ExtDrawComponent.METHODS();
    _this.XTYPE = ExtDrawComponent.XTYPE(); //this.PROPERTIES = ExtDrawComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtDrawComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtDrawComponent.EVENTS();
    return _this;
  }

  var _proto = ExtDrawComponent.prototype;
