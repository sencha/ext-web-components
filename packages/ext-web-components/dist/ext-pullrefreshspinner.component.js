...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtPullrefreshspinnerComponent, _ExtBase);

  ExtPullrefreshspinnerComponent.XTYPE = function XTYPE() {
    return 'pullrefreshspinner';
  };

  ExtPullrefreshspinnerComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtPullrefreshspinnerComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
      ...
      name: 'blur',
      parameters: 'pullrefreshspinner,event'
    }, {
      name: 'bottomchange',
  ...
  ExtPullrefreshspinnerComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtPullrefreshspinnerComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtPullrefreshspinnerComponent() {
    ...
    _this.METHODS = ExtPullrefreshspinnerComponent.METHODS();
    _this.XTYPE = ExtPullrefreshspinnerComponent.XTYPE(); //this.PROPERTIES = ExtPullrefreshspinnerComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtPullrefreshspinnerComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtPullrefreshspinnerComponent.EVENTS();
    return _this;
  }

  var _proto = ExtPullrefreshspinnerComponent.prototype;
