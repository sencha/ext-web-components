...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtProgressComponent, _ExtBase);

  ExtProgressComponent.XTYPE = function XTYPE() {
    return 'progress';
  };

  ExtProgressComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtProgressComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtProgressComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtProgressComponent, [{
    key: "alwaysOnTop",
    get: function get() {
  ...
  function ExtProgressComponent() {
    ...
    _this.METHODS = ExtProgressComponent.METHODS();
    _this.XTYPE = ExtProgressComponent.XTYPE(); //this.PROPERTIES = ExtProgressComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtProgressComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtProgressComponent.EVENTS();
    return _this;
  }

  var _proto = ExtProgressComponent.prototype;
