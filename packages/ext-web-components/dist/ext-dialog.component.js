...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtDialogComponent, _ExtBase);

  ExtDialogComponent.XTYPE = function XTYPE() {
    return 'dialog';
  };

  ExtDialogComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtDialogComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'newActiveItem,dialog,oldActiveItem'
    }, {
      name: 'activeItemchange',
      parameters: 'sender,value,oldValue'
    }, {
      name: 'add',
      parameters: 'dialog,item,index'
    }, {
      name: 'added',
      ...
      name: 'deactivate',
      parameters: 'oldActiveItem,dialog,newActiveItem'
    }, {
      name: 'destroy',
      parameters: ''
    }, {
      ...
      name: 'move',
      parameters: 'dialog,item,toIndex,fromIndex'
    }, {
      name: 'moved',
      ...
      name: 'renderedchange',
      parameters: 'dialog,item,rendered'
    }, {
      name: 'resize',
  ...
  ExtDialogComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtDialogComponent, [{
    ...
    key: "constrainDrag",
    get: function get() {
      return this.getAttribute('constrainDrag');
    },
    set: function set(constrainDrag) {
      this.setAttribute('constrainDrag', constrainDrag);
    }
  }, {
    key: "contentEl",
    get: function get() {
    ...
    key: "dismissAction",
    get: function get() {
      return this.getAttribute('dismissAction');
    },
    set: function set(dismissAction) {
      this.setAttribute('dismissAction', dismissAction);
    }
  }, {
    key: "dismissHandler",
    get: function get() {
      return this.getAttribute('dismissHandler');
    },
    set: function set(dismissHandler) {
      this.setAttribute('dismissHandler', dismissHandler);
    }
  }, {
    key: "displayed",
    get: function get() {
    ...
    key: "maskTapHandler",
    get: function get() {
      return this.getAttribute('maskTapHandler');
    },
    set: function set(maskTapHandler) {
      this.setAttribute('maskTapHandler', maskTapHandler);
    }
  }, {
    key: "maxHeight",
    get: function get() {
    ...
    key: "maximizable",
    get: function get() {
      return this.getAttribute('maximizable');
    },
    set: function set(maximizable) {
      this.setAttribute('maximizable', maximizable);
    }
  }, {
    key: "maximizeAnimation",
    get: function get() {
      return this.getAttribute('maximizeAnimation');
    },
    set: function set(maximizeAnimation) {
      this.setAttribute('maximizeAnimation', maximizeAnimation);
    }
  }, {
    key: "maximized",
    get: function get() {
      return this.getAttribute('maximized');
    },
    set: function set(maximized) {
      this.setAttribute('maximized', maximized);
    }
  }, {
    key: "maximizeProxy",
    get: function get() {
      return this.getAttribute('maximizeProxy');
    },
    set: function set(maximizeProxy) {
      this.setAttribute('maximizeProxy', maximizeProxy);
    }
  }, {
    key: "maximizeTool",
    get: function get() {
      return this.getAttribute('maximizeTool');
    },
    set: function set(maximizeTool) {
      this.setAttribute('maximizeTool', maximizeTool);
    }
  }, {
    key: "maxWidth",
    get: function get() {
    ...
    key: "restorable",
    get: function get() {
      return this.getAttribute('restorable');
    },
    set: function set(restorable) {
      this.setAttribute('restorable', restorable);
    }
  }, {
    key: "restoreAnimation",
    get: function get() {
      return this.getAttribute('restoreAnimation');
    },
    set: function set(restoreAnimation) {
      this.setAttribute('restoreAnimation', restoreAnimation);
    }
  }, {
    key: "restoreTool",
    get: function get() {
      return this.getAttribute('restoreTool');
    },
    set: function set(restoreTool) {
      this.setAttribute('restoreTool', restoreTool);
    }
  }, {
    key: "right",
    get: function get() {
  ...
  function ExtDialogComponent() {
    ...
    _this.METHODS = ExtDialogComponent.METHODS();
    _this.XTYPE = ExtDialogComponent.XTYPE(); //this.PROPERTIES = ExtDialogComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtDialogComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtDialogComponent.EVENTS();
    return _this;
  }

  var _proto = ExtDialogComponent.prototype;
