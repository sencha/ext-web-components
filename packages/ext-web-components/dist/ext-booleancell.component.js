...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtBooleancellComponent, _ExtBase);

  ExtBooleancellComponent.XTYPE = function XTYPE() {
    return 'booleancell';
  };

  ExtBooleancellComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    var _ref;
  ...
  ExtBooleancellComponent.EVENTS = function EVENTS() {
    return [{
      ...
      name: 'beforetofront',
      parameters: 'booleancell'
    }, {
      name: 'beforewidthchange',
      parameters: 'sender,value,oldValue,undefined'
    }, {
      name: 'blur',
      parameters: 'booleancell,event'
    }, {
      name: 'disabledchange',
  ...
  ExtBooleancellComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtBooleancellComponent, [{
    key: "align",
    get: function get() {
    ...
    key: "encodeHtml",
    get: function get() {
      return this.getAttribute('encodeHtml');
    },
    set: function set(encodeHtml) {
      this.setAttribute('encodeHtml', encodeHtml);
    }
  }, {
    key: "falseText",
    get: function get() {
    ...
    set: function set(rawValue) {
      this.setAttribute('rawValue', rawValue);
    }
  }, {
    key: "record",
    get: function get() {
    ...
    key: "zeroValue",
    get: function get() {
      return this.getAttribute('zeroValue');
    },
    set: function set(zeroValue) {
      this.setAttribute('zeroValue', zeroValue);
    }
  }, {
    key: "platformConfig",
    get: function get() {
  ...
  function ExtBooleancellComponent() {
    ...
    _this.METHODS = ExtBooleancellComponent.METHODS();
    _this.XTYPE = ExtBooleancellComponent.XTYPE(); //this.PROPERTIES = ExtBooleancellComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtBooleancellComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtBooleancellComponent.EVENTS();
    return _this;
  }

  var _proto = ExtBooleancellComponent.prototype;
