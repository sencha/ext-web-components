...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtToolComponent, _ExtBase);

  ExtToolComponent.XTYPE = function XTYPE() {
    return 'tool';
  };

  ExtToolComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtToolComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtToolComponent.METHODS = function METHODS() {
    return [{
  ...
  function ExtToolComponent() {
    ...
    _this.METHODS = ExtToolComponent.METHODS();
    _this.XTYPE = ExtToolComponent.XTYPE(); //this.PROPERTIES = ExtToolComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtToolComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtToolComponent.EVENTS();
    return _this;
  }

  var _proto = ExtToolComponent.prototype;
