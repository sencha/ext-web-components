...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtDatecolumnComponent, _ExtBase);

  ExtDatecolumnComponent.XTYPE = function XTYPE() {
    return 'datecolumn';
  };

  ExtDatecolumnComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    var _ref;
  ...
  ExtDatecolumnComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtDatecolumnComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtDatecolumnComponent, [{
  ...
  function ExtDatecolumnComponent() {
    ...
    _this.METHODS = ExtDatecolumnComponent.METHODS();
    _this.XTYPE = ExtDatecolumnComponent.XTYPE(); //this.PROPERTIES = ExtDatecolumnComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtDatecolumnComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtDatecolumnComponent.EVENTS();
    return _this;
  }

  var _proto = ExtDatecolumnComponent.prototype;
