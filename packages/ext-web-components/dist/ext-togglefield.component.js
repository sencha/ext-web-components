...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtTogglefieldComponent, _ExtBase);

  ExtTogglefieldComponent.XTYPE = function XTYPE() {
    return 'togglefield';
  };

  ExtTogglefieldComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "activeLabel": ["string"],
      "alignSelf": ["string"],
  ...
  ExtTogglefieldComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtTogglefieldComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtTogglefieldComponent, [{
    key: "activeLabel",
    get: function get() {
      return this.getAttribute('activeLabel');
    },
    set: function set(activeLabel) {
      this.setAttribute('activeLabel', activeLabel);
    }
  }, {
    key: "alignSelf",
    get: function get() {
    ...
    key: "boxLabel",
    get: function get() {
      return this.getAttribute('boxLabel');
    },
    set: function set(boxLabel) {
      this.setAttribute('boxLabel', boxLabel);
    }
  }, {
    key: "boxLabelAlign",
    get: function get() {
      return this.getAttribute('boxLabelAlign');
    },
    set: function set(boxLabelAlign) {
    ...
    key: "inactiveLabel",
    get: function get() {
      return this.getAttribute('inactiveLabel');
    },
    set: function set(inactiveLabel) {
      this.setAttribute('inactiveLabel', inactiveLabel);
    }
  }, {
    key: "increment",
    get: function get() {
    ...
    key: "liveUpdate",
    get: function get() {
      return this.getAttribute('liveUpdate');
    },
    set: function set(liveUpdate) {
      this.setAttribute('liveUpdate', liveUpdate);
    }
  }, {
    key: "margin",
    get: function get() {
    ...
    key: "slider",
    get: function get() {
      return this.getAttribute('slider');
    },
    set: function set(slider) {
      this.setAttribute('slider', slider);
    }
  }, {
    key: "stateful",
    get: function get() {
  ...
  function ExtTogglefieldComponent() {
    ...
    _this.METHODS = ExtTogglefieldComponent.METHODS();
    _this.XTYPE = ExtTogglefieldComponent.XTYPE(); //this.PROPERTIES = ExtTogglefieldComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtTogglefieldComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtTogglefieldComponent.EVENTS();
    return _this;
  }

  var _proto = ExtTogglefieldComponent.prototype;
