...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtColorpickercolorpreviewComponent, _ExtBase);

  ExtColorpickercolorpreviewComponent.XTYPE = function XTYPE() {
    return 'colorpickercolorpreview';
  };

  ExtColorpickercolorpreviewComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtColorpickercolorpreviewComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
      ...
      name: 'beforetofront',
      parameters: 'colorpickercolorpreview'
    }, {
      ...
      name: 'blur',
      parameters: 'colorpickercolorpreview,event'
    }, {
      name: 'bottomchange',
  ...
  ExtColorpickercolorpreviewComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtColorpickercolorpreviewComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtColorpickercolorpreviewComponent() {
    ...
    _this.METHODS = ExtColorpickercolorpreviewComponent.METHODS();
    _this.XTYPE = ExtColorpickercolorpreviewComponent.XTYPE(); //this.PROPERTIES = ExtColorpickercolorpreviewComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtColorpickercolorpreviewComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtColorpickercolorpreviewComponent.EVENTS();
    return _this;
  }

  var _proto = ExtColorpickercolorpreviewComponent.prototype;
