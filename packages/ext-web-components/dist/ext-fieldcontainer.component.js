...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtFieldcontainerComponent, _ExtBase);

  ExtFieldcontainerComponent.XTYPE = function XTYPE() {
    return 'fieldcontainer';
  };

  ExtFieldcontainerComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtFieldcontainerComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtFieldcontainerComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtFieldcontainerComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtFieldcontainerComponent() {
    ...
    _this.METHODS = ExtFieldcontainerComponent.METHODS();
    _this.XTYPE = ExtFieldcontainerComponent.XTYPE(); //this.PROPERTIES = ExtFieldcontainerComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtFieldcontainerComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtFieldcontainerComponent.EVENTS();
    return _this;
  }

  var _proto = ExtFieldcontainerComponent.prototype;
