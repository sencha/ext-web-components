...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtTriggerComponent, _ExtBase);

  ExtTriggerComponent.XTYPE = function XTYPE() {
    return 'trigger';
  };

  ExtTriggerComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtTriggerComponent.EVENTS = function EVENTS() {
    return [{
  ...
  ExtTriggerComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtTriggerComponent, [{
    key: "alwaysOnTop",
    get: function get() {
  ...
  function ExtTriggerComponent() {
    ...
    _this.METHODS = ExtTriggerComponent.METHODS();
    _this.XTYPE = ExtTriggerComponent.XTYPE(); //this.PROPERTIES = ExtTriggerComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtTriggerComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtTriggerComponent.EVENTS();
    return _this;
  }

  var _proto = ExtTriggerComponent.prototype;
