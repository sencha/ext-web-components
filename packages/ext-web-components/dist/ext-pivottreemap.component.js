...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtPivottreemapComponent, _ExtBase);

  ExtPivottreemapComponent.XTYPE = function XTYPE() {
    return 'pivottreemap';
  };

  ExtPivottreemapComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtPivottreemapComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtPivottreemapComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtPivottreemapComponent, [{
    key: "alwaysOnTop",
    get: function get() {
    ...
    key: "autoExpand",
    get: function get() {
      return this.getAttribute('autoExpand');
    },
    set: function set(autoExpand) {
      this.setAttribute('autoExpand', autoExpand);
    }
  }, {
    key: "axisLock",
    get: function get() {
  ...
  function ExtPivottreemapComponent() {
    ...
    _this.METHODS = ExtPivottreemapComponent.METHODS();
    _this.XTYPE = ExtPivottreemapComponent.XTYPE(); //this.PROPERTIES = ExtPivottreemapComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtPivottreemapComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtPivottreemapComponent.EVENTS();
    return _this;
  }

  var _proto = ExtPivottreemapComponent.prototype;
