...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtEditorComponent, _ExtBase);

  ExtEditorComponent.XTYPE = function XTYPE() {
    return 'editor';
  };

  ExtEditorComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtEditorComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtEditorComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtEditorComponent, [{
  ...
  function ExtEditorComponent() {
    ...
    _this.METHODS = ExtEditorComponent.METHODS();
    _this.XTYPE = ExtEditorComponent.XTYPE(); //this.PROPERTIES = ExtEditorComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtEditorComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtEditorComponent.EVENTS();
    return _this;
  }

  var _proto = ExtEditorComponent.prototype;
