...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtGroupcontainerComponent, _ExtBase);

  ExtGroupcontainerComponent.XTYPE = function XTYPE() {
    return 'groupcontainer';
  };

  ExtGroupcontainerComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtGroupcontainerComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
      ...
      name: 'blur',
      parameters: 'groupcontainer,event'
    }, {
      name: 'bottomchange',
      ...
      name: 'change',
      parameters: 'groupcontainer,newValue,oldValue'
    }, {
      name: 'click',
      parameters: 'e'
    }, {
      ...
      name: 'dirtychange',
      parameters: 'groupcontainer,dirty'
    }, {
      name: 'disabledchange',
      parameters: 'sender,value,oldValue'
    }, {
      ...
      name: 'errorchange',
      parameters: 'groupcontainer,error'
    }, {
      name: 'floatingchange',
  ...
  ExtGroupcontainerComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtGroupcontainerComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtGroupcontainerComponent() {
    ...
    _this.METHODS = ExtGroupcontainerComponent.METHODS();
    _this.XTYPE = ExtGroupcontainerComponent.XTYPE(); //this.PROPERTIES = ExtGroupcontainerComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtGroupcontainerComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtGroupcontainerComponent.EVENTS();
    return _this;
  }

  var _proto = ExtGroupcontainerComponent.prototype;
