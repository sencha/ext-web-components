...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtGridcellbaseComponent, _ExtBase);

  ExtGridcellbaseComponent.XTYPE = function XTYPE() {
    return 'gridcellbase';
  };

  ExtGridcellbaseComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    var _ref;
  ...
  ExtGridcellbaseComponent.EVENTS = function EVENTS() {
    return [{
  ...
  ExtGridcellbaseComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtGridcellbaseComponent, [{
    key: "align",
    get: function get() {
  ...
  function ExtGridcellbaseComponent() {
    ...
    _this.METHODS = ExtGridcellbaseComponent.METHODS();
    _this.XTYPE = ExtGridcellbaseComponent.XTYPE(); //this.PROPERTIES = ExtGridcellbaseComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtGridcellbaseComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtGridcellbaseComponent.EVENTS();
    return _this;
  }

  var _proto = ExtGridcellbaseComponent.prototype;
