...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtDatetitleComponent, _ExtBase);

  ExtDatetitleComponent.XTYPE = function XTYPE() {
    return 'datetitle';
  };

  ExtDatetitleComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtDatetitleComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtDatetitleComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtDatetitleComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtDatetitleComponent() {
    ...
    _this.METHODS = ExtDatetitleComponent.METHODS();
    _this.XTYPE = ExtDatetitleComponent.XTYPE(); //this.PROPERTIES = ExtDatetitleComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtDatetitleComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtDatetitleComponent.EVENTS();
    return _this;
  }

  var _proto = ExtDatetitleComponent.prototype;
