...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtCalendar_eventComponent, _ExtBase);

  ExtCalendar_eventComponent.XTYPE = function XTYPE() {
    return 'calendar_event';
  };

  ExtCalendar_eventComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtCalendar_eventComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtCalendar_eventComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtCalendar_eventComponent, [{
    key: "alwaysOnTop",
    get: function get() {
    ...
    key: "defaultTitle",
    get: function get() {
      return this.getAttribute('defaultTitle');
    },
    set: function set(defaultTitle) {
      this.setAttribute('defaultTitle', defaultTitle);
    }
  }, {
    key: "disabled",
    get: function get() {
    ...
    key: "palette",
    get: function get() {
      return this.getAttribute('palette');
    },
  ...
  function ExtCalendar_eventComponent() {
    ...
    _this.METHODS = ExtCalendar_eventComponent.METHODS();
    _this.XTYPE = ExtCalendar_eventComponent.XTYPE(); //this.PROPERTIES = ExtCalendar_eventComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtCalendar_eventComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtCalendar_eventComponent.EVENTS();
    return _this;
  }

  var _proto = ExtCalendar_eventComponent.prototype;
