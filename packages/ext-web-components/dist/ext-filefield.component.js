...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtFilefieldComponent, _ExtBase);

  ExtFilefieldComponent.XTYPE = function XTYPE() {
    return 'filefield';
  };

  ExtFilefieldComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "accept": ["string"],
      "alignSelf": ["string"],
  ...
  ExtFilefieldComponent.EVENTS = function EVENTS() {
    return [{
      name: 'action',
  ...
  ExtFilefieldComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtFilefieldComponent, [{
    key: "accept",
    get: function get() {
  ...
  function ExtFilefieldComponent() {
    ...
    _this.METHODS = ExtFilefieldComponent.METHODS();
    _this.XTYPE = ExtFilefieldComponent.XTYPE(); //this.PROPERTIES = ExtFilefieldComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtFilefieldComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtFilefieldComponent.EVENTS();
    return _this;
  }

  var _proto = ExtFilefieldComponent.prototype;
