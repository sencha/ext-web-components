...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtRowheaderComponent, _ExtBase);

  ExtRowheaderComponent.XTYPE = function XTYPE() {
    return 'rowheader';
  };

  ExtRowheaderComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtRowheaderComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtRowheaderComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtRowheaderComponent, [{
    key: "alwaysOnTop",
    get: function get() {
  ...
  function ExtRowheaderComponent() {
    ...
    _this.METHODS = ExtRowheaderComponent.METHODS();
    _this.XTYPE = ExtRowheaderComponent.XTYPE(); //this.PROPERTIES = ExtRowheaderComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtRowheaderComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtRowheaderComponent.EVENTS();
    return _this;
  }

  var _proto = ExtRowheaderComponent.prototype;
