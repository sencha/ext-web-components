...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtRoweditorcellComponent, _ExtBase);

  ExtRoweditorcellComponent.XTYPE = function XTYPE() {
    return 'roweditorcell';
  };

  ExtRoweditorcellComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtRoweditorcellComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
      ...
      name: 'blur',
      parameters: 'roweditorcell,event'
    }, {
      name: 'bottomchange',
  ...
  ExtRoweditorcellComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtRoweditorcellComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtRoweditorcellComponent() {
    ...
    _this.METHODS = ExtRoweditorcellComponent.METHODS();
    _this.XTYPE = ExtRoweditorcellComponent.XTYPE(); //this.PROPERTIES = ExtRoweditorcellComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtRoweditorcellComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtRoweditorcellComponent.EVENTS();
    return _this;
  }

  var _proto = ExtRoweditorcellComponent.prototype;
