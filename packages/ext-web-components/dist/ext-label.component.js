...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtLabelComponent, _ExtBase);

  ExtLabelComponent.XTYPE = function XTYPE() {
    return 'label';
  };

  ExtLabelComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtLabelComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtLabelComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtLabelComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtLabelComponent() {
    ...
    _this.METHODS = ExtLabelComponent.METHODS();
    _this.XTYPE = ExtLabelComponent.XTYPE(); //this.PROPERTIES = ExtLabelComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtLabelComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtLabelComponent.EVENTS();
    return _this;
  }

  var _proto = ExtLabelComponent.prototype;
