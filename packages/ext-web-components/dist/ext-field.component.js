...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtFieldComponent, _ExtBase);

  ExtFieldComponent.XTYPE = function XTYPE() {
    return 'field';
  };

  ExtFieldComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtFieldComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtFieldComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtFieldComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtFieldComponent() {
    ...
    _this.METHODS = ExtFieldComponent.METHODS();
    _this.XTYPE = ExtFieldComponent.XTYPE(); //this.PROPERTIES = ExtFieldComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtFieldComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtFieldComponent.EVENTS();
    return _this;
  }

  var _proto = ExtFieldComponent.prototype;
