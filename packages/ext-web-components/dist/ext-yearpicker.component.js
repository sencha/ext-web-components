...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtYearpickerComponent, _ExtBase);

  ExtYearpickerComponent.XTYPE = function XTYPE() {
    return 'yearpicker';
  };

  ExtYearpickerComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtYearpickerComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtYearpickerComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtYearpickerComponent, [{
  ...
  function ExtYearpickerComponent() {
    ...
    _this.METHODS = ExtYearpickerComponent.METHODS();
    _this.XTYPE = ExtYearpickerComponent.XTYPE(); //this.PROPERTIES = ExtYearpickerComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtYearpickerComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtYearpickerComponent.EVENTS();
    return _this;
  }

  var _proto = ExtYearpickerComponent.prototype;
