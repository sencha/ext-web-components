...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtCheckboxfieldComponent, _ExtBase);

  ExtCheckboxfieldComponent.XTYPE = function XTYPE() {
    return 'checkboxfield';
  };

  ExtCheckboxfieldComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtCheckboxfieldComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtCheckboxfieldComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtCheckboxfieldComponent, [{
    key: "alwaysOnTop",
    get: function get() {
  ...
  function ExtCheckboxfieldComponent() {
    ...
    _this.METHODS = ExtCheckboxfieldComponent.METHODS();
    _this.XTYPE = ExtCheckboxfieldComponent.XTYPE(); //this.PROPERTIES = ExtCheckboxfieldComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtCheckboxfieldComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtCheckboxfieldComponent.EVENTS();
    return _this;
  }

  var _proto = ExtCheckboxfieldComponent.prototype;
