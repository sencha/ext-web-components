...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtSurfaceComponent, _ExtBase);

  ExtSurfaceComponent.XTYPE = function XTYPE() {
    return 'surface';
  };

  ExtSurfaceComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtSurfaceComponent.EVENTS = function EVENTS() {
    return [{
  ...
  ExtSurfaceComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtSurfaceComponent, [{
    key: "alignSelf",
    get: function get() {
    ...
    key: "flipRtlText",
    get: function get() {
      return this.getAttribute('flipRtlText');
    },
    set: function set(flipRtlText) {
      this.setAttribute('flipRtlText', flipRtlText);
    }
  }, {
    key: "floated",
    get: function get() {
    ...
    key: "rect",
    get: function get() {
      return this.getAttribute('rect');
    },
    set: function set(rect) {
      this.setAttribute('rect', rect);
    }
  }, {
    key: "reference",
    get: function get() {
  ...
  function ExtSurfaceComponent() {
    ...
    _this.METHODS = ExtSurfaceComponent.METHODS();
    _this.XTYPE = ExtSurfaceComponent.XTYPE(); //this.PROPERTIES = ExtSurfaceComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtSurfaceComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtSurfaceComponent.EVENTS();
    return _this;
  }

  var _proto = ExtSurfaceComponent.prototype;
