...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtMenuitemComponent, _ExtBase);

  ExtMenuitemComponent.XTYPE = function XTYPE() {
    return 'menuitem';
  };

  ExtMenuitemComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtMenuitemComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtMenuitemComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtMenuitemComponent, [{
    key: "alwaysOnTop",
    get: function get() {
  ...
  function ExtMenuitemComponent() {
    ...
    _this.METHODS = ExtMenuitemComponent.METHODS();
    _this.XTYPE = ExtMenuitemComponent.XTYPE(); //this.PROPERTIES = ExtMenuitemComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtMenuitemComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtMenuitemComponent.EVENTS();
    return _this;
  }

  var _proto = ExtMenuitemComponent.prototype;
