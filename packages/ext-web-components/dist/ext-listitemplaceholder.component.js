...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtListitemplaceholderComponent, _ExtBase);

  ExtListitemplaceholderComponent.XTYPE = function XTYPE() {
    return 'listitemplaceholder';
  };

  ExtListitemplaceholderComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtListitemplaceholderComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
      ...
      name: 'beforetofront',
      parameters: 'listitemplaceholder'
    }, {
      ...
      name: 'blur',
      parameters: 'listitemplaceholder,event'
    }, {
      name: 'bottomchange',
  ...
  ExtListitemplaceholderComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtListitemplaceholderComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtListitemplaceholderComponent() {
    ...
    _this.METHODS = ExtListitemplaceholderComponent.METHODS();
    _this.XTYPE = ExtListitemplaceholderComponent.XTYPE(); //this.PROPERTIES = ExtListitemplaceholderComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtListitemplaceholderComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtListitemplaceholderComponent.EVENTS();
    return _this;
  }

  var _proto = ExtListitemplaceholderComponent.prototype;
