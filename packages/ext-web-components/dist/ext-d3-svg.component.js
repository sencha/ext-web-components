...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtD3_svgComponent, _ExtBase);

  ExtD3_svgComponent.XTYPE = function XTYPE() {
    return 'd3_svg';
  };

  ExtD3_svgComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtD3_svgComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtD3_svgComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtD3_svgComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtD3_svgComponent() {
    ...
    _this.METHODS = ExtD3_svgComponent.METHODS();
    _this.XTYPE = ExtD3_svgComponent.XTYPE(); //this.PROPERTIES = ExtD3_svgComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtD3_svgComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtD3_svgComponent.EVENTS();
    return _this;
  }

  var _proto = ExtD3_svgComponent.prototype;
