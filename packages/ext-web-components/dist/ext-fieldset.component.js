...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtFieldsetComponent, _ExtBase);

  ExtFieldsetComponent.XTYPE = function XTYPE() {
    return 'fieldset';
  };

  ExtFieldsetComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtFieldsetComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'newActiveItem,fieldset,oldActiveItem'
    }, {
      name: 'activeItemchange',
      parameters: 'sender,value,oldValue'
    }, {
      name: 'add',
      parameters: 'fieldset,item,index'
    }, {
      name: 'added',
      ...
      name: 'deactivate',
      parameters: 'oldActiveItem,fieldset,newActiveItem'
    }, {
      name: 'destroy',
      parameters: ''
    }, {
      ...
      name: 'move',
      parameters: 'fieldset,item,toIndex,fromIndex'
    }, {
      name: 'moved',
      ...
      name: 'renderedchange',
      parameters: 'fieldset,item,rendered'
    }, {
      name: 'resize',
  ...
  ExtFieldsetComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtFieldsetComponent, [{
    ...
    set: function set(instructions) {
      this.setAttribute('instructions', instructions);
    }
  }, {
    key: "itemId",
    get: function get() {
  ...
  function ExtFieldsetComponent() {
    ...
    _this.METHODS = ExtFieldsetComponent.METHODS();
    _this.XTYPE = ExtFieldsetComponent.XTYPE(); //this.PROPERTIES = ExtFieldsetComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtFieldsetComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtFieldsetComponent.EVENTS();
    return _this;
  }

  var _proto = ExtFieldsetComponent.prototype;
