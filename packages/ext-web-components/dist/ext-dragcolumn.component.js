...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtDragcolumnComponent, _ExtBase);

  ExtDragcolumnComponent.XTYPE = function XTYPE() {
    return 'dragcolumn';
  };

  ExtDragcolumnComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    var _ref;
  ...
  ExtDragcolumnComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'newActiveItem,dragcolumn,oldActiveItem'
    }, {
      name: 'activeItemchange',
      parameters: 'sender,value,oldValue'
    }, {
      name: 'add',
      parameters: 'dragcolumn,item,index'
    }, {
      name: 'added',
      ...
      name: 'deactivate',
      parameters: 'oldActiveItem,dragcolumn,newActiveItem'
    }, {
      name: 'destroy',
      parameters: ''
    }, {
      ...
      name: 'move',
      parameters: 'dragcolumn,item,toIndex,fromIndex'
    }, {
      name: 'moved',
      ...
      name: 'renderedchange',
      parameters: 'dragcolumn,item,rendered'
    }, {
      name: 'resize',
  ...
  ExtDragcolumnComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtDragcolumnComponent, [{
  ...
  function ExtDragcolumnComponent() {
    ...
    _this.METHODS = ExtDragcolumnComponent.METHODS();
    _this.XTYPE = ExtDragcolumnComponent.XTYPE(); //this.PROPERTIES = ExtDragcolumnComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtDragcolumnComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtDragcolumnComponent.EVENTS();
    return _this;
  }

  var _proto = ExtDragcolumnComponent.prototype;
