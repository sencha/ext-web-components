...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtSplitbuttonComponent, _ExtBase);

  ExtSplitbuttonComponent.XTYPE = function XTYPE() {
    return 'splitbutton';
  };

  ExtSplitbuttonComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtSplitbuttonComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtSplitbuttonComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtSplitbuttonComponent, [{
    key: "allowDepress",
    get: function get() {
      return this.getAttribute('allowDepress');
    },
    set: function set(allowDepress) {
      this.setAttribute('allowDepress', allowDepress);
    }
  }, {
    key: "alwaysOnTop",
    get: function get() {
    ...
    key: "arrowAlign",
    get: function get() {
      return this.getAttribute('arrowAlign');
    },
    set: function set(arrowAlign) {
      this.setAttribute('arrowAlign', arrowAlign);
    }
  }, {
    key: "arrowHandler",
    get: function get() {
      return this.getAttribute('arrowHandler');
    },
    set: function set(arrowHandler) {
      this.setAttribute('arrowHandler', arrowHandler);
    }
  }, {
    key: "autoEvent",
    get: function get() {
      return this.getAttribute('autoEvent');
    },
    set: function set(autoEvent) {
      this.setAttribute('autoEvent', autoEvent);
    }
  }, {
    key: "axisLock",
    get: function get() {
    ...
    set: function set(badgeText) {
      this.setAttribute('badgeText', badgeText);
    }
  }, {
    key: "bind",
    get: function get() {
    ...
    set: function set(buttonType) {
      this.setAttribute('buttonType', buttonType);
    }
  }, {
    key: "centered",
    get: function get() {
    ...
    key: "enableToggle",
    get: function get() {
      return this.getAttribute('enableToggle');
    },
    set: function set(enableToggle) {
    ...
    key: "stretchMenu",
    get: function get() {
      return this.getAttribute('stretchMenu');
    },
    set: function set(stretchMenu) {
      this.setAttribute('stretchMenu', stretchMenu);
    }
  }, {
    key: "style",
    get: function get() {
    ...
    key: "toggleHandler",
    get: function get() {
      return this.getAttribute('toggleHandler');
    },
    set: function set(toggleHandler) {
  ...
  function ExtSplitbuttonComponent() {
    ...
    _this.METHODS = ExtSplitbuttonComponent.METHODS();
    _this.XTYPE = ExtSplitbuttonComponent.XTYPE(); //this.PROPERTIES = ExtSplitbuttonComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtSplitbuttonComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtSplitbuttonComponent.EVENTS();
    return _this;
  }

  var _proto = ExtSplitbuttonComponent.prototype;
