...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtIndexbarComponent, _ExtBase);

  ExtIndexbarComponent.XTYPE = function XTYPE() {
    return 'indexbar';
  };

  ExtIndexbarComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtIndexbarComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
      ...
      name: 'index',
      parameters: 'indexbar,html,target'
    }, {
      name: 'initialize',
      parameters: 'sender'
    }, {
  ...
  ExtIndexbarComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtIndexbarComponent, [{
    key: "alignSelf",
    get: function get() {
    ...
    set: function set(letters) {
      this.setAttribute('letters', letters);
    }
  }, {
    key: "listeners",
    get: function get() {
    ...
    key: "listPrefix",
    get: function get() {
      return this.getAttribute('listPrefix');
    },
    set: function set(listPrefix) {
      this.setAttribute('listPrefix', listPrefix);
    }
  }, {
    key: "margin",
    get: function get() {
  ...
  function ExtIndexbarComponent() {
    ...
    _this.METHODS = ExtIndexbarComponent.METHODS();
    _this.XTYPE = ExtIndexbarComponent.XTYPE(); //this.PROPERTIES = ExtIndexbarComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtIndexbarComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtIndexbarComponent.EVENTS();
    return _this;
  }

  var _proto = ExtIndexbarComponent.prototype;
