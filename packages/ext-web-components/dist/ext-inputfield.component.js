...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtInputfieldComponent, _ExtBase);

  ExtInputfieldComponent.XTYPE = function XTYPE() {
    return 'inputfield';
  };

  ExtInputfieldComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtInputfieldComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
      ...
      name: 'change',
      parameters: 'inputfield,newValue,oldValue'
    }, {
      name: 'click',
      parameters: 'e'
    }, {
  ...
  ExtInputfieldComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtInputfieldComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtInputfieldComponent() {
    ...
    _this.METHODS = ExtInputfieldComponent.METHODS();
    _this.XTYPE = ExtInputfieldComponent.XTYPE(); //this.PROPERTIES = ExtInputfieldComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtInputfieldComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtInputfieldComponent.EVENTS();
    return _this;
  }

  var _proto = ExtInputfieldComponent.prototype;
