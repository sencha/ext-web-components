...
function (_ExtBase) {
  ...
  ExtCalendar_weeksComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtCalendar_weeksComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtCalendar_weeksComponent, [{
  ...
  function ExtCalendar_weeksComponent() {
    ...
    _this.METHODS = ExtCalendar_weeksComponent.METHODS();
    _this.XTYPE = ExtCalendar_weeksComponent.XTYPE(); //this.PROPERTIES = ExtCalendar_weeksComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtCalendar_weeksComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtCalendar_weeksComponent.EVENTS();
    return _this;
  }

  var _proto = ExtCalendar_weeksComponent.prototype;
