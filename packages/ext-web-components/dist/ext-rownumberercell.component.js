...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtRownumberercellComponent, _ExtBase);

  ExtRownumberercellComponent.XTYPE = function XTYPE() {
    return 'rownumberercell';
  };

  ExtRownumberercellComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    var _ref;
  ...
  ExtRownumberercellComponent.EVENTS = function EVENTS() {
    return [{
  ...
  ExtRownumberercellComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtRownumberercellComponent, [{
    key: "align",
    get: function get() {
  ...
  function ExtRownumberercellComponent() {
    ...
    _this.METHODS = ExtRownumberercellComponent.METHODS();
    _this.XTYPE = ExtRownumberercellComponent.XTYPE(); //this.PROPERTIES = ExtRownumberercellComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtRownumberercellComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtRownumberercellComponent.EVENTS();
    return _this;
  }

  var _proto = ExtRownumberercellComponent.prototype;
