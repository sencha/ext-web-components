...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtGridgroupbythismenuitemComponent, _ExtBase);

  ExtGridgroupbythismenuitemComponent.XTYPE = function XTYPE() {
    return 'gridgroupbythismenuitem';
  };

  ExtGridgroupbythismenuitemComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtGridgroupbythismenuitemComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
      ...
      name: 'beforetofront',
      parameters: 'gridgroupbythismenuitem'
    }, {
      ...
      name: 'blur',
      parameters: 'gridgroupbythismenuitem,event'
    }, {
      name: 'bottomchange',
  ...
  ExtGridgroupbythismenuitemComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtGridgroupbythismenuitemComponent, [{
    key: "alwaysOnTop",
    get: function get() {
  ...
  function ExtGridgroupbythismenuitemComponent() {
    ...
    _this.METHODS = ExtGridgroupbythismenuitemComponent.METHODS();
    _this.XTYPE = ExtGridgroupbythismenuitemComponent.XTYPE(); //this.PROPERTIES = ExtGridgroupbythismenuitemComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtGridgroupbythismenuitemComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtGridgroupbythismenuitemComponent.EVENTS();
    return _this;
  }

  var _proto = ExtGridgroupbythismenuitemComponent.prototype;
