...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtSparklinebarComponent, _ExtBase);

  ExtSparklinebarComponent.XTYPE = function XTYPE() {
    return 'sparklinebar';
  };

  ExtSparklinebarComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtSparklinebarComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtSparklinebarComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtSparklinebarComponent, [{
    key: "alignSelf",
    get: function get() {
    ...
    key: "barColor",
    get: function get() {
      return this.getAttribute('barColor');
    },
    set: function set(barColor) {
      this.setAttribute('barColor', barColor);
    }
  }, {
    key: "barSpacing",
    get: function get() {
      return this.getAttribute('barSpacing');
    },
    set: function set(barSpacing) {
      this.setAttribute('barSpacing', barSpacing);
    }
  }, {
    key: "barWidth",
    get: function get() {
      return this.getAttribute('barWidth');
    },
    set: function set(barWidth) {
      this.setAttribute('barWidth', barWidth);
    }
  }, {
    key: "bind",
    get: function get() {
    ...
    key: "chartRangeClip",
    get: function get() {
      return this.getAttribute('chartRangeClip');
    },
    set: function set(chartRangeClip) {
      this.setAttribute('chartRangeClip', chartRangeClip);
    }
  }, {
    key: "chartRangeMax",
    get: function get() {
    ...
    key: "colorMap",
    get: function get() {
      return this.getAttribute('colorMap');
    },
    set: function set(colorMap) {
      this.setAttribute('colorMap', colorMap);
    }
  }, {
    key: "constrainAlign",
    get: function get() {
    ...
    key: "negBarColor",
    get: function get() {
      return this.getAttribute('negBarColor');
    },
    set: function set(negBarColor) {
      this.setAttribute('negBarColor', negBarColor);
    }
  }, {
    key: "nullColor",
    get: function get() {
      return this.getAttribute('nullColor');
    },
    set: function set(nullColor) {
      this.setAttribute('nullColor', nullColor);
    }
  }, {
    key: "padding",
    get: function get() {
    ...
    key: "stackedBarColor",
    get: function get() {
      return this.getAttribute('stackedBarColor');
    },
    set: function set(stackedBarColor) {
      this.setAttribute('stackedBarColor', stackedBarColor);
    }
  }, {
    key: "stateful",
    get: function get() {
    ...
    key: "zeroAxis",
    get: function get() {
      return this.getAttribute('zeroAxis');
    },
    set: function set(zeroAxis) {
      this.setAttribute('zeroAxis', zeroAxis);
    }
  }, {
    key: "zeroColor",
    get: function get() {
      return this.getAttribute('zeroColor');
    },
    set: function set(zeroColor) {
      this.setAttribute('zeroColor', zeroColor);
    }
  }, {
    key: "zIndex",
    get: function get() {
  ...
  function ExtSparklinebarComponent() {
    ...
    _this.METHODS = ExtSparklinebarComponent.METHODS();
    _this.XTYPE = ExtSparklinebarComponent.XTYPE(); //this.PROPERTIES = ExtSparklinebarComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtSparklinebarComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtSparklinebarComponent.EVENTS();
    return _this;
  }

  var _proto = ExtSparklinebarComponent.prototype;
