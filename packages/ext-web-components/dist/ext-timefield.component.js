...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtTimefieldComponent, _ExtBase);

  ExtTimefieldComponent.XTYPE = function XTYPE() {
    return 'timefield';
  };

  ExtTimefieldComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
      "alignTarget": ["string"],
  ...
  ExtTimefieldComponent.EVENTS = function EVENTS() {
    return [{
      name: 'action',
  ...
  ExtTimefieldComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtTimefieldComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtTimefieldComponent() {
    ...
    _this.METHODS = ExtTimefieldComponent.METHODS();
    _this.XTYPE = ExtTimefieldComponent.XTYPE(); //this.PROPERTIES = ExtTimefieldComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtTimefieldComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtTimefieldComponent.EVENTS();
    return _this;
  }

  var _proto = ExtTimefieldComponent.prototype;
