...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtChartComponent, _ExtBase);

  ExtChartComponent.XTYPE = function XTYPE() {
    return 'chart';
  };

  ExtChartComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtChartComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtChartComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtChartComponent, [{
  ...
  function ExtChartComponent() {
    ...
    _this.METHODS = ExtChartComponent.METHODS();
    _this.XTYPE = ExtChartComponent.XTYPE(); //this.PROPERTIES = ExtChartComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtChartComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtChartComponent.EVENTS();
    return _this;
  }

  var _proto = ExtChartComponent.prototype;
