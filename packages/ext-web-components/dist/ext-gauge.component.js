...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtGaugeComponent, _ExtBase);

  ExtGaugeComponent.XTYPE = function XTYPE() {
    return 'gauge';
  };

  ExtGaugeComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtGaugeComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtGaugeComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtGaugeComponent, [{
    key: "alwaysOnTop",
    get: function get() {
    ...
    key: "angleOffset",
    get: function get() {
      return this.getAttribute('angleOffset');
    },
    set: function set(angleOffset) {
      this.setAttribute('angleOffset', angleOffset);
    }
  }, {
    key: "animation",
    get: function get() {
    ...
    key: "clockwise",
    get: function get() {
      return this.getAttribute('clockwise');
    },
    set: function set(clockwise) {
      this.setAttribute('clockwise', clockwise);
    }
  }, {
    key: "cls",
    get: function get() {
    ...
    set: function set(needle) {
      this.setAttribute('needle', needle);
    }
  }, {
    key: "padding",
    get: function get() {
    ...
    key: "textOffset",
    get: function get() {
      return this.getAttribute('textOffset');
    },
    set: function set(textOffset) {
      this.setAttribute('textOffset', textOffset);
    }
  }, {
    key: "textTpl",
    get: function get() {
      return this.getAttribute('textTpl');
    },
    set: function set(textTpl) {
      this.setAttribute('textTpl', textTpl);
    }
  }, {
    key: "toFrontOnShow",
    get: function get() {
    ...
    key: "trackLength",
    get: function get() {
      return this.getAttribute('trackLength');
    },
    set: function set(trackLength) {
      this.setAttribute('trackLength', trackLength);
    }
  }, {
    key: "trackStart",
    get: function get() {
      return this.getAttribute('trackStart');
    },
    set: function set(trackStart) {
      this.setAttribute('trackStart', trackStart);
    }
  }, {
    key: "trackStyle",
    get: function get() {
      return this.getAttribute('trackStyle');
    },
    set: function set(trackStyle) {
      this.setAttribute('trackStyle', trackStyle);
    }
  }, {
    key: "translatable",
    get: function get() {
    ...
    key: "valueStyle",
    get: function get() {
      return this.getAttribute('valueStyle');
    },
    set: function set(valueStyle) {
      this.setAttribute('valueStyle', valueStyle);
    }
  }, {
    key: "viewModel",
    get: function get() {
  ...
  function ExtGaugeComponent() {
    ...
    _this.METHODS = ExtGaugeComponent.METHODS();
    _this.XTYPE = ExtGaugeComponent.XTYPE(); //this.PROPERTIES = ExtGaugeComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtGaugeComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtGaugeComponent.EVENTS();
    return _this;
  }

  var _proto = ExtGaugeComponent.prototype;
