...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtPaneltoolComponent, _ExtBase);

  ExtPaneltoolComponent.XTYPE = function XTYPE() {
    return 'paneltool';
  };

  ExtPaneltoolComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtPaneltoolComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtPaneltoolComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtPaneltoolComponent, [{
    key: "alignSelf",
    get: function get() {
    ...
    key: "passive",
    get: function get() {
      return this.getAttribute('passive');
    },
    set: function set(passive) {
      this.setAttribute('passive', passive);
    }
  }, {
    key: "plugins",
    get: function get() {
    ...
    key: "stopEvent",
    get: function get() {
      return this.getAttribute('stopEvent');
    },
    set: function set(stopEvent) {
      this.setAttribute('stopEvent', stopEvent);
    }
  }, {
    key: "style",
    get: function get() {
    ...
    key: "toolOwner",
    get: function get() {
      return this.getAttribute('toolOwner');
    },
    set: function set(toolOwner) {
      this.setAttribute('toolOwner', toolOwner);
    }
  }, {
    key: "tooltip",
    get: function get() {
  ...
  function ExtPaneltoolComponent() {
    ...
    _this.METHODS = ExtPaneltoolComponent.METHODS();
    _this.XTYPE = ExtPaneltoolComponent.XTYPE(); //this.PROPERTIES = ExtPaneltoolComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtPaneltoolComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtPaneltoolComponent.EVENTS();
    return _this;
  }

  var _proto = ExtPaneltoolComponent.prototype;
