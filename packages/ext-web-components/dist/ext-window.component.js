...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtWindowComponent, _ExtBase);

  ExtWindowComponent.XTYPE = function XTYPE() {
    return 'window';
  };

  ExtWindowComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtWindowComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtWindowComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtWindowComponent, [{
  ...
  function ExtWindowComponent() {
    ...
    _this.METHODS = ExtWindowComponent.METHODS();
    _this.XTYPE = ExtWindowComponent.XTYPE(); //this.PROPERTIES = ExtWindowComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtWindowComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtWindowComponent.EVENTS();
    return _this;
  }

  var _proto = ExtWindowComponent.prototype;
