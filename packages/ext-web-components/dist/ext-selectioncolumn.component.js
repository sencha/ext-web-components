...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtSelectioncolumnComponent, _ExtBase);

  ExtSelectioncolumnComponent.XTYPE = function XTYPE() {
    return 'selectioncolumn';
  };

  ExtSelectioncolumnComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    var _ref;
  ...
  ExtSelectioncolumnComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtSelectioncolumnComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtSelectioncolumnComponent, [{
  ...
  function ExtSelectioncolumnComponent() {
    ...
    _this.METHODS = ExtSelectioncolumnComponent.METHODS();
    _this.XTYPE = ExtSelectioncolumnComponent.XTYPE(); //this.PROPERTIES = ExtSelectioncolumnComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtSelectioncolumnComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtSelectioncolumnComponent.EVENTS();
    return _this;
  }

  var _proto = ExtSelectioncolumnComponent.prototype;
