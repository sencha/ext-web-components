...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtSinglesliderfieldComponent, _ExtBase);

  ExtSinglesliderfieldComponent.XTYPE = function XTYPE() {
    return 'singlesliderfield';
  };

  ExtSinglesliderfieldComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtSinglesliderfieldComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtSinglesliderfieldComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtSinglesliderfieldComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtSinglesliderfieldComponent() {
    ...
    _this.METHODS = ExtSinglesliderfieldComponent.METHODS();
    _this.XTYPE = ExtSinglesliderfieldComponent.XTYPE(); //this.PROPERTIES = ExtSinglesliderfieldComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtSinglesliderfieldComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtSinglesliderfieldComponent.EVENTS();
    return _this;
  }

  var _proto = ExtSinglesliderfieldComponent.prototype;
