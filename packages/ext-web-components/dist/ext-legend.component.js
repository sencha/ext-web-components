...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtLegendComponent, _ExtBase);

  ExtLegendComponent.XTYPE = function XTYPE() {
    return 'legend';
  };

  ExtLegendComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtLegendComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtLegendComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtLegendComponent, [{
    ...
    key: "toggleable",
    get: function get() {
      return this.getAttribute('toggleable');
    },
    set: function set(toggleable) {
      this.setAttribute('toggleable', toggleable);
    }
  }, {
    key: "tooltip",
    get: function get() {
  ...
  function ExtLegendComponent() {
    ...
    _this.METHODS = ExtLegendComponent.METHODS();
    _this.XTYPE = ExtLegendComponent.XTYPE(); //this.PROPERTIES = ExtLegendComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtLegendComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtLegendComponent.EVENTS();
    return _this;
  }

  var _proto = ExtLegendComponent.prototype;
