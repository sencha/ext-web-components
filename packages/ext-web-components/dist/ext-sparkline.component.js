...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtSparklineComponent, _ExtBase);

  ExtSparklineComponent.XTYPE = function XTYPE() {
    return 'sparkline';
  };

  ExtSparklineComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtSparklineComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtSparklineComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtSparklineComponent, [{
    key: "alwaysOnTop",
    get: function get() {
  ...
  function ExtSparklineComponent() {
    ...
    _this.METHODS = ExtSparklineComponent.METHODS();
    _this.XTYPE = ExtSparklineComponent.XTYPE(); //this.PROPERTIES = ExtSparklineComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtSparklineComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtSparklineComponent.EVENTS();
    return _this;
  }

  var _proto = ExtSparklineComponent.prototype;
