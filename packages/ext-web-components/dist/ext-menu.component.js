...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtMenuComponent, _ExtBase);

  ExtMenuComponent.XTYPE = function XTYPE() {
    return 'menu';
  };

  ExtMenuComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    var _ref;
  ...
  ExtMenuComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtMenuComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtMenuComponent, [{
    ...
    key: "allowOtherMenus",
    get: function get() {
      return this.getAttribute('allowOtherMenus');
    },
    set: function set(allowOtherMenus) {
    ...
    key: "ignoreParentClicks",
    get: function get() {
      return this.getAttribute('ignoreParentClicks');
    },
    set: function set(ignoreParentClicks) {
    ...
    key: "mouseLeaveDelay",
    get: function get() {
      return this.getAttribute('mouseLeaveDelay');
    },
    set: function set(mouseLeaveDelay) {
      this.setAttribute('mouseLeaveDelay', mouseLeaveDelay);
    }
  }, {
    key: "name",
    get: function get() {
  ...
  function ExtMenuComponent() {
    ...
    _this.METHODS = ExtMenuComponent.METHODS();
    _this.XTYPE = ExtMenuComponent.XTYPE(); //this.PROPERTIES = ExtMenuComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtMenuComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtMenuComponent.EVENTS();
    return _this;
  }

  var _proto = ExtMenuComponent.prototype;
