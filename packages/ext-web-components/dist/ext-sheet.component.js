...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtSheetComponent, _ExtBase);

  ExtSheetComponent.XTYPE = function XTYPE() {
    return 'sheet';
  };

  ExtSheetComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtSheetComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtSheetComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtSheetComponent, [{
  ...
  function ExtSheetComponent() {
    ...
    _this.METHODS = ExtSheetComponent.METHODS();
    _this.XTYPE = ExtSheetComponent.XTYPE(); //this.PROPERTIES = ExtSheetComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtSheetComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtSheetComponent.EVENTS();
    return _this;
  }

  var _proto = ExtSheetComponent.prototype;
