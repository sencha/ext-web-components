...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtLockedgridComponent, _ExtBase);

  ExtLockedgridComponent.XTYPE = function XTYPE() {
    return 'lockedgrid';
  };

  ExtLockedgridComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtLockedgridComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtLockedgridComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtLockedgridComponent, [{
    ...
    key: "defaultLockedRegion",
    get: function get() {
      return this.getAttribute('defaultLockedRegion');
    },
    set: function set(defaultLockedRegion) {
      this.setAttribute('defaultLockedRegion', defaultLockedRegion);
    }
  }, {
    key: "defaults",
    get: function get() {
    ...
    key: "gridDefaults",
    get: function get() {
      return this.getAttribute('gridDefaults');
    },
    set: function set(gridDefaults) {
      this.setAttribute('gridDefaults', gridDefaults);
    }
  }, {
    key: "height",
    get: function get() {
    ...
    key: "leftGridDefaults",
    get: function get() {
      return this.getAttribute('leftGridDefaults');
    },
    set: function set(leftGridDefaults) {
      this.setAttribute('leftGridDefaults', leftGridDefaults);
    }
  }, {
    key: "listeners",
    get: function get() {
    ...
    key: "regions",
    get: function get() {
      return this.getAttribute('regions');
    },
    ...
    key: "rightGridDefaults",
    get: function get() {
      return this.getAttribute('rightGridDefaults');
    },
    set: function set(rightGridDefaults) {
      this.setAttribute('rightGridDefaults', rightGridDefaults);
    }
  }, {
    key: "ripple",
    get: function get() {
  ...
  function ExtLockedgridComponent() {
    ...
    _this.METHODS = ExtLockedgridComponent.METHODS();
    _this.XTYPE = ExtLockedgridComponent.XTYPE(); //this.PROPERTIES = ExtLockedgridComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtLockedgridComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtLockedgridComponent.EVENTS();
    return _this;
  }

  var _proto = ExtLockedgridComponent.prototype;
