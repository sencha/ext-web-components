...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtIndicatorComponent, _ExtBase);

  ExtIndicatorComponent.XTYPE = function XTYPE() {
    return 'indicator';
  };

  ExtIndicatorComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "activeIndex": ["number"],
      "alignSelf": ["string"],
  ...
  ExtIndicatorComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtIndicatorComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtIndicatorComponent, [{
    key: "activeIndex",
    get: function get() {
      return this.getAttribute('activeIndex');
    },
    set: function set(activeIndex) {
      this.setAttribute('activeIndex', activeIndex);
    }
  }, {
    key: "alignSelf",
    get: function get() {
    ...
    key: "tapMode",
    get: function get() {
      return this.getAttribute('tapMode');
    },
    set: function set(tapMode) {
      this.setAttribute('tapMode', tapMode);
    }
  }, {
    key: "toFrontOnShow",
    get: function get() {
  ...
  function ExtIndicatorComponent() {
    ...
    _this.METHODS = ExtIndicatorComponent.METHODS();
    _this.XTYPE = ExtIndicatorComponent.XTYPE(); //this.PROPERTIES = ExtIndicatorComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtIndicatorComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtIndicatorComponent.EVENTS();
    return _this;
  }

  var _proto = ExtIndicatorComponent.prototype;
