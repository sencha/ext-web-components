...
function (_ExtBase) {
  ...
  ExtD3_packComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtD3_packComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtD3_packComponent, [{
    key: "alignSelf",
    get: function get() {
    ...
    key: "clipText",
    get: function get() {
      return this.getAttribute('clipText');
    },
    set: function set(clipText) {
      this.setAttribute('clipText', clipText);
    }
  }, {
    key: "cls",
    get: function get() {
  ...
  function ExtD3_packComponent() {
    ...
    _this.METHODS = ExtD3_packComponent.METHODS();
    _this.XTYPE = ExtD3_packComponent.XTYPE(); //this.PROPERTIES = ExtD3_packComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtD3_packComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtD3_packComponent.EVENTS();
    return _this;
  }

  var _proto = ExtD3_packComponent.prototype;
