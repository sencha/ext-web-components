...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtUrlfieldComponent, _ExtBase);

  ExtUrlfieldComponent.XTYPE = function XTYPE() {
    return 'urlfield';
  };

  ExtUrlfieldComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtUrlfieldComponent.EVENTS = function EVENTS() {
    return [{
      name: 'action',
      parameters: 'urlfield,e'
    }, {
      name: 'added',
      ...
      name: 'change',
      parameters: 'urlfield,newValue,oldValue'
    }, {
      name: 'clearicontap',
      parameters: 'urlfield,input,e'
    }, {
      name: 'click',
      parameters: 'e'
    }, {
  ...
  ExtUrlfieldComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtUrlfieldComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtUrlfieldComponent() {
    ...
    _this.METHODS = ExtUrlfieldComponent.METHODS();
    _this.XTYPE = ExtUrlfieldComponent.XTYPE(); //this.PROPERTIES = ExtUrlfieldComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtUrlfieldComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtUrlfieldComponent.EVENTS();
    return _this;
  }

  var _proto = ExtUrlfieldComponent.prototype;
