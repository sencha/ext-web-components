...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtComponentComponent, _ExtBase);

  ExtComponentComponent.XTYPE = function XTYPE() {
    return 'component';
  };

  ExtComponentComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtComponentComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtComponentComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtComponentComponent, [{
    key: "alwaysOnTop",
    get: function get() {
  ...
  function ExtComponentComponent() {
    ...
    _this.METHODS = ExtComponentComponent.METHODS();
    _this.XTYPE = ExtComponentComponent.XTYPE(); //this.PROPERTIES = ExtComponentComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtComponentComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtComponentComponent.EVENTS();
    return _this;
  }

  var _proto = ExtComponentComponent.prototype;
