...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtTreecolumnComponent, _ExtBase);

  ExtTreecolumnComponent.XTYPE = function XTYPE() {
    return 'treecolumn';
  };

  ExtTreecolumnComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    var _ref;
  ...
  ExtTreecolumnComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtTreecolumnComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtTreecolumnComponent, [{
  ...
  function ExtTreecolumnComponent() {
    ...
    _this.METHODS = ExtTreecolumnComponent.METHODS();
    _this.XTYPE = ExtTreecolumnComponent.XTYPE(); //this.PROPERTIES = ExtTreecolumnComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtTreecolumnComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtTreecolumnComponent.EVENTS();
    return _this;
  }

  var _proto = ExtTreecolumnComponent.prototype;
