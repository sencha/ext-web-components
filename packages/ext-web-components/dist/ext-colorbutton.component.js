...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtColorbuttonComponent, _ExtBase);

  ExtColorbuttonComponent.XTYPE = function XTYPE() {
    return 'colorbutton';
  };

  ExtColorbuttonComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtColorbuttonComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
      ...
      name: 'change',
      parameters: 'colorbutton,color,previousColor'
    }, {
      name: 'destroy',
      parameters: ''
    }, {
  ...
  ExtColorbuttonComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtColorbuttonComponent, [{
  ...
  function ExtColorbuttonComponent() {
    ...
    _this.METHODS = ExtColorbuttonComponent.METHODS();
    _this.XTYPE = ExtColorbuttonComponent.XTYPE(); //this.PROPERTIES = ExtColorbuttonComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtColorbuttonComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtColorbuttonComponent.EVENTS();
    return _this;
  }

  var _proto = ExtColorbuttonComponent.prototype;
