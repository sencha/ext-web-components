...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtSparklinetristateComponent, _ExtBase);

  ExtSparklinetristateComponent.XTYPE = function XTYPE() {
    return 'sparklinetristate';
  };

  ExtSparklinetristateComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtSparklinetristateComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
      ...
      name: 'blur',
      parameters: 'sparklinetristate,event'
    }, {
      name: 'bottomchange',
  ...
  ExtSparklinetristateComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtSparklinetristateComponent, [{
    key: "alwaysOnTop",
    get: function get() {
    ...
    key: "posBarColor",
    get: function get() {
      return this.getAttribute('posBarColor');
    },
    set: function set(posBarColor) {
      this.setAttribute('posBarColor', posBarColor);
    }
  }, {
    key: "publishes",
    get: function get() {
    ...
    key: "zeroBarColor",
    get: function get() {
      return this.getAttribute('zeroBarColor');
    },
    set: function set(zeroBarColor) {
      this.setAttribute('zeroBarColor', zeroBarColor);
    }
  }, {
    key: "zIndex",
    get: function get() {
  ...
  function ExtSparklinetristateComponent() {
    ...
    _this.METHODS = ExtSparklinetristateComponent.METHODS();
    _this.XTYPE = ExtSparklinetristateComponent.XTYPE(); //this.PROPERTIES = ExtSparklinetristateComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtSparklinetristateComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtSparklinetristateComponent.EVENTS();
    return _this;
  }

  var _proto = ExtSparklinetristateComponent.prototype;
