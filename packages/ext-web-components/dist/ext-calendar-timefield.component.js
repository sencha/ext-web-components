...
function (_ExtBase) {
  ...
  ExtCalendar_timefieldComponent.EVENTS = function EVENTS() {
    return [{
      name: 'action',
  ...
  ExtCalendar_timefieldComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtCalendar_timefieldComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtCalendar_timefieldComponent() {
    ...
    _this.METHODS = ExtCalendar_timefieldComponent.METHODS();
    _this.XTYPE = ExtCalendar_timefieldComponent.XTYPE(); //this.PROPERTIES = ExtCalendar_timefieldComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtCalendar_timefieldComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtCalendar_timefieldComponent.EVENTS();
    return _this;
  }

  var _proto = ExtCalendar_timefieldComponent.prototype;
