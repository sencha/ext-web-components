...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtAccordionComponent, _ExtBase);

  ExtAccordionComponent.XTYPE = function XTYPE() {
    return 'accordion';
  };

  ExtAccordionComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtAccordionComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtAccordionComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtAccordionComponent, [{
    ...
    key: "defaultPanelUI",
    get: function get() {
      return this.getAttribute('defaultPanelUI');
    },
    set: function set(defaultPanelUI) {
      this.setAttribute('defaultPanelUI', defaultPanelUI);
    }
  }, {
    key: "defaults",
    get: function get() {
    ...
    key: "expandedFirst",
    get: function get() {
      return this.getAttribute('expandedFirst');
    },
    set: function set(expandedFirst) {
      this.setAttribute('expandedFirst', expandedFirst);
    }
  }, {
    key: "flex",
    get: function get() {
    ...
    key: "openable",
    get: function get() {
      return this.getAttribute('openable');
    },
    set: function set(openable) {
      this.setAttribute('openable', openable);
    }
  }, {
    key: "padding",
    get: function get() {
  ...
  function ExtAccordionComponent() {
    ...
    _this.METHODS = ExtAccordionComponent.METHODS();
    _this.XTYPE = ExtAccordionComponent.XTYPE(); //this.PROPERTIES = ExtAccordionComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtAccordionComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtAccordionComponent.EVENTS();
    return _this;
  }

  var _proto = ExtAccordionComponent.prototype;
