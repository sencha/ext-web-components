...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtColorfieldComponent, _ExtBase);

  ExtColorfieldComponent.XTYPE = function XTYPE() {
    return 'colorfield';
  };

  ExtColorfieldComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
      "alignTarget": ["string"],
  ...
  ExtColorfieldComponent.EVENTS = function EVENTS() {
    return [{
      name: 'action',
  ...
  ExtColorfieldComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtColorfieldComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtColorfieldComponent() {
    ...
    _this.METHODS = ExtColorfieldComponent.METHODS();
    _this.XTYPE = ExtColorfieldComponent.XTYPE(); //this.PROPERTIES = ExtColorfieldComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtColorfieldComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtColorfieldComponent.EVENTS();
    return _this;
  }

  var _proto = ExtColorfieldComponent.prototype;
