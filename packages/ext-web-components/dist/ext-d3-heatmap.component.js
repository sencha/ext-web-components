...
function (_ExtBase) {
  ...
  ExtD3_heatmapComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtD3_heatmapComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtD3_heatmapComponent, [{
    key: "alwaysOnTop",
    get: function get() {
  ...
  function ExtD3_heatmapComponent() {
    ...
    _this.METHODS = ExtD3_heatmapComponent.METHODS();
    _this.XTYPE = ExtD3_heatmapComponent.XTYPE(); //this.PROPERTIES = ExtD3_heatmapComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtD3_heatmapComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtD3_heatmapComponent.EVENTS();
    return _this;
  }

  var _proto = ExtD3_heatmapComponent.prototype;
