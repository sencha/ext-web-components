...
function (_ExtBase) {
  ...
  ExtCalendar_listComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtCalendar_listComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtCalendar_listComponent, [{
  ...
  function ExtCalendar_listComponent() {
    ...
    _this.METHODS = ExtCalendar_listComponent.METHODS();
    _this.XTYPE = ExtCalendar_listComponent.XTYPE(); //this.PROPERTIES = ExtCalendar_listComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtCalendar_listComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtCalendar_listComponent.EVENTS();
    return _this;
  }

  var _proto = ExtCalendar_listComponent.prototype;
