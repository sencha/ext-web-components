...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtViewportComponent, _ExtBase);

  ExtViewportComponent.XTYPE = function XTYPE() {
    return 'viewport';
  };

  ExtViewportComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtViewportComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtViewportComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtViewportComponent, [{
    ...
    key: "autoBlurInput",
    get: function get() {
      return this.getAttribute('autoBlurInput');
    },
    set: function set(autoBlurInput) {
      this.setAttribute('autoBlurInput', autoBlurInput);
    }
  }, {
    key: "autoDestroy",
    get: function get() {
    ...
    key: "autoMaximize",
    get: function get() {
      return this.getAttribute('autoMaximize');
    },
    set: function set(autoMaximize) {
      this.setAttribute('autoMaximize', autoMaximize);
    }
  }, {
    key: "autoRender",
    get: function get() {
      return this.getAttribute('autoRender');
    },
    set: function set(autoRender) {
      this.setAttribute('autoRender', autoRender);
    }
  }, {
    key: "autoSize",
    get: function get() {
    ...
    key: "menus",
    get: function get() {
      return this.getAttribute('menus');
    },
    set: function set(menus) {
      this.setAttribute('menus', menus);
    }
  }, {
    key: "minHeight",
    get: function get() {
    ...
    key: "preventZooming",
    get: function get() {
      return this.getAttribute('preventZooming');
    },
    set: function set(preventZooming) {
      this.setAttribute('preventZooming', preventZooming);
    }
  }, {
    key: "publishes",
    get: function get() {
    ...
    key: "swipeThreshold",
    get: function get() {
      return this.getAttribute('swipeThreshold');
    },
    set: function set(swipeThreshold) {
      this.setAttribute('swipeThreshold', swipeThreshold);
    }
  }, {
    key: "tabIndex",
    get: function get() {
  ...
  function ExtViewportComponent() {
    ...
    _this.METHODS = ExtViewportComponent.METHODS();
    _this.XTYPE = ExtViewportComponent.XTYPE(); //this.PROPERTIES = ExtViewportComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtViewportComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtViewportComponent.EVENTS();
    return _this;
  }

  var _proto = ExtViewportComponent.prototype;
