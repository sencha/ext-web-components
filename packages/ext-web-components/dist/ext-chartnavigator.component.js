...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtChartnavigatorComponent, _ExtBase);

  ExtChartnavigatorComponent.XTYPE = function XTYPE() {
    return 'chartnavigator';
  };

  ExtChartnavigatorComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtChartnavigatorComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'newActiveItem,chartnavigator,oldActiveItem'
    }, {
      name: 'activeItemchange',
      parameters: 'sender,value,oldValue'
    }, {
      name: 'add',
      parameters: 'chartnavigator,item,index'
    }, {
      name: 'added',
      ...
      name: 'blur',
      parameters: 'chartnavigator,event'
    }, {
      name: 'bottomchange',
      parameters: 'sender,value,oldValue'
    }, {
      ...
      name: 'deactivate',
      parameters: 'oldActiveItem,chartnavigator,newActiveItem'
    }, {
      name: 'destroy',
      parameters: ''
    }, {
      ...
      name: 'move',
      parameters: 'chartnavigator,item,toIndex,fromIndex'
    }, {
      name: 'moved',
      ...
      name: 'renderedchange',
      parameters: 'chartnavigator,item,rendered'
    }, {
      name: 'resize',
  ...
  ExtChartnavigatorComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtChartnavigatorComponent, [{
    ...
    key: "navigator",
    get: function get() {
      return this.getAttribute('navigator');
    },
    set: function set(navigator) {
      this.setAttribute('navigator', navigator);
    }
  }, {
    key: "padding",
    get: function get() {
  ...
  function ExtChartnavigatorComponent() {
    ...
    _this.METHODS = ExtChartnavigatorComponent.METHODS();
    _this.XTYPE = ExtChartnavigatorComponent.XTYPE(); //this.PROPERTIES = ExtChartnavigatorComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtChartnavigatorComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtChartnavigatorComponent.EVENTS();
    return _this;
  }

  var _proto = ExtChartnavigatorComponent.prototype;
