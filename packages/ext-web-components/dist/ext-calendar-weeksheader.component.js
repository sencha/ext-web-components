...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtCalendar_weeksheaderComponent, _ExtBase);

  ExtCalendar_weeksheaderComponent.XTYPE = function XTYPE() {
    return 'calendar_weeksheader';
  };

  ExtCalendar_weeksheaderComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtCalendar_weeksheaderComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
      ...
      name: 'beforetofront',
      parameters: 'calendar-weeksheader'
    }, {
      ...
      name: 'blur',
      parameters: 'calendar-weeksheader,event'
    }, {
      name: 'bottomchange',
  ...
  ExtCalendar_weeksheaderComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtCalendar_weeksheaderComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtCalendar_weeksheaderComponent() {
    ...
    _this.METHODS = ExtCalendar_weeksheaderComponent.METHODS();
    _this.XTYPE = ExtCalendar_weeksheaderComponent.XTYPE(); //this.PROPERTIES = ExtCalendar_weeksheaderComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtCalendar_weeksheaderComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtCalendar_weeksheaderComponent.EVENTS();
    return _this;
  }

  var _proto = ExtCalendar_weeksheaderComponent.prototype;
