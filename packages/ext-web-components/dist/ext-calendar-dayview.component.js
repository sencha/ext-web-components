...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtCalendar_dayviewComponent, _ExtBase);

  ExtCalendar_dayviewComponent.XTYPE = function XTYPE() {
    return 'calendar_dayview';
  };

  ExtCalendar_dayviewComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "addForm": "Object",
  ...
  ExtCalendar_dayviewComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtCalendar_dayviewComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtCalendar_dayviewComponent, [{
    key: "addForm",
    get: function get() {
  ...
  function ExtCalendar_dayviewComponent() {
    ...
    _this.METHODS = ExtCalendar_dayviewComponent.METHODS();
    _this.XTYPE = ExtCalendar_dayviewComponent.XTYPE(); //this.PROPERTIES = ExtCalendar_dayviewComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtCalendar_dayviewComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtCalendar_dayviewComponent.EVENTS();
    return _this;
  }

  var _proto = ExtCalendar_dayviewComponent.prototype;
