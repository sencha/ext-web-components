...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtSliderfieldComponent, _ExtBase);

  ExtSliderfieldComponent.XTYPE = function XTYPE() {
    return 'sliderfield';
  };

  ExtSliderfieldComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtSliderfieldComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
      ...
      name: 'drag',
      parameters: 'sliderfield,sl,thumb,e'
    }, {
      name: 'dragchange',
      parameters: 'me,sl,thumb,newValue,oldValue'
    }, {
      name: 'dragend',
      parameters: 'sliderfield,sl,thumb,value,e'
    }, {
      name: 'dragstart',
      parameters: 'sliderfield,sl,thumb,value,e'
    }, {
  ...
  ExtSliderfieldComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtSliderfieldComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtSliderfieldComponent() {
    ...
    _this.METHODS = ExtSliderfieldComponent.METHODS();
    _this.XTYPE = ExtSliderfieldComponent.XTYPE(); //this.PROPERTIES = ExtSliderfieldComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtSliderfieldComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtSliderfieldComponent.EVENTS();
    return _this;
  }

  var _proto = ExtSliderfieldComponent.prototype;
