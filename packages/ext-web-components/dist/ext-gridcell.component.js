...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtGridcellComponent, _ExtBase);

  ExtGridcellComponent.XTYPE = function XTYPE() {
    return 'gridcell';
  };

  ExtGridcellComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    var _ref;
  ...
  ExtGridcellComponent.EVENTS = function EVENTS() {
    return [{
  ...
  ExtGridcellComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtGridcellComponent, [{
    key: "align",
    get: function get() {
  ...
  function ExtGridcellComponent() {
    ...
    _this.METHODS = ExtGridcellComponent.METHODS();
    _this.XTYPE = ExtGridcellComponent.XTYPE(); //this.PROPERTIES = ExtGridcellComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtGridcellComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtGridcellComponent.EVENTS();
    return _this;
  }

  var _proto = ExtGridcellComponent.prototype;
