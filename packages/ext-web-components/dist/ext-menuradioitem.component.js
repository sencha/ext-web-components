...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtMenuradioitemComponent, _ExtBase);

  ExtMenuradioitemComponent.XTYPE = function XTYPE() {
    return 'menuradioitem';
  };

  ExtMenuradioitemComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtMenuradioitemComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtMenuradioitemComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtMenuradioitemComponent, [{
    key: "allowUncheck",
    get: function get() {
  ...
  function ExtMenuradioitemComponent() {
    ...
    _this.METHODS = ExtMenuradioitemComponent.METHODS();
    _this.XTYPE = ExtMenuradioitemComponent.XTYPE(); //this.PROPERTIES = ExtMenuradioitemComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtMenuradioitemComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtMenuradioitemComponent.EVENTS();
    return _this;
  }

  var _proto = ExtMenuradioitemComponent.prototype;
