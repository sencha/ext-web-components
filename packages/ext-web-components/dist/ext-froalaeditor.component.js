...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtFroalaeditorComponent, _ExtBase);

  ExtFroalaeditorComponent.XTYPE = function XTYPE() {
    return 'froalaeditor';
  };

  ExtFroalaeditorComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtFroalaeditorComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtFroalaeditorComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtFroalaeditorComponent, [{
    key: "activationKey",
    get: function get() {
  ...
  function ExtFroalaeditorComponent() {
    ...
    _this.METHODS = ExtFroalaeditorComponent.METHODS();
    _this.XTYPE = ExtFroalaeditorComponent.XTYPE(); //this.PROPERTIES = ExtFroalaeditorComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtFroalaeditorComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtFroalaeditorComponent.EVENTS();
    return _this;
  }

  var _proto = ExtFroalaeditorComponent.prototype;
