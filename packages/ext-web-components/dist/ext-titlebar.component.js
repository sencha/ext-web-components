...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtTitlebarComponent, _ExtBase);

  ExtTitlebarComponent.XTYPE = function XTYPE() {
    return 'titlebar';
  };

  ExtTitlebarComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtTitlebarComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'newActiveItem,titlebar,oldActiveItem'
    }, {
      name: 'activeItemchange',
      parameters: 'sender,value,oldValue'
    }, {
      name: 'add',
      parameters: 'titlebar,item,index'
    }, {
      name: 'added',
      ...
      name: 'deactivate',
      parameters: 'oldActiveItem,titlebar,newActiveItem'
    }, {
      name: 'destroy',
      parameters: ''
    }, {
      ...
      name: 'move',
      parameters: 'titlebar,item,toIndex,fromIndex'
    }, {
      name: 'moved',
      ...
      name: 'renderedchange',
      parameters: 'titlebar,item,rendered'
    }, {
      name: 'resize',
  ...
  ExtTitlebarComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtTitlebarComponent, [{
    ...
    key: "maxButtonWidth",
    get: function get() {
      return this.getAttribute('maxButtonWidth');
    },
    set: function set(maxButtonWidth) {
      this.setAttribute('maxButtonWidth', maxButtonWidth);
    }
  }, {
    key: "maxHeight",
    get: function get() {
  ...
  function ExtTitlebarComponent() {
    ...
    _this.METHODS = ExtTitlebarComponent.METHODS();
    _this.XTYPE = ExtTitlebarComponent.XTYPE(); //this.PROPERTIES = ExtTitlebarComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtTitlebarComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtTitlebarComponent.EVENTS();
    return _this;
  }

  var _proto = ExtTitlebarComponent.prototype;
