...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtDisplayfieldComponent, _ExtBase);

  ExtDisplayfieldComponent.XTYPE = function XTYPE() {
    return 'displayfield';
  };

  ExtDisplayfieldComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtDisplayfieldComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
      ...
      name: 'change',
      parameters: 'displayfield,newValue,oldValue'
    }, {
      name: 'click',
      parameters: 'e'
    }, {
  ...
  ExtDisplayfieldComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtDisplayfieldComponent, [{
    key: "alignSelf",
    get: function get() {
    ...
    key: "focusable",
    get: function get() {
      return this.getAttribute('focusable');
    },
    set: function set(focusable) {
      this.setAttribute('focusable', focusable);
    }
  }, {
    key: "focusCls",
    get: function get() {
  ...
  function ExtDisplayfieldComponent() {
    ...
    _this.METHODS = ExtDisplayfieldComponent.METHODS();
    _this.XTYPE = ExtDisplayfieldComponent.XTYPE(); //this.PROPERTIES = ExtDisplayfieldComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtDisplayfieldComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtDisplayfieldComponent.EVENTS();
    return _this;
  }

  var _proto = ExtDisplayfieldComponent.prototype;
