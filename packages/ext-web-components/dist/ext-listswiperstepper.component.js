...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtListswiperstepperComponent, _ExtBase);

  ExtListswiperstepperComponent.XTYPE = function XTYPE() {
    return 'listswiperstepper';
  };

  ExtListswiperstepperComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "action": ["any"],
  ...
  ExtListswiperstepperComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtListswiperstepperComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtListswiperstepperComponent, [{
    key: "action",
    get: function get() {
  ...
  function ExtListswiperstepperComponent() {
    ...
    _this.METHODS = ExtListswiperstepperComponent.METHODS();
    _this.XTYPE = ExtListswiperstepperComponent.XTYPE(); //this.PROPERTIES = ExtListswiperstepperComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtListswiperstepperComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtListswiperstepperComponent.EVENTS();
    return _this;
  }

  var _proto = ExtListswiperstepperComponent.prototype;
