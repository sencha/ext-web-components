...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtImageComponent, _ExtBase);

  ExtImageComponent.XTYPE = function XTYPE() {
    return 'image';
  };

  ExtImageComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtImageComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtImageComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtImageComponent, [{
    key: "alwaysOnTop",
    get: function get() {
    ...
    key: "backgroundCls",
    get: function get() {
      return this.getAttribute('backgroundCls');
    },
    set: function set(backgroundCls) {
      this.setAttribute('backgroundCls', backgroundCls);
    }
  }, {
    key: "bind",
    get: function get() {
    ...
    key: "imageCls",
    get: function get() {
      return this.getAttribute('imageCls');
    },
    set: function set(imageCls) {
      this.setAttribute('imageCls', imageCls);
    }
  }, {
    key: "instanceCls",
    get: function get() {
  ...
  function ExtImageComponent() {
    ...
    _this.METHODS = ExtImageComponent.METHODS();
    _this.XTYPE = ExtImageComponent.XTYPE(); //this.PROPERTIES = ExtImageComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtImageComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtImageComponent.EVENTS();
    return _this;
  }

  var _proto = ExtImageComponent.prototype;
