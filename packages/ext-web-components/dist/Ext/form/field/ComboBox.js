...
function (_Ext_field_Select_Com) {
  ...
  function Ext_form_field_ComboBox_Component() {
    var _this;

    _this = _Ext_field_Select_Com.call(this, Ext_form_field_ComboBox_Component.METHODS(), Ext_form_field_ComboBox_Component.XTYPE(), Ext_form_field_ComboBox_Component.PROPERTIESOBJECT(), Ext_form_field_ComboBox_Component.EVENTS()) || this;
    _this.XTYPE = Ext_form_field_ComboBox_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_form_field_ComboBox_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_form_field_ComboBox_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_form_field_ComboBox_Component.EVENTS());
    return _this;
  }
