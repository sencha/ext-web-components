...
function (_Ext_field_Panel_Comp) {
  ...
  function Ext_form_Panel_Component() {
    var _this;

    _this = _Ext_field_Panel_Comp.call(this, Ext_form_Panel_Component.METHODS(), Ext_form_Panel_Component.XTYPE(), Ext_form_Panel_Component.PROPERTIESOBJECT(), Ext_form_Panel_Component.EVENTS()) || this;
    _this.XTYPE = Ext_form_Panel_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_form_Panel_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_form_Panel_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_form_Panel_Component.EVENTS());
    return _this;
  }
