...
function (_Ext_field_Input_Comp) {
  ...
  function Ext_form_Checkbox_Component(propertiesobject, methods, events) {
    return _Ext_field_Input_Comp.call(this, Object.assign(propertiesobject, Ext_form_Checkbox_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_form_Checkbox_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_form_Checkbox_Component.METHODS()), events.concat(Ext_form_Checkbox_Component.EVENTS())) || this; //this.XTYPE = Ext_form_Checkbox_Component.XTYPE()
