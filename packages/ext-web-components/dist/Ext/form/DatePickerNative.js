...
function (_Ext_field_Date_Compo) {
  ...
  function Ext_form_DatePickerNative_Component(propertiesobject, methods, events) {
    return _Ext_field_Date_Compo.call(this, Object.assign(propertiesobject, Ext_form_DatePickerNative_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_form_DatePickerNative_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_form_DatePickerNative_Component.METHODS()), events.concat(Ext_form_DatePickerNative_Component.EVENTS())) || this; //this.XTYPE = Ext_form_DatePickerNative_Component.XTYPE()
