...
function (_Ext_field_Text_Compo) {
  ...
  function Ext_form_Email_Component(propertiesobject, methods, events) {
    return _Ext_field_Text_Compo.call(this, Object.assign(propertiesobject, Ext_form_Email_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_form_Email_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_form_Email_Component.METHODS()), events.concat(Ext_form_Email_Component.EVENTS())) || this; //this.XTYPE = Ext_form_Email_Component.XTYPE()
