...
function (_Ext_field_Picker_Com) {
  ...
  function Ext_form_DatePicker_Component(propertiesobject, methods, events) {
    return _Ext_field_Picker_Com.call(this, Object.assign(propertiesobject, Ext_form_DatePicker_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_form_DatePicker_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_form_DatePicker_Component.METHODS()), events.concat(Ext_form_DatePicker_Component.EVENTS())) || this; //this.XTYPE = Ext_form_DatePicker_Component.XTYPE()
