...
function (_Ext_field_Field_Comp) {
  ...
  function Ext_form_Slider_Component(propertiesobject, methods, events) {
    return _Ext_field_Field_Comp.call(this, Object.assign(propertiesobject, Ext_form_Slider_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_form_Slider_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_form_Slider_Component.METHODS()), events.concat(Ext_form_Slider_Component.EVENTS())) || this; //this.XTYPE = Ext_form_Slider_Component.XTYPE()
