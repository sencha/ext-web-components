...
function (_Ext_field_SingleSlid) {
  ...
  function Ext_form_Toggle_Component() {
    var _this;

    _this = _Ext_field_SingleSlid.call(this, Ext_form_Toggle_Component.METHODS(), Ext_form_Toggle_Component.XTYPE(), Ext_form_Toggle_Component.PROPERTIESOBJECT(), Ext_form_Toggle_Component.EVENTS()) || this;
    _this.XTYPE = Ext_form_Toggle_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_form_Toggle_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_form_Toggle_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_form_Toggle_Component.EVENTS());
    return _this;
  }
