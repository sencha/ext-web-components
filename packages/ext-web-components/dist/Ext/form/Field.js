...
function (_Ext_Component_Compon) {
  ...
  function Ext_form_Field_Component(propertiesobject, methods, events) {
    return _Ext_Component_Compon.call(this, Object.assign(propertiesobject, Ext_form_Field_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_form_Field_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_form_Field_Component.METHODS()), events.concat(Ext_form_Field_Component.EVENTS())) || this; //this.XTYPE = Ext_form_Field_Component.XTYPE()
