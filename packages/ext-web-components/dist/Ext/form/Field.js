...
var Ext_form_Field_Component =
/*#__PURE__*/
function (_Ext_Component_Compon) {
  _inheritsLoose(Ext_form_Field_Component, _Ext_Component_Compon);

  //configs
  Ext_form_Field_Component.XTYPE = function XTYPE() {
    return 'field';
  };

  Ext_form_Field_Component.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  Ext_form_Field_Component.EVENTS = function EVENTS() {
    return [{
      name: 'change',
  ...
  Ext_form_Field_Component.METHODS = function METHODS() {
    return [{
  ...
  _createClass(Ext_form_Field_Component, [{
    key: "onchange",
    //events
    get: function get() {
  ...
  function Ext_form_Field_Component() {
    var _this;

    _this = _Ext_Component_Compon.call(this, Ext_form_Field_Component.METHODS(), Ext_form_Field_Component.XTYPE(), Ext_form_Field_Component.PROPERTIESOBJECT(), Ext_form_Field_Component.EVENTS()) || this;
    _this.XTYPE = Ext_form_Field_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_form_Field_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_form_Field_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_form_Field_Component.EVENTS());
    return _this;
  }

  var _proto = Ext_form_Field_Component.prototype;
  ...
  return Ext_form_Field_Component;
}(Ext_Component_Component);

export { Ext_form_Field_Component as default };