...
function (_Ext_Container_Compon) {
  ...
  function Ext_tab_Panel_Component(propertiesobject, methods, events) {
    return _Ext_Container_Compon.call(this, Object.assign(propertiesobject, Ext_tab_Panel_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_tab_Panel_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_tab_Panel_Component.METHODS()), events.concat(Ext_tab_Panel_Component.EVENTS())) || this; //this.XTYPE = Ext_tab_Panel_Component.XTYPE()
