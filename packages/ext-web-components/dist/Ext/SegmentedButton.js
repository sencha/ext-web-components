...
function (_Ext_Container_Compon) {
  ...
  function Ext_SegmentedButton_Component(propertiesobject, methods, events) {
    return _Ext_Container_Compon.call(this, Object.assign(propertiesobject, Ext_SegmentedButton_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_SegmentedButton_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_SegmentedButton_Component.METHODS()), events.concat(Ext_SegmentedButton_Component.EVENTS())) || this; //this.XTYPE = Ext_SegmentedButton_Component.XTYPE()
