...
function (_Ext_Widget_Component) {
  ...
  function Ext_AbstractComponent_Component(propertiesobject, methods, events) {
    return _Ext_Widget_Component.call(this, Object.assign(propertiesobject, Ext_AbstractComponent_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_AbstractComponent_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_AbstractComponent_Component.METHODS()), events.concat(Ext_AbstractComponent_Component.EVENTS())) || this; //this.XTYPE = Ext_AbstractComponent_Component.XTYPE()
