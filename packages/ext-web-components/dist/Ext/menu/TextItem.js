...
function (_Ext_Component_Compon) {
  ...
  function Ext_menu_TextItem_Component(propertiesobject, methods, events) {
    return _Ext_Component_Compon.call(this, Object.assign(propertiesobject, Ext_menu_TextItem_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_menu_TextItem_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_menu_TextItem_Component.METHODS()), events.concat(Ext_menu_TextItem_Component.EVENTS())) || this; //this.XTYPE = Ext_menu_TextItem_Component.XTYPE()
