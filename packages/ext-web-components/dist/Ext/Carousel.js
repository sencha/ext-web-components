...
function (_Ext_Container_Compon) {
  ...
  function Ext_Carousel_Component(propertiesobject, methods, events) {
    return _Ext_Container_Compon.call(this, Object.assign(propertiesobject, Ext_Carousel_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_Carousel_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_Carousel_Component.METHODS()), events.concat(Ext_Carousel_Component.EVENTS())) || this; //this.XTYPE = Ext_Carousel_Component.XTYPE()
