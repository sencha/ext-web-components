...
var Ext_Carousel_Component =
/*#__PURE__*/
function (_Ext_Container_Compon) {
  _inheritsLoose(Ext_Carousel_Component, _Ext_Container_Compon);

  //events
  //configs
  Ext_Carousel_Component.XTYPE = function XTYPE() {
    return 'carousel';
  };

  Ext_Carousel_Component.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "direction": ["string"],
      "draggable": ["any"],
  ...
  Ext_Carousel_Component.EVENTS = function EVENTS() {
    return [];
  };

  Ext_Carousel_Component.METHODS = function METHODS() {
    return [{
  ...
  _createClass(Ext_Carousel_Component, null, [{
  ...
  function Ext_Carousel_Component() {
    var _this;

    _this = _Ext_Container_Compon.call(this, Ext_Carousel_Component.METHODS(), Ext_Carousel_Component.XTYPE(), Ext_Carousel_Component.PROPERTIESOBJECT(), Ext_Carousel_Component.EVENTS()) || this;
    _this.XTYPE = Ext_Carousel_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_Carousel_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_Carousel_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_Carousel_Component.EVENTS());
    return _this;
  }

  var _proto = Ext_Carousel_Component.prototype;
  ...
  return Ext_Carousel_Component;
}(Ext_Container_Component);

export { Ext_Carousel_Component as default };