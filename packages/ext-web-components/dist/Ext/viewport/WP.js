...
function (_Ext_viewport_Default) {
  ...
  function Ext_viewport_WP_Component(propertiesobject, methods, events) {
    return _Ext_viewport_Default.call(this, Object.assign(propertiesobject, Ext_viewport_WP_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_viewport_WP_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_viewport_WP_Component.METHODS()), events.concat(Ext_viewport_WP_Component.EVENTS())) || this; //this.XTYPE = Ext_viewport_WP_Component.XTYPE()
