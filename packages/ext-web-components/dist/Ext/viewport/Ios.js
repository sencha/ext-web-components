...
function (_Ext_viewport_Default) {
  ...
  function Ext_viewport_Ios_Component(propertiesobject, methods, events) {
    return _Ext_viewport_Default.call(this, Object.assign(propertiesobject, Ext_viewport_Ios_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_viewport_Ios_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_viewport_Ios_Component.METHODS()), events.concat(Ext_viewport_Ios_Component.EVENTS())) || this; //this.XTYPE = Ext_viewport_Ios_Component.XTYPE()
