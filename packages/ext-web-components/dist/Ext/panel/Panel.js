...
function (_Ext_Container_Compon) {
  ...
  function Ext_panel_Panel_Component() {
    var _this;

    _this = _Ext_Container_Compon.call(this, Ext_panel_Panel_Component.METHODS(), Ext_panel_Panel_Component.XTYPE(), Ext_panel_Panel_Component.PROPERTIESOBJECT(), Ext_panel_Panel_Component.EVENTS()) || this;
    _this.XTYPE = Ext_panel_Panel_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_panel_Panel_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_panel_Panel_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_panel_Panel_Component.EVENTS());
    return _this;
  }
