...
function (_Ext_Component_Compon) {
  ...
  function Ext_panel_Tool_Component(propertiesobject, methods, events) {
    return _Ext_Component_Compon.call(this, Object.assign(propertiesobject, Ext_panel_Tool_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_panel_Tool_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_panel_Tool_Component.METHODS()), events.concat(Ext_panel_Tool_Component.EVENTS())) || this; //this.XTYPE = Ext_panel_Tool_Component.XTYPE()
