...
function (_Ext_dataview_Abstrac) {
  ...
  function Ext_DataView_Component(propertiesobject, methods, events) {
    return _Ext_dataview_Abstrac.call(this, Object.assign(propertiesobject, Ext_DataView_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_DataView_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_DataView_Component.METHODS()), events.concat(Ext_DataView_Component.EVENTS())) || this; //this.XTYPE = Ext_DataView_Component.XTYPE()
