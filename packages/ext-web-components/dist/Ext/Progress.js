...
function (_Ext_Gadget_Component) {
  ...
  function Ext_Progress_Component(propertiesobject, methods, events) {
    return _Ext_Gadget_Component.call(this, Object.assign(propertiesobject, Ext_Progress_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_Progress_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_Progress_Component.METHODS()), events.concat(Ext_Progress_Component.EVENTS())) || this; //this.XTYPE = Ext_Progress_Component.XTYPE()
