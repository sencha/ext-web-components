...
function (_Ext_field_trigger_Tr) {
  ...
  function Ext_field_trigger_SpinUp_Component(propertiesobject, methods, events) {
    return _Ext_field_trigger_Tr.call(this, Object.assign(propertiesobject, Ext_field_trigger_SpinUp_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_field_trigger_SpinUp_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_field_trigger_SpinUp_Component.METHODS()), events.concat(Ext_field_trigger_SpinUp_Component.EVENTS())) || this; //this.XTYPE = Ext_field_trigger_SpinUp_Component.XTYPE()
