...
function (_Ext_field_Picker_Com) {
  ...
  function Ext_field_DatePicker_Component() {
    var _this;

    _this = _Ext_field_Picker_Com.call(this, Ext_field_DatePicker_Component.METHODS(), Ext_field_DatePicker_Component.XTYPE(), Ext_field_DatePicker_Component.PROPERTIESOBJECT(), Ext_field_DatePicker_Component.EVENTS()) || this;
    _this.XTYPE = Ext_field_DatePicker_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_field_DatePicker_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_field_DatePicker_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_field_DatePicker_Component.EVENTS());
    return _this;
  }
