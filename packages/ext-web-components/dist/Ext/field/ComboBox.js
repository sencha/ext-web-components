...
function (_Ext_field_Select_Com) {
  ...
  function Ext_field_ComboBox_Component(propertiesobject, methods, events) {
    return _Ext_field_Select_Com.call(this, Object.assign(propertiesobject, Ext_field_ComboBox_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_field_ComboBox_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_field_ComboBox_Component.METHODS()), events.concat(Ext_field_ComboBox_Component.EVENTS())) || this; //this.XTYPE = Ext_field_ComboBox_Component.XTYPE()
