...
var Ext_field_Select_Component =
/*#__PURE__*/
function (_Ext_field_Picker_Com) {
  _inheritsLoose(Ext_field_Select_Component, _Ext_field_Picker_Com);

  //configs
  Ext_field_Select_Component.XTYPE = function XTYPE() {
    return 'selectfield';
  };

  Ext_field_Select_Component.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "autoFocus": ["boolean"],
  ...
  Ext_field_Select_Component.EVENTS = function EVENTS() {
    return [{
      name: 'change',
  ...
  Ext_field_Select_Component.METHODS = function METHODS() {
    return [{
  ...
  _createClass(Ext_field_Select_Component, [{
    key: "onchange",
    //events
    get: function get() {
  ...
  function Ext_field_Select_Component() {
    var _this;

    _this = _Ext_field_Picker_Com.call(this, Ext_field_Select_Component.METHODS(), Ext_field_Select_Component.XTYPE(), Ext_field_Select_Component.PROPERTIESOBJECT(), Ext_field_Select_Component.EVENTS()) || this;
    _this.XTYPE = Ext_field_Select_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_field_Select_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_field_Select_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_field_Select_Component.EVENTS());
    return _this;
  }

  var _proto = Ext_field_Select_Component.prototype;
  ...
  return Ext_field_Select_Component;
}(Ext_field_Picker_Component);

export { Ext_field_Select_Component as default };