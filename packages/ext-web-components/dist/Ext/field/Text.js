...
var Ext_field_Text_Component =
/*#__PURE__*/
function (_Ext_field_Input_Comp) {
  _inheritsLoose(Ext_field_Text_Component, _Ext_field_Input_Comp);

  //configs
  Ext_field_Text_Component.XTYPE = function XTYPE() {
    return 'textfield';
  };

  Ext_field_Text_Component.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  Ext_field_Text_Component.EVENTS = function EVENTS() {
    return [{
      name: 'action',
  ...
  Ext_field_Text_Component.METHODS = function METHODS() {
    return [{
      name: 'addTrigger',
  ...
  _createClass(Ext_field_Text_Component, [{
    key: "onaction",
    //events
    get: function get() {
  ...
  function Ext_field_Text_Component() {
    var _this;

    _this = _Ext_field_Input_Comp.call(this, Ext_field_Text_Component.METHODS(), Ext_field_Text_Component.XTYPE(), Ext_field_Text_Component.PROPERTIESOBJECT(), Ext_field_Text_Component.EVENTS()) || this;
    _this.XTYPE = Ext_field_Text_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_field_Text_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_field_Text_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_field_Text_Component.EVENTS());
    return _this;
  }

  var _proto = Ext_field_Text_Component.prototype;
  ...
  return Ext_field_Text_Component;
}(Ext_field_Input_Component);

export { Ext_field_Text_Component as default };