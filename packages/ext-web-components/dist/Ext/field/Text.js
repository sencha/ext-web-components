...
function (_Ext_field_Input_Comp) {
  ...
  function Ext_field_Text_Component(propertiesobject, methods, events) {
    return _Ext_field_Input_Comp.call(this, Object.assign(propertiesobject, Ext_field_Text_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_field_Text_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_field_Text_Component.METHODS()), events.concat(Ext_field_Text_Component.EVENTS())) || this; //this.XTYPE = Ext_field_Text_Component.XTYPE()
