...
function (_Ext_field_Checkbox_C) {
  ...
  function Ext_field_Radio_Component(propertiesobject, methods, events) {
    return _Ext_field_Checkbox_C.call(this, Object.assign(propertiesobject, Ext_field_Radio_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_field_Radio_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_field_Radio_Component.METHODS()), events.concat(Ext_field_Radio_Component.EVENTS())) || this; //this.XTYPE = Ext_field_Radio_Component.XTYPE()
