...
function (_Ext_field_Text_Compo) {
  ...
  function Ext_field_Number_Component(propertiesobject, methods, events) {
    return _Ext_field_Text_Compo.call(this, Object.assign(propertiesobject, Ext_field_Number_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_field_Number_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_field_Number_Component.METHODS()), events.concat(Ext_field_Number_Component.EVENTS())) || this; //this.XTYPE = Ext_field_Number_Component.XTYPE()
