...
function (_Ext_field_Text_Compo) {
  ...
  function Ext_field_TextArea_Component() {
    var _this;

    _this = _Ext_field_Text_Compo.call(this, Ext_field_TextArea_Component.METHODS(), Ext_field_TextArea_Component.XTYPE(), Ext_field_TextArea_Component.PROPERTIESOBJECT(), Ext_field_TextArea_Component.EVENTS()) || this;
    _this.XTYPE = Ext_field_TextArea_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_field_TextArea_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_field_TextArea_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_field_TextArea_Component.EVENTS());
    return _this;
  }
