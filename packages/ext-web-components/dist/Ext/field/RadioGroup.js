...
function (_Ext_field_FieldGroup) {
  ...
  function Ext_field_RadioGroup_Component(propertiesobject, methods, events) {
    return _Ext_field_FieldGroup.call(this, Object.assign(propertiesobject, Ext_field_RadioGroup_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_field_RadioGroup_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_field_RadioGroup_Component.METHODS()), events.concat(Ext_field_RadioGroup_Component.EVENTS())) || this; //this.XTYPE = Ext_field_RadioGroup_Component.XTYPE()
