...
var Ext_field_Slider_Component =
/*#__PURE__*/
function (_Ext_field_Field_Comp) {
  _inheritsLoose(Ext_field_Slider_Component, _Ext_field_Field_Comp);

  //configs
  Ext_field_Slider_Component.XTYPE = function XTYPE() {
    return 'sliderfield';
  };

  Ext_field_Slider_Component.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  Ext_field_Slider_Component.EVENTS = function EVENTS() {
    return [{
      name: 'change',
  ...
  Ext_field_Slider_Component.METHODS = function METHODS() {
    return [{
      name: 'getValues',
  ...
  _createClass(Ext_field_Slider_Component, [{
    key: "onchange",
    //events
    get: function get() {
  ...
  function Ext_field_Slider_Component() {
    var _this;

    _this = _Ext_field_Field_Comp.call(this, Ext_field_Slider_Component.METHODS(), Ext_field_Slider_Component.XTYPE(), Ext_field_Slider_Component.PROPERTIESOBJECT(), Ext_field_Slider_Component.EVENTS()) || this;
    _this.XTYPE = Ext_field_Slider_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_field_Slider_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_field_Slider_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_field_Slider_Component.EVENTS());
    return _this;
  }

  var _proto = Ext_field_Slider_Component.prototype;
  ...
  return Ext_field_Slider_Component;
}(Ext_field_Field_Component);

export { Ext_field_Slider_Component as default };