...
function (_Ext_field_Picker_Com) {
  ...
  function Ext_field_Date_Component(propertiesobject, methods, events) {
    return _Ext_field_Picker_Com.call(this, Object.assign(propertiesobject, Ext_field_Date_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_field_Date_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_field_Date_Component.METHODS()), events.concat(Ext_field_Date_Component.EVENTS())) || this; //this.XTYPE = Ext_field_Date_Component.XTYPE()
