...
function (_Ext_form_Panel_Compo) {
  ...
  function Ext_pivot_plugin_configurator_Form_Component() {
    var _this;

    _this = _Ext_form_Panel_Compo.call(this, Ext_pivot_plugin_configurator_Form_Component.METHODS(), Ext_pivot_plugin_configurator_Form_Component.XTYPE(), Ext_pivot_plugin_configurator_Form_Component.PROPERTIESOBJECT(), Ext_pivot_plugin_configurator_Form_Component.EVENTS()) || this;
    _this.XTYPE = Ext_pivot_plugin_configurator_Form_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_pivot_plugin_configurator_Form_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_pivot_plugin_configurator_Form_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_pivot_plugin_configurator_Form_Component.EVENTS());
    return _this;
  }
