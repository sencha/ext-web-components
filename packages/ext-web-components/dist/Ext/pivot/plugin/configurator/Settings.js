...
function (_Ext_form_Panel_Compo) {
  ...
  function Ext_pivot_plugin_configurator_Settings_Component(propertiesobject, methods, events) {
    return _Ext_form_Panel_Compo.call(this, Object.assign(propertiesobject, Ext_pivot_plugin_configurator_Settings_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_pivot_plugin_configurator_Settings_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_pivot_plugin_configurator_Settings_Component.METHODS()), events.concat(Ext_pivot_plugin_configurator_Settings_Component.EVENTS())) || this; //this.XTYPE = Ext_pivot_plugin_configurator_Settings_Component.XTYPE()
