...
function (_Ext_Container_Compon) {
  ...
  function Ext_navigation_View_Component(propertiesobject, methods, events) {
    return _Ext_Container_Compon.call(this, Object.assign(propertiesobject, Ext_navigation_View_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_navigation_View_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_navigation_View_Component.METHODS()), events.concat(Ext_navigation_View_Component.EVENTS())) || this; //this.XTYPE = Ext_navigation_View_Component.XTYPE()
