...
var Ext_navigation_View_Component =
/*#__PURE__*/
function (_Ext_Container_Compon) {
  _inheritsLoose(Ext_navigation_View_Component, _Ext_Container_Compon);

  //configs
  Ext_navigation_View_Component.XTYPE = function XTYPE() {
    return 'navigationview';
  };

  Ext_navigation_View_Component.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  Ext_navigation_View_Component.EVENTS = function EVENTS() {
    return [{
      name: 'back',
  ...
  Ext_navigation_View_Component.METHODS = function METHODS() {
    return [{
  ...
  _createClass(Ext_navigation_View_Component, [{
    key: "onback",
    //events
    get: function get() {
  ...
  function Ext_navigation_View_Component() {
    var _this;

    _this = _Ext_Container_Compon.call(this, Ext_navigation_View_Component.METHODS(), Ext_navigation_View_Component.XTYPE(), Ext_navigation_View_Component.PROPERTIESOBJECT(), Ext_navigation_View_Component.EVENTS()) || this;
    _this.XTYPE = Ext_navigation_View_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_navigation_View_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_navigation_View_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_navigation_View_Component.EVENTS());
    return _this;
  }

  var _proto = Ext_navigation_View_Component.prototype;
  ...
  return Ext_navigation_View_Component;
}(Ext_Container_Component);

export { Ext_navigation_View_Component as default };