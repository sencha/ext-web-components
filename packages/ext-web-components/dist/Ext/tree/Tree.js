...
function (_Ext_grid_Grid_Compon) {
  ...
  function Ext_tree_Tree_Component() {
    var _this;

    _this = _Ext_grid_Grid_Compon.call(this, Ext_tree_Tree_Component.METHODS(), Ext_tree_Tree_Component.XTYPE(), Ext_tree_Tree_Component.PROPERTIESOBJECT(), Ext_tree_Tree_Component.EVENTS()) || this;
    _this.XTYPE = Ext_tree_Tree_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_tree_Tree_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_tree_Tree_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_tree_Tree_Component.EVENTS());
    return _this;
  }
