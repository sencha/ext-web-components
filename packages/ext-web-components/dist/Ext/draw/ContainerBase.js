...
function (_Ext_Container_Compon) {
  ...
  function Ext_draw_ContainerBase_Component(propertiesobject, methods, events) {
    return _Ext_Container_Compon.call(this, Object.assign(propertiesobject, Ext_draw_ContainerBase_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_draw_ContainerBase_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_draw_ContainerBase_Component.METHODS()), events.concat(Ext_draw_ContainerBase_Component.EVENTS())) || this; //this.XTYPE = Ext_draw_ContainerBase_Component.XTYPE()
