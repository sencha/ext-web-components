...
function (_Ext_draw_Surface_Com) {
  ...
  function Ext_draw_engine_Svg_Component(propertiesobject, methods, events) {
    return _Ext_draw_Surface_Com.call(this, Object.assign(propertiesobject, Ext_draw_engine_Svg_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_draw_engine_Svg_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_draw_engine_Svg_Component.METHODS()), events.concat(Ext_draw_engine_Svg_Component.EVENTS())) || this; //this.XTYPE = Ext_draw_engine_Svg_Component.XTYPE()
