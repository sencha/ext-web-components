...
function (_Ext_draw_ContainerBa) {
  ...
  function Ext_draw_Container_Component(propertiesobject, methods, events) {
    return _Ext_draw_ContainerBa.call(this, Object.assign(propertiesobject, Ext_draw_Container_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_draw_Container_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_draw_Container_Component.METHODS()), events.concat(Ext_draw_Container_Component.EVENTS())) || this; //this.XTYPE = Ext_draw_Container_Component.XTYPE()
