...
var Ext_window_Window_Component =
/*#__PURE__*/
function (_Ext_Panel_Component) {
  _inheritsLoose(Ext_window_Window_Component, _Ext_Panel_Component);

  //configs
  Ext_window_Window_Component.XTYPE = function XTYPE() {
    return 'dialog';
  };

  Ext_window_Window_Component.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "bodyBorder": ["boolean"],
      "border": ["boolean"],
      "centered": ["boolean"],
  ...
  Ext_window_Window_Component.EVENTS = function EVENTS() {
    return [{
      name: 'beforemaximize',
      parameters: 'dialog'
    }, {
  ...
  Ext_window_Window_Component.METHODS = function METHODS() {
    return [{
      name: 'maximize',
  ...
  _createClass(Ext_window_Window_Component, [{
  ...
  function Ext_window_Window_Component() {
    var _this;

    _this = _Ext_Panel_Component.call(this, Ext_window_Window_Component.METHODS(), Ext_window_Window_Component.XTYPE(), Ext_window_Window_Component.PROPERTIESOBJECT(), Ext_window_Window_Component.EVENTS()) || this;
    _this.XTYPE = Ext_window_Window_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_window_Window_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_window_Window_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_window_Window_Component.EVENTS());
    return _this;
  }

  var _proto = Ext_window_Window_Component.prototype;
  ...
  return Ext_window_Window_Component;
}(Ext_Panel_Component);

export { Ext_window_Window_Component as default };