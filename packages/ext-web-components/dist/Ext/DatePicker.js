...
var Ext_DatePicker_Component =
/*#__PURE__*/
function (_Ext_picker_Picker_Co) {
  _inheritsLoose(Ext_DatePicker_Component, _Ext_picker_Picker_Co);

  //configs
  Ext_DatePicker_Component.XTYPE = function XTYPE() {
    return 'datepicker';
  };

  Ext_DatePicker_Component.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "dayText": ["string"],
  ...
  Ext_DatePicker_Component.EVENTS = function EVENTS() {
    return [{
      name: 'change',
  ...
  Ext_DatePicker_Component.METHODS = function METHODS() {
    return [{
      name: 'constructor',
  ...
  _createClass(Ext_DatePicker_Component, [{
    key: "onchange",
    //events
    get: function get() {
  ...
  function Ext_DatePicker_Component() {
    var _this;

    _this = _Ext_picker_Picker_Co.call(this, Ext_DatePicker_Component.METHODS(), Ext_DatePicker_Component.XTYPE(), Ext_DatePicker_Component.PROPERTIESOBJECT(), Ext_DatePicker_Component.EVENTS()) || this;
    _this.XTYPE = Ext_DatePicker_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_DatePicker_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_DatePicker_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_DatePicker_Component.EVENTS());
    return _this;
  }

  var _proto = Ext_DatePicker_Component.prototype;
  ...
  return Ext_DatePicker_Component;
}(Ext_picker_Picker_Component);

export { Ext_DatePicker_Component as default };