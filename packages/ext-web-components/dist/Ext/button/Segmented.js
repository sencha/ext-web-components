...
function (_Ext_Container_Compon) {
  ...
  function Ext_button_Segmented_Component(propertiesobject, methods, events) {
    return _Ext_Container_Compon.call(this, Object.assign(propertiesobject, Ext_button_Segmented_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_button_Segmented_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_button_Segmented_Component.METHODS()), events.concat(Ext_button_Segmented_Component.EVENTS())) || this; //this.XTYPE = Ext_button_Segmented_Component.XTYPE()
