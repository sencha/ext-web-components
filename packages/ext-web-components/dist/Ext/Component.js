...
function (_Ext_Widget_Component) {
  ...
  function Ext_Component_Component() {
    var _this;

    _this = _Ext_Widget_Component.call(this, Ext_Component_Component.METHODS(), Ext_Component_Component.XTYPE(), Ext_Component_Component.PROPERTIESOBJECT(), Ext_Component_Component.EVENTS()) || this;
    _this.XTYPE = Ext_Component_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_Component_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_Component_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_Component_Component.EVENTS());
    return _this;
  }
