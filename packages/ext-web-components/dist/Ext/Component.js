...
var Ext_Component_Component =
/*#__PURE__*/
function (_Ext_Widget_Component) {
  _inheritsLoose(Ext_Component_Component, _Ext_Widget_Component);

  //configs
  Ext_Component_Component.XTYPE = function XTYPE() {
    return 'component';
  };

  Ext_Component_Component.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "axisLock": ["boolean"],
  ...
  Ext_Component_Component.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  Ext_Component_Component.METHODS = function METHODS() {
    return [{
      name: 'afterEdit',
  ...
  _createClass(Ext_Component_Component, [{
    key: "onadded",
    //events
    get: function get() {
    ...
    get: function get() {
      ...
      for (var property in Ext_Component_Component.PROPERTIESOBJECT()) {
        attrs.push(property);
      }

      Ext_Component_Component.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_Component_Component(propertiesobject, methods, events) {
    return _Ext_Widget_Component.call(this, Object.assign(propertiesobject, Ext_Component_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_Component_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_Component_Component.METHODS()), events.concat(Ext_Component_Component.EVENTS())) || this; //this.XTYPE = Ext_Component_Component.XTYPE()
    //this.PROPERTIESOBJECT = this.extendObject(this.PROPERTIESOBJECT, Ext_Component_Component.PROPERTIESOBJECT());
    //this.methods = this.extendArray(this.methods, Ext_Component_Component.METHODS());
    //this.events = this.extendArray(this.events, Ext_Component_Component.EVENTS());
  }

  var _proto = Ext_Component_Component.prototype;
  ...
  return Ext_Component_Component;
}(Ext_Widget_Component);

export { Ext_Component_Component as default };