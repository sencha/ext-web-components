...
var Ext_container_Container_Component =
/*#__PURE__*/
function (_Ext_Component_Compon) {
  _inheritsLoose(Ext_container_Container_Component, _Ext_Component_Compon);

  //configs
  Ext_container_Container_Component.XTYPE = function XTYPE() {
    return 'container';
  };

  Ext_container_Container_Component.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  Ext_container_Container_Component.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  Ext_container_Container_Component.METHODS = function METHODS() {
    return [{
      name: 'add',
  ...
  _createClass(Ext_container_Container_Component, [{
    key: "onactivate",
    //events
    get: function get() {
    ...
    get: function get() {
      ...
      for (var property in Ext_container_Container_Component.PROPERTIESOBJECT()) {
        attrs.push(property);
      }

      Ext_container_Container_Component.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_container_Container_Component(propertiesobject, methods, events) {
    return _Ext_Component_Compon.call(this, Object.assign(propertiesobject, Ext_container_Container_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_container_Container_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_container_Container_Component.METHODS()), events.concat(Ext_container_Container_Component.EVENTS())) || this; //this.XTYPE = Ext_container_Container_Component.XTYPE()
    //this.PROPERTIESOBJECT = this.extendObject(this.PROPERTIESOBJECT, Ext_container_Container_Component.PROPERTIESOBJECT());
    //this.methods = this.extendArray(this.methods, Ext_container_Container_Component.METHODS());
    //this.events = this.extendArray(this.events, Ext_container_Container_Component.EVENTS());
  }

  var _proto = Ext_container_Container_Component.prototype;
  ...
  return Ext_container_Container_Component;
}(Ext_Component_Component);

export { Ext_container_Container_Component as default };