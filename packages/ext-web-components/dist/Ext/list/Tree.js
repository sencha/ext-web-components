...
function (_Ext_Gadget_Component) {
  ...
  function Ext_list_Tree_Component() {
    var _this;

    _this = _Ext_Gadget_Component.call(this, Ext_list_Tree_Component.METHODS(), Ext_list_Tree_Component.XTYPE(), Ext_list_Tree_Component.PROPERTIESOBJECT(), Ext_list_Tree_Component.EVENTS()) || this;
    _this.XTYPE = Ext_list_Tree_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_list_Tree_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_list_Tree_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_list_Tree_Component.EVENTS());
    return _this;
  }
