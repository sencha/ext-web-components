...
function (_Ext_chart_navigator_) {
  ...
  function Ext_chart_navigator_Navigator_Component() {
    var _this;

    _this = _Ext_chart_navigator_.call(this, Ext_chart_navigator_Navigator_Component.METHODS(), Ext_chart_navigator_Navigator_Component.XTYPE(), Ext_chart_navigator_Navigator_Component.PROPERTIESOBJECT(), Ext_chart_navigator_Navigator_Component.EVENTS()) || this;
    _this.XTYPE = Ext_chart_navigator_Navigator_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_chart_navigator_Navigator_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_chart_navigator_Navigator_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_chart_navigator_Navigator_Component.EVENTS());
    return _this;
  }
