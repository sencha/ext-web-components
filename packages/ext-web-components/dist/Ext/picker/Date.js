...
function (_Ext_picker_Picker_Co) {
  ...
  function Ext_picker_Date_Component(propertiesobject, methods, events) {
    return _Ext_picker_Picker_Co.call(this, Object.assign(propertiesobject, Ext_picker_Date_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_picker_Date_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_picker_Date_Component.METHODS()), events.concat(Ext_picker_Date_Component.EVENTS())) || this; //this.XTYPE = Ext_picker_Date_Component.XTYPE()
