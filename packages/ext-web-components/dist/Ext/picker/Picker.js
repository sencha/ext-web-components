...
var Ext_picker_Picker_Component =
/*#__PURE__*/
function (_Ext_Sheet_Component) {
  _inheritsLoose(Ext_picker_Picker_Component, _Ext_Sheet_Component);

  //configs
  Ext_picker_Picker_Component.XTYPE = function XTYPE() {
    return 'picker';
  };

  Ext_picker_Picker_Component.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  Ext_picker_Picker_Component.EVENTS = function EVENTS() {
    return [{
      name: 'cancel',
  ...
  Ext_picker_Picker_Component.METHODS = function METHODS() {
    return [{
  ...
  _createClass(Ext_picker_Picker_Component, [{
    key: "oncancel",
    //events
    get: function get() {
    ...
    get: function get() {
      ...
      for (var property in Ext_picker_Picker_Component.PROPERTIESOBJECT()) {
        attrs.push(property);
      }

      Ext_picker_Picker_Component.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_picker_Picker_Component(propertiesobject, methods, events) {
    return _Ext_Sheet_Component.call(this, Object.assign(propertiesobject, Ext_picker_Picker_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_picker_Picker_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_picker_Picker_Component.METHODS()), events.concat(Ext_picker_Picker_Component.EVENTS())) || this; //this.XTYPE = Ext_picker_Picker_Component.XTYPE()
    //this.PROPERTIESOBJECT = this.extendObject(this.PROPERTIESOBJECT, Ext_picker_Picker_Component.PROPERTIESOBJECT());
    //this.methods = this.extendArray(this.methods, Ext_picker_Picker_Component.METHODS());
    //this.events = this.extendArray(this.events, Ext_picker_Picker_Component.EVENTS());
  }

  var _proto = Ext_picker_Picker_Component.prototype;
  ...
  return Ext_picker_Picker_Component;
}(Ext_Sheet_Component);

export { Ext_picker_Picker_Component as default };