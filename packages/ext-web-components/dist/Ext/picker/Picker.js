...
function (_Ext_Sheet_Component) {
  ...
  function Ext_picker_Picker_Component() {
    var _this;

    _this = _Ext_Sheet_Component.call(this, Ext_picker_Picker_Component.METHODS(), Ext_picker_Picker_Component.XTYPE(), Ext_picker_Picker_Component.PROPERTIESOBJECT(), Ext_picker_Picker_Component.EVENTS()) || this;
    _this.XTYPE = Ext_picker_Picker_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_picker_Picker_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_picker_Picker_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_picker_Picker_Component.EVENTS());
    return _this;
  }
