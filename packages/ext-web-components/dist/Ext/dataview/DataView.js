...
var Ext_dataview_DataView_Component =
/*#__PURE__*/
function (_Ext_dataview_Abstrac) {
  _inheritsLoose(Ext_dataview_DataView_Component, _Ext_dataview_Abstrac);

  //configs
  Ext_dataview_DataView_Component.XTYPE = function XTYPE() {
    return 'dataview';
  };

  Ext_dataview_DataView_Component.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  Ext_dataview_DataView_Component.EVENTS = function EVENTS() {
    return [{
      name: 'childdoubletap',
  ...
  Ext_dataview_DataView_Component.METHODS = function METHODS() {
    return [{
      name: 'getItemClass',
  ...
  _createClass(Ext_dataview_DataView_Component, [{
  ...
  function Ext_dataview_DataView_Component() {
    var _this;

    _this = _Ext_dataview_Abstrac.call(this, Ext_dataview_DataView_Component.METHODS(), Ext_dataview_DataView_Component.XTYPE(), Ext_dataview_DataView_Component.PROPERTIESOBJECT(), Ext_dataview_DataView_Component.EVENTS()) || this;
    _this.XTYPE = Ext_dataview_DataView_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_dataview_DataView_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_dataview_DataView_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_dataview_DataView_Component.EVENTS());
    return _this;
  }

  var _proto = Ext_dataview_DataView_Component.prototype;
  ...
  return Ext_dataview_DataView_Component;
}(Ext_dataview_Abstract_Component);

export { Ext_dataview_DataView_Component as default };