...
function (_Ext_dataview_Compone) {
  ...
  function Ext_dataview_List_Component() {
    var _this;

    _this = _Ext_dataview_Compone.call(this, Ext_dataview_List_Component.METHODS(), Ext_dataview_List_Component.XTYPE(), Ext_dataview_List_Component.PROPERTIESOBJECT(), Ext_dataview_List_Component.EVENTS()) || this;
    _this.XTYPE = Ext_dataview_List_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_dataview_List_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_dataview_List_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_dataview_List_Component.EVENTS());
    return _this;
  }
