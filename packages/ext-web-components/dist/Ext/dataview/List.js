...
var Ext_dataview_List_Component =
/*#__PURE__*/
function (_Ext_dataview_Compone) {
  _inheritsLoose(Ext_dataview_List_Component, _Ext_dataview_Compone);

  //configs
  Ext_dataview_List_Component.XTYPE = function XTYPE() {
    return 'list';
  };

  Ext_dataview_List_Component.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "bufferSize": ["number"],
  ...
  Ext_dataview_List_Component.EVENTS = function EVENTS() {
    return [{
  ...
  Ext_dataview_List_Component.METHODS = function METHODS() {
    return [{
  ...
  _createClass(Ext_dataview_List_Component, [{
    ...
    get: function get() {
      ...
      for (var property in Ext_dataview_List_Component.PROPERTIESOBJECT()) {
        attrs.push(property);
      }

      Ext_dataview_List_Component.EVENTS().forEach(function (eventparameter, index, array) {
  ...
  function Ext_dataview_List_Component(propertiesobject, methods, events) {
    return _Ext_dataview_Compone.call(this, Object.assign(propertiesobject, Ext_dataview_List_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_dataview_List_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_dataview_List_Component.METHODS()), events.concat(Ext_dataview_List_Component.EVENTS())) || this; //this.XTYPE = Ext_dataview_List_Component.XTYPE()
    //this.PROPERTIESOBJECT = this.extendObject(this.PROPERTIESOBJECT, Ext_dataview_List_Component.PROPERTIESOBJECT());
    //this.methods = this.extendArray(this.methods, Ext_dataview_List_Component.METHODS());
    //this.events = this.extendArray(this.events, Ext_dataview_List_Component.EVENTS());
  }

  var _proto = Ext_dataview_List_Component.prototype;
  ...
  return Ext_dataview_List_Component;
}(Ext_dataview_Component_Component);

export { Ext_dataview_List_Component as default };