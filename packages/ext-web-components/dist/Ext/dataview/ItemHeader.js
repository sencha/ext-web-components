...
function (_Ext_Component_Compon) {
  ...
  function Ext_dataview_ItemHeader_Component(propertiesobject, methods, events) {
    return _Ext_Component_Compon.call(this, Object.assign(propertiesobject, Ext_dataview_ItemHeader_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_dataview_ItemHeader_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_dataview_ItemHeader_Component.METHODS()), events.concat(Ext_dataview_ItemHeader_Component.EVENTS())) || this; //this.XTYPE = Ext_dataview_ItemHeader_Component.XTYPE()
