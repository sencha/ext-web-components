...
function (_Ext_dataview_DataIte) {
  ...
  function Ext_dataview_ListItem_Component(propertiesobject, methods, events) {
    return _Ext_dataview_DataIte.call(this, Object.assign(propertiesobject, Ext_dataview_ListItem_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_dataview_ListItem_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_dataview_ListItem_Component.METHODS()), events.concat(Ext_dataview_ListItem_Component.EVENTS())) || this; //this.XTYPE = Ext_dataview_ListItem_Component.XTYPE()
