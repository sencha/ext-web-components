...
function (_Ext_Container_Compon) {
  ...
  function Ext_dataview_NestedList_Component() {
    var _this;

    _this = _Ext_Container_Compon.call(this, Ext_dataview_NestedList_Component.METHODS(), Ext_dataview_NestedList_Component.XTYPE(), Ext_dataview_NestedList_Component.PROPERTIESOBJECT(), Ext_dataview_NestedList_Component.EVENTS()) || this;
    _this.XTYPE = Ext_dataview_NestedList_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_dataview_NestedList_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_dataview_NestedList_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_dataview_NestedList_Component.EVENTS());
    return _this;
  }
