...
function (_Ext_Container_Compon) {
  ...
  function Ext_dataview_component_DataItem_Component(propertiesobject, methods, events) {
    return _Ext_Container_Compon.call(this, Object.assign(propertiesobject, Ext_dataview_component_DataItem_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_dataview_component_DataItem_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_dataview_component_DataItem_Component.METHODS()), events.concat(Ext_dataview_component_DataItem_Component.EVENTS())) || this; //this.XTYPE = Ext_dataview_component_DataItem_Component.XTYPE()
