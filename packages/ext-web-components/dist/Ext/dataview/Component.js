...
function (_Ext_dataview_Abstrac) {
  ...
  function Ext_dataview_Component_Component(propertiesobject, methods, events) {
    return _Ext_dataview_Abstrac.call(this, Object.assign(propertiesobject, Ext_dataview_Component_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_dataview_Component_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_dataview_Component_Component.METHODS()), events.concat(Ext_dataview_Component_Component.EVENTS())) || this; //this.XTYPE = Ext_dataview_Component_Component.XTYPE()
