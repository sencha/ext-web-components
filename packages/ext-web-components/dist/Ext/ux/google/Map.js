...
function (_Ext_Container_Compon) {
  ...
  function Ext_ux_google_Map_Component(propertiesobject, methods, events) {
    return _Ext_Container_Compon.call(this, Object.assign(propertiesobject, Ext_ux_google_Map_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_ux_google_Map_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_ux_google_Map_Component.METHODS()), events.concat(Ext_ux_google_Map_Component.EVENTS())) || this; //this.XTYPE = Ext_ux_google_Map_Component.XTYPE()
