...
var Ext_ux_google_Map_Component =
/*#__PURE__*/
function (_Ext_Container_Compon) {
  _inheritsLoose(Ext_ux_google_Map_Component, _Ext_Container_Compon);

  //configs
  Ext_ux_google_Map_Component.XTYPE = function XTYPE() {
    return 'map';
  };

  Ext_ux_google_Map_Component.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  Ext_ux_google_Map_Component.EVENTS = function EVENTS() {
    return [{
      name: 'centerchange',
  ...
  Ext_ux_google_Map_Component.METHODS = function METHODS() {
    return [{
  ...
  _createClass(Ext_ux_google_Map_Component, [{
    key: "oncenterchange",
    //events
    get: function get() {
  ...
  function Ext_ux_google_Map_Component() {
    var _this;

    _this = _Ext_Container_Compon.call(this, Ext_ux_google_Map_Component.METHODS(), Ext_ux_google_Map_Component.XTYPE(), Ext_ux_google_Map_Component.PROPERTIESOBJECT(), Ext_ux_google_Map_Component.EVENTS()) || this;
    _this.XTYPE = Ext_ux_google_Map_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_ux_google_Map_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_ux_google_Map_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_ux_google_Map_Component.EVENTS());
    return _this;
  }

  var _proto = Ext_ux_google_Map_Component.prototype;
  ...
  return Ext_ux_google_Map_Component;
}(Ext_Container_Component);

export { Ext_ux_google_Map_Component as default };