...
function (_Ext_Gadget_Component) {
  ...
  function Ext_ux_gauge_Gauge_Component() {
    var _this;

    _this = _Ext_Gadget_Component.call(this, Ext_ux_gauge_Gauge_Component.METHODS(), Ext_ux_gauge_Gauge_Component.XTYPE(), Ext_ux_gauge_Gauge_Component.PROPERTIESOBJECT(), Ext_ux_gauge_Gauge_Component.EVENTS()) || this;
    _this.XTYPE = Ext_ux_gauge_Gauge_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_ux_gauge_Gauge_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_ux_gauge_Gauge_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_ux_gauge_Gauge_Component.EVENTS());
    return _this;
  }
