...
function (_Ext_grid_Grid_Compon) {
  ...
  function Ext_grid_Tree_Component(propertiesobject, methods, events) {
    return _Ext_grid_Grid_Compon.call(this, Object.assign(propertiesobject, Ext_grid_Tree_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_grid_Tree_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_grid_Tree_Component.METHODS()), events.concat(Ext_grid_Tree_Component.EVENTS())) || this; //this.XTYPE = Ext_grid_Tree_Component.XTYPE()
