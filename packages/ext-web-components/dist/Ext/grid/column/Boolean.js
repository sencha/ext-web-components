...
function (_Ext_grid_column_Colu) {
  ...
  function Ext_grid_column_Boolean_Component(propertiesobject, methods, events) {
    return _Ext_grid_column_Colu.call(this, Object.assign(propertiesobject, Ext_grid_column_Boolean_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_grid_column_Boolean_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_grid_column_Boolean_Component.METHODS()), events.concat(Ext_grid_column_Boolean_Component.EVENTS())) || this; //this.XTYPE = Ext_grid_column_Boolean_Component.XTYPE()
