...
function (_Ext_grid_HeaderConta) {
  ...
  function Ext_grid_column_Template_Component(propertiesobject, methods, events) {
    return _Ext_grid_HeaderConta.call(this, Object.assign(propertiesobject, Ext_grid_column_Template_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_grid_column_Template_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_grid_column_Template_Component.METHODS()), events.concat(Ext_grid_column_Template_Component.EVENTS())) || this; //this.XTYPE = Ext_grid_column_Template_Component.XTYPE()
