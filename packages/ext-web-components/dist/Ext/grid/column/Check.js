...
function (_Ext_grid_column_Colu) {
  ...
  function Ext_grid_column_Check_Component(propertiesobject, methods, events) {
    return _Ext_grid_column_Colu.call(this, Object.assign(propertiesobject, Ext_grid_column_Check_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_grid_column_Check_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_grid_column_Check_Component.METHODS()), events.concat(Ext_grid_column_Check_Component.EVENTS())) || this; //this.XTYPE = Ext_grid_column_Check_Component.XTYPE()
