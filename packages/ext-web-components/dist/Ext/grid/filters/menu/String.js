...
function (_Ext_grid_filters_men) {
  ...
  function Ext_grid_filters_menu_String_Component(propertiesobject, methods, events) {
    return _Ext_grid_filters_men.call(this, Object.assign(propertiesobject, Ext_grid_filters_menu_String_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_grid_filters_menu_String_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_grid_filters_menu_String_Component.METHODS()), events.concat(Ext_grid_filters_menu_String_Component.EVENTS())) || this; //this.XTYPE = Ext_grid_filters_menu_String_Component.XTYPE()
