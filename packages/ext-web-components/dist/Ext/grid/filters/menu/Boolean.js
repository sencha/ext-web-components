...
function (_Ext_grid_filters_men) {
  ...
  function Ext_grid_filters_menu_Boolean_Component() {
    var _this;

    _this = _Ext_grid_filters_men.call(this, Ext_grid_filters_menu_Boolean_Component.METHODS(), Ext_grid_filters_menu_Boolean_Component.XTYPE(), Ext_grid_filters_menu_Boolean_Component.PROPERTIESOBJECT(), Ext_grid_filters_menu_Boolean_Component.EVENTS()) || this;
    _this.XTYPE = Ext_grid_filters_menu_Boolean_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_grid_filters_menu_Boolean_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_grid_filters_menu_Boolean_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_grid_filters_menu_Boolean_Component.EVENTS());
    return _this;
  }
