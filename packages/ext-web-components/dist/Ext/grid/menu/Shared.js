...
function (_Ext_menu_Item_Compon) {
  ...
  function Ext_grid_menu_Shared_Component(propertiesobject, methods, events) {
    return _Ext_menu_Item_Compon.call(this, Object.assign(propertiesobject, Ext_grid_menu_Shared_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_grid_menu_Shared_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_grid_menu_Shared_Component.METHODS()), events.concat(Ext_grid_menu_Shared_Component.EVENTS())) || this; //this.XTYPE = Ext_grid_menu_Shared_Component.XTYPE()
