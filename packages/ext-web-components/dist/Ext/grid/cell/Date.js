...
function (_Ext_grid_cell_Text_C) {
  ...
  function Ext_grid_cell_Date_Component(propertiesobject, methods, events) {
    return _Ext_grid_cell_Text_C.call(this, Object.assign(propertiesobject, Ext_grid_cell_Date_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_grid_cell_Date_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_grid_cell_Date_Component.METHODS()), events.concat(Ext_grid_cell_Date_Component.EVENTS())) || this; //this.XTYPE = Ext_grid_cell_Date_Component.XTYPE()
