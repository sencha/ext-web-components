...
function (_Ext_grid_cell_Number) {
  ...
  function Ext_grid_cell_RowNumberer_Component(propertiesobject, methods, events) {
    return _Ext_grid_cell_Number.call(this, Object.assign(propertiesobject, Ext_grid_cell_RowNumberer_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_grid_cell_RowNumberer_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_grid_cell_RowNumberer_Component.METHODS()), events.concat(Ext_grid_cell_RowNumberer_Component.EVENTS())) || this; //this.XTYPE = Ext_grid_cell_RowNumberer_Component.XTYPE()
