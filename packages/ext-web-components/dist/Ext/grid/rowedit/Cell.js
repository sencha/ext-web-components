...
function (_Ext_Component_Compon) {
  ...
  function Ext_grid_rowedit_Cell_Component(propertiesobject, methods, events) {
    return _Ext_Component_Compon.call(this, Object.assign(propertiesobject, Ext_grid_rowedit_Cell_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_grid_rowedit_Cell_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_grid_rowedit_Cell_Component.METHODS()), events.concat(Ext_grid_rowedit_Cell_Component.EVENTS())) || this; //this.XTYPE = Ext_grid_rowedit_Cell_Component.XTYPE()
