...
function (_Ext_calendar_form_Fo) {
  ...
  function Ext_calendar_form_Add_Component(propertiesobject, methods, events) {
    return _Ext_calendar_form_Fo.call(this, Object.assign(propertiesobject, Ext_calendar_form_Add_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_calendar_form_Add_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_calendar_form_Add_Component.METHODS()), events.concat(Ext_calendar_form_Add_Component.EVENTS())) || this; //this.XTYPE = Ext_calendar_form_Add_Component.XTYPE()
