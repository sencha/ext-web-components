...
function (_Ext_field_Select_Com) {
  ...
  function Ext_calendar_form_TimeField_Component() {
    var _this;

    _this = _Ext_field_Select_Com.call(this, Ext_calendar_form_TimeField_Component.METHODS(), Ext_calendar_form_TimeField_Component.XTYPE(), Ext_calendar_form_TimeField_Component.PROPERTIESOBJECT(), Ext_calendar_form_TimeField_Component.EVENTS()) || this;
    _this.XTYPE = Ext_calendar_form_TimeField_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_calendar_form_TimeField_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_calendar_form_TimeField_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_calendar_form_TimeField_Component.EVENTS());
    return _this;
  }
