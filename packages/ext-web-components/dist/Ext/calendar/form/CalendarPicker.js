...
function (_Ext_field_Select_Com) {
  ...
  function Ext_calendar_form_CalendarPicker_Component(propertiesobject, methods, events) {
    return _Ext_field_Select_Com.call(this, Object.assign(propertiesobject, Ext_calendar_form_CalendarPicker_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_calendar_form_CalendarPicker_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_calendar_form_CalendarPicker_Component.METHODS()), events.concat(Ext_calendar_form_CalendarPicker_Component.EVENTS())) || this; //this.XTYPE = Ext_calendar_form_CalendarPicker_Component.XTYPE()
