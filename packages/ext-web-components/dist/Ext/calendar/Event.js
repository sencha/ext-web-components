...
function (_Ext_calendar_EventBa) {
  ...
  function Ext_calendar_Event_Component() {
    var _this;

    _this = _Ext_calendar_EventBa.call(this, Ext_calendar_Event_Component.METHODS(), Ext_calendar_Event_Component.XTYPE(), Ext_calendar_Event_Component.PROPERTIESOBJECT(), Ext_calendar_Event_Component.EVENTS()) || this;
    _this.XTYPE = Ext_calendar_Event_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_calendar_Event_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_calendar_Event_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_calendar_Event_Component.EVENTS());
    return _this;
  }
