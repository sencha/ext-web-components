...
function (_Ext_Gadget_Component) {
  ...
  function Ext_calendar_view_Base_Component() {
    var _this;

    _this = _Ext_Gadget_Component.call(this, Ext_calendar_view_Base_Component.METHODS(), Ext_calendar_view_Base_Component.XTYPE(), Ext_calendar_view_Base_Component.PROPERTIESOBJECT(), Ext_calendar_view_Base_Component.EVENTS()) || this;
    _this.XTYPE = Ext_calendar_view_Base_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_calendar_view_Base_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_calendar_view_Base_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_calendar_view_Base_Component.EVENTS());
    return _this;
  }
