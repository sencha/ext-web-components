...
function (_Ext_calendar_view_We) {
  ...
  function Ext_calendar_view_Month_Component(propertiesobject, methods, events) {
    return _Ext_calendar_view_We.call(this, Object.assign(propertiesobject, Ext_calendar_view_Month_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_calendar_view_Month_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_calendar_view_Month_Component.METHODS()), events.concat(Ext_calendar_view_Month_Component.EVENTS())) || this; //this.XTYPE = Ext_calendar_view_Month_Component.XTYPE()
