...
function (_Ext_calendar_view_Da) {
  ...
  function Ext_calendar_view_Day_Component(propertiesobject, methods, events) {
    return _Ext_calendar_view_Da.call(this, Object.assign(propertiesobject, Ext_calendar_view_Day_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_calendar_view_Day_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_calendar_view_Day_Component.METHODS()), events.concat(Ext_calendar_view_Day_Component.EVENTS())) || this; //this.XTYPE = Ext_calendar_view_Day_Component.XTYPE()
