...
function (_Ext_Widget_Component) {
  ...
  function Ext_lib_Component_Component(propertiesobject, methods, events) {
    return _Ext_Widget_Component.call(this, Object.assign(propertiesobject, Ext_lib_Component_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_lib_Component_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_lib_Component_Component.METHODS()), events.concat(Ext_lib_Component_Component.EVENTS())) || this; //this.XTYPE = Ext_lib_Component_Component.XTYPE()
