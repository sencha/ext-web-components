...
function (_Ext_Component_Compon) {
  ...
  function Ext_lib_Container_Component() {
    var _this;

    _this = _Ext_Component_Compon.call(this, Ext_lib_Container_Component.METHODS(), Ext_lib_Container_Component.XTYPE(), Ext_lib_Container_Component.PROPERTIESOBJECT(), Ext_lib_Container_Component.EVENTS()) || this;
    _this.XTYPE = Ext_lib_Container_Component.XTYPE();
    _this.PROPERTIESOBJECT = _this.extendObject(_this.PROPERTIESOBJECT, Ext_lib_Container_Component.PROPERTIESOBJECT());
    _this.METHODS = _this.extendArray(_this.METHODS, Ext_lib_Container_Component.METHODS());
    _this.EVENTS = _this.extendArray(_this.EVENTS, Ext_lib_Container_Component.EVENTS());
    return _this;
  }
