...
function (_Ext_Component_Compon) {
  ...
  function Ext_IndexBar_Component(propertiesobject, methods, events) {
    return _Ext_Component_Compon.call(this, Object.assign(propertiesobject, Ext_IndexBar_Component.PROPERTIESOBJECT()), //{propertiesobject, Ext_IndexBar_Component.PROPERTIESOBJECT()},
    methods.concat(Ext_IndexBar_Component.METHODS()), events.concat(Ext_IndexBar_Component.EVENTS())) || this; //this.XTYPE = Ext_IndexBar_Component.XTYPE()
