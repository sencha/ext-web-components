...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtExpandtriggerComponent, _ExtBase);

  ExtExpandtriggerComponent.XTYPE = function XTYPE() {
    return 'expandtrigger';
  };

  ExtExpandtriggerComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtExpandtriggerComponent.EVENTS = function EVENTS() {
    return [{
      ...
      name: 'beforetofront',
      parameters: 'expandtrigger'
    }, {
      name: 'beforewidthchange',
      parameters: 'sender,value,oldValue,undefined'
    }, {
      name: 'blur',
      parameters: 'expandtrigger,event'
    }, {
      name: 'disabledchange',
  ...
  ExtExpandtriggerComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtExpandtriggerComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtExpandtriggerComponent() {
    ...
    _this.METHODS = ExtExpandtriggerComponent.METHODS();
    _this.XTYPE = ExtExpandtriggerComponent.XTYPE(); //this.PROPERTIES = ExtExpandtriggerComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtExpandtriggerComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtExpandtriggerComponent.EVENTS();
    return _this;
  }

  var _proto = ExtExpandtriggerComponent.prototype;
