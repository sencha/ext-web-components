...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtTitleComponent, _ExtBase);

  ExtTitleComponent.XTYPE = function XTYPE() {
    return 'title';
  };

  ExtTitleComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtTitleComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtTitleComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtTitleComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtTitleComponent() {
    ...
    _this.METHODS = ExtTitleComponent.METHODS();
    _this.XTYPE = ExtTitleComponent.XTYPE(); //this.PROPERTIES = ExtTitleComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtTitleComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtTitleComponent.EVENTS();
    return _this;
  }

  var _proto = ExtTitleComponent.prototype;
