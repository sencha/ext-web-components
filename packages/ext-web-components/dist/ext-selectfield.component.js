...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtSelectfieldComponent, _ExtBase);

  ExtSelectfieldComponent.XTYPE = function XTYPE() {
    return 'selectfield';
  };

  ExtSelectfieldComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
      "alignTarget": ["string"],
  ...
  ExtSelectfieldComponent.EVENTS = function EVENTS() {
    return [{
      name: 'action',
  ...
  ExtSelectfieldComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtSelectfieldComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtSelectfieldComponent() {
    ...
    _this.METHODS = ExtSelectfieldComponent.METHODS();
    _this.XTYPE = ExtSelectfieldComponent.XTYPE(); //this.PROPERTIES = ExtSelectfieldComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtSelectfieldComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtSelectfieldComponent.EVENTS();
    return _this;
  }

  var _proto = ExtSelectfieldComponent.prototype;
