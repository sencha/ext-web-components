...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtD3_partitionComponent, _ExtBase);

  ExtD3_partitionComponent.XTYPE = function XTYPE() {
    return 'd3_partition';
  };

  ExtD3_partitionComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtD3_partitionComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtD3_partitionComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtD3_partitionComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtD3_partitionComponent() {
    ...
    _this.METHODS = ExtD3_partitionComponent.METHODS();
    _this.XTYPE = ExtD3_partitionComponent.XTYPE(); //this.PROPERTIES = ExtD3_partitionComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtD3_partitionComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtD3_partitionComponent.EVENTS();
    return _this;
  }

  var _proto = ExtD3_partitionComponent.prototype;
