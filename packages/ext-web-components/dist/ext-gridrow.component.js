...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtGridrowComponent, _ExtBase);

  ExtGridrowComponent.XTYPE = function XTYPE() {
    return 'gridrow';
  };

  ExtGridrowComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtGridrowComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtGridrowComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtGridrowComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtGridrowComponent() {
    ...
    _this.METHODS = ExtGridrowComponent.METHODS();
    _this.XTYPE = ExtGridrowComponent.XTYPE(); //this.PROPERTIES = ExtGridrowComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtGridrowComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtGridrowComponent.EVENTS();
    return _this;
  }

  var _proto = ExtGridrowComponent.prototype;
