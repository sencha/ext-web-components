...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtPivotsettingsComponent, _ExtBase);

  ExtPivotsettingsComponent.XTYPE = function XTYPE() {
    return 'pivotsettings';
  };

  ExtPivotsettingsComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtPivotsettingsComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'newActiveItem,pivotsettings,oldActiveItem'
    }, {
      name: 'activeItemchange',
      parameters: 'sender,value,oldValue'
    }, {
      name: 'add',
      parameters: 'pivotsettings,item,index'
    }, {
      name: 'added',
      ...
      parameters: 'pivotsettings,context'
    }, {
      ...
      name: 'beforesubmit',
      parameters: 'pivotsettings,values,options,e'
    }, {
      name: 'beforetofront',
      parameters: 'pivotsettings'
    }, {
      ...
      name: 'blur',
      parameters: 'pivotsettings,event'
    }, {
      name: 'bottomchange',
      parameters: 'sender,value,oldValue'
    }, {
      ...
      name: 'deactivate',
      parameters: 'oldActiveItem,pivotsettings,newActiveItem'
    }, {
      name: 'destroy',
      parameters: ''
    }, {
      name: 'dirtychange',
      parameters: 'pivotsettings,dirty'
    }, {
      name: 'disabledchange',
      parameters: 'sender,value,oldValue'
    }, {
      ...
      name: 'exception',
      parameters: 'pivotsettings,result'
    }, {
      name: 'expand',
      parameters: 'pivotsettings'
    }, {
      ...
      name: 'move',
      parameters: 'pivotsettings,item,toIndex,fromIndex'
    }, {
      name: 'moved',
      ...
      name: 'renderedchange',
      parameters: 'pivotsettings,item,rendered'
    }, {
      name: 'resize',
      ...
      name: 'submit',
      parameters: 'pivotsettings,result,e'
    }, {
      name: 'tofront',
      parameters: 'pivotsettings'
    }, {
  ...
  ExtPivotsettingsComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtPivotsettingsComponent, [{
  ...
  function ExtPivotsettingsComponent() {
    ...
    _this.METHODS = ExtPivotsettingsComponent.METHODS();
    _this.XTYPE = ExtPivotsettingsComponent.XTYPE(); //this.PROPERTIES = ExtPivotsettingsComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtPivotsettingsComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtPivotsettingsComponent.EVENTS();
    return _this;
  }

  var _proto = ExtPivotsettingsComponent.prototype;
