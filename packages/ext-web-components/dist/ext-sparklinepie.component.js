...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtSparklinepieComponent, _ExtBase);

  ExtSparklinepieComponent.XTYPE = function XTYPE() {
    return 'sparklinepie';
  };

  ExtSparklinepieComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtSparklinepieComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtSparklinepieComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtSparklinepieComponent, [{
    key: "alignSelf",
    get: function get() {
    ...
    set: function set(borderColor) {
      this.setAttribute('borderColor', borderColor);
    }
  }, {
    key: "borderWidth",
    get: function get() {
    ...
    set: function set(borderWidth) {
      this.setAttribute('borderWidth', borderWidth);
    }
  }, {
    key: "bottom",
    get: function get() {
    ...
    key: "sliceColors",
    get: function get() {
      return this.getAttribute('sliceColors');
    },
    set: function set(sliceColors) {
      this.setAttribute('sliceColors', sliceColors);
    }
  }, {
    key: "stateful",
    get: function get() {
  ...
  function ExtSparklinepieComponent() {
    ...
    _this.METHODS = ExtSparklinepieComponent.METHODS();
    _this.XTYPE = ExtSparklinepieComponent.XTYPE(); //this.PROPERTIES = ExtSparklinepieComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtSparklinepieComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtSparklinepieComponent.EVENTS();
    return _this;
  }

  var _proto = ExtSparklinepieComponent.prototype;
