...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtSparklinediscreteComponent, _ExtBase);

  ExtSparklinediscreteComponent.XTYPE = function XTYPE() {
    return 'sparklinediscrete';
  };

  ExtSparklinediscreteComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtSparklinediscreteComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
      ...
      name: 'blur',
      parameters: 'sparklinediscrete,event'
    }, {
      name: 'bottomchange',
  ...
  ExtSparklinediscreteComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtSparklinediscreteComponent, [{
    key: "alwaysOnTop",
    get: function get() {
    ...
    set: function set(lineHeight) {
      this.setAttribute('lineHeight', lineHeight);
    }
  }, {
    key: "listeners",
    get: function get() {
    ...
    key: "thresholdColor",
    get: function get() {
      return this.getAttribute('thresholdColor');
    },
    set: function set(thresholdColor) {
      this.setAttribute('thresholdColor', thresholdColor);
    }
  }, {
    key: "thresholdValue",
    get: function get() {
      return this.getAttribute('thresholdValue');
    },
    set: function set(thresholdValue) {
      this.setAttribute('thresholdValue', thresholdValue);
    }
  }, {
    key: "tipTpl",
    get: function get() {
  ...
  function ExtSparklinediscreteComponent() {
    ...
    _this.METHODS = ExtSparklinediscreteComponent.METHODS();
    _this.XTYPE = ExtSparklinediscreteComponent.XTYPE(); //this.PROPERTIES = ExtSparklinediscreteComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtSparklinediscreteComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtSparklinediscreteComponent.EVENTS();
    return _this;
  }

  var _proto = ExtSparklinediscreteComponent.prototype;
