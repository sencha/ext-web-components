...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtPickerfieldComponent, _ExtBase);

  ExtPickerfieldComponent.XTYPE = function XTYPE() {
    return 'pickerfield';
  };

  ExtPickerfieldComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
      "alignTarget": ["string"],
  ...
  ExtPickerfieldComponent.EVENTS = function EVENTS() {
    return [{
      name: 'action',
  ...
  ExtPickerfieldComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtPickerfieldComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtPickerfieldComponent() {
    ...
    _this.METHODS = ExtPickerfieldComponent.METHODS();
    _this.XTYPE = ExtPickerfieldComponent.XTYPE(); //this.PROPERTIES = ExtPickerfieldComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtPickerfieldComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtPickerfieldComponent.EVENTS();
    return _this;
  }

  var _proto = ExtPickerfieldComponent.prototype;
