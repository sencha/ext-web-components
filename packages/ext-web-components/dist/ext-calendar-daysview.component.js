...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtCalendar_daysviewComponent, _ExtBase);

  ExtCalendar_daysviewComponent.XTYPE = function XTYPE() {
    return 'calendar_daysview';
  };

  ExtCalendar_daysviewComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "addForm": "Object",
  ...
  ExtCalendar_daysviewComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtCalendar_daysviewComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtCalendar_daysviewComponent, [{
    key: "addForm",
    get: function get() {
  ...
  function ExtCalendar_daysviewComponent() {
    ...
    _this.METHODS = ExtCalendar_daysviewComponent.METHODS();
    _this.XTYPE = ExtCalendar_daysviewComponent.XTYPE(); //this.PROPERTIES = ExtCalendar_daysviewComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtCalendar_daysviewComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtCalendar_daysviewComponent.EVENTS();
    return _this;
  }

  var _proto = ExtCalendar_daysviewComponent.prototype;
