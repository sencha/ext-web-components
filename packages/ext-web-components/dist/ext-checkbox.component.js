...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtCheckboxComponent, _ExtBase);

  ExtCheckboxComponent.XTYPE = function XTYPE() {
    return 'checkbox';
  };

  ExtCheckboxComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtCheckboxComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtCheckboxComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtCheckboxComponent, [{
    key: "alwaysOnTop",
    get: function get() {
  ...
  function ExtCheckboxComponent() {
    ...
    _this.METHODS = ExtCheckboxComponent.METHODS();
    _this.XTYPE = ExtCheckboxComponent.XTYPE(); //this.PROPERTIES = ExtCheckboxComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtCheckboxComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtCheckboxComponent.EVENTS();
    return _this;
  }

  var _proto = ExtCheckboxComponent.prototype;
