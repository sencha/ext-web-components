...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtPivotgridrowComponent, _ExtBase);

  ExtPivotgridrowComponent.XTYPE = function XTYPE() {
    return 'pivotgridrow';
  };

  ExtPivotgridrowComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtPivotgridrowComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtPivotgridrowComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtPivotgridrowComponent, [{
    key: "alwaysOnTop",
    get: function get() {
  ...
  function ExtPivotgridrowComponent() {
    ...
    _this.METHODS = ExtPivotgridrowComponent.METHODS();
    _this.XTYPE = ExtPivotgridrowComponent.XTYPE(); //this.PROPERTIES = ExtPivotgridrowComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtPivotgridrowComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtPivotgridrowComponent.EVENTS();
    return _this;
  }

  var _proto = ExtPivotgridrowComponent.prototype;
