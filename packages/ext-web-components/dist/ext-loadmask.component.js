...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtLoadmaskComponent, _ExtBase);

  ExtLoadmaskComponent.XTYPE = function XTYPE() {
    return 'loadmask';
  };

  ExtLoadmaskComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtLoadmaskComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtLoadmaskComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtLoadmaskComponent, [{
    key: "alwaysOnTop",
    get: function get() {
    ...
    key: "messageCls",
    get: function get() {
      return this.getAttribute('messageCls');
    },
    set: function set(messageCls) {
      this.setAttribute('messageCls', messageCls);
    }
  }, {
    key: "minHeight",
    get: function get() {
  ...
  function ExtLoadmaskComponent() {
    ...
    _this.METHODS = ExtLoadmaskComponent.METHODS();
    _this.XTYPE = ExtLoadmaskComponent.XTYPE(); //this.PROPERTIES = ExtLoadmaskComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtLoadmaskComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtLoadmaskComponent.EVENTS();
    return _this;
  }

  var _proto = ExtLoadmaskComponent.prototype;
