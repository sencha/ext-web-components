...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtTextcolumnComponent, _ExtBase);

  ExtTextcolumnComponent.XTYPE = function XTYPE() {
    return 'textcolumn';
  };

  ExtTextcolumnComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    var _ref;
  ...
  ExtTextcolumnComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtTextcolumnComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtTextcolumnComponent, [{
  ...
  function ExtTextcolumnComponent() {
    ...
    _this.METHODS = ExtTextcolumnComponent.METHODS();
    _this.XTYPE = ExtTextcolumnComponent.XTYPE(); //this.PROPERTIES = ExtTextcolumnComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtTextcolumnComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtTextcolumnComponent.EVENTS();
    return _this;
  }

  var _proto = ExtTextcolumnComponent.prototype;
