...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtD3Component, _ExtBase);

  ExtD3Component.XTYPE = function XTYPE() {
    return 'd3';
  };

  ExtD3Component.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtD3Component.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtD3Component.METHODS = function METHODS() {
    return [{
  ...
  function ExtD3Component() {
    ...
    _this.METHODS = ExtD3Component.METHODS();
    _this.XTYPE = ExtD3Component.XTYPE(); //this.PROPERTIES = ExtD3Component.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtD3Component.PROPERTIESOBJECT();
    _this.EVENTS = ExtD3Component.EVENTS();
    return _this;
  }

  var _proto = ExtD3Component.prototype;
