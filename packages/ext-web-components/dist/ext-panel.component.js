...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtPanelComponent, _ExtBase);

  ExtPanelComponent.XTYPE = function XTYPE() {
    return 'panel';
  };

  ExtPanelComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtPanelComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtPanelComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtPanelComponent, [{
  ...
  function ExtPanelComponent() {
    ...
    _this.METHODS = ExtPanelComponent.METHODS();
    _this.XTYPE = ExtPanelComponent.XTYPE(); //this.PROPERTIES = ExtPanelComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtPanelComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtPanelComponent.EVENTS();
    return _this;
  }

  var _proto = ExtPanelComponent.prototype;
