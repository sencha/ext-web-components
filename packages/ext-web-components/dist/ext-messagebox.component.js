...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtMessageboxComponent, _ExtBase);

  ExtMessageboxComponent.XTYPE = function XTYPE() {
    return 'messagebox';
  };

  ExtMessageboxComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtMessageboxComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtMessageboxComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtMessageboxComponent, [{
    ...
    get: function get() {
      return this.getAttribute('defaultTextHeight');
    },
    set: function set(defaultTextHeight) {
      this.setAttribute('defaultTextHeight', defaultTextHeight);
    }
  }, {
  ...
  function ExtMessageboxComponent() {
    ...
    _this.METHODS = ExtMessageboxComponent.METHODS();
    _this.XTYPE = ExtMessageboxComponent.XTYPE(); //this.PROPERTIES = ExtMessageboxComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtMessageboxComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtMessageboxComponent.EVENTS();
    return _this;
  }

  var _proto = ExtMessageboxComponent.prototype;
