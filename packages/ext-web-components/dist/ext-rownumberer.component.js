...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtRownumbererComponent, _ExtBase);

  ExtRownumbererComponent.XTYPE = function XTYPE() {
    return 'rownumberer';
  };

  ExtRownumbererComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    var _ref;
  ...
  ExtRownumbererComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'newActiveItem,rownumberer,oldActiveItem'
    }, {
      name: 'activeItemchange',
      parameters: 'sender,value,oldValue'
    }, {
      name: 'add',
      parameters: 'rownumberer,item,index'
    }, {
      name: 'added',
      ...
      name: 'deactivate',
      parameters: 'oldActiveItem,rownumberer,newActiveItem'
    }, {
      name: 'destroy',
      parameters: ''
    }, {
      ...
      name: 'move',
      parameters: 'rownumberer,item,toIndex,fromIndex'
    }, {
      name: 'moved',
      ...
      name: 'renderedchange',
      parameters: 'rownumberer,item,rendered'
    }, {
      name: 'resize',
  ...
  ExtRownumbererComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtRownumbererComponent, [{
  ...
  function ExtRownumbererComponent() {
    ...
    _this.METHODS = ExtRownumbererComponent.METHODS();
    _this.XTYPE = ExtRownumbererComponent.XTYPE(); //this.PROPERTIES = ExtRownumbererComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtRownumbererComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtRownumbererComponent.EVENTS();
    return _this;
  }

  var _proto = ExtRownumbererComponent.prototype;
