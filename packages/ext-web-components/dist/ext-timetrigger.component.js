...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtTimetriggerComponent, _ExtBase);

  ExtTimetriggerComponent.XTYPE = function XTYPE() {
    return 'timetrigger';
  };

  ExtTimetriggerComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtTimetriggerComponent.EVENTS = function EVENTS() {
    return [{
  ...
  ExtTimetriggerComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtTimetriggerComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtTimetriggerComponent() {
    ...
    _this.METHODS = ExtTimetriggerComponent.METHODS();
    _this.XTYPE = ExtTimetriggerComponent.XTYPE(); //this.PROPERTIES = ExtTimetriggerComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtTimetriggerComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtTimetriggerComponent.EVENTS();
    return _this;
  }

  var _proto = ExtTimetriggerComponent.prototype;
