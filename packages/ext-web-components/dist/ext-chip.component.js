...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtChipComponent, _ExtBase);

  ExtChipComponent.XTYPE = function XTYPE() {
    return 'chip';
  };

  ExtChipComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtChipComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtChipComponent.METHODS = function METHODS() {
    return [{
  ...
  function ExtChipComponent() {
    ...
    _this.METHODS = ExtChipComponent.METHODS();
    _this.XTYPE = ExtChipComponent.XTYPE(); //this.PROPERTIES = ExtChipComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtChipComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtChipComponent.EVENTS();
    return _this;
  }

  var _proto = ExtChipComponent.prototype;
