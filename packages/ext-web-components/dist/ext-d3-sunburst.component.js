...
function (_ExtBase) {
  ...
  ExtD3_sunburstComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtD3_sunburstComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtD3_sunburstComponent, [{
    key: "alignSelf",
    get: function get() {
    ...
    set: function set(textPadding) {
      this.setAttribute('textPadding', textPadding);
    }
  }, {
    key: "toFrontOnShow",
    get: function get() {
    ...
    key: "zoomParentDotRadius",
    get: function get() {
      return this.getAttribute('zoomParentDotRadius');
    },
    set: function set(zoomParentDotRadius) {
      this.setAttribute('zoomParentDotRadius', zoomParentDotRadius);
    }
  }, {
    key: "platformConfig",
    get: function get() {
  ...
  function ExtD3_sunburstComponent() {
    ...
    _this.METHODS = ExtD3_sunburstComponent.METHODS();
    _this.XTYPE = ExtD3_sunburstComponent.XTYPE(); //this.PROPERTIES = ExtD3_sunburstComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtD3_sunburstComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtD3_sunburstComponent.EVENTS();
    return _this;
  }

  var _proto = ExtD3_sunburstComponent.prototype;
