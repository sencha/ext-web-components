...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtDatefieldComponent, _ExtBase);

  ExtDatefieldComponent.XTYPE = function XTYPE() {
    return 'datefield';
  };

  ExtDatefieldComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
      "alignTarget": ["string"],
  ...
  ExtDatefieldComponent.EVENTS = function EVENTS() {
    return [{
      name: 'action',
  ...
  ExtDatefieldComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtDatefieldComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtDatefieldComponent() {
    ...
    _this.METHODS = ExtDatefieldComponent.METHODS();
    _this.XTYPE = ExtDatefieldComponent.XTYPE(); //this.PROPERTIES = ExtDatefieldComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtDatefieldComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtDatefieldComponent.EVENTS();
    return _this;
  }

  var _proto = ExtDatefieldComponent.prototype;
