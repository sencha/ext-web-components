...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtActionsheetComponent, _ExtBase);

  ExtActionsheetComponent.XTYPE = function XTYPE() {
    return 'actionsheet';
  };

  ExtActionsheetComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtActionsheetComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'newActiveItem,actionsheet,oldActiveItem'
    }, {
      name: 'activeItemchange',
      parameters: 'sender,value,oldValue'
    }, {
      name: 'add',
      parameters: 'actionsheet,item,index'
    }, {
      name: 'added',
      ...
      parameters: 'actionsheet,context'
    }, {
      ...
      name: 'deactivate',
      parameters: 'oldActiveItem,actionsheet,newActiveItem'
    }, {
      name: 'destroy',
      parameters: ''
    }, {
      ...
      name: 'move',
      parameters: 'actionsheet,item,toIndex,fromIndex'
    }, {
      name: 'moved',
      ...
      name: 'renderedchange',
      parameters: 'actionsheet,item,rendered'
    }, {
      name: 'resize',
  ...
  ExtActionsheetComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtActionsheetComponent, [{
  ...
  function ExtActionsheetComponent() {
    ...
    _this.METHODS = ExtActionsheetComponent.METHODS();
    _this.XTYPE = ExtActionsheetComponent.XTYPE(); //this.PROPERTIES = ExtActionsheetComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtActionsheetComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtActionsheetComponent.EVENTS();
    return _this;
  }

  var _proto = ExtActionsheetComponent.prototype;
