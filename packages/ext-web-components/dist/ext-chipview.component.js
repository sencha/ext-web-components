...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtChipviewComponent, _ExtBase);

  ExtChipviewComponent.XTYPE = function XTYPE() {
    return 'chipview';
  };

  ExtChipviewComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtChipviewComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtChipviewComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtChipviewComponent, [{
    ...
    key: "closableField",
    get: function get() {
      return this.getAttribute('closableField');
    },
    set: function set(closableField) {
      this.setAttribute('closableField', closableField);
    }
  }, {
    key: "closeHandler",
    get: function get() {
      return this.getAttribute('closeHandler');
    },
    set: function set(closeHandler) {
      this.setAttribute('closeHandler', closeHandler);
    }
  }, {
    key: "cls",
    get: function get() {
    ...
    key: "iconClsField",
    get: function get() {
      return this.getAttribute('iconClsField');
    },
    set: function set(iconClsField) {
      this.setAttribute('iconClsField', iconClsField);
    }
  }, {
    key: "iconField",
    get: function get() {
      return this.getAttribute('iconField');
    },
    set: function set(iconField) {
      this.setAttribute('iconField', iconField);
    }
  }, {
    key: "id",
    get: function get() {
  ...
  function ExtChipviewComponent() {
    ...
    _this.METHODS = ExtChipviewComponent.METHODS();
    _this.XTYPE = ExtChipviewComponent.XTYPE(); //this.PROPERTIES = ExtChipviewComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtChipviewComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtChipviewComponent.EVENTS();
    return _this;
  }

  var _proto = ExtChipviewComponent.prototype;
