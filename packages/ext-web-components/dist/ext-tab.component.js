...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtTabComponent, _ExtBase);

  ExtTabComponent.XTYPE = function XTYPE() {
    return 'tab';
  };

  ExtTabComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "active": ["boolean"],
      "alignSelf": ["string"],
  ...
  ExtTabComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'tab'
    }, {
  ...
  ExtTabComponent.METHODS = function METHODS() {
    return [{
  ...
  function ExtTabComponent() {
    ...
    _this.METHODS = ExtTabComponent.METHODS();
    _this.XTYPE = ExtTabComponent.XTYPE(); //this.PROPERTIES = ExtTabComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtTabComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtTabComponent.EVENTS();
    return _this;
  }

  var _proto = ExtTabComponent.prototype;
