...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtPasswordfieldComponent, _ExtBase);

  ExtPasswordfieldComponent.XTYPE = function XTYPE() {
    return 'passwordfield';
  };

  ExtPasswordfieldComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtPasswordfieldComponent.EVENTS = function EVENTS() {
    return [{
      name: 'action',
  ...
  ExtPasswordfieldComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtPasswordfieldComponent, [{
    key: "alignSelf",
    get: function get() {
    ...
    key: "revealable",
    get: function get() {
      return this.getAttribute('revealable');
    },
    set: function set(revealable) {
      this.setAttribute('revealable', revealable);
    }
  }, {
    key: "revealed",
    get: function get() {
      return this.getAttribute('revealed');
    },
    set: function set(revealed) {
      this.setAttribute('revealed', revealed);
    }
  }, {
    key: "right",
    get: function get() {
  ...
  function ExtPasswordfieldComponent() {
    ...
    _this.METHODS = ExtPasswordfieldComponent.METHODS();
    _this.XTYPE = ExtPasswordfieldComponent.XTYPE(); //this.PROPERTIES = ExtPasswordfieldComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtPasswordfieldComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtPasswordfieldComponent.EVENTS();
    return _this;
  }

  var _proto = ExtPasswordfieldComponent.prototype;
