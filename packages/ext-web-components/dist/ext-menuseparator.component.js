...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtMenuseparatorComponent, _ExtBase);

  ExtMenuseparatorComponent.XTYPE = function XTYPE() {
    return 'menuseparator';
  };

  ExtMenuseparatorComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtMenuseparatorComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
      ...
      name: 'blur',
      parameters: 'menuseparator,event'
    }, {
      name: 'bottomchange',
  ...
  ExtMenuseparatorComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtMenuseparatorComponent, [{
    key: "alwaysOnTop",
    get: function get() {
  ...
  function ExtMenuseparatorComponent() {
    ...
    _this.METHODS = ExtMenuseparatorComponent.METHODS();
    _this.XTYPE = ExtMenuseparatorComponent.XTYPE(); //this.PROPERTIES = ExtMenuseparatorComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtMenuseparatorComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtMenuseparatorComponent.EVENTS();
    return _this;
  }

  var _proto = ExtMenuseparatorComponent.prototype;
