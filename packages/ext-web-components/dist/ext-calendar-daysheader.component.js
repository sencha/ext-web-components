...
function (_ExtBase) {
  ...
  ExtCalendar_daysheaderComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
      ...
      name: 'beforetofront',
      parameters: 'calendar-daysheader'
    }, {
      ...
      name: 'blur',
      parameters: 'calendar-daysheader,event'
    }, {
      name: 'bottomchange',
  ...
  ExtCalendar_daysheaderComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtCalendar_daysheaderComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtCalendar_daysheaderComponent() {
    ...
    _this.METHODS = ExtCalendar_daysheaderComponent.METHODS();
    _this.XTYPE = ExtCalendar_daysheaderComponent.XTYPE(); //this.PROPERTIES = ExtCalendar_daysheaderComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtCalendar_daysheaderComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtCalendar_daysheaderComponent.EVENTS();
    return _this;
  }

  var _proto = ExtCalendar_daysheaderComponent.prototype;
