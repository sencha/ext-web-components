...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtGridcolumnsmenuComponent, _ExtBase);

  ExtGridcolumnsmenuComponent.XTYPE = function XTYPE() {
    return 'gridcolumnsmenu';
  };

  ExtGridcolumnsmenuComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtGridcolumnsmenuComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
      ...
      name: 'blur',
      parameters: 'gridcolumnsmenu,event'
    }, {
      name: 'bottomchange',
  ...
  ExtGridcolumnsmenuComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtGridcolumnsmenuComponent, [{
    key: "alwaysOnTop",
    get: function get() {
  ...
  function ExtGridcolumnsmenuComponent() {
    ...
    _this.METHODS = ExtGridcolumnsmenuComponent.METHODS();
    _this.XTYPE = ExtGridcolumnsmenuComponent.XTYPE(); //this.PROPERTIES = ExtGridcolumnsmenuComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtGridcolumnsmenuComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtGridcolumnsmenuComponent.EVENTS();
    return _this;
  }

  var _proto = ExtGridcolumnsmenuComponent.prototype;
