...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtPickerComponent, _ExtBase);

  ExtPickerComponent.XTYPE = function XTYPE() {
    return 'picker';
  };

  ExtPickerComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtPickerComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtPickerComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtPickerComponent, [{
  ...
  function ExtPickerComponent() {
    ...
    _this.METHODS = ExtPickerComponent.METHODS();
    _this.XTYPE = ExtPickerComponent.XTYPE(); //this.PROPERTIES = ExtPickerComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtPickerComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtPickerComponent.EVENTS();
    return _this;
  }

  var _proto = ExtPickerComponent.prototype;
