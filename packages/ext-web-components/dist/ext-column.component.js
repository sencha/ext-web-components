...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtColumnComponent, _ExtBase);

  ExtColumnComponent.XTYPE = function XTYPE() {
    return 'column';
  };

  ExtColumnComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    var _ref;
  ...
  ExtColumnComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtColumnComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtColumnComponent, [{
  ...
  function ExtColumnComponent() {
    ...
    _this.METHODS = ExtColumnComponent.METHODS();
    _this.XTYPE = ExtColumnComponent.XTYPE(); //this.PROPERTIES = ExtColumnComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtColumnComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtColumnComponent.EVENTS();
    return _this;
  }

  var _proto = ExtColumnComponent.prototype;
