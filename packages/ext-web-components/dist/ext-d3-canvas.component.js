...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtD3_canvasComponent, _ExtBase);

  ExtD3_canvasComponent.XTYPE = function XTYPE() {
    return 'd3_canvas';
  };

  ExtD3_canvasComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtD3_canvasComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtD3_canvasComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtD3_canvasComponent, [{
    key: "alwaysOnTop",
    get: function get() {
    ...
    key: "hdpi",
    get: function get() {
      return this.getAttribute('hdpi');
    },
    set: function set(hdpi) {
      this.setAttribute('hdpi', hdpi);
    }
  }, {
    key: "height",
    get: function get() {
  ...
  function ExtD3_canvasComponent() {
    ...
    _this.METHODS = ExtD3_canvasComponent.METHODS();
    _this.XTYPE = ExtD3_canvasComponent.XTYPE(); //this.PROPERTIES = ExtD3_canvasComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtD3_canvasComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtD3_canvasComponent.EVENTS();
    return _this;
  }

  var _proto = ExtD3_canvasComponent.prototype;
