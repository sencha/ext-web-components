...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtThumbComponent, _ExtBase);

  ExtThumbComponent.XTYPE = function XTYPE() {
    return 'thumb';
  };

  ExtThumbComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtThumbComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtThumbComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtThumbComponent, [{
    key: "alignSelf",
    get: function get() {
    ...
    key: "fillCls",
    get: function get() {
      return this.getAttribute('fillCls');
    },
    set: function set(fillCls) {
      this.setAttribute('fillCls', fillCls);
    }
  }, {
    key: "fillTrack",
    get: function get() {
      return this.getAttribute('fillTrack');
    },
    set: function set(fillTrack) {
      this.setAttribute('fillTrack', fillTrack);
    }
  }, {
    key: "flex",
    get: function get() {
  ...
  function ExtThumbComponent() {
    ...
    _this.METHODS = ExtThumbComponent.METHODS();
    _this.XTYPE = ExtThumbComponent.XTYPE(); //this.PROPERTIES = ExtThumbComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtThumbComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtThumbComponent.EVENTS();
    return _this;
  }

  var _proto = ExtThumbComponent.prototype;
