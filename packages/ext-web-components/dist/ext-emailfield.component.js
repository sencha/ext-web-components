...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtEmailfieldComponent, _ExtBase);

  ExtEmailfieldComponent.XTYPE = function XTYPE() {
    return 'emailfield';
  };

  ExtEmailfieldComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtEmailfieldComponent.EVENTS = function EVENTS() {
    return [{
      name: 'action',
      parameters: 'emailfield,e'
    }, {
      name: 'added',
      ...
      name: 'change',
      parameters: 'emailfield,newValue,oldValue'
    }, {
      name: 'clearicontap',
      parameters: 'emailfield,input,e'
    }, {
      name: 'click',
      parameters: 'e'
    }, {
  ...
  ExtEmailfieldComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtEmailfieldComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtEmailfieldComponent() {
    ...
    _this.METHODS = ExtEmailfieldComponent.METHODS();
    _this.XTYPE = ExtEmailfieldComponent.XTYPE(); //this.PROPERTIES = ExtEmailfieldComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtEmailfieldComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtEmailfieldComponent.EVENTS();
    return _this;
  }

  var _proto = ExtEmailfieldComponent.prototype;
