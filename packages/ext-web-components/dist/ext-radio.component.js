...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtRadioComponent, _ExtBase);

  ExtRadioComponent.XTYPE = function XTYPE() {
    return 'radio';
  };
  ...
  ExtRadioComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtRadioComponent.METHODS = function METHODS() {
    return [{
  ...
  function ExtRadioComponent() {
    ...
    _this.METHODS = ExtRadioComponent.METHODS();
    _this.XTYPE = ExtRadioComponent.XTYPE(); //this.PROPERTIES = ExtRadioComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtRadioComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtRadioComponent.EVENTS();
    return _this;
  }

  var _proto = ExtRadioComponent.prototype;
