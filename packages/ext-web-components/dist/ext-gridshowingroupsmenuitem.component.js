...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtGridshowingroupsmenuitemComponent, _ExtBase);

  ExtGridshowingroupsmenuitemComponent.XTYPE = function XTYPE() {
    return 'gridshowingroupsmenuitem';
  };

  ExtGridshowingroupsmenuitemComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtGridshowingroupsmenuitemComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtGridshowingroupsmenuitemComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtGridshowingroupsmenuitemComponent, [{
    key: "alwaysOnTop",
    get: function get() {
  ...
  function ExtGridshowingroupsmenuitemComponent() {
    ...
    _this.METHODS = ExtGridshowingroupsmenuitemComponent.METHODS();
    _this.XTYPE = ExtGridshowingroupsmenuitemComponent.XTYPE(); //this.PROPERTIES = ExtGridshowingroupsmenuitemComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtGridshowingroupsmenuitemComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtGridshowingroupsmenuitemComponent.EVENTS();
    return _this;
  }

  var _proto = ExtGridshowingroupsmenuitemComponent.prototype;
