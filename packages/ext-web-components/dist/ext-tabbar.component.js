...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtTabbarComponent, _ExtBase);

  ExtTabbarComponent.XTYPE = function XTYPE() {
    return 'tabbar';
  };

  ExtTabbarComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtTabbarComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtTabbarComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtTabbarComponent, [{
    ...
    key: "animateIndicator",
    get: function get() {
      return this.getAttribute('animateIndicator');
    },
    set: function set(animateIndicator) {
      this.setAttribute('animateIndicator', animateIndicator);
    }
  }, {
    key: "ariaAttributes",
    get: function get() {
    ...
    key: "defaultTabUI",
    get: function get() {
      return this.getAttribute('defaultTabUI');
    },
    set: function set(defaultTabUI) {
      this.setAttribute('defaultTabUI', defaultTabUI);
    }
  }, {
    key: "defaultType",
    get: function get() {
  ...
  function ExtTabbarComponent() {
    ...
    _this.METHODS = ExtTabbarComponent.METHODS();
    _this.XTYPE = ExtTabbarComponent.XTYPE(); //this.PROPERTIES = ExtTabbarComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtTabbarComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtTabbarComponent.EVENTS();
    return _this;
  }

  var _proto = ExtTabbarComponent.prototype;
