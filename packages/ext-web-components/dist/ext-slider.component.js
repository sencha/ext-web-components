...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtSliderComponent, _ExtBase);

  ExtSliderComponent.XTYPE = function XTYPE() {
    return 'slider';
  };

  ExtSliderComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtSliderComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtSliderComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtSliderComponent, [{
  ...
  function ExtSliderComponent() {
    ...
    _this.METHODS = ExtSliderComponent.METHODS();
    _this.XTYPE = ExtSliderComponent.XTYPE(); //this.PROPERTIES = ExtSliderComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtSliderComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtSliderComponent.EVENTS();
    return _this;
  }

  var _proto = ExtSliderComponent.prototype;
