...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtFilebuttonComponent, _ExtBase);

  ExtFilebuttonComponent.XTYPE = function XTYPE() {
    return 'filebutton';
  };

  ExtFilebuttonComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "accept": ["string"],
      "alignSelf": ["string"],
  ...
  ExtFilebuttonComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtFilebuttonComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtFilebuttonComponent, [{
    key: "accept",
    get: function get() {
      return this.getAttribute('accept');
    },
    set: function set(accept) {
  ...
  function ExtFilebuttonComponent() {
    ...
    _this.METHODS = ExtFilebuttonComponent.METHODS();
    _this.XTYPE = ExtFilebuttonComponent.XTYPE(); //this.PROPERTIES = ExtFilebuttonComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtFilebuttonComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtFilebuttonComponent.EVENTS();
    return _this;
  }

  var _proto = ExtFilebuttonComponent.prototype;
