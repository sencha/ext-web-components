...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtSpinnerfieldComponent, _ExtBase);

  ExtSpinnerfieldComponent.XTYPE = function XTYPE() {
    return 'spinnerfield';
  };

  ExtSpinnerfieldComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtSpinnerfieldComponent.EVENTS = function EVENTS() {
    return [{
      name: 'action',
      parameters: ''
    }, {
  ...
  ExtSpinnerfieldComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtSpinnerfieldComponent, [{
    key: "accelerateOnTapHold",
    get: function get() {
      return this.getAttribute('accelerateOnTapHold');
    },
    set: function set(accelerateOnTapHold) {
      this.setAttribute('accelerateOnTapHold', accelerateOnTapHold);
    }
  }, {
    key: "alignSelf",
    get: function get() {
    ...
    set: function set(decimalSeparator) {
      this.setAttribute('decimalSeparator', decimalSeparator);
    }
  }, {
    key: "decimalsText",
    get: function get() {
      return this.getAttribute('decimalsText');
    },
    set: function set(decimalsText) {
      this.setAttribute('decimalsText', decimalsText);
    }
  }, {
    ...
    key: "maxValueText",
    get: function get() {
      return this.getAttribute('maxValueText');
    },
    set: function set(maxValueText) {
      this.setAttribute('maxValueText', maxValueText);
    }
  }, {
    key: "maxWidth",
    get: function get() {
    ...
    key: "minValueText",
    get: function get() {
      return this.getAttribute('minValueText');
    },
    set: function set(minValueText) {
      this.setAttribute('minValueText', minValueText);
    }
  }, {
    key: "minWidth",
    get: function get() {
    ...
    key: "stepValue",
    get: function get() {
      return this.getAttribute('stepValue');
    },
    set: function set(stepValue) {
      this.setAttribute('stepValue', stepValue);
    }
  }, {
    key: "stripCharsRe",
    get: function get() {
      return this.getAttribute('stripCharsRe');
    },
    set: function set(stripCharsRe) {
  ...
  function ExtSpinnerfieldComponent() {
    ...
    _this.METHODS = ExtSpinnerfieldComponent.METHODS();
    _this.XTYPE = ExtSpinnerfieldComponent.XTYPE(); //this.PROPERTIES = ExtSpinnerfieldComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtSpinnerfieldComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtSpinnerfieldComponent.EVENTS();
    return _this;
  }

  var _proto = ExtSpinnerfieldComponent.prototype;
