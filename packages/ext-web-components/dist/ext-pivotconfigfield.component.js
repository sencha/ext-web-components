...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtPivotconfigfieldComponent, _ExtBase);

  ExtPivotconfigfieldComponent.XTYPE = function XTYPE() {
    return 'pivotconfigfield';
  };

  ExtPivotconfigfieldComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtPivotconfigfieldComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'newActiveItem,pivotconfigfield,oldActiveItem'
    }, {
      name: 'activeItemchange',
      parameters: 'sender,value,oldValue'
    }, {
      name: 'add',
      parameters: 'pivotconfigfield,item,index'
    }, {
      name: 'added',
      ...
      name: 'blur',
      parameters: 'pivotconfigfield,event'
    }, {
      name: 'bottomchange',
      parameters: 'sender,value,oldValue'
    }, {
      ...
      name: 'deactivate',
      parameters: 'oldActiveItem,pivotconfigfield,newActiveItem'
    }, {
      name: 'destroy',
      parameters: ''
    }, {
      ...
      name: 'move',
      parameters: 'pivotconfigfield,item,toIndex,fromIndex'
    }, {
      name: 'moved',
      ...
      name: 'renderedchange',
      parameters: 'pivotconfigfield,item,rendered'
    }, {
      name: 'resize',
  ...
  ExtPivotconfigfieldComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtPivotconfigfieldComponent, [{
  ...
  function ExtPivotconfigfieldComponent() {
    ...
    _this.METHODS = ExtPivotconfigfieldComponent.METHODS();
    _this.XTYPE = ExtPivotconfigfieldComponent.XTYPE(); //this.PROPERTIES = ExtPivotconfigfieldComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtPivotconfigfieldComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtPivotconfigfieldComponent.EVENTS();
    return _this;
  }

  var _proto = ExtPivotconfigfieldComponent.prototype;
