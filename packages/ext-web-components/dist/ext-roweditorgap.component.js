...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtRoweditorgapComponent, _ExtBase);

  ExtRoweditorgapComponent.XTYPE = function XTYPE() {
    return 'roweditorgap';
  };

  ExtRoweditorgapComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtRoweditorgapComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtRoweditorgapComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtRoweditorgapComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtRoweditorgapComponent() {
    ...
    _this.METHODS = ExtRoweditorgapComponent.METHODS();
    _this.XTYPE = ExtRoweditorgapComponent.XTYPE(); //this.PROPERTIES = ExtRoweditorgapComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtRoweditorgapComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtRoweditorgapComponent.EVENTS();
    return _this;
  }

  var _proto = ExtRoweditorgapComponent.prototype;
