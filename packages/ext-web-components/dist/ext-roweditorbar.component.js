...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtRoweditorbarComponent, _ExtBase);

  ExtRoweditorbarComponent.XTYPE = function XTYPE() {
    return 'roweditorbar';
  };

  ExtRoweditorbarComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtRoweditorbarComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtRoweditorbarComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtRoweditorbarComponent, [{
  ...
  function ExtRoweditorbarComponent() {
    ...
    _this.METHODS = ExtRoweditorbarComponent.METHODS();
    _this.XTYPE = ExtRoweditorbarComponent.XTYPE(); //this.PROPERTIES = ExtRoweditorbarComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtRoweditorbarComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtRoweditorbarComponent.EVENTS();
    return _this;
  }

  var _proto = ExtRoweditorbarComponent.prototype;
