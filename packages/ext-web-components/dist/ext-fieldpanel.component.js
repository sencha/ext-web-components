...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtFieldpanelComponent, _ExtBase);

  ExtFieldpanelComponent.XTYPE = function XTYPE() {
    return 'fieldpanel';
  };

  ExtFieldpanelComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtFieldpanelComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtFieldpanelComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtFieldpanelComponent, [{
  ...
  function ExtFieldpanelComponent() {
    ...
    _this.METHODS = ExtFieldpanelComponent.METHODS();
    _this.XTYPE = ExtFieldpanelComponent.XTYPE(); //this.PROPERTIES = ExtFieldpanelComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtFieldpanelComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtFieldpanelComponent.EVENTS();
    return _this;
  }

  var _proto = ExtFieldpanelComponent.prototype;
