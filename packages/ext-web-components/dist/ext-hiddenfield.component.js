...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtHiddenfieldComponent, _ExtBase);

  ExtHiddenfieldComponent.XTYPE = function XTYPE() {
    return 'hiddenfield';
  };

  ExtHiddenfieldComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtHiddenfieldComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
      ...
      name: 'change',
      parameters: 'hiddenfield,newValue,oldValue'
    }, {
      name: 'click',
      parameters: 'e'
    }, {
  ...
  ExtHiddenfieldComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtHiddenfieldComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtHiddenfieldComponent() {
    ...
    _this.METHODS = ExtHiddenfieldComponent.METHODS();
    _this.XTYPE = ExtHiddenfieldComponent.XTYPE(); //this.PROPERTIES = ExtHiddenfieldComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtHiddenfieldComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtHiddenfieldComponent.EVENTS();
    return _this;
  }

  var _proto = ExtHiddenfieldComponent.prototype;
