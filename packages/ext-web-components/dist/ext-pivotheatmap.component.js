...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtPivotheatmapComponent, _ExtBase);

  ExtPivotheatmapComponent.XTYPE = function XTYPE() {
    return 'pivotheatmap';
  };

  ExtPivotheatmapComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtPivotheatmapComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtPivotheatmapComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtPivotheatmapComponent, [{
    key: "alwaysOnTop",
    get: function get() {
    ...
    get: function get() {
      return this.getAttribute('defaultFormatter');
    },
    set: function set(defaultFormatter) {
      this.setAttribute('defaultFormatter', defaultFormatter);
    }
  }, {
    ...
    key: "tiles",
    get: function get() {
      return this.getAttribute('tiles');
    },
  ...
  function ExtPivotheatmapComponent() {
    ...
    _this.METHODS = ExtPivotheatmapComponent.METHODS();
    _this.XTYPE = ExtPivotheatmapComponent.XTYPE(); //this.PROPERTIES = ExtPivotheatmapComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtPivotheatmapComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtPivotheatmapComponent.EVENTS();
    return _this;
  }

  var _proto = ExtPivotheatmapComponent.prototype;
