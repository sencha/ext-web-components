...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtMenucheckitemComponent, _ExtBase);

  ExtMenucheckitemComponent.XTYPE = function XTYPE() {
    return 'menucheckitem';
  };

  ExtMenucheckitemComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtMenucheckitemComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtMenucheckitemComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtMenucheckitemComponent, [{
    key: "alwaysOnTop",
    get: function get() {
  ...
  function ExtMenucheckitemComponent() {
    ...
    _this.METHODS = ExtMenucheckitemComponent.METHODS();
    _this.XTYPE = ExtMenucheckitemComponent.XTYPE(); //this.PROPERTIES = ExtMenucheckitemComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtMenucheckitemComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtMenucheckitemComponent.EVENTS();
    return _this;
  }

  var _proto = ExtMenucheckitemComponent.prototype;
