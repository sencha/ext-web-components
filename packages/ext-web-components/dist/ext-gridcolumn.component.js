...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtGridcolumnComponent, _ExtBase);

  ExtGridcolumnComponent.XTYPE = function XTYPE() {
    return 'gridcolumn';
  };

  ExtGridcolumnComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    var _ref;
  ...
  ExtGridcolumnComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtGridcolumnComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtGridcolumnComponent, [{
  ...
  function ExtGridcolumnComponent() {
    ...
    _this.METHODS = ExtGridcolumnComponent.METHODS();
    _this.XTYPE = ExtGridcolumnComponent.XTYPE(); //this.PROPERTIES = ExtGridcolumnComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtGridcolumnComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtGridcolumnComponent.EVENTS();
    return _this;
  }

  var _proto = ExtGridcolumnComponent.prototype;
