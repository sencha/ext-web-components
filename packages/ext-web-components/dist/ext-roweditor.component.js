...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtRoweditorComponent, _ExtBase);

  ExtRoweditorComponent.XTYPE = function XTYPE() {
    return 'roweditor';
  };

  ExtRoweditorComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtRoweditorComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'newActiveItem,roweditor,oldActiveItem'
    }, {
      name: 'activeItemchange',
      parameters: 'sender,value,oldValue'
    }, {
      name: 'add',
      parameters: 'roweditor,item,index'
    }, {
      name: 'added',
      ...
      name: 'deactivate',
      parameters: 'oldActiveItem,roweditor,newActiveItem'
    }, {
      name: 'destroy',
      parameters: ''
    }, {
      ...
      name: 'move',
      parameters: 'roweditor,item,toIndex,fromIndex'
    }, {
      name: 'moved',
      ...
      name: 'renderedchange',
      parameters: 'roweditor,item,rendered'
    }, {
      name: 'resize',
  ...
  ExtRoweditorComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtRoweditorComponent, [{
    ...
    key: "ownerListeners",
    get: function get() {
      return this.getAttribute('ownerListeners');
    },
    set: function set(ownerListeners) {
      this.setAttribute('ownerListeners', ownerListeners);
    }
  }, {
    key: "padding",
    get: function get() {
    ...
    key: "sourceListeners",
    get: function get() {
      return this.getAttribute('sourceListeners');
    },
    set: function set(sourceListeners) {
      this.setAttribute('sourceListeners', sourceListeners);
    }
  }, {
    key: "standardButtons",
    get: function get() {
    ...
    key: "storeListeners",
    get: function get() {
      return this.getAttribute('storeListeners');
    },
    set: function set(storeListeners) {
      this.setAttribute('storeListeners', storeListeners);
    }
  }, {
    key: "style",
    get: function get() {
  ...
  function ExtRoweditorComponent() {
    ...
    _this.METHODS = ExtRoweditorComponent.METHODS();
    _this.XTYPE = ExtRoweditorComponent.XTYPE(); //this.PROPERTIES = ExtRoweditorComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtRoweditorComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtRoweditorComponent.EVENTS();
    return _this;
  }

  var _proto = ExtRoweditorComponent.prototype;
