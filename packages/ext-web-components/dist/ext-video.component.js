...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtVideoComponent, _ExtBase);

  ExtVideoComponent.XTYPE = function XTYPE() {
    return 'video';
  };

  ExtVideoComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtVideoComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtVideoComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtVideoComponent, [{
    key: "alwaysOnTop",
    get: function get() {
    ...
    key: "autoPause",
    get: function get() {
      return this.getAttribute('autoPause');
    },
    set: function set(autoPause) {
      this.setAttribute('autoPause', autoPause);
    }
  }, {
    key: "autoResume",
    get: function get() {
      return this.getAttribute('autoResume');
    },
    set: function set(autoResume) {
      this.setAttribute('autoResume', autoResume);
    }
  }, {
    key: "axisLock",
    get: function get() {
    ...
    key: "posterUrl",
    get: function get() {
      return this.getAttribute('posterUrl');
    },
    set: function set(posterUrl) {
      this.setAttribute('posterUrl', posterUrl);
    }
  }, {
    key: "preload",
    get: function get() {
    ...
    key: "showPosterOnPause",
    get: function get() {
      return this.getAttribute('showPosterOnPause');
    },
    set: function set(showPosterOnPause) {
      this.setAttribute('showPosterOnPause', showPosterOnPause);
    }
  }, {
    key: "stateful",
    get: function get() {
  ...
  function ExtVideoComponent() {
    ...
    _this.METHODS = ExtVideoComponent.METHODS();
    _this.XTYPE = ExtVideoComponent.XTYPE(); //this.PROPERTIES = ExtVideoComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtVideoComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtVideoComponent.EVENTS();
    return _this;
  }

  var _proto = ExtVideoComponent.prototype;
