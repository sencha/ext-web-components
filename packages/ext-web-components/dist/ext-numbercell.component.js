...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtNumbercellComponent, _ExtBase);

  ExtNumbercellComponent.XTYPE = function XTYPE() {
    return 'numbercell';
  };

  ExtNumbercellComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    var _ref;
  ...
  ExtNumbercellComponent.EVENTS = function EVENTS() {
    return [{
  ...
  ExtNumbercellComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtNumbercellComponent, [{
    key: "align",
    get: function get() {
  ...
  function ExtNumbercellComponent() {
    ...
    _this.METHODS = ExtNumbercellComponent.METHODS();
    _this.XTYPE = ExtNumbercellComponent.XTYPE(); //this.PROPERTIES = ExtNumbercellComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtNumbercellComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtNumbercellComponent.EVENTS();
    return _this;
  }

  var _proto = ExtNumbercellComponent.prototype;
