...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtPivotgridcellComponent, _ExtBase);

  ExtPivotgridcellComponent.XTYPE = function XTYPE() {
    return 'pivotgridcell';
  };

  ExtPivotgridcellComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    var _ref;
  ...
  ExtPivotgridcellComponent.EVENTS = function EVENTS() {
    return [{
  ...
  ExtPivotgridcellComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtPivotgridcellComponent, [{
    key: "align",
    get: function get() {
  ...
  function ExtPivotgridcellComponent() {
    ...
    _this.METHODS = ExtPivotgridcellComponent.METHODS();
    _this.XTYPE = ExtPivotgridcellComponent.XTYPE(); //this.PROPERTIES = ExtPivotgridcellComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtPivotgridcellComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtPivotgridcellComponent.EVENTS();
    return _this;
  }

  var _proto = ExtPivotgridcellComponent.prototype;
