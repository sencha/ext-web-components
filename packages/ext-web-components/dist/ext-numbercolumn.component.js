...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtNumbercolumnComponent, _ExtBase);

  ExtNumbercolumnComponent.XTYPE = function XTYPE() {
    return 'numbercolumn';
  };

  ExtNumbercolumnComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    var _ref;
  ...
  ExtNumbercolumnComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'newActiveItem,numbercolumn,oldActiveItem'
    }, {
      name: 'activeItemchange',
      parameters: 'sender,value,oldValue'
    }, {
      name: 'add',
      parameters: 'numbercolumn,item,index'
    }, {
      name: 'added',
      ...
      name: 'deactivate',
      parameters: 'oldActiveItem,numbercolumn,newActiveItem'
    }, {
      name: 'destroy',
      parameters: ''
    }, {
      ...
      name: 'move',
      parameters: 'numbercolumn,item,toIndex,fromIndex'
    }, {
      name: 'moved',
      ...
      name: 'renderedchange',
      parameters: 'numbercolumn,item,rendered'
    }, {
      name: 'resize',
  ...
  ExtNumbercolumnComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtNumbercolumnComponent, [{
  ...
  function ExtNumbercolumnComponent() {
    ...
    _this.METHODS = ExtNumbercolumnComponent.METHODS();
    _this.XTYPE = ExtNumbercolumnComponent.XTYPE(); //this.PROPERTIES = ExtNumbercolumnComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtNumbercolumnComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtNumbercolumnComponent.EVENTS();
    return _this;
  }

  var _proto = ExtNumbercolumnComponent.prototype;
