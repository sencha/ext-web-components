...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtDatecellComponent, _ExtBase);

  ExtDatecellComponent.XTYPE = function XTYPE() {
    return 'datecell';
  };

  ExtDatecellComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    var _ref;
  ...
  ExtDatecellComponent.EVENTS = function EVENTS() {
    return [{
  ...
  ExtDatecellComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtDatecellComponent, [{
    key: "align",
    get: function get() {
  ...
  function ExtDatecellComponent() {
    ...
    _this.METHODS = ExtDatecellComponent.METHODS();
    _this.XTYPE = ExtDatecellComponent.XTYPE(); //this.PROPERTIES = ExtDatecellComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtDatecellComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtDatecellComponent.EVENTS();
    return _this;
  }

  var _proto = ExtDatecellComponent.prototype;
