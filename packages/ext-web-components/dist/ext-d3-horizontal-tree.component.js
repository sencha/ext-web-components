...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtD3_horizontal_treeComponent, _ExtBase);

  ExtD3_horizontal_treeComponent.XTYPE = function XTYPE() {
    return 'd3_horizontal_tree';
  };

  ExtD3_horizontal_treeComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtD3_horizontal_treeComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtD3_horizontal_treeComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtD3_horizontal_treeComponent, [{
    key: "alignSelf",
    get: function get() {
    ...
    key: "nodeRadius",
    get: function get() {
      return this.getAttribute('nodeRadius');
    },
    set: function set(nodeRadius) {
      this.setAttribute('nodeRadius', nodeRadius);
    }
  }, {
    key: "nodeSize",
    get: function get() {
      return this.getAttribute('nodeSize');
    },
    set: function set(nodeSize) {
      this.setAttribute('nodeSize', nodeSize);
    }
  }, {
    key: "nodeText",
    get: function get() {
  ...
  function ExtD3_horizontal_treeComponent() {
    ...
    _this.METHODS = ExtD3_horizontal_treeComponent.METHODS();
    _this.XTYPE = ExtD3_horizontal_treeComponent.XTYPE(); //this.PROPERTIES = ExtD3_horizontal_treeComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtD3_horizontal_treeComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtD3_horizontal_treeComponent.EVENTS();
    return _this;
  }

  var _proto = ExtD3_horizontal_treeComponent.prototype;
