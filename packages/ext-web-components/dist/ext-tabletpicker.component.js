...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtTabletpickerComponent, _ExtBase);

  ExtTabletpickerComponent.XTYPE = function XTYPE() {
    return 'tabletpicker';
  };

  ExtTabletpickerComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtTabletpickerComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'newActiveItem,tabletpicker,oldActiveItem'
    }, {
      name: 'activeItemchange',
      parameters: 'sender,value,oldValue'
    }, {
      name: 'add',
      parameters: 'tabletpicker,item,index'
    }, {
      name: 'added',
      ...
      parameters: 'tabletpicker,context'
    }, {
      ...
      name: 'deactivate',
      parameters: 'oldActiveItem,tabletpicker,newActiveItem'
    }, {
      name: 'destroy',
      parameters: ''
    }, {
      ...
      name: 'move',
      parameters: 'tabletpicker,item,toIndex,fromIndex'
    }, {
      name: 'moved',
      ...
      name: 'renderedchange',
      parameters: 'tabletpicker,item,rendered'
    }, {
      name: 'resize',
  ...
  ExtTabletpickerComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtTabletpickerComponent, [{
  ...
  function ExtTabletpickerComponent() {
    ...
    _this.METHODS = ExtTabletpickerComponent.METHODS();
    _this.XTYPE = ExtTabletpickerComponent.XTYPE(); //this.PROPERTIES = ExtTabletpickerComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtTabletpickerComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtTabletpickerComponent.EVENTS();
    return _this;
  }

  var _proto = ExtTabletpickerComponent.prototype;
