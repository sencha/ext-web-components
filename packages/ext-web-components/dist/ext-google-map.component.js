...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtGoogle_mapComponent, _ExtBase);

  ExtGoogle_mapComponent.XTYPE = function XTYPE() {
    return 'google_map';
  };

  ExtGoogle_mapComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtGoogle_mapComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtGoogle_mapComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtGoogle_mapComponent, [{
    ...
    key: "mapListeners",
    get: function get() {
      return this.getAttribute('mapListeners');
    },
    set: function set(mapListeners) {
      this.setAttribute('mapListeners', mapListeners);
    }
  }, {
    key: "mapOptions",
    get: function get() {
      return this.getAttribute('mapOptions');
    },
    set: function set(mapOptions) {
      this.setAttribute('mapOptions', mapOptions);
    }
  }, {
    key: "margin",
    get: function get() {
    ...
    key: "markers",
    get: function get() {
      return this.getAttribute('markers');
    },
    ...
    key: "markerTemplate",
    get: function get() {
      return this.getAttribute('markerTemplate');
    },
    set: function set(markerTemplate) {
      this.setAttribute('markerTemplate', markerTemplate);
    }
  }, {
    key: "masked",
    get: function get() {
    ...
    key: "requiredScripts",
    get: function get() {
      return this.getAttribute('requiredScripts');
    },
    set: function set(requiredScripts) {
      this.setAttribute('requiredScripts', requiredScripts);
    }
  }, {
    ...
    get: function get() {
      return this.getAttribute('useCurrentLocation');
    },
    set: function set(useCurrentLocation) {
      this.setAttribute('useCurrentLocation', useCurrentLocation);
    }
  }, {
    key: "userCls",
    get: function get() {
  ...
  function ExtGoogle_mapComponent() {
    ...
    _this.METHODS = ExtGoogle_mapComponent.METHODS();
    _this.XTYPE = ExtGoogle_mapComponent.XTYPE(); //this.PROPERTIES = ExtGoogle_mapComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtGoogle_mapComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtGoogle_mapComponent.EVENTS();
    return _this;
  }

  var _proto = ExtGoogle_mapComponent.prototype;
