...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtCalendar_form_addComponent, _ExtBase);

  ExtCalendar_form_addComponent.XTYPE = function XTYPE() {
    return 'calendar_form_add';
  };

  ExtCalendar_form_addComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtCalendar_form_addComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtCalendar_form_addComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtCalendar_form_addComponent, [{
  ...
  function ExtCalendar_form_addComponent() {
    ...
    _this.METHODS = ExtCalendar_form_addComponent.METHODS();
    _this.XTYPE = ExtCalendar_form_addComponent.XTYPE(); //this.PROPERTIES = ExtCalendar_form_addComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtCalendar_form_addComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtCalendar_form_addComponent.EVENTS();
    return _this;
  }

  var _proto = ExtCalendar_form_addComponent.prototype;
