...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtFormpanelComponent, _ExtBase);

  ExtFormpanelComponent.XTYPE = function XTYPE() {
    return 'formpanel';
  };

  ExtFormpanelComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtFormpanelComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtFormpanelComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtFormpanelComponent, [{
  ...
  function ExtFormpanelComponent() {
    ...
    _this.METHODS = ExtFormpanelComponent.METHODS();
    _this.XTYPE = ExtFormpanelComponent.XTYPE(); //this.PROPERTIES = ExtFormpanelComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtFormpanelComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtFormpanelComponent.EVENTS();
    return _this;
  }

  var _proto = ExtFormpanelComponent.prototype;
