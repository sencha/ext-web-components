...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtCarouselComponent, _ExtBase);

  ExtCarouselComponent.XTYPE = function XTYPE() {
    return 'carousel';
  };

  ExtCarouselComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtCarouselComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtCarouselComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtCarouselComponent, [{
  ...
  function ExtCarouselComponent() {
    ...
    _this.METHODS = ExtCarouselComponent.METHODS();
    _this.XTYPE = ExtCarouselComponent.XTYPE(); //this.PROPERTIES = ExtCarouselComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtCarouselComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtCarouselComponent.EVENTS();
    return _this;
  }

  var _proto = ExtCarouselComponent.prototype;
