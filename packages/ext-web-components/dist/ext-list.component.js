...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtListComponent, _ExtBase);

  ExtListComponent.XTYPE = function XTYPE() {
    return 'list';
  };

  ExtListComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtListComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtListComponent.METHODS = function METHODS() {
    return [{
  ...
  function ExtListComponent() {
    ...
    _this.METHODS = ExtListComponent.METHODS();
    _this.XTYPE = ExtListComponent.XTYPE(); //this.PROPERTIES = ExtListComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtListComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtListComponent.EVENTS();
    return _this;
  }

  var _proto = ExtListComponent.prototype;
