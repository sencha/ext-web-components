...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtComboboxComponent, _ExtBase);

  ExtComboboxComponent.XTYPE = function XTYPE() {
    return 'combobox';
  };

  ExtComboboxComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
      "alignTarget": ["string"],
      "allQuery": ["string"],
  ...
  ExtComboboxComponent.EVENTS = function EVENTS() {
    return [{
      name: 'action',
  ...
  ExtComboboxComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtComboboxComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtComboboxComponent() {
    ...
    _this.METHODS = ExtComboboxComponent.METHODS();
    _this.XTYPE = ExtComboboxComponent.XTYPE(); //this.PROPERTIES = ExtComboboxComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtComboboxComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtComboboxComponent.EVENTS();
    return _this;
  }

  var _proto = ExtComboboxComponent.prototype;
