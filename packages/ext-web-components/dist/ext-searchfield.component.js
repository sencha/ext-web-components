...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtSearchfieldComponent, _ExtBase);

  ExtSearchfieldComponent.XTYPE = function XTYPE() {
    return 'searchfield';
  };

  ExtSearchfieldComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtSearchfieldComponent.EVENTS = function EVENTS() {
    return [{
      name: 'action',
  ...
  ExtSearchfieldComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtSearchfieldComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtSearchfieldComponent() {
    ...
    _this.METHODS = ExtSearchfieldComponent.METHODS();
    _this.XTYPE = ExtSearchfieldComponent.XTYPE(); //this.PROPERTIES = ExtSearchfieldComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtSearchfieldComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtSearchfieldComponent.EVENTS();
    return _this;
  }

  var _proto = ExtSearchfieldComponent.prototype;
