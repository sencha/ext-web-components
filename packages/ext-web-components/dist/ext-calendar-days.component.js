...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtCalendar_daysComponent, _ExtBase);

  ExtCalendar_daysComponent.XTYPE = function XTYPE() {
    return 'calendar-days';
  };

  ExtCalendar_daysComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtCalendar_daysComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtCalendar_daysComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtCalendar_daysComponent, [{
  ...
  function ExtCalendar_daysComponent() {
    ...
    _this.METHODS = ExtCalendar_daysComponent.METHODS();
    _this.XTYPE = ExtCalendar_daysComponent.XTYPE(); //this.PROPERTIES = ExtCalendar_daysComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtCalendar_daysComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtCalendar_daysComponent.EVENTS();
    return _this;
  }

  var _proto = ExtCalendar_daysComponent.prototype;
