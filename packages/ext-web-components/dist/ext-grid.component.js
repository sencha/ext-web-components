...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtGridComponent, _ExtBase);

  ExtGridComponent.XTYPE = function XTYPE() {
    return 'grid';
  };
  ...
  ExtGridComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtGridComponent.METHODS = function METHODS() {
    return [{
  ...
  function ExtGridComponent() {
    ...
    _this.METHODS = ExtGridComponent.METHODS();
    _this.XTYPE = ExtGridComponent.XTYPE(); //this.PROPERTIES = ExtGridComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtGridComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtGridComponent.EVENTS();
    return _this;
  }

  var _proto = ExtGridComponent.prototype;
