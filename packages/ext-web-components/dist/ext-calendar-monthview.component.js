...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtCalendar_monthviewComponent, _ExtBase);

  ExtCalendar_monthviewComponent.XTYPE = function XTYPE() {
    return 'calendar_monthview';
  };

  ExtCalendar_monthviewComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "addForm": "Object",
      "addOnSelect": "Boolean",
  ...
  ExtCalendar_monthviewComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtCalendar_monthviewComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtCalendar_monthviewComponent, [{
    key: "addForm",
    get: function get() {
  ...
  function ExtCalendar_monthviewComponent() {
    ...
    _this.METHODS = ExtCalendar_monthviewComponent.METHODS();
    _this.XTYPE = ExtCalendar_monthviewComponent.XTYPE(); //this.PROPERTIES = ExtCalendar_monthviewComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtCalendar_monthviewComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtCalendar_monthviewComponent.EVENTS();
    return _this;
  }

  var _proto = ExtCalendar_monthviewComponent.prototype;
