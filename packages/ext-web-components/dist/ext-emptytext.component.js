...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtEmptytextComponent, _ExtBase);

  ExtEmptytextComponent.XTYPE = function XTYPE() {
    return 'emptytext';
  };

  ExtEmptytextComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtEmptytextComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtEmptytextComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtEmptytextComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtEmptytextComponent() {
    ...
    _this.METHODS = ExtEmptytextComponent.METHODS();
    _this.XTYPE = ExtEmptytextComponent.XTYPE(); //this.PROPERTIES = ExtEmptytextComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtEmptytextComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtEmptytextComponent.EVENTS();
    return _this;
  }

  var _proto = ExtEmptytextComponent.prototype;
