...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtItemheaderComponent, _ExtBase);

  ExtItemheaderComponent.XTYPE = function XTYPE() {
    return 'itemheader';
  };

  ExtItemheaderComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtItemheaderComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtItemheaderComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtItemheaderComponent, [{
    key: "alwaysOnTop",
    get: function get() {
  ...
  function ExtItemheaderComponent() {
    ...
    _this.METHODS = ExtItemheaderComponent.METHODS();
    _this.XTYPE = ExtItemheaderComponent.XTYPE(); //this.PROPERTIES = ExtItemheaderComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtItemheaderComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtItemheaderComponent.EVENTS();
    return _this;
  }

  var _proto = ExtItemheaderComponent.prototype;
