...
function (_ExtBase) {
  ...
  ExtCalendar_dayComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtCalendar_dayComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtCalendar_dayComponent, [{
  ...
  function ExtCalendar_dayComponent() {
    ...
    _this.METHODS = ExtCalendar_dayComponent.METHODS();
    _this.XTYPE = ExtCalendar_dayComponent.XTYPE(); //this.PROPERTIES = ExtCalendar_dayComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtCalendar_dayComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtCalendar_dayComponent.EVENTS();
    return _this;
  }

  var _proto = ExtCalendar_dayComponent.prototype;
