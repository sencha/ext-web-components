...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtToolbarComponent, _ExtBase);

  ExtToolbarComponent.XTYPE = function XTYPE() {
    return 'toolbar';
  };

  ExtToolbarComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtToolbarComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'newActiveItem,toolbar,oldActiveItem'
    }, {
      name: 'activeItemchange',
      parameters: 'sender,value,oldValue'
    }, {
      name: 'add',
      parameters: 'toolbar,item,index'
    }, {
      name: 'added',
      ...
      name: 'deactivate',
      parameters: 'oldActiveItem,toolbar,newActiveItem'
    }, {
      name: 'destroy',
      parameters: ''
    }, {
      ...
      name: 'move',
      parameters: 'toolbar,item,toIndex,fromIndex'
    }, {
      name: 'moved',
      ...
      name: 'renderedchange',
      parameters: 'toolbar,item,rendered'
    }, {
      name: 'resize',
  ...
  ExtToolbarComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtToolbarComponent, [{
  ...
  function ExtToolbarComponent() {
    ...
    _this.METHODS = ExtToolbarComponent.METHODS();
    _this.XTYPE = ExtToolbarComponent.XTYPE(); //this.PROPERTIES = ExtToolbarComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtToolbarComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtToolbarComponent.EVENTS();
    return _this;
  }

  var _proto = ExtToolbarComponent.prototype;
