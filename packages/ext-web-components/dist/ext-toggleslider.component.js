...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtTogglesliderComponent, _ExtBase);

  ExtTogglesliderComponent.XTYPE = function XTYPE() {
    return 'toggleslider';
  };

  ExtTogglesliderComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtTogglesliderComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtTogglesliderComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtTogglesliderComponent, [{
    key: "alignSelf",
    get: function get() {
    ...
    key: "allowThumbsOverlapping",
    get: function get() {
      return this.getAttribute('allowThumbsOverlapping');
    },
    set: function set(allowThumbsOverlapping) {
      this.setAttribute('allowThumbsOverlapping', allowThumbsOverlapping);
    }
  }, {
    key: "alwaysOnTop",
    get: function get() {
    ...
    key: "thumbDefaults",
    get: function get() {
      return this.getAttribute('thumbDefaults');
    },
    set: function set(thumbDefaults) {
      this.setAttribute('thumbDefaults', thumbDefaults);
    }
  }, {
    key: "toFrontOnShow",
    get: function get() {
    ...
    key: "valueIsArray",
    get: function get() {
      return this.getAttribute('valueIsArray');
    },
    set: function set(valueIsArray) {
      this.setAttribute('valueIsArray', valueIsArray);
    }
  }, {
    key: "values",
    get: function get() {
  ...
  function ExtTogglesliderComponent() {
    ...
    _this.METHODS = ExtTogglesliderComponent.METHODS();
    _this.XTYPE = ExtTogglesliderComponent.XTYPE(); //this.PROPERTIES = ExtTogglesliderComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtTogglesliderComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtTogglesliderComponent.EVENTS();
    return _this;
  }

  var _proto = ExtTogglesliderComponent.prototype;
