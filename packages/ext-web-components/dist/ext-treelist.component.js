...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtTreelistComponent, _ExtBase);

  ExtTreelistComponent.XTYPE = function XTYPE() {
    return 'treelist';
  };

  ExtTreelistComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtTreelistComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtTreelistComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtTreelistComponent, [{
    key: "alignSelf",
    get: function get() {
    ...
    key: "floatLeafItems",
    get: function get() {
      return this.getAttribute('floatLeafItems');
    },
    set: function set(floatLeafItems) {
      this.setAttribute('floatLeafItems', floatLeafItems);
    }
  }, {
    key: "focusCls",
    get: function get() {
    ...
    key: "highlightPath",
    get: function get() {
      return this.getAttribute('highlightPath');
    },
    set: function set(highlightPath) {
      this.setAttribute('highlightPath', highlightPath);
    }
  }, {
    key: "html",
    get: function get() {
    ...
    key: "indent",
    get: function get() {
      return this.getAttribute('indent');
    },
    ...
    key: "micro",
    get: function get() {
      return this.getAttribute('micro');
    },
    set: function set(micro) {
      this.setAttribute('micro', micro);
    }
  }, {
    key: "minHeight",
    get: function get() {
  ...
  function ExtTreelistComponent() {
    ...
    _this.METHODS = ExtTreelistComponent.METHODS();
    _this.XTYPE = ExtTreelistComponent.XTYPE(); //this.PROPERTIES = ExtTreelistComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtTreelistComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtTreelistComponent.EVENTS();
    return _this;
  }

  var _proto = ExtTreelistComponent.prototype;
