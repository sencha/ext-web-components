...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtDataviewComponent, _ExtBase);

  ExtDataviewComponent.XTYPE = function XTYPE() {
    return 'dataview';
  };

  ExtDataviewComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtDataviewComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtDataviewComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtDataviewComponent, [{
  ...
  function ExtDataviewComponent() {
    ...
    _this.METHODS = ExtDataviewComponent.METHODS();
    _this.XTYPE = ExtDataviewComponent.XTYPE(); //this.PROPERTIES = ExtDataviewComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtDataviewComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtDataviewComponent.EVENTS();
    return _this;
  }

  var _proto = ExtDataviewComponent.prototype;
