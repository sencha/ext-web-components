...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtTextfieldComponent, _ExtBase);

  ExtTextfieldComponent.XTYPE = function XTYPE() {
    return 'textfield';
  };

  ExtTextfieldComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtTextfieldComponent.EVENTS = function EVENTS() {
    return [{
      name: 'action',
      parameters: 'textfield,e'
    }, {
      name: 'added',
      ...
      name: 'change',
      parameters: 'textfield,newValue,oldValue'
    }, {
      name: 'clearicontap',
      parameters: 'textfield,input,e'
    }, {
      name: 'click',
      parameters: 'e'
    }, {
  ...
  ExtTextfieldComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtTextfieldComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtTextfieldComponent() {
    ...
    _this.METHODS = ExtTextfieldComponent.METHODS();
    _this.XTYPE = ExtTextfieldComponent.XTYPE(); //this.PROPERTIES = ExtTextfieldComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtTextfieldComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtTextfieldComponent.EVENTS();
    return _this;
  }

  var _proto = ExtTextfieldComponent.prototype;
