...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtAudioComponent, _ExtBase);

  ExtAudioComponent.XTYPE = function XTYPE() {
    return 'audio';
  };

  ExtAudioComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtAudioComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtAudioComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtAudioComponent, [{
    key: "alwaysOnTop",
    get: function get() {
  ...
  function ExtAudioComponent() {
    ...
    _this.METHODS = ExtAudioComponent.METHODS();
    _this.XTYPE = ExtAudioComponent.XTYPE(); //this.PROPERTIES = ExtAudioComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtAudioComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtAudioComponent.EVENTS();
    return _this;
  }

  var _proto = ExtAudioComponent.prototype;
