...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtNavigationviewComponent, _ExtBase);

  ExtNavigationviewComponent.XTYPE = function XTYPE() {
    return 'navigationview';
  };

  ExtNavigationviewComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtNavigationviewComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtNavigationviewComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtNavigationviewComponent, [{
    ...
    key: "defaultBackButtonText",
    get: function get() {
      return this.getAttribute('defaultBackButtonText');
    },
    set: function set(defaultBackButtonText) {
      this.setAttribute('defaultBackButtonText', defaultBackButtonText);
    }
  }, {
    key: "defaultFocus",
    get: function get() {
    ...
    key: "navigationBar",
    get: function get() {
      return this.getAttribute('navigationBar');
    },
    set: function set(navigationBar) {
      this.setAttribute('navigationBar', navigationBar);
    }
  }, {
    key: "padding",
    get: function get() {
    ...
    key: "useTitleForBackButtonText",
    get: function get() {
      return this.getAttribute('useTitleForBackButtonText');
    },
    set: function set(useTitleForBackButtonText) {
      this.setAttribute('useTitleForBackButtonText', useTitleForBackButtonText);
    }
  }, {
    key: "viewModel",
    get: function get() {
  ...
  function ExtNavigationviewComponent() {
    ...
    _this.METHODS = ExtNavigationviewComponent.METHODS();
    _this.XTYPE = ExtNavigationviewComponent.XTYPE(); //this.PROPERTIES = ExtNavigationviewComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtNavigationviewComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtNavigationviewComponent.EVENTS();
    return _this;
  }

  var _proto = ExtNavigationviewComponent.prototype;
