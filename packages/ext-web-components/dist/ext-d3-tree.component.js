...
function (_ExtBase) {
  ...
  ExtD3_treeComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtD3_treeComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtD3_treeComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtD3_treeComponent() {
    ...
    _this.METHODS = ExtD3_treeComponent.METHODS();
    _this.XTYPE = ExtD3_treeComponent.XTYPE(); //this.PROPERTIES = ExtD3_treeComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtD3_treeComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtD3_treeComponent.EVENTS();
    return _this;
  }

  var _proto = ExtD3_treeComponent.prototype;
