...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtContainerfieldComponent, _ExtBase);

  ExtContainerfieldComponent.XTYPE = function XTYPE() {
    return 'containerfield';
  };

  ExtContainerfieldComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtContainerfieldComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtContainerfieldComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtContainerfieldComponent, [{
    key: "alwaysOnTop",
    get: function get() {
  ...
  function ExtContainerfieldComponent() {
    ...
    _this.METHODS = ExtContainerfieldComponent.METHODS();
    _this.XTYPE = ExtContainerfieldComponent.XTYPE(); //this.PROPERTIES = ExtContainerfieldComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtContainerfieldComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtContainerfieldComponent.EVENTS();
    return _this;
  }

  var _proto = ExtContainerfieldComponent.prototype;
