...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtPivotconfigformComponent, _ExtBase);

  ExtPivotconfigformComponent.XTYPE = function XTYPE() {
    return 'pivotconfigform';
  };

  ExtPivotconfigformComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtPivotconfigformComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'newActiveItem,pivotconfigform,oldActiveItem'
    }, {
      name: 'activeItemchange',
      parameters: 'sender,value,oldValue'
    }, {
      name: 'add',
      parameters: 'pivotconfigform,item,index'
    }, {
      name: 'added',
      ...
      parameters: 'pivotconfigform,context'
    }, {
      ...
      name: 'beforesubmit',
      parameters: 'pivotconfigform,values,options,e'
    }, {
      name: 'beforetofront',
      parameters: 'pivotconfigform'
    }, {
      ...
      name: 'blur',
      parameters: 'pivotconfigform,event'
    }, {
      name: 'bottomchange',
      parameters: 'sender,value,oldValue'
    }, {
      ...
      name: 'deactivate',
      parameters: 'oldActiveItem,pivotconfigform,newActiveItem'
    }, {
      name: 'destroy',
      parameters: ''
    }, {
      name: 'dirtychange',
      parameters: 'pivotconfigform,dirty'
    }, {
      name: 'disabledchange',
      parameters: 'sender,value,oldValue'
    }, {
      ...
      name: 'exception',
      parameters: 'pivotconfigform,result'
    }, {
      name: 'expand',
      parameters: 'pivotconfigform'
    }, {
      ...
      name: 'move',
      parameters: 'pivotconfigform,item,toIndex,fromIndex'
    }, {
      name: 'moved',
      ...
      name: 'renderedchange',
      parameters: 'pivotconfigform,item,rendered'
    }, {
      name: 'resize',
      ...
      name: 'submit',
      parameters: 'pivotconfigform,result,e'
    }, {
      name: 'tofront',
      parameters: 'pivotconfigform'
    }, {
  ...
  ExtPivotconfigformComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtPivotconfigformComponent, [{
  ...
  function ExtPivotconfigformComponent() {
    ...
    _this.METHODS = ExtPivotconfigformComponent.METHODS();
    _this.XTYPE = ExtPivotconfigformComponent.XTYPE(); //this.PROPERTIES = ExtPivotconfigformComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtPivotconfigformComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtPivotconfigformComponent.EVENTS();
    return _this;
  }

  var _proto = ExtPivotconfigformComponent.prototype;
