...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtRevealtriggerComponent, _ExtBase);

  ExtRevealtriggerComponent.XTYPE = function XTYPE() {
    return 'revealtrigger';
  };

  ExtRevealtriggerComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtRevealtriggerComponent.EVENTS = function EVENTS() {
    return [{
  ...
  ExtRevealtriggerComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtRevealtriggerComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtRevealtriggerComponent() {
    ...
    _this.METHODS = ExtRevealtriggerComponent.METHODS();
    _this.XTYPE = ExtRevealtriggerComponent.XTYPE(); //this.PROPERTIES = ExtRevealtriggerComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtRevealtriggerComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtRevealtriggerComponent.EVENTS();
    return _this;
  }

  var _proto = ExtRevealtriggerComponent.prototype;
