...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtMapComponent, _ExtBase);

  ExtMapComponent.XTYPE = function XTYPE() {
    return 'map';
  };

  ExtMapComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtMapComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtMapComponent.METHODS = function METHODS() {
    return [{
  ...
  function ExtMapComponent() {
    ...
    _this.METHODS = ExtMapComponent.METHODS();
    _this.XTYPE = ExtMapComponent.XTYPE(); //this.PROPERTIES = ExtMapComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtMapComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtMapComponent.EVENTS();
    return _this;
  }

  var _proto = ExtMapComponent.prototype;
