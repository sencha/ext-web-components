...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtCheckboxgroupComponent, _ExtBase);

  ExtCheckboxgroupComponent.XTYPE = function XTYPE() {
    return 'checkboxgroup';
  };

  ExtCheckboxgroupComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtCheckboxgroupComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
      ...
      name: 'blur',
      parameters: 'checkboxgroup,event'
    }, {
      name: 'bottomchange',
      ...
      name: 'change',
      parameters: 'checkboxgroup,newValue,oldValue'
    }, {
      name: 'click',
      parameters: 'e'
    }, {
      ...
      name: 'dirtychange',
      parameters: 'checkboxgroup,dirty'
    }, {
      name: 'disabledchange',
      parameters: 'sender,value,oldValue'
    }, {
      ...
      name: 'errorchange',
      parameters: 'checkboxgroup,error'
    }, {
      name: 'floatingchange',
  ...
  ExtCheckboxgroupComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtCheckboxgroupComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtCheckboxgroupComponent() {
    ...
    _this.METHODS = ExtCheckboxgroupComponent.METHODS();
    _this.XTYPE = ExtCheckboxgroupComponent.XTYPE(); //this.PROPERTIES = ExtCheckboxgroupComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtCheckboxgroupComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtCheckboxgroupComponent.EVENTS();
    return _this;
  }

  var _proto = ExtCheckboxgroupComponent.prototype;
