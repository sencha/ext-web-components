...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtNestedlistComponent, _ExtBase);

  ExtNestedlistComponent.XTYPE = function XTYPE() {
    return 'nestedlist';
  };

  ExtNestedlistComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtNestedlistComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtNestedlistComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtNestedlistComponent, [{
    ...
    key: "allowDeselect",
    get: function get() {
      return this.getAttribute('allowDeselect');
    },
    set: function set(allowDeselect) {
      this.setAttribute('allowDeselect', allowDeselect);
    }
  }, {
    ...
    key: "backButton",
    get: function get() {
      return this.getAttribute('backButton');
    },
    set: function set(backButton) {
      this.setAttribute('backButton', backButton);
    }
  }, {
    key: "backText",
    get: function get() {
      return this.getAttribute('backText');
    },
    set: function set(backText) {
      this.setAttribute('backText', backText);
    }
  }, {
    key: "bind",
    get: function get() {
    ...
    key: "detailCard",
    get: function get() {
      return this.getAttribute('detailCard');
    },
    set: function set(detailCard) {
      this.setAttribute('detailCard', detailCard);
    }
  }, {
    key: "detailContainer",
    get: function get() {
      return this.getAttribute('detailContainer');
    },
    set: function set(detailContainer) {
      this.setAttribute('detailContainer', detailContainer);
    }
  }, {
    key: "disabled",
    get: function get() {
    ...
    key: "lastActiveList",
    get: function get() {
      return this.getAttribute('lastActiveList');
    },
    set: function set(lastActiveList) {
      this.setAttribute('lastActiveList', lastActiveList);
    }
  }, {
    key: "lastNode",
    get: function get() {
      return this.getAttribute('lastNode');
    },
    set: function set(lastNode) {
      this.setAttribute('lastNode', lastNode);
    }
  }, {
    key: "layout",
    get: function get() {
    ...
    key: "listConfig",
    get: function get() {
      return this.getAttribute('listConfig');
    },
    set: function set(listConfig) {
      this.setAttribute('listConfig', listConfig);
    }
  }, {
    key: "listeners",
    get: function get() {
    ...
    key: "updateTitleText",
    get: function get() {
      return this.getAttribute('updateTitleText');
    },
    set: function set(updateTitleText) {
      this.setAttribute('updateTitleText', updateTitleText);
    }
  }, {
    key: "userCls",
    get: function get() {
    ...
    key: "useTitleAsBackText",
    get: function get() {
      return this.getAttribute('useTitleAsBackText');
    },
    set: function set(useTitleAsBackText) {
      this.setAttribute('useTitleAsBackText', useTitleAsBackText);
    }
  }, {
    key: "variableHeights",
    get: function get() {
  ...
  function ExtNestedlistComponent() {
    ...
    _this.METHODS = ExtNestedlistComponent.METHODS();
    _this.XTYPE = ExtNestedlistComponent.XTYPE(); //this.PROPERTIES = ExtNestedlistComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtNestedlistComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtNestedlistComponent.EVENTS();
    return _this;
  }

  var _proto = ExtNestedlistComponent.prototype;
