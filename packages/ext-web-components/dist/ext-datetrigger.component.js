...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtDatetriggerComponent, _ExtBase);

  ExtDatetriggerComponent.XTYPE = function XTYPE() {
    return 'datetrigger';
  };

  ExtDatetriggerComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtDatetriggerComponent.EVENTS = function EVENTS() {
    return [{
      ...
      name: 'beforetofront',
      parameters: 'datetrigger'
    }, {
      name: 'beforewidthchange',
      parameters: 'sender,value,oldValue,undefined'
    }, {
      name: 'blur',
      parameters: 'datetrigger,event'
    }, {
      name: 'disabledchange',
  ...
  ExtDatetriggerComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtDatetriggerComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtDatetriggerComponent() {
    ...
    _this.METHODS = ExtDatetriggerComponent.METHODS();
    _this.XTYPE = ExtDatetriggerComponent.XTYPE(); //this.PROPERTIES = ExtDatetriggerComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtDatetriggerComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtDatetriggerComponent.EVENTS();
    return _this;
  }

  var _proto = ExtDatetriggerComponent.prototype;
