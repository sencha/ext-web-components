...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtWidgetComponent, _ExtBase);

  ExtWidgetComponent.XTYPE = function XTYPE() {
    return 'widget';
  };
  ...
  ExtWidgetComponent.EVENTS = function EVENTS() {
    return [{
  ...
  ExtWidgetComponent.METHODS = function METHODS() {
    return [{
  ...
  function ExtWidgetComponent() {
    ...
    _this.METHODS = ExtWidgetComponent.METHODS();
    _this.XTYPE = ExtWidgetComponent.XTYPE(); //this.PROPERTIES = ExtWidgetComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtWidgetComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtWidgetComponent.EVENTS();
    return _this;
  }

  var _proto = ExtWidgetComponent.prototype;
