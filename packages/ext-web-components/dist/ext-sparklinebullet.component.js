...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtSparklinebulletComponent, _ExtBase);

  ExtSparklinebulletComponent.XTYPE = function XTYPE() {
    return 'sparklinebullet';
  };

  ExtSparklinebulletComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtSparklinebulletComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
      ...
      name: 'blur',
      parameters: 'sparklinebullet,event'
    }, {
      name: 'bottomchange',
  ...
  ExtSparklinebulletComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtSparklinebulletComponent, [{
    key: "alwaysOnTop",
    get: function get() {
    ...
    get: function get() {
      return this.getAttribute('performanceColor');
    },
    set: function set(performanceColor) {
      this.setAttribute('performanceColor', performanceColor);
    }
  }, {
    key: "plugins",
    get: function get() {
    ...
    key: "rangeColors",
    get: function get() {
      return this.getAttribute('rangeColors');
    },
    set: function set(rangeColors) {
      this.setAttribute('rangeColors', rangeColors);
    }
  }, {
    key: "record",
    get: function get() {
    ...
    key: "targetWidth",
    get: function get() {
      return this.getAttribute('targetWidth');
    },
    set: function set(targetWidth) {
      this.setAttribute('targetWidth', targetWidth);
    }
  }, {
    key: "tipTpl",
    get: function get() {
  ...
  function ExtSparklinebulletComponent() {
    ...
    _this.METHODS = ExtSparklinebulletComponent.METHODS();
    _this.XTYPE = ExtSparklinebulletComponent.XTYPE(); //this.PROPERTIES = ExtSparklinebulletComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtSparklinebulletComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtSparklinebulletComponent.EVENTS();
    return _this;
  }

  var _proto = ExtSparklinebulletComponent.prototype;
