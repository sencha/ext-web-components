...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtComponentdataviewComponent, _ExtBase);

  ExtComponentdataviewComponent.XTYPE = function XTYPE() {
    return 'componentdataview';
  };

  ExtComponentdataviewComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtComponentdataviewComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtComponentdataviewComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtComponentdataviewComponent, [{
  ...
  function ExtComponentdataviewComponent() {
    ...
    _this.METHODS = ExtComponentdataviewComponent.METHODS();
    _this.XTYPE = ExtComponentdataviewComponent.XTYPE(); //this.PROPERTIES = ExtComponentdataviewComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtComponentdataviewComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtComponentdataviewComponent.EVENTS();
    return _this;
  }

  var _proto = ExtComponentdataviewComponent.prototype;
