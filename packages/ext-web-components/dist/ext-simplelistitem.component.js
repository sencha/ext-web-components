...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtSimplelistitemComponent, _ExtBase);

  ExtSimplelistitemComponent.XTYPE = function XTYPE() {
    return 'simplelistitem';
  };

  ExtSimplelistitemComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtSimplelistitemComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
      ...
      name: 'blur',
      parameters: 'simplelistitem,event'
    }, {
      name: 'bottomchange',
  ...
  ExtSimplelistitemComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtSimplelistitemComponent, [{
    key: "alwaysOnTop",
    get: function get() {
  ...
  function ExtSimplelistitemComponent() {
    ...
    _this.METHODS = ExtSimplelistitemComponent.METHODS();
    _this.XTYPE = ExtSimplelistitemComponent.XTYPE(); //this.PROPERTIES = ExtSimplelistitemComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtSimplelistitemComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtSimplelistitemComponent.EVENTS();
    return _this;
  }

  var _proto = ExtSimplelistitemComponent.prototype;
