...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtCalendar_weekComponent, _ExtBase);

  ExtCalendar_weekComponent.XTYPE = function XTYPE() {
    return 'calendar_week';
  };

  ExtCalendar_weekComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtCalendar_weekComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtCalendar_weekComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtCalendar_weekComponent, [{
  ...
  function ExtCalendar_weekComponent() {
    ...
    _this.METHODS = ExtCalendar_weekComponent.METHODS();
    _this.XTYPE = ExtCalendar_weekComponent.XTYPE(); //this.PROPERTIES = ExtCalendar_weekComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtCalendar_weekComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtCalendar_weekComponent.EVENTS();
    return _this;
  }

  var _proto = ExtCalendar_weekComponent.prototype;
