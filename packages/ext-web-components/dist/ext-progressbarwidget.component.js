...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtProgressbarwidgetComponent, _ExtBase);

  ExtProgressbarwidgetComponent.XTYPE = function XTYPE() {
    return 'progressbarwidget';
  };

  ExtProgressbarwidgetComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtProgressbarwidgetComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtProgressbarwidgetComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtProgressbarwidgetComponent, [{
    key: "alwaysOnTop",
    get: function get() {
  ...
  function ExtProgressbarwidgetComponent() {
    ...
    _this.METHODS = ExtProgressbarwidgetComponent.METHODS();
    _this.XTYPE = ExtProgressbarwidgetComponent.XTYPE(); //this.PROPERTIES = ExtProgressbarwidgetComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtProgressbarwidgetComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtProgressbarwidgetComponent.EVENTS();
    return _this;
  }

  var _proto = ExtProgressbarwidgetComponent.prototype;
