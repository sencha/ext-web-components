...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtRowbodyComponent, _ExtBase);

  ExtRowbodyComponent.XTYPE = function XTYPE() {
    return 'rowbody';
  };

  ExtRowbodyComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtRowbodyComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtRowbodyComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtRowbodyComponent, [{
    key: "alwaysOnTop",
    get: function get() {
  ...
  function ExtRowbodyComponent() {
    ...
    _this.METHODS = ExtRowbodyComponent.METHODS();
    _this.XTYPE = ExtRowbodyComponent.XTYPE(); //this.PROPERTIES = ExtRowbodyComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtRowbodyComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtRowbodyComponent.EVENTS();
    return _this;
  }

  var _proto = ExtRowbodyComponent.prototype;
