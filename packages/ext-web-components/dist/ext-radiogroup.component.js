...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtRadiogroupComponent, _ExtBase);

  ExtRadiogroupComponent.XTYPE = function XTYPE() {
    return 'radiogroup';
  };

  ExtRadiogroupComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtRadiogroupComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
      ...
      name: 'change',
      parameters: 'radiogroup,newValue,oldValue'
    }, {
      name: 'click',
      parameters: 'e'
    }, {
  ...
  ExtRadiogroupComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtRadiogroupComponent, [{
    key: "alignSelf",
    get: function get() {
    ...
    get: function get() {
      return this.getAttribute('defaultFieldValue');
    },
    set: function set(defaultFieldValue) {
      this.setAttribute('defaultFieldValue', defaultFieldValue);
    }
  }, {
    ...
    key: "fieldsName",
    get: function get() {
      return this.getAttribute('fieldsName');
    },
    set: function set(fieldsName) {
      this.setAttribute('fieldsName', fieldsName);
    }
  }, {
    key: "flex",
    get: function get() {
    ...
    key: "simpleValue",
    get: function get() {
      return this.getAttribute('simpleValue');
    },
    set: function set(simpleValue) {
      this.setAttribute('simpleValue', simpleValue);
    }
  }, {
    key: "stateful",
    get: function get() {
  ...
  function ExtRadiogroupComponent() {
    ...
    _this.METHODS = ExtRadiogroupComponent.METHODS();
    _this.XTYPE = ExtRadiogroupComponent.XTYPE(); //this.PROPERTIES = ExtRadiogroupComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtRadiogroupComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtRadiogroupComponent.EVENTS();
    return _this;
  }

  var _proto = ExtRadiogroupComponent.prototype;
