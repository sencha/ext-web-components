...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtSegmentedbuttonComponent, _ExtBase);

  ExtSegmentedbuttonComponent.XTYPE = function XTYPE() {
    return 'segmentedbutton';
  };

  ExtSegmentedbuttonComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtSegmentedbuttonComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtSegmentedbuttonComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtSegmentedbuttonComponent, [{
    ...
    key: "allowMultiple",
    get: function get() {
      return this.getAttribute('allowMultiple');
    },
    set: function set(allowMultiple) {
      this.setAttribute('allowMultiple', allowMultiple);
    }
  }, {
    key: "allowToggle",
    get: function get() {
      return this.getAttribute('allowToggle');
    },
    set: function set(allowToggle) {
      this.setAttribute('allowToggle', allowToggle);
    }
  }, {
    key: "alwaysOnTop",
    get: function get() {
    ...
    key: "defaultUI",
    get: function get() {
      return this.getAttribute('defaultUI');
    },
    set: function set(defaultUI) {
      this.setAttribute('defaultUI', defaultUI);
    }
  }, {
    key: "disabled",
    get: function get() {
    ...
    key: "pressedButtons",
    get: function get() {
      return this.getAttribute('pressedButtons');
    },
    set: function set(pressedButtons) {
      this.setAttribute('pressedButtons', pressedButtons);
    }
  }, {
    key: "publishes",
    get: function get() {
  ...
  function ExtSegmentedbuttonComponent() {
    ...
    _this.METHODS = ExtSegmentedbuttonComponent.METHODS();
    _this.XTYPE = ExtSegmentedbuttonComponent.XTYPE(); //this.PROPERTIES = ExtSegmentedbuttonComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtSegmentedbuttonComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtSegmentedbuttonComponent.EVENTS();
    return _this;
  }

  var _proto = ExtSegmentedbuttonComponent.prototype;
