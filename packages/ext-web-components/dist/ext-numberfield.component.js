...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtNumberfieldComponent, _ExtBase);

  ExtNumberfieldComponent.XTYPE = function XTYPE() {
    return 'numberfield';
  };

  ExtNumberfieldComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtNumberfieldComponent.EVENTS = function EVENTS() {
    return [{
      name: 'action',
      parameters: 'numberfield,e'
    }, {
      name: 'added',
      ...
      name: 'change',
      parameters: 'numberfield,newValue,oldValue'
    }, {
      name: 'clearicontap',
      parameters: 'numberfield,input,e'
    }, {
      name: 'click',
      parameters: 'e'
    }, {
  ...
  ExtNumberfieldComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtNumberfieldComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtNumberfieldComponent() {
    ...
    _this.METHODS = ExtNumberfieldComponent.METHODS();
    _this.XTYPE = ExtNumberfieldComponent.XTYPE(); //this.PROPERTIES = ExtNumberfieldComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtNumberfieldComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtNumberfieldComponent.EVENTS();
    return _this;
  }

  var _proto = ExtNumberfieldComponent.prototype;
