...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtPagingtoolbarComponent, _ExtBase);

  ExtPagingtoolbarComponent.XTYPE = function XTYPE() {
    return 'pagingtoolbar';
  };

  ExtPagingtoolbarComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtPagingtoolbarComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtPagingtoolbarComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtPagingtoolbarComponent, [{
    ...
    key: "prevButton",
    get: function get() {
      return this.getAttribute('prevButton');
    },
    set: function set(prevButton) {
      this.setAttribute('prevButton', prevButton);
    }
  }, {
    key: "publishes",
    get: function get() {
    ...
    key: "sliderField",
    get: function get() {
      return this.getAttribute('sliderField');
    },
    set: function set(sliderField) {
      this.setAttribute('sliderField', sliderField);
    }
  }, {
    key: "stateful",
    get: function get() {
    ...
    get: function get() {
      return this.getAttribute('summaryComponent');
    },
    set: function set(summaryComponent) {
      this.setAttribute('summaryComponent', summaryComponent);
    }
  }, {
    key: "tabIndex",
    get: function get() {
  ...
  function ExtPagingtoolbarComponent() {
    ...
    _this.METHODS = ExtPagingtoolbarComponent.METHODS();
    _this.XTYPE = ExtPagingtoolbarComponent.XTYPE(); //this.PROPERTIES = ExtPagingtoolbarComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtPagingtoolbarComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtPagingtoolbarComponent.EVENTS();
    return _this;
  }

  var _proto = ExtPagingtoolbarComponent.prototype;
