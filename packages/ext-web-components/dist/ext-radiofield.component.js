...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtRadiofieldComponent, _ExtBase);

  ExtRadiofieldComponent.XTYPE = function XTYPE() {
    return 'radiofield';
  };

  ExtRadiofieldComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtRadiofieldComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
      ...
      name: 'change',
      parameters: 'radio,newValue,oldValue'
    }, {
      name: 'check',
      parameters: 'radio'
    }, {
  ...
  ExtRadiofieldComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtRadiofieldComponent, [{
    key: "alignSelf",
    get: function get() {
    ...
    key: "labelMaskTap",
    get: function get() {
      return this.getAttribute('labelMaskTap');
    },
    set: function set(labelMaskTap) {
      this.setAttribute('labelMaskTap', labelMaskTap);
    }
  }, {
    key: "labelMinWidth",
    get: function get() {
  ...
  function ExtRadiofieldComponent() {
    ...
    _this.METHODS = ExtRadiofieldComponent.METHODS();
    _this.XTYPE = ExtRadiofieldComponent.XTYPE(); //this.PROPERTIES = ExtRadiofieldComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtRadiofieldComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtRadiofieldComponent.EVENTS();
    return _this;
  }

  var _proto = ExtRadiofieldComponent.prototype;
