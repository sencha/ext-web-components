...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtImgComponent, _ExtBase);

  ExtImgComponent.XTYPE = function XTYPE() {
    return 'img';
  };

  ExtImgComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtImgComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtImgComponent.METHODS = function METHODS() {
    return [{
  ...
  function ExtImgComponent() {
    ...
    _this.METHODS = ExtImgComponent.METHODS();
    _this.XTYPE = ExtImgComponent.XTYPE(); //this.PROPERTIES = ExtImgComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtImgComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtImgComponent.EVENTS();
    return _this;
  }

  var _proto = ExtImgComponent.prototype;
