...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtPivotconfigcontainerComponent, _ExtBase);

  ExtPivotconfigcontainerComponent.XTYPE = function XTYPE() {
    return 'pivotconfigcontainer';
  };

  ExtPivotconfigcontainerComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtPivotconfigcontainerComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'newActiveItem,pivotconfigcontainer,oldActiveItem'
    }, {
      name: 'activeItemchange',
      parameters: 'sender,value,oldValue'
    }, {
      name: 'add',
      parameters: 'pivotconfigcontainer,item,index'
    }, {
      name: 'added',
      ...
      name: 'beforecollapse',
      parameters: 'pivotconfigcontainer'
    }, {
      ...
      parameters: 'pivotconfigcontainer,context'
    }, {
      ...
      name: 'blur',
      parameters: 'pivotconfigcontainer,event'
    }, {
      name: 'bottomchange',
      parameters: 'sender,value,oldValue'
    }, {
      ...
      name: 'deactivate',
      parameters: 'oldActiveItem,pivotconfigcontainer,newActiveItem'
    }, {
      name: 'destroy',
      parameters: ''
    }, {
      ...
      name: 'move',
      parameters: 'pivotconfigcontainer,item,toIndex,fromIndex'
    }, {
      name: 'moved',
      ...
      name: 'renderedchange',
      parameters: 'pivotconfigcontainer,item,rendered'
    }, {
      name: 'resize',
  ...
  ExtPivotconfigcontainerComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtPivotconfigcontainerComponent, [{
  ...
  function ExtPivotconfigcontainerComponent() {
    ...
    _this.METHODS = ExtPivotconfigcontainerComponent.METHODS();
    _this.XTYPE = ExtPivotconfigcontainerComponent.XTYPE(); //this.PROPERTIES = ExtPivotconfigcontainerComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtPivotconfigcontainerComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtPivotconfigcontainerComponent.EVENTS();
    return _this;
  }

  var _proto = ExtPivotconfigcontainerComponent.prototype;
