...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtDatepickernativefieldComponent, _ExtBase);

  ExtDatepickernativefieldComponent.XTYPE = function XTYPE() {
    return 'datepickernativefield';
  };

  ExtDatepickernativefieldComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
      "alignTarget": ["string"],
  ...
  ExtDatepickernativefieldComponent.EVENTS = function EVENTS() {
    return [{
      name: 'action',
      parameters: 'datepickernativefield,e'
    }, {
      name: 'added',
      ...
      name: 'beforetofront',
      parameters: 'datepickernativefield'
    }, {
      ...
      name: 'change',
      parameters: 'datepickernativefield,newDate,oldDate'
    }, {
      name: 'clearicontap',
      parameters: 'datepickernativefield,input,e'
    }, {
      name: 'click',
      parameters: 'e'
    }, {
      ...
      name: 'dirtychange',
      parameters: 'datepickernativefield,dirty'
    }, {
      name: 'disabledchange',
      parameters: 'sender,value,oldValue'
    }, {
      ...
      name: 'errorchange',
      parameters: 'datepickernativefield,error'
    }, {
      name: 'expand',
      parameters: 'field'
    }, {
      ...
      name: 'focusenter',
      parameters: 'datepickernativefield,event'
    }, {
      name: 'focusleave',
      parameters: 'datepickernativefield,event'
    }, {
  ...
  ExtDatepickernativefieldComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtDatepickernativefieldComponent, [{
    key: "alignSelf",
    get: function get() {
    ...
    key: "altFormats",
    get: function get() {
      return this.getAttribute('altFormats');
    },
    set: function set(altFormats) {
    ...
    key: "destroyPickerOnHide",
    get: function get() {
      return this.getAttribute('destroyPickerOnHide');
    },
    set: function set(destroyPickerOnHide) {
      this.setAttribute('destroyPickerOnHide', destroyPickerOnHide);
    }
  }, {
    key: "dirty",
    get: function get() {
  ...
  function ExtDatepickernativefieldComponent() {
    ...
    _this.METHODS = ExtDatepickernativefieldComponent.METHODS();
    _this.XTYPE = ExtDatepickernativefieldComponent.XTYPE(); //this.PROPERTIES = ExtDatepickernativefieldComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtDatepickernativefieldComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtDatepickernativefieldComponent.EVENTS();
    return _this;
  }

  var _proto = ExtDatepickernativefieldComponent.prototype;
