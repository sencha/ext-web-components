...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtRatingComponent, _ExtBase);

  ExtRatingComponent.XTYPE = function XTYPE() {
    return 'rating';
  };

  ExtRatingComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtRatingComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtRatingComponent.METHODS = function METHODS() {
    return [{
      ...
      name: 'valueFromEvent',
      "function": function _function() {
        return this.ext.valueFromEvent;
      }
    }, {
      name: 'valueToPercent',
  ...
  _createClass(ExtRatingComponent, [{
    key: "alwaysOnTop",
    get: function get() {
    ...
    key: "glyphs",
    get: function get() {
      return this.getAttribute('glyphs');
    },
    set: function set(glyphs) {
      this.setAttribute('glyphs', glyphs);
    }
  }, {
    key: "height",
    get: function get() {
    ...
    key: "overStyle",
    get: function get() {
      return this.getAttribute('overStyle');
    },
    set: function set(overStyle) {
      this.setAttribute('overStyle', overStyle);
    }
  }, {
    key: "padding",
    get: function get() {
    ...
    key: "rounding",
    get: function get() {
      return this.getAttribute('rounding');
    },
    set: function set(rounding) {
      this.setAttribute('rounding', rounding);
    }
  }, {
    key: "scale",
    get: function get() {
    ...
    key: "selectedStyle",
    get: function get() {
      return this.getAttribute('selectedStyle');
    },
    set: function set(selectedStyle) {
      this.setAttribute('selectedStyle', selectedStyle);
    }
  }, {
    key: "selfAlign",
    get: function get() {
    ...
    key: "tooltipText",
    get: function get() {
      return this.getAttribute('tooltipText');
    },
    set: function set(tooltipText) {
    ...
    key: "trackingValue",
    get: function get() {
      return this.getAttribute('trackingValue');
    },
    set: function set(trackingValue) {
      this.setAttribute('trackingValue', trackingValue);
    }
  }, {
    key: "trackOver",
    get: function get() {
      return this.getAttribute('trackOver');
    },
    set: function set(trackOver) {
  ...
  function ExtRatingComponent() {
    ...
    _this.METHODS = ExtRatingComponent.METHODS();
    _this.XTYPE = ExtRatingComponent.XTYPE(); //this.PROPERTIES = ExtRatingComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtRatingComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtRatingComponent.EVENTS();
    return _this;
  }

  var _proto = ExtRatingComponent.prototype;
