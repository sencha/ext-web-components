...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtCalendar_weekviewComponent, _ExtBase);

  ExtCalendar_weekviewComponent.XTYPE = function XTYPE() {
    return 'calendar_weekview';
  };

  ExtCalendar_weekviewComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "addForm": "Object",
  ...
  ExtCalendar_weekviewComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtCalendar_weekviewComponent.METHODS = function METHODS() {
    return [{
      ...
      name: 'getEventWidget',
      "function": function _function() {
        return this.ext.getEventWidget;
      }
    }, {
      name: 'getFloatParent',
      "function": function _function() {
  ...
  _createClass(ExtCalendar_weekviewComponent, [{
    key: "addForm",
    get: function get() {
    ...
    key: "displayOverlap",
    get: function get() {
      return this.getAttribute('displayOverlap');
    },
    set: function set(displayOverlap) {
      this.setAttribute('displayOverlap', displayOverlap);
    }
  }, {
    key: "docked",
    get: function get() {
    ...
    key: "resizeEvents",
    get: function get() {
      return this.getAttribute('resizeEvents');
    },
    set: function set(resizeEvents) {
      this.setAttribute('resizeEvents', resizeEvents);
    }
  }, {
    key: "right",
    get: function get() {
    ...
    key: "showNowMarker",
    get: function get() {
      return this.getAttribute('showNowMarker');
    },
    set: function set(showNowMarker) {
      this.setAttribute('showNowMarker', showNowMarker);
    }
  }, {
    key: "startTime",
    get: function get() {
    ...
    key: "timeRenderer",
    get: function get() {
      return this.getAttribute('timeRenderer');
    },
    set: function set(timeRenderer) {
      this.setAttribute('timeRenderer', timeRenderer);
    }
  }, {
    key: "timezoneOffset",
    get: function get() {
  ...
  function ExtCalendar_weekviewComponent() {
    ...
    _this.METHODS = ExtCalendar_weekviewComponent.METHODS();
    _this.XTYPE = ExtCalendar_weekviewComponent.XTYPE(); //this.PROPERTIES = ExtCalendar_weekviewComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtCalendar_weekviewComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtCalendar_weekviewComponent.EVENTS();
    return _this;
  }

  var _proto = ExtCalendar_weekviewComponent.prototype;
