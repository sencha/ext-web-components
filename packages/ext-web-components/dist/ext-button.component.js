...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtButtonComponent, _ExtBase);

  ExtButtonComponent.XTYPE = function XTYPE() {
    return 'button';
  };

  ExtButtonComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtButtonComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtButtonComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtButtonComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtButtonComponent() {
    ...
    _this.METHODS = ExtButtonComponent.METHODS();
    _this.XTYPE = ExtButtonComponent.XTYPE(); //this.PROPERTIES = ExtButtonComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtButtonComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtButtonComponent.EVENTS();
    return _this;
  }

  var _proto = ExtButtonComponent.prototype;
