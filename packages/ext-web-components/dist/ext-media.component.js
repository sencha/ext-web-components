...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtMediaComponent, _ExtBase);

  ExtMediaComponent.XTYPE = function XTYPE() {
    return 'media';
  };

  ExtMediaComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtMediaComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtMediaComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtMediaComponent, [{
    key: "alwaysOnTop",
    get: function get() {
  ...
  function ExtMediaComponent() {
    ...
    _this.METHODS = ExtMediaComponent.METHODS();
    _this.XTYPE = ExtMediaComponent.XTYPE(); //this.PROPERTIES = ExtMediaComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtMediaComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtMediaComponent.EVENTS();
    return _this;
  }

  var _proto = ExtMediaComponent.prototype;
