...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtPaneltitleComponent, _ExtBase);

  ExtPaneltitleComponent.XTYPE = function XTYPE() {
    return 'paneltitle';
  };

  ExtPaneltitleComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtPaneltitleComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtPaneltitleComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtPaneltitleComponent, [{
    key: "alwaysOnTop",
    get: function get() {
    ...
    key: "rotateIcon",
    get: function get() {
      return this.getAttribute('rotateIcon');
    },
    set: function set(rotateIcon) {
      this.setAttribute('rotateIcon', rotateIcon);
    }
  }, {
    key: "rotation",
    get: function get() {
  ...
  function ExtPaneltitleComponent() {
    ...
    _this.METHODS = ExtPaneltitleComponent.METHODS();
    _this.XTYPE = ExtPaneltitleComponent.XTYPE(); //this.PROPERTIES = ExtPaneltitleComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtPaneltitleComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtPaneltitleComponent.EVENTS();
    return _this;
  }

  var _proto = ExtPaneltitleComponent.prototype;
