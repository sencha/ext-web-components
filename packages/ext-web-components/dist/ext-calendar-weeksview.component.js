...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtCalendar_weeksviewComponent, _ExtBase);

  ExtCalendar_weeksviewComponent.XTYPE = function XTYPE() {
  ...
  ExtCalendar_weeksviewComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtCalendar_weeksviewComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtCalendar_weeksviewComponent, [{
    key: "addForm",
    get: function get() {
  ...
  function ExtCalendar_weeksviewComponent() {
    ...
    _this.METHODS = ExtCalendar_weeksviewComponent.METHODS();
    _this.XTYPE = ExtCalendar_weeksviewComponent.XTYPE(); //this.PROPERTIES = ExtCalendar_weeksviewComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtCalendar_weeksviewComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtCalendar_weeksviewComponent.EVENTS();
    return _this;
  }

  var _proto = ExtCalendar_weeksviewComponent.prototype;
