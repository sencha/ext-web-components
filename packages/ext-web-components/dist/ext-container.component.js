...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtContainerComponent, _ExtBase);

  ExtContainerComponent.XTYPE = function XTYPE() {
    return 'container';
  };

  ExtContainerComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtContainerComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
  ...
  ExtContainerComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtContainerComponent, [{
  ...
  function ExtContainerComponent() {
    ...
    _this.METHODS = ExtContainerComponent.METHODS();
    _this.XTYPE = ExtContainerComponent.XTYPE(); //this.PROPERTIES = ExtContainerComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtContainerComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtContainerComponent.EVENTS();
    return _this;
  }

  var _proto = ExtContainerComponent.prototype;
