...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtSpacerComponent, _ExtBase);

  ExtSpacerComponent.XTYPE = function XTYPE() {
    return 'spacer';
  };

  ExtSpacerComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtSpacerComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
  ...
  ExtSpacerComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtSpacerComponent, [{
    key: "alwaysOnTop",
    get: function get() {
  ...
  function ExtSpacerComponent() {
    ...
    _this.METHODS = ExtSpacerComponent.METHODS();
    _this.XTYPE = ExtSpacerComponent.XTYPE(); //this.PROPERTIES = ExtSpacerComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtSpacerComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtSpacerComponent.EVENTS();
    return _this;
  }

  var _proto = ExtSpacerComponent.prototype;
