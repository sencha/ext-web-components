...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtGridsummaryrowComponent, _ExtBase);

  ExtGridsummaryrowComponent.XTYPE = function XTYPE() {
    return 'gridsummaryrow';
  };

  ExtGridsummaryrowComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtGridsummaryrowComponent.EVENTS = function EVENTS() {
    return [{
      name: 'added',
      ...
      name: 'blur',
      parameters: 'gridsummaryrow,event'
    }, {
      name: 'bottomchange',
  ...
  ExtGridsummaryrowComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtGridsummaryrowComponent, [{
    key: "alignSelf",
    get: function get() {
    ...
    key: "defaultCellUI",
    get: function get() {
      return this.getAttribute('defaultCellUI');
    },
    set: function set(defaultCellUI) {
      this.setAttribute('defaultCellUI', defaultCellUI);
    }
  }, {
    ...
    key: "expandedField",
    get: function get() {
      return this.getAttribute('expandedField');
    },
    set: function set(expandedField) {
      this.setAttribute('expandedField', expandedField);
    }
  }, {
    key: "flex",
    get: function get() {
    ...
    key: "stickyVisibility",
    get: function get() {
      return this.getAttribute('stickyVisibility');
    },
    set: function set(stickyVisibility) {
      this.setAttribute('stickyVisibility', stickyVisibility);
    }
  }, {
    key: "style",
    get: function get() {
  ...
  function ExtGridsummaryrowComponent() {
    ...
    _this.METHODS = ExtGridsummaryrowComponent.METHODS();
    _this.XTYPE = ExtGridsummaryrowComponent.XTYPE(); //this.PROPERTIES = ExtGridsummaryrowComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtGridsummaryrowComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtGridsummaryrowComponent.EVENTS();
    return _this;
  }

  var _proto = ExtGridsummaryrowComponent.prototype;
