...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtPolarComponent, _ExtBase);

  ExtPolarComponent.XTYPE = function XTYPE() {
    return 'polar';
  };

  ExtPolarComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtPolarComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'newActiveItem,polar,oldActiveItem'
    }, {
      name: 'activeItemchange',
      parameters: 'sender,value,oldValue'
    }, {
      name: 'add',
      parameters: 'polar,item,index'
    }, {
      name: 'added',
      ...
      name: 'deactivate',
      parameters: 'oldActiveItem,polar,newActiveItem'
    }, {
      name: 'destroy',
      parameters: ''
    }, {
      ...
      name: 'itemhighlight',
      parameters: 'polar,newItem,oldItem'
    }, {
      ...
      name: 'move',
      parameters: 'polar,item,toIndex,fromIndex'
    }, {
      name: 'moved',
      ...
      name: 'renderedchange',
      parameters: 'polar,item,rendered'
    }, {
      name: 'resize',
  ...
  ExtPolarComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtPolarComponent, [{
  ...
  function ExtPolarComponent() {
    ...
    _this.METHODS = ExtPolarComponent.METHODS();
    _this.XTYPE = ExtPolarComponent.XTYPE(); //this.PROPERTIES = ExtPolarComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtPolarComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtPolarComponent.EVENTS();
    return _this;
  }

  var _proto = ExtPolarComponent.prototype;
