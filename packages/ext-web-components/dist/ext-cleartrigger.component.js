...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtCleartriggerComponent, _ExtBase);

  ExtCleartriggerComponent.XTYPE = function XTYPE() {
    return 'cleartrigger';
  };

  ExtCleartriggerComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtCleartriggerComponent.EVENTS = function EVENTS() {
    return [{
  ...
  ExtCleartriggerComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtCleartriggerComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtCleartriggerComponent() {
    ...
    _this.METHODS = ExtCleartriggerComponent.METHODS();
    _this.XTYPE = ExtCleartriggerComponent.XTYPE(); //this.PROPERTIES = ExtCleartriggerComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtCleartriggerComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtCleartriggerComponent.EVENTS();
    return _this;
  }

  var _proto = ExtCleartriggerComponent.prototype;
