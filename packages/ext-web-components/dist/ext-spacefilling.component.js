...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtSpacefillingComponent, _ExtBase);

  ExtSpacefillingComponent.XTYPE = function XTYPE() {
    return 'spacefilling';
  };

  ExtSpacefillingComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtSpacefillingComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'newActiveItem,spacefilling,oldActiveItem'
    }, {
      name: 'activeItemchange',
      parameters: 'sender,value,oldValue'
    }, {
      name: 'add',
      parameters: 'spacefilling,item,index'
    }, {
      name: 'added',
      ...
      name: 'deactivate',
      parameters: 'oldActiveItem,spacefilling,newActiveItem'
    }, {
      name: 'destroy',
      parameters: ''
    }, {
      ...
      name: 'itemhighlight',
      parameters: 'spacefilling,newItem,oldItem'
    }, {
      ...
      name: 'move',
      parameters: 'spacefilling,item,toIndex,fromIndex'
    }, {
      name: 'moved',
      ...
      name: 'renderedchange',
      parameters: 'spacefilling,item,rendered'
    }, {
      name: 'resize',
  ...
  ExtSpacefillingComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtSpacefillingComponent, [{
  ...
  function ExtSpacefillingComponent() {
    ...
    _this.METHODS = ExtSpacefillingComponent.METHODS();
    _this.XTYPE = ExtSpacefillingComponent.XTYPE(); //this.PROPERTIES = ExtSpacefillingComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtSpacefillingComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtSpacefillingComponent.EVENTS();
    return _this;
  }

  var _proto = ExtSpacefillingComponent.prototype;
