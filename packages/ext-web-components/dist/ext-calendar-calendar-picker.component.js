...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtCalendar_calendar_pickerComponent, _ExtBase);

  ExtCalendar_calendar_pickerComponent.XTYPE = function XTYPE() {
    return 'calendar_calendar_picker';
  };

  ExtCalendar_calendar_pickerComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
      "alignTarget": ["string"],
  ...
  ExtCalendar_calendar_pickerComponent.EVENTS = function EVENTS() {
    return [{
      name: 'action',
      parameters: 'calendar-calendar-picker,e'
    }, {
      name: 'added',
      ...
      name: 'beforetofront',
      parameters: 'calendar-calendar-picker'
    }, {
      ...
      name: 'change',
      parameters: 'calendar-calendar-picker,newValue,oldValue'
    }, {
      name: 'clearicontap',
      parameters: 'calendar-calendar-picker,input,e'
    }, {
      name: 'click',
      parameters: 'e'
    }, {
      ...
      name: 'dirtychange',
      parameters: 'calendar-calendar-picker,dirty'
    }, {
      name: 'disabledchange',
      parameters: 'sender,value,oldValue'
    }, {
      ...
      name: 'errorchange',
      parameters: 'calendar-calendar-picker,error'
    }, {
      name: 'expand',
      parameters: 'field'
    }, {
      ...
      name: 'focusenter',
      parameters: 'calendar-calendar-picker,event'
    }, {
      name: 'focusleave',
      parameters: 'calendar-calendar-picker,event'
    }, {
      ...
      name: 'select',
      parameters: 'calendar-calendar-picker,newValue'
    }, {
      name: 'show',
      parameters: 'sender'
    }, {
  ...
  ExtCalendar_calendar_pickerComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtCalendar_calendar_pickerComponent, [{
    key: "alignSelf",
    get: function get() {
  ...
  function ExtCalendar_calendar_pickerComponent() {
    ...
    _this.METHODS = ExtCalendar_calendar_pickerComponent.METHODS();
    _this.XTYPE = ExtCalendar_calendar_pickerComponent.XTYPE(); //this.PROPERTIES = ExtCalendar_calendar_pickerComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtCalendar_calendar_pickerComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtCalendar_calendar_pickerComponent.EVENTS();
    return _this;
  }

  var _proto = ExtCalendar_calendar_pickerComponent.prototype;
