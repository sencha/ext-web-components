...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtTextareafieldComponent, _ExtBase);

  ExtTextareafieldComponent.XTYPE = function XTYPE() {
    return 'textareafield';
  };

  ExtTextareafieldComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
      "alignSelf": ["string"],
  ...
  ExtTextareafieldComponent.EVENTS = function EVENTS() {
    return [{
      name: 'action',
      parameters: 'textareafield,e'
    }, {
      name: 'added',
      ...
      name: 'change',
      parameters: 'textareafield,newValue,oldValue'
    }, {
      name: 'clearicontap',
      parameters: 'textareafield,input,e'
    }, {
      name: 'click',
      parameters: 'e'
    }, {
      ...
      name: 'dirtychange',
      parameters: 'textareafield,dirty'
    }, {
      name: 'disabledchange',
      parameters: 'sender,value,oldValue'
    }, {
      ...
      name: 'errorchange',
      parameters: 'textareafield,error'
    }, {
      name: 'floatingchange',
      ...
      name: 'focusenter',
      parameters: 'textareafield,event'
    }, {
      name: 'focusleave',
      parameters: 'textareafield,event'
    }, {
  ...
  ExtTextareafieldComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtTextareafieldComponent, [{
    key: "alignSelf",
    get: function get() {
    ...
    key: "maxRows",
    get: function get() {
      return this.getAttribute('maxRows');
    },
    set: function set(maxRows) {
      this.setAttribute('maxRows', maxRows);
    }
  }, {
    key: "maxWidth",
    get: function get() {
  ...
  function ExtTextareafieldComponent() {
    ...
    _this.METHODS = ExtTextareafieldComponent.METHODS();
    _this.XTYPE = ExtTextareafieldComponent.XTYPE(); //this.PROPERTIES = ExtTextareafieldComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtTextareafieldComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtTextareafieldComponent.EVENTS();
    return _this;
  }

  var _proto = ExtTextareafieldComponent.prototype;
