...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtPanelheaderComponent, _ExtBase);

  ExtPanelheaderComponent.XTYPE = function XTYPE() {
    return 'panelheader';
  };

  ExtPanelheaderComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    return {
  ...
  ExtPanelheaderComponent.EVENTS = function EVENTS() {
    return [{
      name: 'activate',
      parameters: 'newActiveItem,panelheader,oldActiveItem'
    }, {
      name: 'activeItemchange',
      parameters: 'sender,value,oldValue'
    }, {
      name: 'add',
      parameters: 'panelheader,item,index'
    }, {
      name: 'added',
      ...
      name: 'deactivate',
      parameters: 'oldActiveItem,panelheader,newActiveItem'
    }, {
      name: 'destroy',
      parameters: ''
    }, {
      ...
      name: 'move',
      parameters: 'panelheader,item,toIndex,fromIndex'
    }, {
      name: 'moved',
      ...
      name: 'renderedchange',
      parameters: 'panelheader,item,rendered'
    }, {
      name: 'resize',
  ...
  ExtPanelheaderComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtPanelheaderComponent, [{
    ...
    key: "titleRotation",
    get: function get() {
      return this.getAttribute('titleRotation');
    },
    set: function set(titleRotation) {
      this.setAttribute('titleRotation', titleRotation);
    }
  }, {
    key: "toFrontOnShow",
    get: function get() {
  ...
  function ExtPanelheaderComponent() {
    ...
    _this.METHODS = ExtPanelheaderComponent.METHODS();
    _this.XTYPE = ExtPanelheaderComponent.XTYPE(); //this.PROPERTIES = ExtPanelheaderComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtPanelheaderComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtPanelheaderComponent.EVENTS();
    return _this;
  }

  var _proto = ExtPanelheaderComponent.prototype;
