...
/*#__PURE__*/
function (_ExtBase) {
  _inheritsLoose(ExtPivotgridgroupcellComponent, _ExtBase);

  ExtPivotgridgroupcellComponent.XTYPE = function XTYPE() {
    return 'pivotgridgroupcell';
  };

  ExtPivotgridgroupcellComponent.PROPERTIESOBJECT = function PROPERTIESOBJECT() {
    var _ref;
  ...
  ExtPivotgridgroupcellComponent.EVENTS = function EVENTS() {
    return [{
  ...
  ExtPivotgridgroupcellComponent.METHODS = function METHODS() {
    return [{
  ...
  _createClass(ExtPivotgridgroupcellComponent, [{
    key: "align",
    get: function get() {
  ...
  function ExtPivotgridgroupcellComponent() {
    ...
    _this.METHODS = ExtPivotgridgroupcellComponent.METHODS();
    _this.XTYPE = ExtPivotgridgroupcellComponent.XTYPE(); //this.PROPERTIES = ExtPivotgridgroupcellComponent.PROPERTIES()

    _this.PROPERTIESOBJECT = ExtPivotgridgroupcellComponent.PROPERTIESOBJECT();
    _this.EVENTS = ExtPivotgridgroupcellComponent.EVENTS();
    return _this;
  }

  var _proto = ExtPivotgridgroupcellComponent.prototype;
