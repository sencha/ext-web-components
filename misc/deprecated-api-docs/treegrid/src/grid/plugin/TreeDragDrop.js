  ...
  * >
  * <ext-tree
  *   onready="treedragdrop.treeready"
  *   height= "600"
  *   width= "400"
  ...
  *
  * export default class TreeDragDropComponent {
  *   constructor () {
  ...
  * 
  *     treeready = () => {
  *         this.treeready = event.detail.cmp;
  *         this.treeready.setStore(this.store);
  *     }
  * }
  * window.treedragdrop = new TreeDragDropComponent();
  * 
  * ```
 */
